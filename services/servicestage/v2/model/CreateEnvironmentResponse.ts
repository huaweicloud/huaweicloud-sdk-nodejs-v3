...
export class CreateEnvironmentResponse extends SdkResponse {
    ...
    public withAlias(alias: string): CreateEnvironmentResponse {
        this['alias'] = alias;
        return this;
    }
    ...
    public withChargeMode(chargeMode: string): CreateEnvironmentResponse {
    ...
    public withDeployMode(deployMode: string): CreateEnvironmentResponse {
    ...
    public withBaseResources(baseResources: Array<Resource>): CreateEnvironmentResponse {
    ...
    public withOptionalResources(optionalResources: Array<Resource>): CreateEnvironmentResponse {
