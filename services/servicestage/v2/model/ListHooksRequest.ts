...
export class ListHooksRequest {
    ...
    public withXRepoAuth(xRepoAuth: string): ListHooksRequest {
        this['X-Repo-Auth'] = xRepoAuth;
        return this;
    }
    ...
    public withNamespace(namespace: string): ListHooksRequest {
        this['namespace'] = namespace;
        return this;
    }
    public withProject(project: string): ListHooksRequest {
        this['project'] = project;
        return this;
    }
}