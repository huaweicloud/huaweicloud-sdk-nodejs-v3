...
export class ListWafWhiteIpRuleRequest {
    ...
    public withDomainName(domainName: string): ListWafWhiteIpRuleRequest {
        this['domain_name'] = domainName;
        return this;
    }
    ...
    public withOverseasType(overseasType: number): ListWafWhiteIpRuleRequest {
        this['overseas_type'] = overseasType;
        return this;
    }
