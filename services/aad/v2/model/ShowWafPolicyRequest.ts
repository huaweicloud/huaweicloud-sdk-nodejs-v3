...
export class ShowWafPolicyRequest {
    ...
    public withDomainName(domainName: string): ShowWafPolicyRequest {
        this['domain_name'] = domainName;
        return this;
    }
    ...
    public withOverseasType(overseasType: number): ShowWafPolicyRequest {
        this['overseas_type'] = overseasType;
        return this;
    }
