...
export class ListWafCustomRuleRequest {
    ...
    public withDomainName(domainName: string): ListWafCustomRuleRequest {
        this['domain_name'] = domainName;
        return this;
    }
    ...
    public withOverseasType(overseasType: number): ListWafCustomRuleRequest {
        this['overseas_type'] = overseasType;
        return this;
    }
