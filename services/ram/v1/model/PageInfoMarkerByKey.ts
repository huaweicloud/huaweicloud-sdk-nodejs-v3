...
export class PageInfoMarkerByKey {
    private 'previous_marker'?: string;
    private 'next_marker'?: string;
    private 'current_count'?: number;
    public constructor() { 
    }
    public withPreviousMarker(previousMarker: string): PageInfoMarkerByKey {
    ...
    public withNextMarker(nextMarker: string): PageInfoMarkerByKey {
    ...
    public withCurrentCount(currentCount: number): PageInfoMarkerByKey {
