...
export class Permission {
    ...
    public constructor(id?: string, name?: string, resourceType?: string, content?: string, isResourceTypeDefault?: boolean, createdAt?: Date, updatedAt?: Date) { 
        this['id'] = id;
        this['name'] = name;
    ...
    public withResourceType(resourceType: string): Permission {
        this['resource_type'] = resourceType;
        return this;
    }
    ...
    public withContent(content: string): Permission {
        this['content'] = content;
        return this;
    }
    public withIsResourceTypeDefault(isResourceTypeDefault: boolean): Permission {
        this['is_resource_type_default'] = isResourceTypeDefault;
        return this;
    }
    ...
    public withUpdatedAt(updatedAt: Date): Permission {
        this['updated_at'] = updatedAt;
        return this;
    }
    ...
    public withPermissionUrn(permissionUrn: string): Permission {
    ...
    public withPermissionType(permissionType: string): Permission {
    ...
    public withDefaultVersion(defaultVersion: boolean): Permission {
    ...
    public withVersion(version: number): Permission {
