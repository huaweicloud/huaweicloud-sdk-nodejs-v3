...
export class UpdateConfigurationDictionariesResponse extends SdkResponse {
    private 'success_list'?: Array<Dictionary>;
    private 'failed_list'?: Array<Dictionary>;
    public constructor() { 
        super();
    }
    public withSuccessList(successList: Array<Dictionary>): UpdateConfigurationDictionariesResponse {
    ...
    public withFailedList(failedList: Array<Dictionary>): UpdateConfigurationDictionariesResponse {
