...
export class CreateDataobjectRelationRequest {
    ...
    public withContentType(contentType: string): CreateDataobjectRelationRequest {
        this['content-type'] = contentType;
        return this;
    }
    ...
    public withWorkspaceId(workspaceId: string): CreateDataobjectRelationRequest {
        this['workspace_id'] = workspaceId;
        return this;
    }
    ...
    public withDataclassType(dataclassType: string): CreateDataobjectRelationRequest {
        this['dataclass_type'] = dataclassType;
        return this;
    }
    ...
    public withDataObjectId(dataObjectId: string): CreateDataobjectRelationRequest {
        this['data_object_id'] = dataObjectId;
        return this;
    }
    ...
    public withRelatedDataclassType(relatedDataclassType: string): CreateDataobjectRelationRequest {
        this['related_dataclass_type'] = relatedDataclassType;
        return this;
    }
    ...
    public withBody(body: CreateDataobjectRelationRequestBody): CreateDataobjectRelationRequest {
        this['body'] = body;
        return this;
    }
}