...
export class RetryShipperRequest {
    ...
    public withWorkspaceId(workspaceId: string): RetryShipperRequest {
        this['workspace_id'] = workspaceId;
        return this;
    }
    ...
    public withShipperId(shipperId: string): RetryShipperRequest {
        this['shipper_id'] = shipperId;
        return this;
    }
