...
export class MetricMetaData {
    ...
    public withName(name: string): MetricMetaData {
        this['name'] = name;
        return this;
    }
    public withId(id: string): MetricMetaData {
        this['id'] = id;
        return this;
    }
    public withMetricType(metricType: string): MetricMetaData {
        this['metric_type'] = metricType;
        return this;
    }
    ...
    public withDataType(dataType: string): MetricMetaData {
        this['data_type'] = dataType;
        return this;
    }
    ...
    public withMetricDimension(metricDimension: number): MetricMetaData {
    ...
    public withCacheTtl(cacheTtl: number): MetricMetaData {
        this['cache_ttl'] = cacheTtl;
        return this;
    }
    ...
    public withReportPeriod(reportPeriod: number): MetricMetaData {
    ...
    public withIsBuiltIn(isBuiltIn: boolean): MetricMetaData {
    ...
    public withEffectiveColumn(effectiveColumn: string): MetricMetaData {
    ...
    public withMaxQueryRange(maxQueryRange: number): MetricMetaData {
    ...
    public withDerivedMetrics(derivedMetrics: Array<MetricMetaDataDerivedMetrics>): MetricMetaData {
    ...
    public withCompoundExpression(compoundExpression: string): MetricMetaData {
    ...
    public withMetricFormat(metricFormat: Array<LayoutMetricFormat>): MetricMetaData {
    ...
    public withMetricExpandDim(metricExpandDim: MetricDimensionExpandParam): MetricMetaData {
    ...
    public withVersion(version: string): MetricMetaData {
