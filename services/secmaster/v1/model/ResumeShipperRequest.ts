...
export class ResumeShipperRequest {
    ...
    public withWorkspaceId(workspaceId: string): ResumeShipperRequest {
        this['workspace_id'] = workspaceId;
        return this;
    }
    ...
    public withShipperId(shipperId: string): ResumeShipperRequest {
        this['shipper_id'] = shipperId;
        return this;
    }
