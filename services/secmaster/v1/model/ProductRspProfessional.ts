...
export class ProductRspProfessional {
    ...
    public withCloudServiceType(cloudServiceType: string): ProductRspProfessional {
    ...
    public withResourceType(resourceType: string): ProductRspProfessional {
    ...
    public withResourceSpecCode(resourceSpecCode: string): ProductRspProfessional {
    ...
    public withResourceSizeMeasureId(resourceSizeMeasureId: number): ProductRspProfessional {
    ...
    public withUsageFactor(usageFactor: string): ProductRspProfessional {
    ...
    public withUsageMeasureId(usageMeasureId: number): ProductRspProfessional {
    ...
    public withRegionId(regionId: string): ProductRspProfessional {
