...
export class CopyPlaybookVersionResponse extends SdkResponse {
    ...
    public withXAPIDeprecationInfo(xAPIDeprecationInfo: string): CopyPlaybookVersionResponse {
    ...
    public withXAPIDeprecationDate(xAPIDeprecationDate: string): CopyPlaybookVersionResponse {
