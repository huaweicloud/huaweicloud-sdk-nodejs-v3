...
export class UpdatePlaybookRuleResponse extends SdkResponse {
    ...
    public withXAPIDeprecationInfo(xAPIDeprecationInfo: string): UpdatePlaybookRuleResponse {
    ...
    public withXAPIDeprecationDate(xAPIDeprecationDate: string): UpdatePlaybookRuleResponse {
