...
export class DeleteCollectorParserRequest {
    ...
    public withWorkspaceId(workspaceId: string): DeleteCollectorParserRequest {
        this['workspace_id'] = workspaceId;
        return this;
    }
    ...
    public withParserId(parserId: string): DeleteCollectorParserRequest {
        this['parser_id'] = parserId;
        return this;
    }
