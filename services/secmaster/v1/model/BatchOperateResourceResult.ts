...
export class BatchOperateResourceResult {
    private 'error_ids'?: Array<string>;
    private 'success_ids'?: Array<string>;
    public constructor() { 
    }
    public withErrorIds(errorIds: Array<string>): BatchOperateResourceResult {
    ...
    public withSuccessIds(successIds: Array<string>): BatchOperateResourceResult {
