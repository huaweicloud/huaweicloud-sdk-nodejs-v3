...
export class SearchPolicyRecordRequest {
    ...
    public withContentType(contentType: string): SearchPolicyRecordRequest {
        this['Content-Type'] = contentType;
        return this;
    }
    ...
    public withXSecmasterVersion(xSecmasterVersion: string): SearchPolicyRecordRequest {
        this['X-Secmaster-Version'] = xSecmasterVersion;
        return this;
    }
    ...
    public withWorkspaceId(workspaceId: string): SearchPolicyRecordRequest {
        this['workspace_id'] = workspaceId;
        return this;
    }
    ...
    public withBody(body: SearchPolicyRequestBody): SearchPolicyRecordRequest {
        this['body'] = body;
        return this;
    }
}