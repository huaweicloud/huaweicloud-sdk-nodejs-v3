...
export class ShowPlaybookMonitorsResponse extends SdkResponse {
    ...
    public withXAPIDeprecationInfo(xAPIDeprecationInfo: string): ShowPlaybookMonitorsResponse {
    ...
    public withXAPIDeprecationDate(xAPIDeprecationDate: string): ShowPlaybookMonitorsResponse {
