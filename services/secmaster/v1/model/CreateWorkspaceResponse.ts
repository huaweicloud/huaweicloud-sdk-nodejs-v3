...
export class CreateWorkspaceResponse extends SdkResponse {
    ...
    public withCreateTime(createTime: string): CreateWorkspaceResponse {
    ...
    public withUpdateTime(updateTime: string): CreateWorkspaceResponse {
    ...
    public withCreatorId(creatorId: string): CreateWorkspaceResponse {
    ...
    public withCreatorName(creatorName: string): CreateWorkspaceResponse {
    ...
    public withModifierId(modifierId: string): CreateWorkspaceResponse {
    ...
    public withModifierName(modifierName: string): CreateWorkspaceResponse {
    ...
    public withProjectId(projectId: string): CreateWorkspaceResponse {
    ...
    public withProjectName(projectName: string): CreateWorkspaceResponse {
    ...
    public withDomainId(domainId: string): CreateWorkspaceResponse {
    ...
    public withDomainName(domainName: string): CreateWorkspaceResponse {
    ...
    public withIsView(isView: boolean): CreateWorkspaceResponse {
        this['is_view'] = isView;
        return this;
    }
    ...
    public withRegionId(regionId: string): CreateWorkspaceResponse {
    ...
    public withViewBindId(viewBindId: string): CreateWorkspaceResponse {
    ...
    public withViewBindName(viewBindName: string): CreateWorkspaceResponse {
    ...
    public withWorkspaceAgencyList(workspaceAgencyList: Array<CreateWorkspaceResponseBodyWorkspaceAgencyList>): CreateWorkspaceResponse {
