...
export class ProductRspSoar {
    ...
    public withCloudServiceType(cloudServiceType: string): ProductRspSoar {
    ...
    public withResourceType(resourceType: string): ProductRspSoar {
    ...
    public withResourceSpecCode(resourceSpecCode: string): ProductRspSoar {
    ...
    public withResourceSizeMeasureId(resourceSizeMeasureId: number): ProductRspSoar {
    ...
    public withUsageFactor(usageFactor: string): ProductRspSoar {
    ...
    public withUsageMeasureId(usageMeasureId: number): ProductRspSoar {
    ...
    public withRegionId(regionId: string): ProductRspSoar {
