...
export class HwcEipVnic {
    ...
    public withPrivateIpAddress(privateIpAddress: string): HwcEipVnic {
    ...
    public withDeviceId(deviceId: string): HwcEipVnic {
    ...
    public withDeviceOwner(deviceOwner: string): HwcEipVnic {
    ...
    public withVpcId(vpcId: string): HwcEipVnic {
        this['vpc_id'] = vpcId;
        return this;
    }
    ...
    public withPortId(portId: string): HwcEipVnic {
        this['port_id'] = portId;
        return this;
    }
    ...
    public withPortProfile(portProfile: string): HwcEipVnic {
    ...
    public withMac(mac: string): HwcEipVnic {
        this['mac'] = mac;
        return this;
    }
    public withVtep(vtep: string): HwcEipVnic {
        this['vtep'] = vtep;
        return this;
    }
    public withVni(vni: string): HwcEipVnic {
        this['vni'] = vni;
        return this;
    }
    public withInstanceId(instanceId: string): HwcEipVnic {
    ...
    public withInstanceType(instanceType: string): HwcEipVnic {
