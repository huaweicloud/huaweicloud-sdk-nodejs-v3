...
export class ProductRspLargeScreen {
    ...
    public withCloudServiceType(cloudServiceType: string): ProductRspLargeScreen {
    ...
    public withResourceType(resourceType: string): ProductRspLargeScreen {
    ...
    public withResourceSpecCode(resourceSpecCode: string): ProductRspLargeScreen {
    ...
    public withResourceSizeMeasureId(resourceSizeMeasureId: number): ProductRspLargeScreen {
    ...
    public withUsageFactor(usageFactor: string): ProductRspLargeScreen {
    ...
    public withUsageMeasureId(usageMeasureId: number): ProductRspLargeScreen {
    ...
    public withRegionId(regionId: string): ProductRspLargeScreen {
