...
export class ShowDataspaceRequest {
    ...
    public withWorkspaceId(workspaceId: string): ShowDataspaceRequest {
        this['workspace_id'] = workspaceId;
        return this;
    }
    ...
    public withDataspaceId(dataspaceId: string): ShowDataspaceRequest {
        this['dataspace_id'] = dataspaceId;
        return this;
    }
