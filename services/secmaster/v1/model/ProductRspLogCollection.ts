...
export class ProductRspLogCollection {
    ...
    public withCloudServiceType(cloudServiceType: string): ProductRspLogCollection {
    ...
    public withResourceType(resourceType: string): ProductRspLogCollection {
    ...
    public withResourceSpecCode(resourceSpecCode: string): ProductRspLogCollection {
    ...
    public withResourceSizeMeasureId(resourceSizeMeasureId: number): ProductRspLogCollection {
    ...
    public withUsageFactor(usageFactor: string): ProductRspLogCollection {
    ...
    public withUsageMeasureId(usageMeasureId: number): ProductRspLogCollection {
    ...
    public withRegionId(regionId: string): ProductRspLogCollection {
