...
export class ProductRspLogAnalysis {
    ...
    public withCloudServiceType(cloudServiceType: string): ProductRspLogAnalysis {
    ...
    public withResourceType(resourceType: string): ProductRspLogAnalysis {
    ...
    public withResourceSpecCode(resourceSpecCode: string): ProductRspLogAnalysis {
    ...
    public withResourceSizeMeasureId(resourceSizeMeasureId: number): ProductRspLogAnalysis {
    ...
    public withUsageFactor(usageFactor: string): ProductRspLogAnalysis {
    ...
    public withUsageMeasureId(usageMeasureId: number): ProductRspLogAnalysis {
    ...
    public withRegionId(regionId: string): ProductRspLogAnalysis {
