...
export class CreateMetricResponse extends SdkResponse {
    public name?: string;
    public id?: string;
    ...
    public withName(name: string): CreateMetricResponse {
        this['name'] = name;
        return this;
    }
    public withId(id: string): CreateMetricResponse {
        this['id'] = id;
        return this;
    }
    public withMetricType(metricType: string): CreateMetricResponse {
    ...
    public withDataType(dataType: string): CreateMetricResponse {
    ...
    public withMetricDimension(metricDimension: number): CreateMetricResponse {
    ...
    public withCacheTtl(cacheTtl: number): CreateMetricResponse {
    ...
    public withReportPeriod(reportPeriod: number): CreateMetricResponse {
    ...
    public withIsBuiltIn(isBuiltIn: boolean): CreateMetricResponse {
    ...
    public withEffectiveColumn(effectiveColumn: string): CreateMetricResponse {
    ...
    public withMaxQueryRange(maxQueryRange: number): CreateMetricResponse {
    ...
    public withDerivedMetrics(derivedMetrics: Array<MetricMetaDataDerivedMetrics>): CreateMetricResponse {
    ...
    public withCompoundExpression(compoundExpression: string): CreateMetricResponse {
    ...
    public withMetricFormat(metricFormat: Array<LayoutMetricFormat>): CreateMetricResponse {
    ...
    public withMetricExpandDim(metricExpandDim: MetricDimensionExpandParam): CreateMetricResponse {
    ...
    public withVersion(version: string): CreateMetricResponse {
        this['version'] = version;
        return this;
    }
    public withXRequestId(xRequestId: string): CreateMetricResponse {
