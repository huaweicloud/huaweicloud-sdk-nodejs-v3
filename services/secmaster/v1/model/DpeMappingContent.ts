...
export class DpeMappingContent {
    public id?: string;
    public name?: string;
    ...
    public withId(id: string): DpeMappingContent {
        this['id'] = id;
        return this;
    }
    public withName(name: string): DpeMappingContent {
        this['name'] = name;
        return this;
    }
    public withProjectId(projectId: string): DpeMappingContent {
    ...
    public withWorkspaceId(workspaceId: string): DpeMappingContent {
    ...
    public withDataclassId(dataclassId: string): DpeMappingContent {
    ...
    public withDataclassName(dataclassName: string): DpeMappingContent {
    ...
    public withMapperTypeId(mapperTypeId: string): DpeMappingContent {
    ...
    public withMappingId(mappingId: string): DpeMappingContent {
    ...
    public withCreateTime(createTime: string): DpeMappingContent {
    ...
    public withCreatorId(creatorId: string): DpeMappingContent {
    ...
    public withCreatorName(creatorName: string): DpeMappingContent {
    ...
    public withUpdateTime(updateTime: string): DpeMappingContent {
    ...
    public withModifierId(modifierId: string): DpeMappingContent {
    ...
    public withModifierName(modifierName: string): DpeMappingContent {
