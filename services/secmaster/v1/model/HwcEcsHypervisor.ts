...
export class HwcEcsHypervisor {
    private 'hypervisor_type'?: string;
    private 'csd_hypervisor'?: string;
    public constructor() { 
    }
    public withHypervisorType(hypervisorType: string): HwcEcsHypervisor {
    ...
    public withCsdHypervisor(csdHypervisor: string): HwcEcsHypervisor {
