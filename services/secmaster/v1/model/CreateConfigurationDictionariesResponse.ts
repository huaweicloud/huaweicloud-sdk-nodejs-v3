...
export class CreateConfigurationDictionariesResponse extends SdkResponse {
    private 'success_list'?: Array<Dictionary>;
    private 'failed_list'?: Array<Dictionary>;
    public constructor() { 
        super();
    }
    public withSuccessList(successList: Array<Dictionary>): CreateConfigurationDictionariesResponse {
    ...
    public withFailedList(failedList: Array<Dictionary>): CreateConfigurationDictionariesResponse {
