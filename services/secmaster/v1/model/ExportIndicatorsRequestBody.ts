...
export class ExportIndicatorsRequestBody {
    private 'data_object_filters_form'?: DataobjectSearch;
    public title?: Array<string>;
    public constructor() { 
    }
    public withDataObjectFiltersForm(dataObjectFiltersForm: DataobjectSearch): ExportIndicatorsRequestBody {
    ...
    public withTitle(title: Array<string>): ExportIndicatorsRequestBody {
        this['title'] = title;
        return this;
    }
}