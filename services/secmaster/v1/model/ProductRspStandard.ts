...
export class ProductRspStandard {
    ...
    public withCloudServiceType(cloudServiceType: string): ProductRspStandard {
    ...
    public withResourceType(resourceType: string): ProductRspStandard {
    ...
    public withResourceSpecCode(resourceSpecCode: string): ProductRspStandard {
    ...
    public withResourceSizeMeasureId(resourceSizeMeasureId: number): ProductRspStandard {
    ...
    public withUsageFactor(usageFactor: string): ProductRspStandard {
    ...
    public withUsageMeasureId(usageMeasureId: number): ProductRspStandard {
    ...
    public withRegionId(regionId: string): ProductRspStandard {
