...
export class WizardDetailInfoBindingButton {
    private 'button_id'?: string;
    private 'button_name'?: string;
    public constructor(buttonId?: string) { 
        this['button_id'] = buttonId;
    }
    public withButtonId(buttonId: string): WizardDetailInfoBindingButton {
        this['button_id'] = buttonId;
        return this;
    }
    ...
    public withButtonName(buttonName: string): WizardDetailInfoBindingButton {
