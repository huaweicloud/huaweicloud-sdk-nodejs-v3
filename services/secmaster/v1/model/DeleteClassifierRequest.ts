...
export class DeleteClassifierRequest {
    ...
    public withContentType(contentType: string): DeleteClassifierRequest {
        this['Content-Type'] = contentType;
        return this;
    }
    ...
    public withWorkspaceId(workspaceId: string): DeleteClassifierRequest {
        this['workspace_id'] = workspaceId;
        return this;
    }
    ...
    public withClassifierId(classifierId: string): DeleteClassifierRequest {
        this['classifier_id'] = classifierId;
        return this;
    }
