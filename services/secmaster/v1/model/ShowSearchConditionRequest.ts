...
export class ShowSearchConditionRequest {
    ...
    public withWorkspaceId(workspaceId: string): ShowSearchConditionRequest {
        this['workspace_id'] = workspaceId;
        return this;
    }
    ...
    public withConditionId(conditionId: string): ShowSearchConditionRequest {
        this['condition_id'] = conditionId;
        return this;
    }
