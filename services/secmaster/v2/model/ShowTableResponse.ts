...
export class ShowTableResponse extends SdkResponse {
    ...
    public withProjectId(projectId: string): ShowTableResponse {
    ...
    public withWorkspaceId(workspaceId: string): ShowTableResponse {
    ...
    public withTableId(tableId: string): ShowTableResponse {
    ...
    public withPipeId(pipeId: string): ShowTableResponse {
        this['pipe_id'] = pipeId;
        return this;
    }
    ...
    public withTableName(tableName: string): ShowTableResponse {
    ...
    public withTableAlias(tableAlias: string): ShowTableResponse {
    ...
    public withDescription(description: string): ShowTableResponse {
        this['description'] = description;
        return this;
    }
    public withDirectory(directory: string): ShowTableResponse {
        this['directory'] = directory;
        return this;
    }
    public withCategory(category: IsapTableCategory): ShowTableResponse {
        this['category'] = category;
        return this;
    }
    public withLockStatus(lockStatus: TableLockStatus): ShowTableResponse {
    ...
    public withProcessStatus(processStatus: IsapTableProcessStatus): ShowTableResponse {
    ...
    public withProcessError(processError: IsapTableProcessError): ShowTableResponse {
    ...
    public withFormat(format: TableFormat): ShowTableResponse {
        this['format'] = format;
        return this;
    }
    public withRwType(rwType: TableRWType): ShowTableResponse {
        this['rw_type'] = rwType;
        return this;
    }
    ...
    public withOwnerType(ownerType: TableOwnerType): ShowTableResponse {
    ...
    public withDataLayering(dataLayering: DataLayering): ShowTableResponse {
    ...
    public withDataClassification(dataClassification: DataClassification): ShowTableResponse {
    ...
    public withSchema(schema: IsapTableSchema): ShowTableResponse {
        this['schema'] = schema;
        return this;
    }
    public withStorageSetting(storageSetting: TableStorageSetting): ShowTableResponse {
    ...
    public withDisplaySetting(displaySetting: TableDisplaySetting): ShowTableResponse {
    ...
    public withCreateTime(createTime: number): ShowTableResponse {
    ...
    public withUpdateTime(updateTime: number): ShowTableResponse {
    ...
    public withDeleteTime(deleteTime: number): ShowTableResponse {
