...
export class UpdateTableSchemaResponse extends SdkResponse {
    ...
    public withProjectId(projectId: string): UpdateTableSchemaResponse {
    ...
    public withWorkspaceId(workspaceId: string): UpdateTableSchemaResponse {
    ...
    public withTableId(tableId: string): UpdateTableSchemaResponse {
    ...
    public withPipeId(pipeId: string): UpdateTableSchemaResponse {
        this['pipe_id'] = pipeId;
        return this;
    }
    ...
    public withTableName(tableName: string): UpdateTableSchemaResponse {
    ...
    public withTableAlias(tableAlias: string): UpdateTableSchemaResponse {
    ...
    public withDescription(description: string): UpdateTableSchemaResponse {
        this['description'] = description;
        return this;
    }
    public withDirectory(directory: string): UpdateTableSchemaResponse {
        this['directory'] = directory;
        return this;
    }
    public withCategory(category: IsapTableCategory): UpdateTableSchemaResponse {
        this['category'] = category;
        return this;
    }
    public withLockStatus(lockStatus: TableLockStatus): UpdateTableSchemaResponse {
    ...
    public withProcessStatus(processStatus: IsapTableProcessStatus): UpdateTableSchemaResponse {
    ...
    public withProcessError(processError: IsapTableProcessError): UpdateTableSchemaResponse {
    ...
    public withFormat(format: TableFormat): UpdateTableSchemaResponse {
        this['format'] = format;
        return this;
    }
    public withRwType(rwType: TableRWType): UpdateTableSchemaResponse {
        this['rw_type'] = rwType;
        return this;
    }
    ...
    public withOwnerType(ownerType: TableOwnerType): UpdateTableSchemaResponse {
    ...
    public withDataLayering(dataLayering: DataLayering): UpdateTableSchemaResponse {
    ...
    public withDataClassification(dataClassification: DataClassification): UpdateTableSchemaResponse {
    ...
    public withSchema(schema: IsapTableSchema): UpdateTableSchemaResponse {
        this['schema'] = schema;
        return this;
    }
    public withStorageSetting(storageSetting: TableStorageSetting): UpdateTableSchemaResponse {
    ...
    public withDisplaySetting(displaySetting: TableDisplaySetting): UpdateTableSchemaResponse {
    ...
    public withCreateTime(createTime: number): UpdateTableSchemaResponse {
    ...
    public withUpdateTime(updateTime: number): UpdateTableSchemaResponse {
    ...
    public withDeleteTime(deleteTime: number): UpdateTableSchemaResponse {
