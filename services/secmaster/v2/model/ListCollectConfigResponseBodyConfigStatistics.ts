...
export class ListCollectConfigResponseBodyConfigStatistics {
    ...
    public withAccountNum(accountNum: number): ListCollectConfigResponseBodyConfigStatistics {
    ...
    public withDailyTraffic(dailyTraffic: number): ListCollectConfigResponseBodyConfigStatistics {
    ...
    public withLogNum(logNum: number): ListCollectConfigResponseBodyConfigStatistics {
        this['log_num'] = logNum;
        return this;
    }
    ...
    public withProductAllNum(productAllNum: number): ListCollectConfigResponseBodyConfigStatistics {
    ...
    public withProductInNum(productInNum: number): ListCollectConfigResponseBodyConfigStatistics {
    ...
    public withVendorNum(vendorNum: number): ListCollectConfigResponseBodyConfigStatistics {
