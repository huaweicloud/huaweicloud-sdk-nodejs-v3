...
export class UpdateAlertRuleResponse extends SdkResponse {
    ...
    public withAlertRuleId(alertRuleId: string): UpdateAlertRuleResponse {
    ...
    public withAlertRuleName(alertRuleName: string): UpdateAlertRuleResponse {
    ...
    public withScript(script: string): UpdateAlertRuleResponse {
        this['script'] = script;
        return this;
    }
    public withStatus(status: JobStatus): UpdateAlertRuleResponse {
        this['status'] = status;
        return this;
    }
    public withDirectory(directory: string): UpdateAlertRuleResponse {
        this['directory'] = directory;
        return this;
    }
    public withDescription(description: string): UpdateAlertRuleResponse {
        this['description'] = description;
        return this;
    }
    public withJobMode(jobMode: IsapJobMode): UpdateAlertRuleResponse {
    ...
    public withJobModeSetting(jobModeSetting: IsapJobModeSettingVo): UpdateAlertRuleResponse {
    ...
    public withJobOutputSetting(jobOutputSetting: AlertRuleJobSetting): UpdateAlertRuleResponse {
    ...
    public withProcessStatus(processStatus: JobProcessStatus): UpdateAlertRuleResponse {
    ...
    public withProcessError(processError: AlertRuleProcessError): UpdateAlertRuleResponse {
    ...
    public withEnvironment(environment: JobEnvironment): UpdateAlertRuleResponse {
        this['environment'] = environment;
        return this;
    }
    public withOutputTableId(outputTableId: string): UpdateAlertRuleResponse {
    ...
    public withOutputTableName(outputTableName: string): UpdateAlertRuleResponse {
    ...
    public withOutputTableIds(outputTableIds: Array<string>): UpdateAlertRuleResponse {
    ...
    public withOutputTableNames(outputTableNames: Array<string>): UpdateAlertRuleResponse {
