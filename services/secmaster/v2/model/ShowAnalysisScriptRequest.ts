...
export class ShowAnalysisScriptRequest {
    ...
    public withWorkspaceId(workspaceId: string): ShowAnalysisScriptRequest {
        this['workspace_id'] = workspaceId;
        return this;
    }
    ...
    public withAnalysisScriptId(analysisScriptId: string): ShowAnalysisScriptRequest {
        this['analysis_script_id'] = analysisScriptId;
        return this;
    }
