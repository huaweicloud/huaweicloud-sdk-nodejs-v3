...
export class UpdateTableResponse extends SdkResponse {
    ...
    public withProjectId(projectId: string): UpdateTableResponse {
    ...
    public withWorkspaceId(workspaceId: string): UpdateTableResponse {
    ...
    public withTableId(tableId: string): UpdateTableResponse {
    ...
    public withPipeId(pipeId: string): UpdateTableResponse {
        this['pipe_id'] = pipeId;
        return this;
    }
    ...
    public withTableName(tableName: string): UpdateTableResponse {
    ...
    public withTableAlias(tableAlias: string): UpdateTableResponse {
    ...
    public withDescription(description: string): UpdateTableResponse {
        this['description'] = description;
        return this;
    }
    public withDirectory(directory: string): UpdateTableResponse {
        this['directory'] = directory;
        return this;
    }
    public withCategory(category: IsapTableCategory): UpdateTableResponse {
        this['category'] = category;
        return this;
    }
    public withLockStatus(lockStatus: TableLockStatus): UpdateTableResponse {
    ...
    public withProcessStatus(processStatus: IsapTableProcessStatus): UpdateTableResponse {
    ...
    public withProcessError(processError: IsapTableProcessError): UpdateTableResponse {
    ...
    public withFormat(format: TableFormat): UpdateTableResponse {
        this['format'] = format;
        return this;
    }
    public withRwType(rwType: TableRWType): UpdateTableResponse {
        this['rw_type'] = rwType;
        return this;
    }
    ...
    public withOwnerType(ownerType: TableOwnerType): UpdateTableResponse {
    ...
    public withDataLayering(dataLayering: DataLayering): UpdateTableResponse {
    ...
    public withDataClassification(dataClassification: DataClassification): UpdateTableResponse {
    ...
    public withSchema(schema: IsapTableSchema): UpdateTableResponse {
        this['schema'] = schema;
        return this;
    }
    public withStorageSetting(storageSetting: TableStorageSetting): UpdateTableResponse {
    ...
    public withDisplaySetting(displaySetting: TableDisplaySetting): UpdateTableResponse {
    ...
    public withCreateTime(createTime: number): UpdateTableResponse {
    ...
    public withUpdateTime(updateTime: number): UpdateTableResponse {
    ...
    public withDeleteTime(deleteTime: number): UpdateTableResponse {
