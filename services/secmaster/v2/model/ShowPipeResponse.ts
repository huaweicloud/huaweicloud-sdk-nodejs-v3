...
export class ShowPipeResponse extends SdkResponse {
    ...
    public withCategory(category: PipeCategory): ShowPipeResponse {
    ...
    public withProcessStatus(processStatus: PipeProcessStatus): ShowPipeResponse {
    ...
    public withProcessError(processError: PipeProcessError): ShowPipeResponse {
    ...
    public withOwnerType(ownerType: PipeOwnerType): ShowPipeResponse {
    ...
    public withResources(resources: Array<PipeResource>): ShowPipeResponse {
        this['resources'] = resources;
        return this;
    }
    public withSchema(schema: PipeSchema): ShowPipeResponse {
        this['schema'] = schema;
        return this;
    }
