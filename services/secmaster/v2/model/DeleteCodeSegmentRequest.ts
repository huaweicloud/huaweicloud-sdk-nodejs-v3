...
export class DeleteCodeSegmentRequest {
    ...
    public withWorkspaceId(workspaceId: string): DeleteCodeSegmentRequest {
        this['workspace_id'] = workspaceId;
        return this;
    }
    ...
    public withCodeSegmentId(codeSegmentId: string): DeleteCodeSegmentRequest {
        this['code_segment_id'] = codeSegmentId;
        return this;
    }
