...
export class UpdatePipeResponse extends SdkResponse {
    ...
    public withWorkspaceId(workspaceId: string): UpdatePipeResponse {
    ...
    public withPipeAlias(pipeAlias: string): UpdatePipeResponse {
    ...
    public withCategory(category: PipeCategory): UpdatePipeResponse {
        this['category'] = category;
        return this;
    }
    public withDirectory(directory: string): UpdatePipeResponse {
    ...
    public withProcessStatus(processStatus: PipeProcessStatus): UpdatePipeResponse {
    ...
    public withProcessError(processError: PipeProcessError): UpdatePipeResponse {
    ...
    public withOwnerType(ownerType: PipeOwnerType): UpdatePipeResponse {
    ...
    public withResources(resources: Array<PipeResource>): UpdatePipeResponse {
        this['resources'] = resources;
        return this;
    }
    public withSchema(schema: PipeSchema): UpdatePipeResponse {
        this['schema'] = schema;
        return this;
    }
    ...
    public withDeleteTime(deleteTime: number): UpdatePipeResponse {
