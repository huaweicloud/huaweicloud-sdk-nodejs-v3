...
export class BatchOperateDataobjectResult {
    private 'error_ids'?: Array<string>;
    private 'success_ids'?: Array<string>;
    public constructor() { 
    }
    public withErrorIds(errorIds: Array<string>): BatchOperateDataobjectResult {
    ...
    public withSuccessIds(successIds: Array<string>): BatchOperateDataobjectResult {
