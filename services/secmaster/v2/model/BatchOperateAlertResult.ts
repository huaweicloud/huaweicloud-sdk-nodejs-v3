...
export class BatchOperateAlertResult {
    private 'error_ids'?: Array<string>;
    private 'success_ids'?: Array<string>;
    public constructor() { 
    }
    public withErrorIds(errorIds: Array<string>): BatchOperateAlertResult {
    ...
    public withSuccessIds(successIds: Array<string>): BatchOperateAlertResult {
