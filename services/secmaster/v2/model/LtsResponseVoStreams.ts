...
export class LtsResponseVoStreams {
    private 'log_stream_id'?: string;
    private 'log_stream_name'?: string;
    public constructor() { 
    }
    public withLogStreamId(logStreamId: string): LtsResponseVoStreams {
    ...
    public withLogStreamName(logStreamName: string): LtsResponseVoStreams {
