...
export class AlertRuleJobSetting {
    ...
    public withAlertCustomProperties(alertCustomProperties: { [key: string]: string; }): AlertRuleJobSetting {
    ...
    public withAlertDescription(alertDescription: string): AlertRuleJobSetting {
    ...
    public withAlertGrouping(alertGrouping: boolean): AlertRuleJobSetting {
    ...
    public withAlertMapping(alertMapping: { [key: string]: string; }): AlertRuleJobSetting {
    ...
    public withAlertName(alertName: string): AlertRuleJobSetting {
    ...
    public withAlertRemediation(alertRemediation: string): AlertRuleJobSetting {
    ...
    public withAlertSeverity(alertSeverity: IsapAlertSeverity): AlertRuleJobSetting {
    ...
    public withAlertSuppression(alertSuppression: boolean): AlertRuleJobSetting {
    ...
    public withAlertType(alertType: { [key: string]: string; }): AlertRuleJobSetting {
    ...
    public withEntityExtraction(entityExtraction: { [key: string]: string; }): AlertRuleJobSetting {
    ...
    public withFieldMapping(fieldMapping: { [key: string]: string; }): AlertRuleJobSetting {
