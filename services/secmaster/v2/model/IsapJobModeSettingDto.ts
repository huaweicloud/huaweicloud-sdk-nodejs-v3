...
export class IsapJobModeSettingDto {
    ...
    private 'dss_id'?: number;
    public constructor() { 
    }
    public withBatchOvertimeInterval(batchOvertimeInterval: number): IsapJobModeSettingDto {
    ...
    public withBatchOvertimeUnit(batchOvertimeUnit: IsapTimeUnit): IsapJobModeSettingDto {
    ...
    public withBatchFrequencyInterval(batchFrequencyInterval: number): IsapJobModeSettingDto {
    ...
    public withBatchFrequencyUnit(batchFrequencyUnit: IsapTimeUnit): IsapJobModeSettingDto {
    ...
    public withStreamingStateTtlInterval(streamingStateTtlInterval: number): IsapJobModeSettingDto {
    ...
    public withStreamingStateTtlUnit(streamingStateTtlUnit: IsapTimeUnit): IsapJobModeSettingDto {
    ...
    public withStreamingCheckpointTtlInterval(streamingCheckpointTtlInterval: number): IsapJobModeSettingDto {
    ...
    public withStreamingCheckpointTtlUnit(streamingCheckpointTtlUnit: IsapTimeUnit): IsapJobModeSettingDto {
    ...
    public withStreamingStartupMode(streamingStartupMode: IsapJobStartupModeEnum): IsapJobModeSettingDto {
    ...
    public withBatchOvertimeStrategyInterval(batchOvertimeStrategyInterval: number): IsapJobModeSettingDto {
    ...
    public withBatchOvertimeStrategyUnit(batchOvertimeStrategyUnit: IsapTimeUnit): IsapJobModeSettingDto {
    ...
    public withSearchDelayInterval(searchDelayInterval: number): IsapJobModeSettingDto {
    ...
    public withSearchDelayUnit(searchDelayUnit: IsapTimeUnit): IsapJobModeSettingDto {
    ...
    public withSearchFrequencyInterval(searchFrequencyInterval: number): IsapJobModeSettingDto {
    ...
    public withSearchFrequencyUnit(searchFrequencyUnit: IsapTimeUnit): IsapJobModeSettingDto {
    ...
    public withSearchOvertimeInterval(searchOvertimeInterval: number): IsapJobModeSettingDto {
    ...
    public withSearchOvertimeUnit(searchOvertimeUnit: IsapTimeUnit): IsapJobModeSettingDto {
    ...
    public withSearchPeriodInterval(searchPeriodInterval: number): IsapJobModeSettingDto {
    ...
    public withSearchPeriodUnit(searchPeriodUnit: IsapTimeUnit): IsapJobModeSettingDto {
    ...
    public withSearchTableId(searchTableId: string): IsapJobModeSettingDto {
    ...
    public withSearchTableName(searchTableName: string): IsapJobModeSettingDto {
    ...
    public withFieldNotNullPolicy(fieldNotNullPolicy: IsapJobFieldNotNullPolicy): IsapJobModeSettingDto {
    ...
    public withDssId(dssId: number): IsapJobModeSettingDto {
        this['dss_id'] = dssId;
        return this;
    }
    public set dssId(dssId: number  | undefined) {
        this['dss_id'] = dssId;
    }
    public get dssId(): number | undefined {
        return this['dss_id'];
    }
}