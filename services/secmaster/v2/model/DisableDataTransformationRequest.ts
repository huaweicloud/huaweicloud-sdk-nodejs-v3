...
export class DisableDataTransformationRequest {
    ...
    public withWorkspaceId(workspaceId: string): DisableDataTransformationRequest {
        this['workspace_id'] = workspaceId;
        return this;
    }
    ...
    public withDataTransformationId(dataTransformationId: string): DisableDataTransformationRequest {
        this['data_transformation_id'] = dataTransformationId;
        return this;
    }
