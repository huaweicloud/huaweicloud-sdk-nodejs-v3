...
export class ShowDataTransformationResponse extends SdkResponse {
    ...
    public withDataTransformationId(dataTransformationId: string): ShowDataTransformationResponse {
    ...
    public withDataTransformationName(dataTransformationName: string): ShowDataTransformationResponse {
    ...
    public withScript(script: string): ShowDataTransformationResponse {
        this['script'] = script;
        return this;
    }
    public withStatus(status: JobStatus): ShowDataTransformationResponse {
        this['status'] = status;
        return this;
    }
    public withDirectory(directory: string): ShowDataTransformationResponse {
        this['directory'] = directory;
        return this;
    }
    public withDescription(description: string): ShowDataTransformationResponse {
        this['description'] = description;
        return this;
    }
    public withJobMode(jobMode: IsapJobMode): ShowDataTransformationResponse {
    ...
    public withJobModeSetting(jobModeSetting: IsapJobModeSettingVo): ShowDataTransformationResponse {
    ...
    public withProcessStatus(processStatus: JobProcessStatus): ShowDataTransformationResponse {
    ...
    public withProcessError(processError: DataTransformationProcessError): ShowDataTransformationResponse {
    ...
    public withEnvironment(environment: JobEnvironment): ShowDataTransformationResponse {
        this['environment'] = environment;
        return this;
    }
    public withOutputTableId(outputTableId: string): ShowDataTransformationResponse {
    ...
    public withOutputTableName(outputTableName: string): ShowDataTransformationResponse {
    ...
    public withOutputTableIds(outputTableIds: Array<string>): ShowDataTransformationResponse {
    ...
    public withOutputTableNames(outputTableNames: Array<string>): ShowDataTransformationResponse {
    ...
    public withCreateBy(createBy: string): ShowDataTransformationResponse {
    ...
    public withCreateTime(createTime: number): ShowDataTransformationResponse {
    ...
    public withUpdateBy(updateBy: string): ShowDataTransformationResponse {
    ...
    public withUpdateTime(updateTime: number): ShowDataTransformationResponse {
    ...
    public withDeleteTime(deleteTime: number): ShowDataTransformationResponse {
