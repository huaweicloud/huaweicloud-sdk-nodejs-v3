...
export class AnalysisScript {
    ...
    public withScriptId(scriptId: string): AnalysisScript {
    ...
    public withProjectId(projectId: string): AnalysisScript {
    ...
    public withWorkspaceId(workspaceId: string): AnalysisScript {
    ...
    public withScriptName(scriptName: string): AnalysisScript {
    ...
    public withCategory(category: ScriptCategory): AnalysisScript {
        this['category'] = category;
        return this;
    }
    public withDirectory(directory: string): AnalysisScript {
        this['directory'] = directory;
        return this;
    }
    public withDescription(description: string): AnalysisScript {
        this['description'] = description;
        return this;
    }
    public withScriptType(scriptType: AnalysisScriptType): AnalysisScript {
    ...
    public withRetrieveTableId(retrieveTableId: string): AnalysisScript {
    ...
    public withScript(script: string): AnalysisScript {
        this['script'] = script;
        return this;
    }
    public withOwner(owner: string): AnalysisScript {
        this['owner'] = owner;
        return this;
    }
    public withScriptParams(scriptParams: Array<AnalysisScriptParam>): AnalysisScript {
    ...
    public withCreateBy(createBy: string): AnalysisScript {
    ...
    public withCreateTime(createTime: number): AnalysisScript {
    ...
    public withUpdateBy(updateBy: string): AnalysisScript {
    ...
    public withUpdateTime(updateTime: number): AnalysisScript {
