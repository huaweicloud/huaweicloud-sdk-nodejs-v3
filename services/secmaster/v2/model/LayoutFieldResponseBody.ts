...
export class LayoutFieldResponseBody {
    public id?: string;
    ...
    public withId(id: string): LayoutFieldResponseBody {
        this['id'] = id;
        return this;
    }
    public withCloudPackId(cloudPackId: string): LayoutFieldResponseBody {
    ...
    public withCloudPackName(cloudPackName: string): LayoutFieldResponseBody {
    ...
    public withDataclassId(dataclassId: string): LayoutFieldResponseBody {
    ...
    public withCloudPackVersion(cloudPackVersion: string): LayoutFieldResponseBody {
    ...
    public withFieldKey(fieldKey: string): LayoutFieldResponseBody {
    ...
    public withName(name: string): LayoutFieldResponseBody {
        this['name'] = name;
        return this;
    }
    public withDescription(description: string): LayoutFieldResponseBody {
        this['description'] = description;
        return this;
    }
    public withEnDescription(enDescription: string): LayoutFieldResponseBody {
    ...
    public withDefaultValue(defaultValue: string): LayoutFieldResponseBody {
    ...
    public withEnDefaultValue(enDefaultValue: string): LayoutFieldResponseBody {
    ...
    public withFieldType(fieldType: string): LayoutFieldResponseBody {
    ...
    public withExtraJson(extraJson: string): LayoutFieldResponseBody {
    ...
    public withFieldTooltip(fieldTooltip: string): LayoutFieldResponseBody {
    ...
    public withEnFieldTooltip(enFieldTooltip: string): LayoutFieldResponseBody {
    ...
    public withJsonSchema(jsonSchema: string): LayoutFieldResponseBody {
    ...
    public withIsBuiltIn(isBuiltIn: boolean): LayoutFieldResponseBody {
    ...
    public withReadOnly(readOnly: boolean): LayoutFieldResponseBody {
    ...
    public withRequired(required: boolean): LayoutFieldResponseBody {
        this['required'] = required;
        return this;
    }
    public withSearchable(searchable: boolean): LayoutFieldResponseBody {
        this['searchable'] = searchable;
        return this;
    }
    public withVisible(visible: boolean): LayoutFieldResponseBody {
        this['visible'] = visible;
        return this;
    }
    public withMaintainable(maintainable: boolean): LayoutFieldResponseBody {
        this['maintainable'] = maintainable;
        return this;
    }
    public withEditable(editable: boolean): LayoutFieldResponseBody {
        this['editable'] = editable;
        return this;
    }
    public withCreatable(creatable: boolean): LayoutFieldResponseBody {
        this['creatable'] = creatable;
        return this;
    }
    public withCreatorId(creatorId: string): LayoutFieldResponseBody {
    ...
    public withCreatorName(creatorName: string): LayoutFieldResponseBody {
    ...
    public withModifierId(modifierId: string): LayoutFieldResponseBody {
    ...
    public withModifierName(modifierName: string): LayoutFieldResponseBody {
    ...
    public withCreateTime(createTime: string): LayoutFieldResponseBody {
    ...
    public withUpdateTime(updateTime: string): LayoutFieldResponseBody {
    ...
    public withWizardId(wizardId: string): LayoutFieldResponseBody {
    ...
    public withAopworkflowId(aopworkflowId: string): LayoutFieldResponseBody {
    ...
    public withAopworkflowVersionId(aopworkflowVersionId: string): LayoutFieldResponseBody {
    ...
    public withPlaybookId(playbookId: string): LayoutFieldResponseBody {
    ...
    public withPlaybookVersionId(playbookVersionId: string): LayoutFieldResponseBody {
    ...
    public withBoaVersion(boaVersion: string): LayoutFieldResponseBody {
    ...
    public withVersion(version: string): LayoutFieldResponseBody {
