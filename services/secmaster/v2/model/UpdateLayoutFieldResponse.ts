...
export class UpdateLayoutFieldResponse extends SdkResponse {
    public id?: string;
    ...
    public withId(id: string): UpdateLayoutFieldResponse {
        this['id'] = id;
        return this;
    }
    public withCloudPackId(cloudPackId: string): UpdateLayoutFieldResponse {
    ...
    public withCloudPackName(cloudPackName: string): UpdateLayoutFieldResponse {
    ...
    public withDataclassId(dataclassId: string): UpdateLayoutFieldResponse {
    ...
    public withCloudPackVersion(cloudPackVersion: string): UpdateLayoutFieldResponse {
    ...
    public withFieldKey(fieldKey: string): UpdateLayoutFieldResponse {
    ...
    public withName(name: string): UpdateLayoutFieldResponse {
        this['name'] = name;
        return this;
    }
    public withDescription(description: string): UpdateLayoutFieldResponse {
        this['description'] = description;
        return this;
    }
    public withEnDescription(enDescription: string): UpdateLayoutFieldResponse {
    ...
    public withDefaultValue(defaultValue: string): UpdateLayoutFieldResponse {
    ...
    public withEnDefaultValue(enDefaultValue: string): UpdateLayoutFieldResponse {
    ...
    public withFieldType(fieldType: string): UpdateLayoutFieldResponse {
    ...
    public withExtraJson(extraJson: string): UpdateLayoutFieldResponse {
    ...
    public withFieldTooltip(fieldTooltip: string): UpdateLayoutFieldResponse {
    ...
    public withEnFieldTooltip(enFieldTooltip: string): UpdateLayoutFieldResponse {
    ...
    public withJsonSchema(jsonSchema: string): UpdateLayoutFieldResponse {
    ...
    public withIsBuiltIn(isBuiltIn: boolean): UpdateLayoutFieldResponse {
    ...
    public withReadOnly(readOnly: boolean): UpdateLayoutFieldResponse {
    ...
    public withRequired(required: boolean): UpdateLayoutFieldResponse {
        this['required'] = required;
        return this;
    }
    public withSearchable(searchable: boolean): UpdateLayoutFieldResponse {
        this['searchable'] = searchable;
        return this;
    }
    public withVisible(visible: boolean): UpdateLayoutFieldResponse {
        this['visible'] = visible;
        return this;
    }
    public withMaintainable(maintainable: boolean): UpdateLayoutFieldResponse {
        this['maintainable'] = maintainable;
        return this;
    }
    public withEditable(editable: boolean): UpdateLayoutFieldResponse {
        this['editable'] = editable;
        return this;
    }
    public withCreatable(creatable: boolean): UpdateLayoutFieldResponse {
        this['creatable'] = creatable;
        return this;
    }
    public withCreatorId(creatorId: string): UpdateLayoutFieldResponse {
    ...
    public withCreatorName(creatorName: string): UpdateLayoutFieldResponse {
    ...
    public withModifierId(modifierId: string): UpdateLayoutFieldResponse {
    ...
    public withModifierName(modifierName: string): UpdateLayoutFieldResponse {
    ...
    public withCreateTime(createTime: string): UpdateLayoutFieldResponse {
    ...
    public withUpdateTime(updateTime: string): UpdateLayoutFieldResponse {
    ...
    public withWizardId(wizardId: string): UpdateLayoutFieldResponse {
    ...
    public withAopworkflowId(aopworkflowId: string): UpdateLayoutFieldResponse {
    ...
    public withAopworkflowVersionId(aopworkflowVersionId: string): UpdateLayoutFieldResponse {
    ...
    public withPlaybookId(playbookId: string): UpdateLayoutFieldResponse {
    ...
    public withPlaybookVersionId(playbookVersionId: string): UpdateLayoutFieldResponse {
    ...
    public withBoaVersion(boaVersion: string): UpdateLayoutFieldResponse {
    ...
    public withVersion(version: string): UpdateLayoutFieldResponse {
        this['version'] = version;
        return this;
    }
    public withXRequestId(xRequestId: string): UpdateLayoutFieldResponse {
