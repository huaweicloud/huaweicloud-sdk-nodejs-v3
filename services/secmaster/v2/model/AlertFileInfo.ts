...
export class AlertFileInfo {
    ...
    public withFilePath(filePath: string): AlertFileInfo {
    ...
    public withFileContent(fileContent: string): AlertFileInfo {
    ...
    public withFileNewPath(fileNewPath: string): AlertFileInfo {
    ...
    public withFileHash(fileHash: string): AlertFileInfo {
    ...
    public withFileMd5(fileMd5: string): AlertFileInfo {
    ...
    public withFileSha256(fileSha256: string): AlertFileInfo {
    ...
    public withFileAttr(fileAttr: string): AlertFileInfo {
