...
export class ListStorageGearsRequest {
    ...
    public withZoneCode(zoneCode: string): ListStorageGearsRequest {
    ...
    public withPayMode(payMode: Array<PayMode>): ListStorageGearsRequest {
    ...
    public withPeriodNum(periodNum: Array<number>): ListStorageGearsRequest {
    ...
    public withLimit(limit: number): ListStorageGearsRequest {
        this['limit'] = limit;
        return this;
    }
    public withMarker(marker: string): ListStorageGearsRequest {
        this['marker'] = marker;
        return this;
    }
}