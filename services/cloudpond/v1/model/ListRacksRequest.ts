...
export class ListRacksRequest {
    ...
    public withLimit(limit: number): ListRacksRequest {
        this['limit'] = limit;
        return this;
    }
    public withMarker(marker: string): ListRacksRequest {
        this['marker'] = marker;
        return this;
    }
    public withSortKey(sortKey: Array<string>): ListRacksRequest {
    ...
    public withSortDir(sortDir: Array<string>): ListRacksRequest {
    ...
    public withEdgeSiteId(edgeSiteId: string): ListRacksRequest {
