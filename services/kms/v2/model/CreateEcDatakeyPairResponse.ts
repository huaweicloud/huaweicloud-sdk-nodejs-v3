...
export class CreateEcDatakeyPairResponse extends SdkResponse {
    private 'key_id'?: string;
    private 'key_spec'?: CreateEcDatakeyPairResponseKeySpecEnum | string;
    ...
    public withKeyId(keyId: string): CreateEcDatakeyPairResponse {
        this['key_id'] = keyId;
        return this;
    }
    ...
    public withKeySpec(keySpec: CreateEcDatakeyPairResponseKeySpecEnum | string): CreateEcDatakeyPairResponse {
        this['key_spec'] = keySpec;
        return this;
    }
    public set keySpec(keySpec: CreateEcDatakeyPairResponseKeySpecEnum | string  | undefined) {
        this['key_spec'] = keySpec;
    }
    public get keySpec(): CreateEcDatakeyPairResponseKeySpecEnum | string | undefined {
        return this['key_spec'];
    }
    public withPublicKey(publicKey: string): CreateEcDatakeyPairResponse {
    ...
    public withPrivateKeyCipherText(privateKeyCipherText: string): CreateEcDatakeyPairResponse {
    ...
    public withPrivateKeyPlainText(privateKeyPlainText: string): CreateEcDatakeyPairResponse {
    ...
    public withWrappedPrivateKey(wrappedPrivateKey: string): CreateEcDatakeyPairResponse {
    ...
    public withCiphertextRecipient(ciphertextRecipient: string): CreateEcDatakeyPairResponse {
...
/**
    ...
    * @enum {string}
    */
export enum CreateEcDatakeyPairResponseKeySpecEnum {
    RSA_2048 = 'RSA_2048',
    RSA_3072 = 'RSA_3072',
    RSA_4096 = 'RSA_4096',
