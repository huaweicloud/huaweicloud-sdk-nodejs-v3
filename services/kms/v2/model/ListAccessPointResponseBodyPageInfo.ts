...
export class ListAccessPointResponseBodyPageInfo {
    ...
    public withNextMarker(nextMarker: string): ListAccessPointResponseBodyPageInfo {
        this['next_marker'] = nextMarker;
        return this;
    }
    ...
    public withCurrentCount(currentCount: number): ListAccessPointResponseBodyPageInfo {
        this['current_count'] = currentCount;
        return this;
    }
