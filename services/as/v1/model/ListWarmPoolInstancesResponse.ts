...
export class ListWarmPoolInstancesResponse extends SdkResponse {
    private 'page_info'?: PageInfo;
    private 'warm_pool_instances'?: Array<WarmPoolInstance>;
    public constructor() { 
        super();
    }
    public withPageInfo(pageInfo: PageInfo): ListWarmPoolInstancesResponse {
    ...
    public withWarmPoolInstances(warmPoolInstances: Array<WarmPoolInstance>): ListWarmPoolInstancesResponse {
