...
export class ShowLifeCycleHookRequest {
    ...
    public withScalingGroupId(scalingGroupId: string): ShowLifeCycleHookRequest {
        this['scaling_group_id'] = scalingGroupId;
        return this;
    }
    ...
    public withLifecycleHookName(lifecycleHookName: string): ShowLifeCycleHookRequest {
        this['lifecycle_hook_name'] = lifecycleHookName;
        return this;
    }
