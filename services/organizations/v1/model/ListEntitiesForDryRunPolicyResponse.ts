...
export class ListEntitiesForDryRunPolicyResponse extends SdkResponse {
    private 'attached_entities'?: Array<EntityDto>;
    private 'page_info'?: PageInfoDto;
    public constructor() { 
        super();
    }
    public withAttachedEntities(attachedEntities: Array<EntityDto>): ListEntitiesForDryRunPolicyResponse {
    ...
    public withPageInfo(pageInfo: PageInfoDto): ListEntitiesForDryRunPolicyResponse {
