...
export class AcceptHandshakeRequest {
    private 'X-Security-Token'?: string;
    private 'handshake_id'?: string;
    public constructor(handshakeId?: string) { 
        this['handshake_id'] = handshakeId;
    }
    public withXSecurityToken(xSecurityToken: string): AcceptHandshakeRequest {
    ...
    public withHandshakeId(handshakeId: string): AcceptHandshakeRequest {
        this['handshake_id'] = handshakeId;
        return this;
    }
