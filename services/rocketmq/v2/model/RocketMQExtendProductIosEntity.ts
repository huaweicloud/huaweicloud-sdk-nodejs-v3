...
export class RocketMQExtendProductIosEntity {
    ...
    public withIoSpec(ioSpec: string): RocketMQExtendProductIosEntity {
        this['io_spec'] = ioSpec;
        return this;
    }
    ...
    public withAvailableZones(availableZones: Array<string>): RocketMQExtendProductIosEntity {
    ...
    public withType(type: string): RocketMQExtendProductIosEntity {
        this['type'] = type;
        return this;
    }
    public withUnavailableZones(unavailableZones: Array<string>): RocketMQExtendProductIosEntity {
