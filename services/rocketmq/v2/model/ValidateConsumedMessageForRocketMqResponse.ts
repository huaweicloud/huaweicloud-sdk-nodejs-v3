...
export class ValidateConsumedMessageForRocketMqResponse extends SdkResponse {
    private 'resend_results'?: Array<DeadletterResendRespResendResults>;
    public constructor() { 
        super();
    }
    public withResendResults(resendResults: Array<DeadletterResendRespResendResults>): ValidateConsumedMessageForRocketMqResponse {
