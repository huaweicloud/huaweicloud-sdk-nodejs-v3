...
export class BatchDeleteRocketMqMigrationTaskResponse extends SdkResponse {
    private 'success_task_list'?: Array<string>;
    public constructor() { 
        super();
    }
    public withSuccessTaskList(successTaskList: Array<string>): BatchDeleteRocketMqMigrationTaskResponse {
