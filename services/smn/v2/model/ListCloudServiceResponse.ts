...
export class ListCloudServiceResponse extends SdkResponse {
    private 'request_id'?: string;
    private 'cloud_services'?: Array<ListCloudServiceResponseItemInfo>;
    public constructor() { 
        super();
    }
    public withRequestId(requestId: string): ListCloudServiceResponse {
    ...
    public withCloudServices(cloudServices: Array<ListCloudServiceResponseItemInfo>): ListCloudServiceResponse {
