...
export class SubscribeTopicResponse extends SdkResponse {
    private 'request_id'?: string;
    private 'subscription_urn'?: string;
    public constructor() { 
        super();
    }
    public withRequestId(requestId: string): SubscribeTopicResponse {
    ...
    public withSubscriptionUrn(subscriptionUrn: string): SubscribeTopicResponse {
