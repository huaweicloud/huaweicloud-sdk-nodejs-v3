...
export class PerformanceStat {
    ...
    public withPeakStats(peakStats: Array<HealthReportSingleValueStat>): PerformanceStat {
    ...
    public withRatioStats(ratioStats: Array<HealthReportRatioStat>): PerformanceStat {
    ...
    public withAnalyzeSuccess(analyzeSuccess: boolean): PerformanceStat {
    ...
    public withErrorMessage(errorMessage: string): PerformanceStat {
