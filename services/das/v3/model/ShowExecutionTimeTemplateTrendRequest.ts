...
export class ShowExecutionTimeTemplateTrendRequest {
    ...
    public withInstanceId(instanceId: string): ShowExecutionTimeTemplateTrendRequest {
        this['instance_id'] = instanceId;
        return this;
    }
    ...
    public withNodeId(nodeId: string): ShowExecutionTimeTemplateTrendRequest {
        this['node_id'] = nodeId;
        return this;
    }
    ...
    public withStartAt(startAt: number): ShowExecutionTimeTemplateTrendRequest {
        this['start_at'] = startAt;
        return this;
    }
    ...
    public withEndAt(endAt: number): ShowExecutionTimeTemplateTrendRequest {
        this['end_at'] = endAt;
        return this;
    }
    ...
    public withIntervalMillis(intervalMillis: number): ShowExecutionTimeTemplateTrendRequest {
