...
export class ExecuteTuningResponse extends SdkResponse {
    ...
    public withMessageId(messageId: Array<string>): ExecuteTuningResponse {
    ...
    public withStatus(status: boolean): ExecuteTuningResponse {
        this['status'] = status;
        return this;
    }
    public withQuotaExceeded(quotaExceeded: boolean): ExecuteTuningResponse {
