...
export class SlowLogStat {
    ...
    public withCollectSlowLog(collectSlowLog: boolean): SlowLogStat {
    ...
    public withTopExecuteSlowLogs(topExecuteSlowLogs: Array<HealthReportSqlTemplate>): SlowLogStat {
    ...
    public withTopAvgQueryTimeSlowLogs(topAvgQueryTimeSlowLogs: Array<HealthReportSqlTemplate>): SlowLogStat {
    ...
    public withTopMaxQueryTimeSlowLogs(topMaxQueryTimeSlowLogs: Array<HealthReportSqlTemplate>): SlowLogStat {
    ...
    public withRowsExaminedExceeding(rowsExaminedExceeding: Array<HealthReportSqlTemplate>): SlowLogStat {
    ...
    public withAnalyzeSuccess(analyzeSuccess: boolean): SlowLogStat {
    ...
    public withErrorMessage(errorMessage: string): SlowLogStat {
