...
export class ShowSqlExplainResponse extends SdkResponse {
    private 'execution_plans'?: Array<ExecutionPlan>;
    private 'error_message'?: string;
    public constructor() { 
        super();
    }
    public withExecutionPlans(executionPlans: Array<ExecutionPlan>): ShowSqlExplainResponse {
    ...
    public withErrorMessage(errorMessage: string): ShowSqlExplainResponse {
