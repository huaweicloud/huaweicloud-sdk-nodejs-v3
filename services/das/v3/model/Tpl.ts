...
export class Tpl {
    ...
    public withTemplateId(templateId: string): Tpl {
    ...
    public withSqlTemplate(sqlTemplate: string): Tpl {
    ...
    public withSqlSampleString(sqlSampleString: string): Tpl {
    ...
    public withDbName(dbName: string): Tpl {
        this['db_name'] = dbName;
        return this;
    }
    ...
    public withDbNames(dbNames: Array<string>): Tpl {
    ...
    public withSqlType(sqlType: string): Tpl {
    ...
    public withExecuteNum(executeNum: number): Tpl {
    ...
    public withTotalCost(totalCost: number): Tpl {
    ...
    public withAvgCost(avgCost: number): Tpl {
    ...
    public withMaxCost(maxCost: number): Tpl {
    ...
    public withAvgRowsSent(avgRowsSent: number): Tpl {
    ...
    public withMaxRowsSent(maxRowsSent: number): Tpl {
    ...
    public withAvgRowsAffected(avgRowsAffected: number): Tpl {
    ...
    public withMaxRowsAffected(maxRowsAffected: number): Tpl {
    ...
    public withAvgLockTime(avgLockTime: number): Tpl {
    ...
    public withMaxLockTime(maxLockTime: number): Tpl {
    ...
    public withTotalRowsExamined(totalRowsExamined: number): Tpl {
    ...
    public withAvgRowsExamined(avgRowsExamined: number): Tpl {
    ...
    public withMaxRowsExamined(maxRowsExamined: number): Tpl {
    ...
    public withTunable(tunable: boolean): Tpl {
        this['tunable'] = tunable;
        return this;
    }
    public withTotalCostRatio(totalCostRatio: string): Tpl {
    ...
    public withTotalExaminedRatio(totalExaminedRatio: string): Tpl {
    ...
    public withExecuteNumRatio(executeNumRatio: string): Tpl {
