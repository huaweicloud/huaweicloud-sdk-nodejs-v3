...
export class DiskStat {
    ...
    public withPeakStats(peakStats: Array<HealthReportSingleValueStat>): DiskStat {
    ...
    public withRatioStats(ratioStats: Array<HealthReportRatioStat>): DiskStat {
    ...
    public withAnalyzeSuccess(analyzeSuccess: boolean): DiskStat {
    ...
    public withErrorMessage(errorMessage: string): DiskStat {
