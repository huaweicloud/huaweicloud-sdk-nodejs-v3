...
export class ShowHistoryTransactionSwitchNewResponse extends SdkResponse {
    ...
    public withSwitchOn(switchOn: boolean): ShowHistoryTransactionSwitchNewResponse {
    ...
    public withRetentionHours(retentionHours: number): ShowHistoryTransactionSwitchNewResponse {
    ...
    public withCanOpen(canOpen: boolean): ShowHistoryTransactionSwitchNewResponse {
    ...
    public withCantOpenMsg(cantOpenMsg: string): ShowHistoryTransactionSwitchNewResponse {
