...
export class ShowSqlTemplateTrendRequest {
    ...
    public withInstanceId(instanceId: string): ShowSqlTemplateTrendRequest {
        this['instance_id'] = instanceId;
        return this;
    }
    ...
    public withNodeId(nodeId: string): ShowSqlTemplateTrendRequest {
        this['node_id'] = nodeId;
        return this;
    }
    ...
    public withStartAt(startAt: number): ShowSqlTemplateTrendRequest {
        this['start_at'] = startAt;
        return this;
    }
    ...
    public withEndAt(endAt: number): ShowSqlTemplateTrendRequest {
        this['end_at'] = endAt;
        return this;
    }
    ...
    public withIntervalMillis(intervalMillis: number): ShowSqlTemplateTrendRequest {
