...
export class TopInstanceSlowLogTopExecuteSlowLogs {
    ...
    public withTemplateId(templateId: string): TopInstanceSlowLogTopExecuteSlowLogs {
    ...
    public withTemplate(template: string): TopInstanceSlowLogTopExecuteSlowLogs {
        this['template'] = template;
        return this;
    }
    public withDatabases(databases: Array<string>): TopInstanceSlowLogTopExecuteSlowLogs {
        this['databases'] = databases;
        return this;
    }
    public withTimes(times: number): TopInstanceSlowLogTopExecuteSlowLogs {
        this['times'] = times;
        return this;
    }
    public withAvgQueryTime(avgQueryTime: number): TopInstanceSlowLogTopExecuteSlowLogs {
    ...
    public withMaxQueryTime(maxQueryTime: number): TopInstanceSlowLogTopExecuteSlowLogs {
    ...
    public withAvgRowsExamined(avgRowsExamined: number): TopInstanceSlowLogTopExecuteSlowLogs {
    ...
    public withSumRowsExamined(sumRowsExamined: number): TopInstanceSlowLogTopExecuteSlowLogs {
    ...
    public withAvgRowsSent(avgRowsSent: number): TopInstanceSlowLogTopExecuteSlowLogs {
