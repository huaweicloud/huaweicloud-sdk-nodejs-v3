...
export class AddTasksNewRequestBody {
    ...
    public withInstanceId(instanceId: string): AddTasksNewRequestBody {
        this['instance_id'] = instanceId;
        return this;
    }
    ...
    public withStartAt(startAt: number): AddTasksNewRequestBody {
        this['start_at'] = startAt;
        return this;
    }
    ...
    public withEndAt(endAt: number): AddTasksNewRequestBody {
        this['end_at'] = endAt;
        return this;
    }
    ...
    public withNodeId(nodeId: string): AddTasksNewRequestBody {
        this['node_id'] = nodeId;
        return this;
    }
    ...
    public withKeyword(keyword: string): AddTasksNewRequestBody {
        this['keyword'] = keyword;
        return this;
    }
    public withUserList(userList: string): AddTasksNewRequestBody {
    ...
    public withDbList(dbList: string): AddTasksNewRequestBody {
        this['db_list'] = dbList;
        return this;
    }
    ...
    public withOperationList(operationList: string): AddTasksNewRequestBody {
    ...
    public withThreadIdList(threadIdList: string): AddTasksNewRequestBody {
    ...
    public withTrxIdList(trxIdList: string): AddTasksNewRequestBody {
    ...
    public withStatusList(statusList: string): AddTasksNewRequestBody {
    ...
    public withSqlTemplateIds(sqlTemplateIds: string): AddTasksNewRequestBody {
