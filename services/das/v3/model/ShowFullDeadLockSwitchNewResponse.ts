...
export class ShowFullDeadLockSwitchNewResponse extends SdkResponse {
    ...
    public withSwitchOn(switchOn: boolean): ShowFullDeadLockSwitchNewResponse {
    ...
    public withRetentionHours(retentionHours: number): ShowFullDeadLockSwitchNewResponse {
    ...
    public withCanOpen(canOpen: boolean): ShowFullDeadLockSwitchNewResponse {
    ...
    public withCantOpenMsg(cantOpenMsg: string): ShowFullDeadLockSwitchNewResponse {
