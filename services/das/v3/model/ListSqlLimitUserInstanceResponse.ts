...
export class ListSqlLimitUserInstanceResponse extends SdkResponse {
    private 'das_instances'?: Array<DASUserInstanceInfo>;
    public total?: number;
    public constructor() { 
        super();
    }
    public withDasInstances(dasInstances: Array<DASUserInstanceInfo>): ListSqlLimitUserInstanceResponse {
    ...
    public withTotal(total: number): ListSqlLimitUserInstanceResponse {
        this['total'] = total;
        return this;
    }
}