...
export class FullSqlStat {
    ...
    public withCollectFullSql(collectFullSql: boolean): FullSqlStat {
    ...
    public withExecuteTopTemplates(executeTopTemplates: Array<HealthReportSqlTemplate>): FullSqlStat {
    ...
    public withSumRowsExaminedTopTemplates(sumRowsExaminedTopTemplates: Array<HealthReportSqlTemplate>): FullSqlStat {
    ...
    public withAvgCostTopTemplates(avgCostTopTemplates: Array<HealthReportSqlTemplate>): FullSqlStat {
    ...
    public withAnalyzeSuccess(analyzeSuccess: boolean): FullSqlStat {
    ...
    public withErrorMessage(errorMessage: string): FullSqlStat {
