...
export class ShowDeadLockStatisticsResponse extends SdkResponse {
    ...
    public withLastDayCount(lastDayCount: number): ShowDeadLockStatisticsResponse {
    ...
    public withLastWeekCount(lastWeekCount: number): ShowDeadLockStatisticsResponse {
    ...
    public withLastTwoWeekCount(lastTwoWeekCount: number): ShowDeadLockStatisticsResponse {
    ...
    public withLastMonthCount(lastMonthCount: number): ShowDeadLockStatisticsResponse {
