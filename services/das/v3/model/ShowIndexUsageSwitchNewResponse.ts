...
export class ShowIndexUsageSwitchNewResponse extends SdkResponse {
    ...
    public withSwitchOn(switchOn: boolean): ShowIndexUsageSwitchNewResponse {
    ...
    public withRetentionHours(retentionHours: number): ShowIndexUsageSwitchNewResponse {
    ...
    public withCanOpen(canOpen: boolean): ShowIndexUsageSwitchNewResponse {
    ...
    public withCantOpenMsg(cantOpenMsg: string): ShowIndexUsageSwitchNewResponse {
