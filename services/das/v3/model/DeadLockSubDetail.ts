...
export class DeadLockSubDetail {
    ...
    public withLastTranStarted(lastTranStarted: string): DeadLockSubDetail {
    ...
    public withSpid(spid: string): DeadLockSubDetail {
        this['spid'] = spid;
        return this;
    }
    public withIsVictim(isVictim: boolean): DeadLockSubDetail {
    ...
    public withLogUsed(logUsed: number): DeadLockSubDetail {
    ...
    public withLockMode(lockMode: string): DeadLockSubDetail {
    ...
    public withWaitResourceDesc(waitResourceDesc: string): DeadLockSubDetail {
    ...
    public withObjectOwned(objectOwned: string): DeadLockSubDetail {
    ...
    public withObjectRequested(objectRequested: string): DeadLockSubDetail {
    ...
    public withWaitResource(waitResource: string): DeadLockSubDetail {
    ...
    public withHostName(hostName: string): DeadLockSubDetail {
    ...
    public withLoginName(loginName: string): DeadLockSubDetail {
    ...
    public withStatus(status: string): DeadLockSubDetail {
        this['status'] = status;
        return this;
    }
    public withClientApp(clientApp: string): DeadLockSubDetail {
    ...
    public withSql(sql: string): DeadLockSubDetail {
        this['sql'] = sql;
        return this;
    }
    public withDbId(dbId: string): DeadLockSubDetail {
        this['db_id'] = dbId;
        return this;
    }
    ...
    public withDbName(dbName: string): DeadLockSubDetail {
        this['db_name'] = dbName;
        return this;
    }
