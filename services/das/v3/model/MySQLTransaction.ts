...
export class MySQLTransaction {
    ...
    public withSessionId(sessionId: string): MySQLTransaction {
    ...
    public withThreadId(threadId: string): MySQLTransaction {
    ...
    public withRequestType(requestType: string): MySQLTransaction {
    ...
    public withTransactionId(transactionId: string): MySQLTransaction {
    ...
    public withTable(table: string): MySQLTransaction {
        this['table'] = table;
        return this;
    }
    public withWaitingLock(waitingLock: string): MySQLTransaction {
    ...
    public withWaitingLockIndex(waitingLockIndex: string): MySQLTransaction {
    ...
    public withWaitingLockType(waitingLockType: string): MySQLTransaction {
    ...
    public withHoldingLock(holdingLock: string): MySQLTransaction {
    ...
    public withHoldingLockIndex(holdingLockIndex: string): MySQLTransaction {
    ...
    public withHoldingLockType(holdingLockType: string): MySQLTransaction {
    ...
    public withSql(sql: string): MySQLTransaction {
        this['sql'] = sql;
        return this;
    }
}