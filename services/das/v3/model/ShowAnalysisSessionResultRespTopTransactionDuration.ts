...
export class ShowAnalysisSessionResultRespTopTransactionDuration {
    ...
    public withSessionId(sessionId: string): ShowAnalysisSessionResultRespTopTransactionDuration {
        this['session_id'] = sessionId;
        return this;
    }
    ...
    public withUser(user: string): ShowAnalysisSessionResultRespTopTransactionDuration {
        this['user'] = user;
        return this;
    }
    public withHost(host: string): ShowAnalysisSessionResultRespTopTransactionDuration {
        this['host'] = host;
        return this;
    }
    public withDatabaseName(databaseName: string): ShowAnalysisSessionResultRespTopTransactionDuration {
        this['database_name'] = databaseName;
        return this;
    }
    ...
    public withExecutionStatus(executionStatus: string): ShowAnalysisSessionResultRespTopTransactionDuration {
        this['execution_status'] = executionStatus;
        return this;
    }
    ...
    public withCommand(command: string): ShowAnalysisSessionResultRespTopTransactionDuration {
        this['command'] = command;
        return this;
    }
    public withSqlStatement(sqlStatement: string): ShowAnalysisSessionResultRespTopTransactionDuration {
        this['sql_statement'] = sqlStatement;
        return this;
    }
    ...
    public withStateDuration(stateDuration: string): ShowAnalysisSessionResultRespTopTransactionDuration {
        this['state_duration'] = stateDuration;
        return this;
    }
    ...
    public withTransactionDuration(transactionDuration: string): ShowAnalysisSessionResultRespTopTransactionDuration {
        this['transaction_duration'] = transactionDuration;
        return this;
    }
    ...
    public withTransactionId(transactionId: string): ShowAnalysisSessionResultRespTopTransactionDuration {
        this['transaction_id'] = transactionId;
        return this;
    }
    ...
    public withTransactionLockWaitTime(transactionLockWaitTime: string): ShowAnalysisSessionResultRespTopTransactionDuration {
        this['transaction_lock_wait_time'] = transactionLockWaitTime;
        return this;
    }
    ...
    public withTransactionStatus(transactionStatus: string): ShowAnalysisSessionResultRespTopTransactionDuration {
        this['transaction_status'] = transactionStatus;
        return this;
    }
    ...
    public withRowsLockedByTransactions(rowsLockedByTransactions: string): ShowAnalysisSessionResultRespTopTransactionDuration {
        this['rows_locked_by_transactions'] = rowsLockedByTransactions;
        return this;
    }
    ...
    public withTablesLockedByTransactions(tablesLockedByTransactions: string): ShowAnalysisSessionResultRespTopTransactionDuration {
        this['tables_locked_by_transactions'] = tablesLockedByTransactions;
        return this;
    }
    ...
    public withRowsUpdatedByTransactions(rowsUpdatedByTransactions: string): ShowAnalysisSessionResultRespTopTransactionDuration {
        this['rows_updated_by_transactions'] = rowsUpdatedByTransactions;
        return this;
    }
