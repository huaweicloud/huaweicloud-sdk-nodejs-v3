...
export class ShowExecutionPlanResponse extends SdkResponse {
    ...
    public withColumnValues(columnValues: Array<object>): ShowExecutionPlanResponse {
    ...
    public withMetadata(metadata: Array<Column>): ShowExecutionPlanResponse {
        this['metadata'] = metadata;
        return this;
    }
    public withResultType(resultType: string): ShowExecutionPlanResponse {
    ...
    public withRows(rows: number): ShowExecutionPlanResponse {
        this['rows'] = rows;
        return this;
    }
    public withTimeDelay(timeDelay: number): ShowExecutionPlanResponse {
    ...
    public withCanEdit(canEdit: boolean): ShowExecutionPlanResponse {
    ...
    public withCanExport(canExport: boolean): ShowExecutionPlanResponse {
    ...
    public withEditDbName(editDbName: string): ShowExecutionPlanResponse {
    ...
    public withEditTable(editTable: string): ShowExecutionPlanResponse {
    ...
    public withEditPrimaryKeys(editPrimaryKeys: Array<string>): ShowExecutionPlanResponse {
    ...
    public withCannotEditReason(cannotEditReason: number): ShowExecutionPlanResponse {
    ...
    public withExtendDatas(extendDatas: Array<object>): ShowExecutionPlanResponse {
    ...
    public withDataSum(dataSum: number): ShowExecutionPlanResponse {
    ...
    public withBigTable(bigTable: boolean): ShowExecutionPlanResponse {
    ...
    public withWarning(warning: Array<string>): ShowExecutionPlanResponse {
        this['warning'] = warning;
        return this;
    }
    public withSql(sql: string): ShowExecutionPlanResponse {
        this['sql'] = sql;
        return this;
    }
    public withExplainSql(explainSql: boolean): ShowExecutionPlanResponse {
    ...
    public withPageState(pageState: string): ShowExecutionPlanResponse {
    ...
    public withExceedData(exceedData: boolean): ShowExecutionPlanResponse {
    ...
    public withExecuteStatus(executeStatus: string): ShowExecutionPlanResponse {
