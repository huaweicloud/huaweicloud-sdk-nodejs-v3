...
export class TplCmp {
    ...
    public withTemplateId(templateId: string): TplCmp {
    ...
    public withSqlTemplate(sqlTemplate: string): TplCmp {
    ...
    public withSqlSampleString(sqlSampleString: string): TplCmp {
    ...
    public withDbNames(dbNames: Array<string>): TplCmp {
    ...
    public withDbName(dbName: string): TplCmp {
        this['db_name'] = dbName;
        return this;
    }
    ...
    public withSqlType(sqlType: string): TplCmp {
    ...
    public withExecuteNum(executeNum: number): TplCmp {
    ...
    public withTotalCost(totalCost: number): TplCmp {
    ...
    public withAvgCost(avgCost: number): TplCmp {
    ...
    public withMaxCost(maxCost: number): TplCmp {
        this['max_cost'] = maxCost;
        return this;
    }
    public set maxCost(maxCost: number  | undefined) {
        this['max_cost'] = maxCost;
    }
    public get maxCost(): number | undefined {
        return this['max_cost'];
    }
    public withAvgRowsSent(avgRowsSent: number): TplCmp {
    ...
    public withMaxRowsSent(maxRowsSent: number): TplCmp {
    ...
    public withAvgRowsAffected(avgRowsAffected: number): TplCmp {
    ...
    public withMaxRowsAffected(maxRowsAffected: number): TplCmp {
        this['max_rows_affected'] = maxRowsAffected;
        return this;
    }
    public set maxRowsAffected(maxRowsAffected: number  | undefined) {
        this['max_rows_affected'] = maxRowsAffected;
    }
    public get maxRowsAffected(): number | undefined {
        return this['max_rows_affected'];
    }
    public withAvgLockTime(avgLockTime: number): TplCmp {
    ...
    public withMaxLockTime(maxLockTime: number): TplCmp {
        this['max_lock_time'] = maxLockTime;
        return this;
    }
    public set maxLockTime(maxLockTime: number  | undefined) {
        this['max_lock_time'] = maxLockTime;
    }
    public get maxLockTime(): number | undefined {
        return this['max_lock_time'];
    }
    public withTotalRowsExamined(totalRowsExamined: number): TplCmp {
    ...
    public withAvgRowsExamined(avgRowsExamined: number): TplCmp {
    ...
    public withMaxRowsExamined(maxRowsExamined: number): TplCmp {
    ...
    public withTotalCostRatio(totalCostRatio: string): TplCmp {
    ...
    public withTotalExaminedRatio(totalExaminedRatio: string): TplCmp {
    ...
    public withExecuteNumRatio(executeNumRatio: string): TplCmp {
