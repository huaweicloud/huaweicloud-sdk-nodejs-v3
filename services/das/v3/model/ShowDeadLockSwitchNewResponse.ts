...
export class ShowDeadLockSwitchNewResponse extends SdkResponse {
    ...
    public withSuccess(success: boolean): ShowDeadLockSwitchNewResponse {
        this['success'] = success;
        return this;
    }
    public withSwitchOn(switchOn: boolean): ShowDeadLockSwitchNewResponse {
    ...
    public withRetentionHours(retentionHours: number): ShowDeadLockSwitchNewResponse {
    ...
    public withRetry(retry: boolean): ShowDeadLockSwitchNewResponse {
        this['retry'] = retry;
        return this;
    }
    public withErrorMsg(errorMsg: string): ShowDeadLockSwitchNewResponse {
    ...
    public withCanOpen(canOpen: boolean): ShowDeadLockSwitchNewResponse {
    ...
    public withCantOpenMsg(cantOpenMsg: string): ShowDeadLockSwitchNewResponse {
