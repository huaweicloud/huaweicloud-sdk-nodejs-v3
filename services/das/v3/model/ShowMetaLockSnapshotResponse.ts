...
export class ShowMetaLockSnapshotResponse extends SdkResponse {
    ...
    public withInfos(infos: Array<MetaLockInfo>): ShowMetaLockSnapshotResponse {
        this['infos'] = infos;
        return this;
    }
    public withCount(count: number): ShowMetaLockSnapshotResponse {
        this['count'] = count;
        return this;
    }
    public withWaitLockCount(waitLockCount: number): ShowMetaLockSnapshotResponse {
    ...
    public withHoldLockCount(holdLockCount: number): ShowMetaLockSnapshotResponse {
    ...
    public withTimeGreaterThanCount(timeGreaterThanCount: number): ShowMetaLockSnapshotResponse {
    ...
    public withLockWaitThresholdSecond(lockWaitThresholdSecond: number): ShowMetaLockSnapshotResponse {
