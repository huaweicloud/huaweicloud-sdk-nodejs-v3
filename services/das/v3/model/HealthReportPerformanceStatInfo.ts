...
export class HealthReportPerformanceStatInfo {
    ...
    public withPeakStats(peakStats: Array<HealthReportSingleValueStat>): HealthReportPerformanceStatInfo {
    ...
    public withRatioStats(ratioStats: Array<HealthReportRatioStat>): HealthReportPerformanceStatInfo {
    ...
    public withAnalyzeSuccess(analyzeSuccess: boolean): HealthReportPerformanceStatInfo {
    ...
    public withErrorMessage(errorMessage: string): HealthReportPerformanceStatInfo {
