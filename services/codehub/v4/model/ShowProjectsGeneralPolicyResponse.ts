...
export class ShowProjectsGeneralPolicyResponse extends SdkResponse {
    ...
    public withDisableFork(disableFork: boolean): ShowProjectsGeneralPolicyResponse {
    ...
    public withForbiddenDeveloperCreateBranch(forbiddenDeveloperCreateBranch: boolean): ShowProjectsGeneralPolicyResponse {
    ...
    public withForbiddenDeveloperCreateTag(forbiddenDeveloperCreateTag: boolean): ShowProjectsGeneralPolicyResponse {
    ...
    public withForbiddenCommitterCreateBranch(forbiddenCommitterCreateBranch: boolean): ShowProjectsGeneralPolicyResponse {
    ...
    public withBranchNameRegex(branchNameRegex: string): ShowProjectsGeneralPolicyResponse {
    ...
    public withTagNameRegex(tagNameRegex: string): ShowProjectsGeneralPolicyResponse {
    ...
    public withGeneratePreMergeRef(generatePreMergeRef: boolean): ShowProjectsGeneralPolicyResponse {
    ...
    public withForbiddenGitlabAccess(forbiddenGitlabAccess: boolean): ShowProjectsGeneralPolicyResponse {
    ...
    public withRebaseDisableTriggerWebhook(rebaseDisableTriggerWebhook: boolean): ShowProjectsGeneralPolicyResponse {
    ...
    public withOpenGpgVerified(openGpgVerified: boolean): ShowProjectsGeneralPolicyResponse {
