...
export class ListMergeRequestVersionsRequest {
    ...
    public withRepositoryId(repositoryId: number): ListMergeRequestVersionsRequest {
        this['repository_id'] = repositoryId;
        return this;
    }
    ...
    public withMergeRequestIid(mergeRequestIid: number): ListMergeRequestVersionsRequest {
        this['merge_request_iid'] = mergeRequestIid;
        return this;
    }
