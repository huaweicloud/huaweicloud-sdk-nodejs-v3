...
export class ShowProjectGeneralPolicyResponse extends SdkResponse {
    ...
    public withDisableFork(disableFork: boolean): ShowProjectGeneralPolicyResponse {
    ...
    public withForbiddenDeveloperCreateBranch(forbiddenDeveloperCreateBranch: boolean): ShowProjectGeneralPolicyResponse {
    ...
    public withForbiddenDeveloperCreateTag(forbiddenDeveloperCreateTag: boolean): ShowProjectGeneralPolicyResponse {
    ...
    public withForbiddenCommitterCreateBranch(forbiddenCommitterCreateBranch: boolean): ShowProjectGeneralPolicyResponse {
    ...
    public withBranchNameRegex(branchNameRegex: string): ShowProjectGeneralPolicyResponse {
    ...
    public withTagNameRegex(tagNameRegex: string): ShowProjectGeneralPolicyResponse {
    ...
    public withGeneratePreMergeRef(generatePreMergeRef: boolean): ShowProjectGeneralPolicyResponse {
    ...
    public withForbiddenGitlabAccess(forbiddenGitlabAccess: boolean): ShowProjectGeneralPolicyResponse {
    ...
    public withRebaseDisableTriggerWebhook(rebaseDisableTriggerWebhook: boolean): ShowProjectGeneralPolicyResponse {
    ...
    public withOpenGpgVerified(openGpgVerified: boolean): ShowProjectGeneralPolicyResponse {
