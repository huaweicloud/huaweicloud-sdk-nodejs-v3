...
export class UpdateTenantTrustedIpAddressResponse extends SdkResponse {
    ...
    public withIpType(ipType: number): UpdateTenantTrustedIpAddressResponse {
        this['ip_type'] = ipType;
        return this;
    }
    ...
    public withViewFlag(viewFlag: number): UpdateTenantTrustedIpAddressResponse {
    ...
    public withDownloadFlag(downloadFlag: number): UpdateTenantTrustedIpAddressResponse {
    ...
    public withUploadFlag(uploadFlag: number): UpdateTenantTrustedIpAddressResponse {
    ...
    public withOrderFlag(orderFlag: number): UpdateTenantTrustedIpAddressResponse {
