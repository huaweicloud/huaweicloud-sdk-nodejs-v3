...
export class ShowRepositoryGeneralPolicyResponse extends SdkResponse {
    ...
    public withDisableFork(disableFork: boolean): ShowRepositoryGeneralPolicyResponse {
    ...
    public withGeneratePreMergeRef(generatePreMergeRef: boolean): ShowRepositoryGeneralPolicyResponse {
    ...
    public withBranchNameRegex(branchNameRegex: string): ShowRepositoryGeneralPolicyResponse {
    ...
    public withTagNameRegex(tagNameRegex: string): ShowRepositoryGeneralPolicyResponse {
    ...
    public withForbiddenDeveloperCreateBranch(forbiddenDeveloperCreateBranch: boolean): ShowRepositoryGeneralPolicyResponse {
    ...
    public withCreateBranchWhitelistUsers(createBranchWhitelistUsers: Array<PushRuleDevelopersDto>): ShowRepositoryGeneralPolicyResponse {
