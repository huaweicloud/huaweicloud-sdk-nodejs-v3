...
export class CommitRuleUpdateBodyDto {
    public name?: string;
    ...
    public withName(name: string): CommitRuleUpdateBodyDto {
        this['name'] = name;
        return this;
    }
    public withBranchName(branchName: string): CommitRuleUpdateBodyDto {
        this['branch_name'] = branchName;
        return this;
    }
    ...
    public withCommitMessageRegex(commitMessageRegex: string): CommitRuleUpdateBodyDto {
    ...
    public withCommitMessageNegativeRegex(commitMessageNegativeRegex: string): CommitRuleUpdateBodyDto {
    ...
    public withAuthorRegex(authorRegex: string): CommitRuleUpdateBodyDto {
    ...
    public withAuthorEmailRegex(authorEmailRegex: string): CommitRuleUpdateBodyDto {
    ...
    public withProhibitedFileNameRegex(prohibitedFileNameRegex: string): CommitRuleUpdateBodyDto {
    ...
    public withMaxFileSize(maxFileSize: number): CommitRuleUpdateBodyDto {
    ...
    public withBinaryGateEnabled(binaryGateEnabled: boolean): CommitRuleUpdateBodyDto {
    ...
    public withAllowedModifyBinary(allowedModifyBinary: boolean): CommitRuleUpdateBodyDto {
    ...
    public withAllowedBinaryFileNameRegex(allowedBinaryFileNameRegex: string): CommitRuleUpdateBodyDto {
    ...
    public withPrivilegedUserIds(privilegedUserIds: Array<number>): CommitRuleUpdateBodyDto {
    ...
    public withEffectiveDate(effectiveDate: string): CommitRuleUpdateBodyDto {
    ...
    public withSkipRuleCheck(skipRuleCheck: boolean): CommitRuleUpdateBodyDto {
    ...
    public withSkipRuleEndDate(skipRuleEndDate: string): CommitRuleUpdateBodyDto {
