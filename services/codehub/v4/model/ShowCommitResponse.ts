...
export class ShowCommitResponse extends SdkResponse {
    public id?: string;
    ...
    public withId(id: string): ShowCommitResponse {
        this['id'] = id;
        return this;
    }
    public withMessage(message: string): ShowCommitResponse {
        this['message'] = message;
        return this;
    }
    public withParentIds(parentIds: Array<string>): ShowCommitResponse {
    ...
    public withAuthoredDate(authoredDate: string): ShowCommitResponse {
    ...
    public withAuthorName(authorName: string): ShowCommitResponse {
    ...
    public withAuthorEmail(authorEmail: string): ShowCommitResponse {
    ...
    public withCommittedDate(committedDate: string): ShowCommitResponse {
    ...
    public withCommitterName(committerName: string): ShowCommitResponse {
    ...
    public withCommitterEmail(committerEmail: string): ShowCommitResponse {
    ...
    public withOpenGpgVerified(openGpgVerified: boolean): ShowCommitResponse {
    ...
    public withVerificationStatus(verificationStatus: number): ShowCommitResponse {
    ...
    public withGpgPrimaryKeyId(gpgPrimaryKeyId: string): ShowCommitResponse {
    ...
    public withName(name: string): ShowCommitResponse {
        this['name'] = name;
        return this;
    }
    public withGpgNickName(gpgNickName: string): ShowCommitResponse {
    ...
    public withGpgTenantName(gpgTenantName: string): ShowCommitResponse {
    ...
    public withGpgUserName(gpgUserName: string): ShowCommitResponse {
    ...
    public withShortId(shortId: string): ShowCommitResponse {
    ...
    public withCreatedAt(createdAt: string): ShowCommitResponse {
    ...
    public withTitle(title: string): ShowCommitResponse {
        this['title'] = title;
        return this;
    }
    public withAuthorAvatarUrl(authorAvatarUrl: string): ShowCommitResponse {
    ...
    public withCommitterAvatarUrl(committerAvatarUrl: string): ShowCommitResponse {
    ...
    public withRelateUrl(relateUrl: Array<RelatedCommitSimpleDto>): ShowCommitResponse {
    ...
    public withNickName(nickName: string): ShowCommitResponse {
    ...
    public withTenantName(tenantName: string): ShowCommitResponse {
    ...
    public withUserName(userName: string): ShowCommitResponse {
    ...
    public withStatus(status: ShowCommitResponseStatusEnum | string): ShowCommitResponse {
        this['status'] = status;
        return this;
    }
    public withLastPipeline(lastPipeline: PipelineBasicDto): ShowCommitResponse {
    ...
    public withProjectId(projectId: number): ShowCommitResponse {
    ...
    public withMergeRequest(mergeRequest: SimpleMergeRequestDetailDto): ShowCommitResponse {
    ...
    public withCodeChanges(codeChanges: Array<SimpleDiffDto>): ShowCommitResponse {
...
/**
    ...
    * @enum {string}
    */
export enum ShowCommitResponseStatusEnum {
    PENDING = 'pending',
    RUNNING = 'running',
    SUCCESS = 'success',
    FAILED = 'failed',
