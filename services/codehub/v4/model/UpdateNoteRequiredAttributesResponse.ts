...
export class UpdateNoteRequiredAttributesResponse extends SdkResponse {
    private 'note_required_attributes'?: Array<RequiredAttributeDto>;
    public constructor() { 
        super();
    }
    public withNoteRequiredAttributes(noteRequiredAttributes: Array<RequiredAttributeDto>): UpdateNoteRequiredAttributesResponse {
