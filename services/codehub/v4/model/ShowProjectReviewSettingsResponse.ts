...
export class ShowProjectReviewSettingsResponse extends SdkResponse {
    ...
    public withCategoriesAndModulesEnabled(categoriesAndModulesEnabled: boolean): ShowProjectReviewSettingsResponse {
    ...
    public withSecondaryCategoryEnabled(secondaryCategoryEnabled: boolean): ShowProjectReviewSettingsResponse {
    ...
    public withPrimaryCategories(primaryCategories: Array<CategoryDto>): ShowProjectReviewSettingsResponse {
    ...
    public withReviewDefaultCategories(reviewDefaultCategories: Array<string>): ShowProjectReviewSettingsResponse {
    ...
    public withReviewCustomizedCategories(reviewCustomizedCategories: Array<string>): ShowProjectReviewSettingsResponse {
    ...
    public withReviewModules(reviewModules: Array<string>): ShowProjectReviewSettingsResponse {
    ...
    public withRepositoryId(repositoryId: number): ShowProjectReviewSettingsResponse {
    ...
    public withNoteRequiredAttributes(noteRequiredAttributes: Array<RequiredAttributeDto>): ShowProjectReviewSettingsResponse {
    ...
    public withCodehubDefaultCategories(codehubDefaultCategories: Array<CategoryDto>): ShowProjectReviewSettingsResponse {
    ...
    public withHicodeDefaultCategories(hicodeDefaultCategories: Array<CategoryDto>): ShowProjectReviewSettingsResponse {
