...
export class RepositoryMergeRequestTemplateDto {
    ...
    public withCreatedAt(createdAt: string): RepositoryMergeRequestTemplateDto {
    ...
    public withUpdatedAt(updatedAt: string): RepositoryMergeRequestTemplateDto {
    ...
    public withTemplateName(templateName: string): RepositoryMergeRequestTemplateDto {
    ...
    public withMergeRequestTitle(mergeRequestTitle: string): RepositoryMergeRequestTemplateDto {
    ...
    public withIsDefault(isDefault: boolean): RepositoryMergeRequestTemplateDto {
    ...
    public withIsWip(isWip: boolean): RepositoryMergeRequestTemplateDto {
        this['is_wip'] = isWip;
        return this;
    }
    ...
    public withAutoExtractMrTitle(autoExtractMrTitle: number): RepositoryMergeRequestTemplateDto {
