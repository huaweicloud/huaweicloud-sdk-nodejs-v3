...
export class CommitRuleDto {
    ...
    public withRepositoryId(repositoryId: number): CommitRuleDto {
    ...
    public withCommitMessageRegex(commitMessageRegex: string): CommitRuleDto {
    ...
    public withCommitMessageNegativeRegex(commitMessageNegativeRegex: string): CommitRuleDto {
    ...
    public withProhibitedFileNameRegex(prohibitedFileNameRegex: string): CommitRuleDto {
    ...
    public withAuthorEmailRegex(authorEmailRegex: string): CommitRuleDto {
    ...
    public withMaxFileSize(maxFileSize: number): CommitRuleDto {
    ...
    public withAllowedMaxFileSize(allowedMaxFileSize: number): CommitRuleDto {
    ...
    public withEffectiveDate(effectiveDate: string): CommitRuleDto {
    ...
    public withBinaryGateEnabled(binaryGateEnabled: boolean): CommitRuleDto {
    ...
    public withPrivilegedUsers(privilegedUsers: Array<RepositoryUserBasicDto>): CommitRuleDto {
    ...
    public withAllowedModifyBinary(allowedModifyBinary: boolean): CommitRuleDto {
    ...
    public withAllowedBinaryFileNameRegex(allowedBinaryFileNameRegex: string): CommitRuleDto {
    ...
    public withAuthorRegex(authorRegex: object): CommitRuleDto {
    ...
    public withUpdatedAt(updatedAt: string): CommitRuleDto {
    ...
    public withBranchName(branchName: string): CommitRuleDto {
    ...
    public withCreatedAt(createdAt: string): CommitRuleDto {
