...
export class FilePushPermissionActionBodyDto {
    ...
    public withEnable(enable: boolean): FilePushPermissionActionBodyDto {
        this['enable'] = enable;
        return this;
    }
    ...
    public withRelatedRoleIds(relatedRoleIds: Array<string>): FilePushPermissionActionBodyDto {
    ...
    public withAction(action: FilePushPermissionActionBodyDtoActionEnum | string): FilePushPermissionActionBodyDto {
        this['action'] = action;
        return this;
    }
}
...
/**
    ...
    * @enum {string}
    */
export enum FilePushPermissionActionBodyDtoActionEnum {
    PUSH = 'push'
}
