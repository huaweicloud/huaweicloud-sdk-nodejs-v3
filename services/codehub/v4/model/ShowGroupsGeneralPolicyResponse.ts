...
export class ShowGroupsGeneralPolicyResponse extends SdkResponse {
    ...
    public withDisableFork(disableFork: boolean): ShowGroupsGeneralPolicyResponse {
    ...
    public withForbiddenDeveloperCreateBranch(forbiddenDeveloperCreateBranch: boolean): ShowGroupsGeneralPolicyResponse {
    ...
    public withForbiddenDeveloperCreateTag(forbiddenDeveloperCreateTag: boolean): ShowGroupsGeneralPolicyResponse {
    ...
    public withForbiddenCommitterCreateBranch(forbiddenCommitterCreateBranch: boolean): ShowGroupsGeneralPolicyResponse {
    ...
    public withBranchNameRegex(branchNameRegex: string): ShowGroupsGeneralPolicyResponse {
    ...
    public withTagNameRegex(tagNameRegex: string): ShowGroupsGeneralPolicyResponse {
    ...
    public withGeneratePreMergeRef(generatePreMergeRef: boolean): ShowGroupsGeneralPolicyResponse {
    ...
    public withForbiddenGitlabAccess(forbiddenGitlabAccess: boolean): ShowGroupsGeneralPolicyResponse {
    ...
    public withRebaseDisableTriggerWebhook(rebaseDisableTriggerWebhook: boolean): ShowGroupsGeneralPolicyResponse {
    ...
    public withOpenGpgVerified(openGpgVerified: boolean): ShowGroupsGeneralPolicyResponse {
