...
export class UpdateGroupMergeRequestTemplateResponse extends SdkResponse {
    ...
    public withCreatedAt(createdAt: string): UpdateGroupMergeRequestTemplateResponse {
    ...
    public withUpdatedAt(updatedAt: string): UpdateGroupMergeRequestTemplateResponse {
    ...
    public withTemplateName(templateName: string): UpdateGroupMergeRequestTemplateResponse {
    ...
    public withMergeRequestTitle(mergeRequestTitle: string): UpdateGroupMergeRequestTemplateResponse {
    ...
    public withIsDefault(isDefault: boolean): UpdateGroupMergeRequestTemplateResponse {
    ...
    public withIsWip(isWip: boolean): UpdateGroupMergeRequestTemplateResponse {
        this['is_wip'] = isWip;
        return this;
    }
    ...
    public withAutoExtractMrTitle(autoExtractMrTitle: number): UpdateGroupMergeRequestTemplateResponse {
    ...
    public withCreator(creator: UserBasicDto): UpdateGroupMergeRequestTemplateResponse {
        this['creator'] = creator;
        return this;
    }
    public withGroupId(groupId: number): UpdateGroupMergeRequestTemplateResponse {
