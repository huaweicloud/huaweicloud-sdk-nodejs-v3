...
export class UpdateMergeRequestDiscussionResponse extends SdkResponse {
    ...
    private 'noteable_type'?: UpdateMergeRequestDiscussionResponseNoteableTypeEnum | string;
    ...
    public severity?: UpdateMergeRequestDiscussionResponseSeverityEnum | string;
    private 'severity_cn'?: string;
    private 'severity_en'?: UpdateMergeRequestDiscussionResponseSeverityEnEnum | string;
    ...
    public withId(id: number): UpdateMergeRequestDiscussionResponse {
        this['id'] = id;
        return this;
    }
    ...
    public withCreatedAt(createdAt: string): UpdateMergeRequestDiscussionResponse {
    ...
    public withUpdatedAt(updatedAt: string): UpdateMergeRequestDiscussionResponse {
    ...
    public withSystem(system: boolean): UpdateMergeRequestDiscussionResponse {
        this['system'] = system;
        return this;
    }
    public withNoteableId(noteableId: number): UpdateMergeRequestDiscussionResponse {
    ...
    public withNoteableType(noteableType: UpdateMergeRequestDiscussionResponseNoteableTypeEnum | string): UpdateMergeRequestDiscussionResponse {
        this['noteable_type'] = noteableType;
        return this;
    }
    public set noteableType(noteableType: UpdateMergeRequestDiscussionResponseNoteableTypeEnum | string  | undefined) {
        this['noteable_type'] = noteableType;
    }
    public get noteableType(): UpdateMergeRequestDiscussionResponseNoteableTypeEnum | string | undefined {
        return this['noteable_type'];
    }
    public withCommitId(commitId: string): UpdateMergeRequestDiscussionResponse {
    ...
    public withResolvable(resolvable: boolean): UpdateMergeRequestDiscussionResponse {
        this['resolvable'] = resolvable;
        return this;
    }
    public withIsReply(isReply: boolean): UpdateMergeRequestDiscussionResponse {
    ...
    public withResolvedBy(resolvedBy: UserBasicDto): UpdateMergeRequestDiscussionResponse {
    ...
    public withNoteableIid(noteableIid: number): UpdateMergeRequestDiscussionResponse {
    ...
    public withDiscussionId(discussionId: string): UpdateMergeRequestDiscussionResponse {
    ...
    public withRepository(repository: string): UpdateMergeRequestDiscussionResponse {
        this['repository'] = repository;
        return this;
    }
    public withDiffFile(diffFile: string): UpdateMergeRequestDiscussionResponse {
    ...
    public withDiff(diff: string): UpdateMergeRequestDiscussionResponse {
        this['diff'] = diff;
        return this;
    }
    public withArchived(archived: boolean): UpdateMergeRequestDiscussionResponse {
        this['archived'] = archived;
        return this;
    }
    public withReviewCategories(reviewCategories: string): UpdateMergeRequestDiscussionResponse {
    ...
    public withReviewCategoriesCn(reviewCategoriesCn: string): UpdateMergeRequestDiscussionResponse {
    ...
    public withReviewCategoriesEn(reviewCategoriesEn: string): UpdateMergeRequestDiscussionResponse {
    ...
    public withReviewModules(reviewModules: string): UpdateMergeRequestDiscussionResponse {
    ...
    public withSeverity(severity: UpdateMergeRequestDiscussionResponseSeverityEnum | string): UpdateMergeRequestDiscussionResponse {
        this['severity'] = severity;
        return this;
    }
    public withSeverityCn(severityCn: string): UpdateMergeRequestDiscussionResponse {
    ...
    public withSeverityEn(severityEn: UpdateMergeRequestDiscussionResponseSeverityEnEnum | string): UpdateMergeRequestDiscussionResponse {
        this['severity_en'] = severityEn;
        return this;
    }
    public set severityEn(severityEn: UpdateMergeRequestDiscussionResponseSeverityEnEnum | string  | undefined) {
        this['severity_en'] = severityEn;
    }
    public get severityEn(): UpdateMergeRequestDiscussionResponseSeverityEnEnum | string | undefined {
        return this['severity_en'];
    }
    public withFilePath(filePath: string): UpdateMergeRequestDiscussionResponse {
    ...
    public withLine(line: string): UpdateMergeRequestDiscussionResponse {
        this['line'] = line;
        return this;
    }
    public withAssignee(assignee: UserBasicDto): UpdateMergeRequestDiscussionResponse {
        this['assignee'] = assignee;
        return this;
    }
    public withProposer(proposer: UserBasicDto): UpdateMergeRequestDiscussionResponse {
        this['proposer'] = proposer;
        return this;
    }
    public withPosition(position: PositionDto): UpdateMergeRequestDiscussionResponse {
        this['position'] = position;
        return this;
    }
    public withResolved(resolved: boolean): UpdateMergeRequestDiscussionResponse {
        this['resolved'] = resolved;
        return this;
    }
    public withIsOutdated(isOutdated: boolean): UpdateMergeRequestDiscussionResponse {
    ...
    public withModerationTime(moderationTime: number): UpdateMergeRequestDiscussionResponse {
    ...
    public withModerationStatus(moderationStatus: number): UpdateMergeRequestDiscussionResponse {
...
/**
    ...
    * @enum {string}
    */
export enum UpdateMergeRequestDiscussionResponseNoteableTypeEnum {
...
/**
    ...
    * @enum {string}
    */
export enum UpdateMergeRequestDiscussionResponseSeverityEnum {
...
/**
    ...
    * @enum {string}
    */
export enum UpdateMergeRequestDiscussionResponseSeverityEnEnum {
    SUGGESTION = 'Suggestion',
    MINOR = 'Minor',
    MAJOR = 'Major',
    FATAL = 'Fatal'
