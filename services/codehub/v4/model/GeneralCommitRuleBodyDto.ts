...
export class GeneralCommitRuleBodyDto {
    ...
    public withRejectUnsignedCommits(rejectUnsignedCommits: boolean): GeneralCommitRuleBodyDto {
    ...
    public withRejectNotSignedByGpg(rejectNotSignedByGpg: boolean): GeneralCommitRuleBodyDto {
    ...
    public withDenyDeleteTag(denyDeleteTag: boolean): GeneralCommitRuleBodyDto {
    ...
    public withPreventSecrets(preventSecrets: boolean): GeneralCommitRuleBodyDto {
    ...
    public withDenyForcePush(denyForcePush: boolean): GeneralCommitRuleBodyDto {
