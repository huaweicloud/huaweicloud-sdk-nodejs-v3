...
export class UpdateMergeRequestDiscussionInfoRequest {
    ...
    public withRepositoryId(repositoryId: number): UpdateMergeRequestDiscussionInfoRequest {
        this['repository_id'] = repositoryId;
        return this;
    }
    ...
    public withMergeRequestIid(mergeRequestIid: number): UpdateMergeRequestDiscussionInfoRequest {
        this['merge_request_iid'] = mergeRequestIid;
        return this;
    }
    ...
    public withDiscussionId(discussionId: string): UpdateMergeRequestDiscussionInfoRequest {
        this['discussion_id'] = discussionId;
        return this;
    }
    ...
    public withBody(body: UpdateMergeRequestNoteDto): UpdateMergeRequestDiscussionInfoRequest {
        this['body'] = body;
        return this;
    }
}