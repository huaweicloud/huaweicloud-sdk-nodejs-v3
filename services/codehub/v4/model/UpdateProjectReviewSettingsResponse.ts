...
export class UpdateProjectReviewSettingsResponse extends SdkResponse {
    ...
    public withCategoriesAndModulesEnabled(categoriesAndModulesEnabled: boolean): UpdateProjectReviewSettingsResponse {
    ...
    public withSecondaryCategoryEnabled(secondaryCategoryEnabled: boolean): UpdateProjectReviewSettingsResponse {
    ...
    public withPrimaryCategories(primaryCategories: Array<CategoryDto>): UpdateProjectReviewSettingsResponse {
    ...
    public withReviewDefaultCategories(reviewDefaultCategories: Array<string>): UpdateProjectReviewSettingsResponse {
    ...
    public withReviewCustomizedCategories(reviewCustomizedCategories: Array<string>): UpdateProjectReviewSettingsResponse {
    ...
    public withReviewModules(reviewModules: Array<string>): UpdateProjectReviewSettingsResponse {
