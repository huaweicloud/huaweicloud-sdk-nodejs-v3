import { CreateMergeRequestNoteDto } from './CreateMergeRequestNoteDto';


export class CreateMergeRequestDiscussionRequest {
    private 'repository_id'?: number;
    private 'merge_request_iid'?: number;
    public body?: CreateMergeRequestNoteDto;
    ...
    public withBody(body: CreateMergeRequestNoteDto): CreateMergeRequestDiscussionRequest {
        this['body'] = body;
        return this;
    }
}