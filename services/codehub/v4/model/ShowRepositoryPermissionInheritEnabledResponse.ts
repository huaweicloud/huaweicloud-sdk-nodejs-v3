...
export class ShowRepositoryPermissionInheritEnabledResponse extends SdkResponse {
    private 'inherit_parent_permission'?: boolean;
    public constructor() { 
        super();
    }
    public withInheritParentPermission(inheritParentPermission: boolean): ShowRepositoryPermissionInheritEnabledResponse {
