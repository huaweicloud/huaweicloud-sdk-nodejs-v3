...
export class ListFilesRequest {
    ...
    public withRepositoryUuid(repositoryUuid: string): ListFilesRequest {
        this['repository_uuid'] = repositoryUuid;
        return this;
    }
    ...
    public withBranchName(branchName: string): ListFilesRequest {
        this['branch_name'] = branchName;
        return this;
    }
    ...
    public withPath(path: string): ListFilesRequest {
        this['path'] = path;
        return this;
    }
}