...
export class MergeRequestDiscussionDto {
    ...
    public withProjectId(projectId: number): MergeRequestDiscussionDto {
    ...
    public withNoteableType(noteableType: string): MergeRequestDiscussionDto {
    ...
    public withProjectFullPath(projectFullPath: string): MergeRequestDiscussionDto {
    ...
    public withSeverity(severity: string): MergeRequestDiscussionDto {
    ...
    public withSeverityEn(severityEn: string): MergeRequestDiscussionDto {
