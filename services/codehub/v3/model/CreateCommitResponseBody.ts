import { CreateCommitResponseBodyStats } from './CreateCommitResponseBodyStats';


export class CreateCommitResponseBody {
    public id?: string;
    ...
    public stats?: CreateCommitResponseBodyStats;
    public constructor() { 
    }
    public withId(id: string): CreateCommitResponseBody {
        this['id'] = id;
        return this;
    }
    public withShortId(shortId: string): CreateCommitResponseBody {
    ...
    public withTitle(title: string): CreateCommitResponseBody {
        this['title'] = title;
        return this;
    }
    public withAuthorName(authorName: string): CreateCommitResponseBody {
    ...
    public withAuthorEmail(authorEmail: string): CreateCommitResponseBody {
    ...
    public withCommitterName(committerName: string): CreateCommitResponseBody {
    ...
    public withCommitterEmail(committerEmail: string): CreateCommitResponseBody {
    ...
    public withCreatedAt(createdAt: string): CreateCommitResponseBody {
    ...
    public withMessage(message: string): CreateCommitResponseBody {
        this['message'] = message;
        return this;
    }
    public withParentIds(parentIds: Array<string>): CreateCommitResponseBody {
    ...
    public withCommittedDate(committedDate: Date): CreateCommitResponseBody {
    ...
    public withAuthoredDate(authoredDate: Date): CreateCommitResponseBody {
    ...
    public withStats(stats: CreateCommitResponseBodyStats): CreateCommitResponseBody {
        this['stats'] = stats;
        return this;
    }
}