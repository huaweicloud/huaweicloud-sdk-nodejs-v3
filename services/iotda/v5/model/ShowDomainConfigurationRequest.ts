...
export class ShowDomainConfigurationRequest {
    ...
    public withConfigurationId(configurationId: string): ShowDomainConfigurationRequest {
        this['configuration_id'] = configurationId;
        return this;
    }
