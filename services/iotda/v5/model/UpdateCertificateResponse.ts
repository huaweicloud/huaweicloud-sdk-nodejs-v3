...
export class UpdateCertificateResponse extends SdkResponse {
    ...
    public withCertificateId(certificateId: string): UpdateCertificateResponse {
    ...
    public withCnName(cnName: string): UpdateCertificateResponse {
        this['cn_name'] = cnName;
        return this;
    }
    ...
    public withOwner(owner: string): UpdateCertificateResponse {
        this['owner'] = owner;
        return this;
    }
    public withStatus(status: boolean): UpdateCertificateResponse {
        this['status'] = status;
        return this;
    }
    public withVerifyCode(verifyCode: string): UpdateCertificateResponse {
    ...
    public withProvisionEnable(provisionEnable: boolean): UpdateCertificateResponse {
    ...
    public withTemplateId(templateId: string): UpdateCertificateResponse {
    ...
    public withOcspEnable(ocspEnable: boolean): UpdateCertificateResponse {
    ...
    public withOcspServerCaId(ocspServerCaId: string): UpdateCertificateResponse {
    ...
    public withOcspSslEnable(ocspSslEnable: boolean): UpdateCertificateResponse {
    ...
    public withCreateDate(createDate: string): UpdateCertificateResponse {
    ...
    public withEffectiveDate(effectiveDate: string): UpdateCertificateResponse {
    ...
    public withExpiryDate(expiryDate: string): UpdateCertificateResponse {
