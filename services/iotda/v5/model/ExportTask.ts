...
export class ExportTask {
    ...
    public withExportTaskId(exportTaskId: string): ExportTask {
    ...
    public withResourceType(resourceType: string): ExportTask {
    ...
    public withResourceCondition(resourceCondition: object): ExportTask {
    ...
    public withExportFormat(exportFormat: string): ExportTask {
    ...
    public withStatus(status: string): ExportTask {
        this['status'] = status;
        return this;
    }
    public withExportCount(exportCount: number): ExportTask {
    ...
    public withProgress(progress: number): ExportTask {
        this['progress'] = progress;
        return this;
    }
    public withCreateTime(createTime: string): ExportTask {
    ...
    public withEndTime(endTime: string): ExportTask {
    ...
    public withAppType(appType: string): ExportTask {
    ...
    public withAppId(appId: string): ExportTask {
        this['app_id'] = appId;
        return this;
    }
