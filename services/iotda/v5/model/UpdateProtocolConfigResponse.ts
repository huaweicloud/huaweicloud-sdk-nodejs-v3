...
export class UpdateProtocolConfigResponse extends SdkResponse {
    ...
    public withProtocolId(protocolId: string): UpdateProtocolConfigResponse {
    ...
    public withPort(port: number): UpdateProtocolConfigResponse {
        this['port'] = port;
        return this;
    }
    public withKeepaliveTimeout(keepaliveTimeout: number): UpdateProtocolConfigResponse {
    ...
    public withProtocolType(protocolType: string): UpdateProtocolConfigResponse {
    ...
    public withDescription(description: string): UpdateProtocolConfigResponse {
        this['description'] = description;
        return this;
    }
    public withSslEnable(sslEnable: boolean): UpdateProtocolConfigResponse {
    ...
    public withFrameDecodeConfigs(frameDecodeConfigs: Array<FrameDecodeConfig>): UpdateProtocolConfigResponse {
    ...
    public withCodecMode(codecMode: string): UpdateProtocolConfigResponse {
    ...
    public withFuncUrn(funcUrn: string): UpdateProtocolConfigResponse {
    ...
    public withCreateTime(createTime: string): UpdateProtocolConfigResponse {
    ...
    public withUpdateTime(updateTime: string): UpdateProtocolConfigResponse {
