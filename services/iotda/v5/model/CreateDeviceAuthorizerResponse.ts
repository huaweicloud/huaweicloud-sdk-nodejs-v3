...
export class CreateDeviceAuthorizerResponse extends SdkResponse {
    ...
    public withAuthorizerId(authorizerId: string): CreateDeviceAuthorizerResponse {
    ...
    public withAuthorizerName(authorizerName: string): CreateDeviceAuthorizerResponse {
    ...
    public withFuncName(funcName: string): CreateDeviceAuthorizerResponse {
    ...
    public withFuncUrn(funcUrn: string): CreateDeviceAuthorizerResponse {
    ...
    public withSigningEnable(signingEnable: boolean): CreateDeviceAuthorizerResponse {
    ...
    public withSigningToken(signingToken: string): CreateDeviceAuthorizerResponse {
    ...
    public withSigningPublicKey(signingPublicKey: string): CreateDeviceAuthorizerResponse {
    ...
    public withDefaultAuthorizer(defaultAuthorizer: boolean): CreateDeviceAuthorizerResponse {
    ...
    public withStatus(status: string): CreateDeviceAuthorizerResponse {
        this['status'] = status;
        return this;
    }
    public withCacheEnable(cacheEnable: boolean): CreateDeviceAuthorizerResponse {
    ...
    public withCreateTime(createTime: string): CreateDeviceAuthorizerResponse {
    ...
    public withUpdateTime(updateTime: string): CreateDeviceAuthorizerResponse {
