...
export class DeleteServerCertificateRequest {
    ...
    public withInstanceId(instanceId: string): DeleteServerCertificateRequest {
    ...
    public withServerCertificateId(serverCertificateId: string): DeleteServerCertificateRequest {
        this['server_certificate_id'] = serverCertificateId;
        return this;
    }
