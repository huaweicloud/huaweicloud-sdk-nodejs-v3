...
export class CloseDeviceTunnelRequest {
    private 'Instance-Id'?: string;
    private 'tunnel_id'?: string;
    public constructor(tunnelId?: string) { 
        this['tunnel_id'] = tunnelId;
    }
    public withInstanceId(instanceId: string): CloseDeviceTunnelRequest {
    ...
    public withTunnelId(tunnelId: string): CloseDeviceTunnelRequest {
        this['tunnel_id'] = tunnelId;
        return this;
    }
