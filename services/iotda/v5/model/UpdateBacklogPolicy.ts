...
export class UpdateBacklogPolicy {
    ...
    public withPolicyName(policyName: string): UpdateBacklogPolicy {
    ...
    public withDescription(description: string): UpdateBacklogPolicy {
        this['description'] = description;
        return this;
    }
    public withBacklogSize(backlogSize: number): UpdateBacklogPolicy {
    ...
    public withBacklogTime(backlogTime: number): UpdateBacklogPolicy {
