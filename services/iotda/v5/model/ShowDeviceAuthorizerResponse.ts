...
export class ShowDeviceAuthorizerResponse extends SdkResponse {
    ...
    public withAuthorizerId(authorizerId: string): ShowDeviceAuthorizerResponse {
    ...
    public withAuthorizerName(authorizerName: string): ShowDeviceAuthorizerResponse {
    ...
    public withFuncName(funcName: string): ShowDeviceAuthorizerResponse {
    ...
    public withFuncUrn(funcUrn: string): ShowDeviceAuthorizerResponse {
    ...
    public withSigningEnable(signingEnable: boolean): ShowDeviceAuthorizerResponse {
    ...
    public withSigningToken(signingToken: string): ShowDeviceAuthorizerResponse {
    ...
    public withSigningPublicKey(signingPublicKey: string): ShowDeviceAuthorizerResponse {
    ...
    public withDefaultAuthorizer(defaultAuthorizer: boolean): ShowDeviceAuthorizerResponse {
    ...
    public withStatus(status: string): ShowDeviceAuthorizerResponse {
        this['status'] = status;
        return this;
    }
    public withCacheEnable(cacheEnable: boolean): ShowDeviceAuthorizerResponse {
    ...
    public withCreateTime(createTime: string): ShowDeviceAuthorizerResponse {
    ...
    public withUpdateTime(updateTime: string): ShowDeviceAuthorizerResponse {
