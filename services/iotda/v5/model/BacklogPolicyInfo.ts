...
export class BacklogPolicyInfo {
    ...
    public withPolicyId(policyId: string): BacklogPolicyInfo {
    ...
    public withPolicyName(policyName: string): BacklogPolicyInfo {
    ...
    public withDescription(description: string): BacklogPolicyInfo {
        this['description'] = description;
        return this;
    }
    public withBacklogSize(backlogSize: number): BacklogPolicyInfo {
    ...
    public withBacklogTime(backlogTime: number): BacklogPolicyInfo {
