...
export class CreateDomainConfigurationResponse extends SdkResponse {
    ...
    public withConfigurationId(configurationId: string): CreateDomainConfigurationResponse {
    ...
    public withDomainName(domainName: string): CreateDomainConfigurationResponse {
    ...
    public withAccessProtocol(accessProtocol: string): CreateDomainConfigurationResponse {
    ...
    public withServerCertificateId(serverCertificateId: string): CreateDomainConfigurationResponse {
    ...
    public withServerCertificateConfig(serverCertificateConfig: ServerCertificateConfig): CreateDomainConfigurationResponse {
