...
export class UpdateSecurityProfileResponse extends SdkResponse {
    ...
    public withProfileId(profileId: string): UpdateSecurityProfileResponse {
    ...
    public withSecurityType(securityType: string): UpdateSecurityProfileResponse {
    ...
    public withAlarmLevel(alarmLevel: string): UpdateSecurityProfileResponse {
    ...
    public withSecurityLevel(securityLevel: string): UpdateSecurityProfileResponse {
    ...
    public withEnable(enable: boolean): UpdateSecurityProfileResponse {
        this['enable'] = enable;
        return this;
    }
    public withProfile(profile: Array<SecurityProfile>): UpdateSecurityProfileResponse {
        this['profile'] = profile;
        return this;
    }
    public withProfileTargets(profileTargets: SecurityTarget): UpdateSecurityProfileResponse {
