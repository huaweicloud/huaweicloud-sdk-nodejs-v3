...
export class ShowDeviceTunnelRequest {
    private 'Instance-Id'?: string;
    private 'tunnel_id'?: string;
    public constructor(tunnelId?: string) { 
        this['tunnel_id'] = tunnelId;
    }
    public withInstanceId(instanceId: string): ShowDeviceTunnelRequest {
    ...
    public withTunnelId(tunnelId: string): ShowDeviceTunnelRequest {
        this['tunnel_id'] = tunnelId;
        return this;
    }
