...
export class UpdateDomainConfigurationResponse extends SdkResponse {
    ...
    public withConfigurationId(configurationId: string): UpdateDomainConfigurationResponse {
    ...
    public withDomainName(domainName: string): UpdateDomainConfigurationResponse {
    ...
    public withAccessProtocol(accessProtocol: string): UpdateDomainConfigurationResponse {
    ...
    public withServerCertificateId(serverCertificateId: string): UpdateDomainConfigurationResponse {
    ...
    public withServerCertificateConfig(serverCertificateConfig: ServerCertificateConfig): UpdateDomainConfigurationResponse {
