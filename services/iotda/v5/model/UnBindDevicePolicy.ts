...
export class UnBindDevicePolicy {
    ...
    public withTargetType(targetType: string): UnBindDevicePolicy {
        this['target_type'] = targetType;
        return this;
    }
    ...
    public withTargetIds(targetIds: Array<string>): UnBindDevicePolicy {
        this['target_ids'] = targetIds;
        return this;
    }
