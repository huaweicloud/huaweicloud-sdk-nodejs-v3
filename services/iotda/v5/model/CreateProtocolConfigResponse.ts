...
export class CreateProtocolConfigResponse extends SdkResponse {
    ...
    public withProtocolId(protocolId: string): CreateProtocolConfigResponse {
    ...
    public withPort(port: number): CreateProtocolConfigResponse {
        this['port'] = port;
        return this;
    }
    public withKeepaliveTimeout(keepaliveTimeout: number): CreateProtocolConfigResponse {
    ...
    public withProtocolType(protocolType: string): CreateProtocolConfigResponse {
    ...
    public withDescription(description: string): CreateProtocolConfigResponse {
        this['description'] = description;
        return this;
    }
    public withSslEnable(sslEnable: boolean): CreateProtocolConfigResponse {
    ...
    public withFrameDecodeConfigs(frameDecodeConfigs: Array<FrameDecodeConfig>): CreateProtocolConfigResponse {
    ...
    public withCodecMode(codecMode: string): CreateProtocolConfigResponse {
    ...
    public withFuncUrn(funcUrn: string): CreateProtocolConfigResponse {
    ...
    public withCreateTime(createTime: string): CreateProtocolConfigResponse {
    ...
    public withUpdateTime(updateTime: string): CreateProtocolConfigResponse {
