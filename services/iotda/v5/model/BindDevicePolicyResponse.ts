...
export class BindDevicePolicyResponse extends SdkResponse {
    ...
    public withPolicyId(policyId: string): BindDevicePolicyResponse {
    ...
    public withTargetType(targetType: string): BindDevicePolicyResponse {
    ...
    public withSuccessTargets(successTargets: Array<string>): BindDevicePolicyResponse {
    ...
    public withFailureTargets(failureTargets: Array<DevicePolicyBindOrUnbindFailureDetail>): BindDevicePolicyResponse {
