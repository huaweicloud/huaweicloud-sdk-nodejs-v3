...
export class ShowDeviceProxyResponse extends SdkResponse {
    ...
    public withProxyId(proxyId: string): ShowDeviceProxyResponse {
    ...
    public withProxyName(proxyName: string): ShowDeviceProxyResponse {
    ...
    public withProxyDevices(proxyDevices: Array<string>): ShowDeviceProxyResponse {
    ...
    public withEffectiveTimeRange(effectiveTimeRange: EffectiveTimeRangeResponseDTO): ShowDeviceProxyResponse {
    ...
    public withAppId(appId: string): ShowDeviceProxyResponse {
        this['app_id'] = appId;
        return this;
    }
