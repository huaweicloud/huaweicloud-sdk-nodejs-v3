...
export class ShowProtocolConfigResponse extends SdkResponse {
    ...
    public withProtocolId(protocolId: string): ShowProtocolConfigResponse {
    ...
    public withPort(port: number): ShowProtocolConfigResponse {
        this['port'] = port;
        return this;
    }
    public withKeepaliveTimeout(keepaliveTimeout: number): ShowProtocolConfigResponse {
    ...
    public withProtocolType(protocolType: string): ShowProtocolConfigResponse {
    ...
    public withDescription(description: string): ShowProtocolConfigResponse {
        this['description'] = description;
        return this;
    }
    public withSslEnable(sslEnable: boolean): ShowProtocolConfigResponse {
    ...
    public withFrameDecodeConfigs(frameDecodeConfigs: Array<FrameDecodeConfig>): ShowProtocolConfigResponse {
    ...
    public withCodecMode(codecMode: string): ShowProtocolConfigResponse {
    ...
    public withFuncUrn(funcUrn: string): ShowProtocolConfigResponse {
    ...
    public withCreateTime(createTime: string): ShowProtocolConfigResponse {
    ...
    public withUpdateTime(updateTime: string): ShowProtocolConfigResponse {
