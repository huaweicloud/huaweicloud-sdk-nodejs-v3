...
export class CreateDeviceProxyResponse extends SdkResponse {
    ...
    public withProxyId(proxyId: string): CreateDeviceProxyResponse {
    ...
    public withProxyName(proxyName: string): CreateDeviceProxyResponse {
    ...
    public withProxyDevices(proxyDevices: Array<string>): CreateDeviceProxyResponse {
    ...
    public withEffectiveTimeRange(effectiveTimeRange: EffectiveTimeRangeResponseDTO): CreateDeviceProxyResponse {
    ...
    public withAppId(appId: string): CreateDeviceProxyResponse {
        this['app_id'] = appId;
        return this;
    }
