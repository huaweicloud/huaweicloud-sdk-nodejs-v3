...
export class DeleteDeviceAuthorizerRequest {
    private 'Instance-Id'?: string;
    private 'authorizer_id'?: string;
    public constructor(authorizerId?: string) { 
        this['authorizer_id'] = authorizerId;
    }
    public withInstanceId(instanceId: string): DeleteDeviceAuthorizerRequest {
    ...
    public withAuthorizerId(authorizerId: string): DeleteDeviceAuthorizerRequest {
        this['authorizer_id'] = authorizerId;
        return this;
    }
