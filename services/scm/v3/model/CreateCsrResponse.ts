...
export class CreateCsrResponse extends SdkResponse {
    public id?: string;
    public name?: string;
    ...
    public withId(id: string): CreateCsrResponse {
        this['id'] = id;
        return this;
    }
    public withName(name: string): CreateCsrResponse {
        this['name'] = name;
        return this;
    }
    public withDomainName(domainName: string): CreateCsrResponse {
    ...
    public withSans(sans: string): CreateCsrResponse {
        this['sans'] = sans;
        return this;
    }
    public withPrivateKeyAlgo(privateKeyAlgo: string): CreateCsrResponse {
    ...
    public withUsage(usage: string): CreateCsrResponse {
        this['usage'] = usage;
        return this;
    }
    public withCompanyCountry(companyCountry: string): CreateCsrResponse {
    ...
    public withCompanyProvince(companyProvince: string): CreateCsrResponse {
    ...
    public withCompanyCity(companyCity: string): CreateCsrResponse {
    ...
    public withCompanyName(companyName: string): CreateCsrResponse {
    ...
    public withCreateTime(createTime: number): CreateCsrResponse {
    ...
    public withUpdateTime(updateTime: number): CreateCsrResponse {
