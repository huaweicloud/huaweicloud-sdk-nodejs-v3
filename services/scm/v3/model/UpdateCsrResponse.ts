...
export class UpdateCsrResponse extends SdkResponse {
    public id?: string;
    public name?: string;
    public csr?: string;
    ...
    public withId(id: string): UpdateCsrResponse {
        this['id'] = id;
        return this;
    }
    public withName(name: string): UpdateCsrResponse {
        this['name'] = name;
        return this;
    }
    public withCsr(csr: string): UpdateCsrResponse {
        this['csr'] = csr;
        return this;
    }
    public withDomainName(domainName: string): UpdateCsrResponse {
    ...
    public withSans(sans: string): UpdateCsrResponse {
        this['sans'] = sans;
        return this;
    }
    public withPrivateKeyAlgo(privateKeyAlgo: string): UpdateCsrResponse {
    ...
    public withUsage(usage: string): UpdateCsrResponse {
        this['usage'] = usage;
        return this;
    }
    public withCompanyCountry(companyCountry: string): UpdateCsrResponse {
    ...
    public withCompanyProvince(companyProvince: string): UpdateCsrResponse {
    ...
    public withCompanyCity(companyCity: string): UpdateCsrResponse {
    ...
    public withCompanyName(companyName: string): UpdateCsrResponse {
    ...
    public withCreateTime(createTime: number): UpdateCsrResponse {
    ...
    public withUpdateTime(updateTime: number): UpdateCsrResponse {
