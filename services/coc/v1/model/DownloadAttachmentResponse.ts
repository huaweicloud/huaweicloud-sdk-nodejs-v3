...
export class DownloadAttachmentResponse extends SdkResponse {
    ...
    public withProviderCode(providerCode: string): DownloadAttachmentResponse {
    ...
    public withErrorCode(errorCode: string): DownloadAttachmentResponse {
    ...
    public withErrorMsg(errorMsg: string): DownloadAttachmentResponse {
