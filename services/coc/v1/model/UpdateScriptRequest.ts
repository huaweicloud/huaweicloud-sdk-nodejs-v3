import { EditScriptModel } from './EditScriptModel';
...
export class UpdateScriptRequest {
    ...
    public body?: EditScriptModel;
    public constructor(scriptUuid?: string) { 
        this['script_uuid'] = scriptUuid;
    }
    public withScriptUuid(scriptUuid: string): UpdateScriptRequest {
        this['script_uuid'] = scriptUuid;
        return this;
    }
    ...
    public withXLanguage(xLanguage: string): UpdateScriptRequest {
    ...
    public withXProjectId(xProjectId: string): UpdateScriptRequest {
    ...
    public withXUserProfile(xUserProfile: string): UpdateScriptRequest {
    ...
    public withBody(body: EditScriptModel): UpdateScriptRequest {
        this['body'] = body;
        return this;
    }
}