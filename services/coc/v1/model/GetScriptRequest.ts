...
export class GetScriptRequest {
    ...
    public withScriptUuid(scriptUuid: string): GetScriptRequest {
        this['script_uuid'] = scriptUuid;
        return this;
    }
    ...
    public withXLanguage(xLanguage: string): GetScriptRequest {
    ...
    public withXProjectId(xProjectId: string): GetScriptRequest {
    ...
    public withXUserProfile(xUserProfile: string): GetScriptRequest {
