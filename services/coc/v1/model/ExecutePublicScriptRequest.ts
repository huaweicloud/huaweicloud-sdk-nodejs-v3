...
export class ExecutePublicScriptRequest {
    ...
    public withScriptUuid(scriptUuid: string): ExecutePublicScriptRequest {
        this['script_uuid'] = scriptUuid;
        return this;
    }
    ...
    public withXLanguage(xLanguage: string): ExecutePublicScriptRequest {
    ...
    public withXProjectId(xProjectId: string): ExecutePublicScriptRequest {
    ...
    public withXUserProfile(xUserProfile: string): ExecutePublicScriptRequest {
    ...
    public withBody(body: ScriptExecuteModel): ExecutePublicScriptRequest {
        this['body'] = body;
        return this;
    }
}