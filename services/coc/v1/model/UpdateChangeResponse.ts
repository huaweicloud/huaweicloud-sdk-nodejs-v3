...
export class UpdateChangeResponse extends SdkResponse {
    ...
    public withErrorCode(errorCode: string): UpdateChangeResponse {
        this['error_code'] = errorCode;
        return this;
    }
    ...
    public withErrorMsg(errorMsg: string): UpdateChangeResponse {
