...
export class ListIncidentsResponse extends SdkResponse {
    ...
    public withProviderCode(providerCode: string): ListIncidentsResponse {
        this['provider_code'] = providerCode;
        return this;
    }
    ...
    public withErrorCode(errorCode: string): ListIncidentsResponse {
        this['error_code'] = errorCode;
        return this;
    }
    ...
    public withErrorMsg(errorMsg: string): ListIncidentsResponse {
        this['error_msg'] = errorMsg;
        return this;
    }
    ...
    public withData(data: object): ListIncidentsResponse {
        this['data'] = data;
        return this;
    }
}