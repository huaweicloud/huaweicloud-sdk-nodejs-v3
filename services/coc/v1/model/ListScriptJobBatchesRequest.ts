...
export class ListScriptJobBatchesRequest {
    ...
    public withExecuteUuid(executeUuid: string): ListScriptJobBatchesRequest {
        this['execute_uuid'] = executeUuid;
        return this;
    }
    ...
    public withXLanguage(xLanguage: string): ListScriptJobBatchesRequest {
    ...
    public withXProjectId(xProjectId: string): ListScriptJobBatchesRequest {
    ...
    public withXUserProfile(xUserProfile: string): ListScriptJobBatchesRequest {
