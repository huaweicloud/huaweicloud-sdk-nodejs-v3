...
export class DeleteTicketInfoRequest {
    ...
    public withTicketType(ticketType: string): DeleteTicketInfoRequest {
        this['ticket_type'] = ticketType;
        return this;
    }
    ...
    public withTicketId(ticketId: string): DeleteTicketInfoRequest {
        this['ticket_id'] = ticketId;
        return this;
    }
