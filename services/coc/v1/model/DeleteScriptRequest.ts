...
export class DeleteScriptRequest {
    ...
    public withScriptUuid(scriptUuid: string): DeleteScriptRequest {
        this['script_uuid'] = scriptUuid;
        return this;
    }
    ...
    public withXLanguage(xLanguage: string): DeleteScriptRequest {
    ...
    public withXProjectId(xProjectId: string): DeleteScriptRequest {
    ...
    public withXUserProfile(xUserProfile: string): DeleteScriptRequest {
