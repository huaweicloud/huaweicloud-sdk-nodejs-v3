...
export class CreateResourceViewsRequestBody {
    ...
    public withOrganizationUnitIds(organizationUnitIds: Array<string>): CreateResourceViewsRequestBody {
        this['organization_unit_ids'] = organizationUnitIds;
        return this;
    }
    ...
    public withResourceTypes(resourceTypes: Array<string>): CreateResourceViewsRequestBody {
        this['resource_types'] = resourceTypes;
        return this;
    }
    ...
    public withViewType(viewType: string): CreateResourceViewsRequestBody {
        this['view_type'] = viewType;
        return this;
    }
    ...
    public withOrganizationId(organizationId: string): CreateResourceViewsRequestBody {
    ...
    public withName(name: string): CreateResourceViewsRequestBody {
        this['name'] = name;
        return this;
    }
}