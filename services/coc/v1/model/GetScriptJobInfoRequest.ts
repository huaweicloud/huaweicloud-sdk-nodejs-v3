...
export class GetScriptJobInfoRequest {
    ...
    public withExecuteUuid(executeUuid: string): GetScriptJobInfoRequest {
        this['execute_uuid'] = executeUuid;
        return this;
    }
    ...
    public withXLanguage(xLanguage: string): GetScriptJobInfoRequest {
    ...
    public withXProjectId(xProjectId: string): GetScriptJobInfoRequest {
    ...
    public withXUserProfile(xUserProfile: string): GetScriptJobInfoRequest {
