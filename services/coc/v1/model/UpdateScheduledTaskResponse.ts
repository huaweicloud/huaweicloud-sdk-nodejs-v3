...
export class UpdateScheduledTaskResponse extends SdkResponse {
    public id?: string;
    ...
    public withId(id: string): UpdateScheduledTaskResponse {
        this['id'] = id;
        return this;
    }
    public withEnterpriseProjectId(enterpriseProjectId: string): UpdateScheduledTaskResponse {
    ...
    public withName(name: string): UpdateScheduledTaskResponse {
        this['name'] = name;
        return this;
    }
    public withAgencyName(agencyName: string): UpdateScheduledTaskResponse {
    ...
    public withTriggerTime(triggerTime: TriggerTime): UpdateScheduledTaskResponse {
    ...
    public withVersionNo(versionNo: string): UpdateScheduledTaskResponse {
    ...
    public withTaskType(taskType: object): UpdateScheduledTaskResponse {
    ...
    public withAssociatedTaskId(associatedTaskId: string): UpdateScheduledTaskResponse {
    ...
    public withAssociatedTaskName(associatedTaskName: string): UpdateScheduledTaskResponse {
    ...
    public withAssociatedTaskNameEn(associatedTaskNameEn: string): UpdateScheduledTaskResponse {
    ...
    public withAssociatedTaskType(associatedTaskType: string): UpdateScheduledTaskResponse {
    ...
    public withRunbookInstanceMode(runbookInstanceMode: string): UpdateScheduledTaskResponse {
    ...
    public withRiskLevel(riskLevel: string): UpdateScheduledTaskResponse {
    ...
    public withInputParam(inputParam: string): UpdateScheduledTaskResponse {
    ...
    public withEnableApprove(enableApprove: boolean): UpdateScheduledTaskResponse {
    ...
    public withReviewerNotification(reviewerNotification: MessageNotification): UpdateScheduledTaskResponse {
    ...
    public withCreatedUserName(createdUserName: string): UpdateScheduledTaskResponse {
    ...
    public withReviewerUserName(reviewerUserName: string): UpdateScheduledTaskResponse {
    ...
    public withApproveStatus(approveStatus: object): UpdateScheduledTaskResponse {
    ...
    public withApproveComments(approveComments: string): UpdateScheduledTaskResponse {
    ...
    public withTargetInstances(targetInstances: string): UpdateScheduledTaskResponse {
    ...
    public withEnableMessageNotification(enableMessageNotification: boolean): UpdateScheduledTaskResponse {
    ...
    public withMessageNotification(messageNotification: MessageNotification): UpdateScheduledTaskResponse {
