...
export class InstanceTask {
    ...
    public withTaskId(taskId: string): InstanceTask {
        this['task_id'] = taskId;
        return this;
    }
    ...
    public withType(type: string): InstanceTask {
        this['type'] = type;
        return this;
    }
    public withStatus(status: string): InstanceTask {
        this['status'] = status;
        return this;
    }
    public withStatusDetail(statusDetail: string): InstanceTask {
    ...
    public withCreateTime(createTime: string): InstanceTask {
    ...
    public withStartTime(startTime: string): InstanceTask {
    ...
    public withEndTime(endTime: string): InstanceTask {
    ...
    public withTargetConfig(targetConfig: TargetConfig): InstanceTask {
    ...
    public withOperateWindow(operateWindow: OperateWindow): InstanceTask {
