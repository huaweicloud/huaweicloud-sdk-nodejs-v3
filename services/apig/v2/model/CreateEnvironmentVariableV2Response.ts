...
export class CreateEnvironmentVariableV2Response extends SdkResponse {
    ...
    public withVariableValue(variableValue: string): CreateEnvironmentVariableV2Response {
        this['variable_value'] = variableValue;
        return this;
    }
    ...
    public withEnvId(envId: string): CreateEnvironmentVariableV2Response {
        this['env_id'] = envId;
        return this;
    }
    ...
    public withGroupId(groupId: string): CreateEnvironmentVariableV2Response {
    ...
    public withVariableName(variableName: string): CreateEnvironmentVariableV2Response {
    ...
    public withId(id: string): CreateEnvironmentVariableV2Response {
        this['id'] = id;
        return this;
    }
}