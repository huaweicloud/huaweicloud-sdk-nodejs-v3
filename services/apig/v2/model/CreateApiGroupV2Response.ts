...
export class CreateApiGroupV2Response extends SdkResponse {
    public id?: string;
    public name?: string;
    public status?: CreateApiGroupV2ResponseStatusEnum | number;
    ...
    public withId(id: string): CreateApiGroupV2Response {
        this['id'] = id;
        return this;
    }
    public withName(name: string): CreateApiGroupV2Response {
        this['name'] = name;
        return this;
    }
    public withStatus(status: CreateApiGroupV2ResponseStatusEnum | number): CreateApiGroupV2Response {
        this['status'] = status;
        return this;
    }
    public withSlDomain(slDomain: string): CreateApiGroupV2Response {
        this['sl_domain'] = slDomain;
        return this;
    }
    ...
    public withRegisterTime(registerTime: Date): CreateApiGroupV2Response {
        this['register_time'] = registerTime;
        return this;
    }
    ...
    public withUpdateTime(updateTime: Date): CreateApiGroupV2Response {
        this['update_time'] = updateTime;
        return this;
    }
    ...
    public withOnSellStatus(onSellStatus: number): CreateApiGroupV2Response {
        this['on_sell_status'] = onSellStatus;
        return this;
    }
    ...
    public withUrlDomains(urlDomains: Array<UrlDomain>): CreateApiGroupV2Response {
    ...
    public withSlDomainAccessEnabled(slDomainAccessEnabled: boolean): CreateApiGroupV2Response {
    ...
    public withSlDomains(slDomains: Array<string>): CreateApiGroupV2Response {
    ...
    public withRemark(remark: string): CreateApiGroupV2Response {
        this['remark'] = remark;
        return this;
    }
    public withCallLimits(callLimits: number): CreateApiGroupV2Response {
    ...
    public withTimeInterval(timeInterval: number): CreateApiGroupV2Response {
    ...
    public withTimeUnit(timeUnit: string): CreateApiGroupV2Response {
    ...
    public withIsDefault(isDefault: number): CreateApiGroupV2Response {
    ...
    public withVersion(version: string): CreateApiGroupV2Response {
        this['version'] = version;
        return this;
    }
    public withRomaAppId(romaAppId: string): CreateApiGroupV2Response {
    ...
    public withRomaAppName(romaAppName: string): CreateApiGroupV2Response {
...
/**
    ...
    * @enum {string}
    */
export enum CreateApiGroupV2ResponseStatusEnum {
    NUMBER_1 = 1
}
