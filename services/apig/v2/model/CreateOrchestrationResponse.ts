...
export class CreateOrchestrationResponse extends SdkResponse {
    private 'orchestration_name'?: string;
    private 'orchestration_strategy'?: CreateOrchestrationResponseOrchestrationStrategyEnum | string;
    ...
    public withOrchestrationName(orchestrationName: string): CreateOrchestrationResponse {
        this['orchestration_name'] = orchestrationName;
        return this;
    }
    ...
    public withOrchestrationStrategy(orchestrationStrategy: CreateOrchestrationResponseOrchestrationStrategyEnum | string): CreateOrchestrationResponse {
        this['orchestration_strategy'] = orchestrationStrategy;
        return this;
    }
    public set orchestrationStrategy(orchestrationStrategy: CreateOrchestrationResponseOrchestrationStrategyEnum | string  | undefined) {
        this['orchestration_strategy'] = orchestrationStrategy;
    }
    public get orchestrationStrategy(): CreateOrchestrationResponseOrchestrationStrategyEnum | string | undefined {
        return this['orchestration_strategy'];
    }
    public withOrchestrationMappedParam(orchestrationMappedParam: OrchestrationMappedParam): CreateOrchestrationResponse {
    ...
    public withIsPreprocessing(isPreprocessing: boolean): CreateOrchestrationResponse {
    ...
    public withOrchestrationMap(orchestrationMap: Array<OrchestrationMap>): CreateOrchestrationResponse {
    ...
    public withOrchestrationId(orchestrationId: string): CreateOrchestrationResponse {
    ...
    public withOrchestrationCreateTime(orchestrationCreateTime: Date): CreateOrchestrationResponse {
    ...
    public withOrchestrationUpdateTime(orchestrationUpdateTime: Date): CreateOrchestrationResponse {
...
/**
    ...
    * @enum {string}
    */
export enum CreateOrchestrationResponseOrchestrationStrategyEnum {
    LIST = 'list',
    HASH = 'hash',
    RANGE = 'range',
