...
export class ApiGroupInfo {
    public id?: string;
    public name?: string;
    public status?: ApiGroupInfoStatusEnum | number;
    ...
    public withId(id: string): ApiGroupInfo {
        this['id'] = id;
        return this;
    }
    public withName(name: string): ApiGroupInfo {
        this['name'] = name;
        return this;
    }
    public withStatus(status: ApiGroupInfoStatusEnum | number): ApiGroupInfo {
        this['status'] = status;
        return this;
    }
    public withSlDomain(slDomain: string): ApiGroupInfo {
        this['sl_domain'] = slDomain;
        return this;
    }
    ...
    public withRegisterTime(registerTime: Date): ApiGroupInfo {
        this['register_time'] = registerTime;
        return this;
    }
    ...
    public withUpdateTime(updateTime: Date): ApiGroupInfo {
        this['update_time'] = updateTime;
        return this;
    }
    ...
    public withOnSellStatus(onSellStatus: number): ApiGroupInfo {
        this['on_sell_status'] = onSellStatus;
        return this;
    }
    ...
    public withUrlDomains(urlDomains: Array<UrlDomain>): ApiGroupInfo {
    ...
    public withSlDomainAccessEnabled(slDomainAccessEnabled: boolean): ApiGroupInfo {
    ...
    public withSlDomains(slDomains: Array<string>): ApiGroupInfo {
    ...
    public withRemark(remark: string): ApiGroupInfo {
        this['remark'] = remark;
        return this;
    }
    public withCallLimits(callLimits: number): ApiGroupInfo {
    ...
    public withTimeInterval(timeInterval: number): ApiGroupInfo {
    ...
    public withTimeUnit(timeUnit: string): ApiGroupInfo {
    ...
    public withIsDefault(isDefault: number): ApiGroupInfo {
    ...
    public withVersion(version: string): ApiGroupInfo {
        this['version'] = version;
        return this;
    }
    public withRomaAppId(romaAppId: string): ApiGroupInfo {
    ...
    public withRomaAppName(romaAppName: string): ApiGroupInfo {
...
/**
    ...
    * @enum {string}
    */
export enum ApiGroupInfoStatusEnum {
    NUMBER_1 = 1
}
