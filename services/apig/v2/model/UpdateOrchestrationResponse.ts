...
export class UpdateOrchestrationResponse extends SdkResponse {
    private 'orchestration_name'?: string;
    private 'orchestration_strategy'?: UpdateOrchestrationResponseOrchestrationStrategyEnum | string;
    ...
    public withOrchestrationName(orchestrationName: string): UpdateOrchestrationResponse {
        this['orchestration_name'] = orchestrationName;
        return this;
    }
    ...
    public withOrchestrationStrategy(orchestrationStrategy: UpdateOrchestrationResponseOrchestrationStrategyEnum | string): UpdateOrchestrationResponse {
        this['orchestration_strategy'] = orchestrationStrategy;
        return this;
    }
    public set orchestrationStrategy(orchestrationStrategy: UpdateOrchestrationResponseOrchestrationStrategyEnum | string  | undefined) {
        this['orchestration_strategy'] = orchestrationStrategy;
    }
    public get orchestrationStrategy(): UpdateOrchestrationResponseOrchestrationStrategyEnum | string | undefined {
        return this['orchestration_strategy'];
    }
    public withOrchestrationMappedParam(orchestrationMappedParam: OrchestrationMappedParam): UpdateOrchestrationResponse {
    ...
    public withIsPreprocessing(isPreprocessing: boolean): UpdateOrchestrationResponse {
    ...
    public withOrchestrationMap(orchestrationMap: Array<OrchestrationMap>): UpdateOrchestrationResponse {
    ...
    public withOrchestrationId(orchestrationId: string): UpdateOrchestrationResponse {
    ...
    public withOrchestrationCreateTime(orchestrationCreateTime: Date): UpdateOrchestrationResponse {
    ...
    public withOrchestrationUpdateTime(orchestrationUpdateTime: Date): UpdateOrchestrationResponse {
...
/**
    ...
    * @enum {string}
    */
export enum UpdateOrchestrationResponseOrchestrationStrategyEnum {
    LIST = 'list',
    HASH = 'hash',
    RANGE = 'range',
