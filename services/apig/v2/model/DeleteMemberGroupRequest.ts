...
export class DeleteMemberGroupRequest {
    ...
    public withInstanceId(instanceId: string): DeleteMemberGroupRequest {
        this['instance_id'] = instanceId;
        return this;
    }
    ...
    public withVpcChannelId(vpcChannelId: string): DeleteMemberGroupRequest {
        this['vpc_channel_id'] = vpcChannelId;
        return this;
    }
    ...
    public withMemberGroupId(memberGroupId: string): DeleteMemberGroupRequest {
        this['member_group_id'] = memberGroupId;
        return this;
    }
