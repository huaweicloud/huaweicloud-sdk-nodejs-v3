...
export class ShowDetailsOfEnvironmentVariableV2Response extends SdkResponse {
    ...
    public withVariableValue(variableValue: string): ShowDetailsOfEnvironmentVariableV2Response {
        this['variable_value'] = variableValue;
        return this;
    }
    ...
    public withEnvId(envId: string): ShowDetailsOfEnvironmentVariableV2Response {
        this['env_id'] = envId;
        return this;
    }
    ...
    public withGroupId(groupId: string): ShowDetailsOfEnvironmentVariableV2Response {
    ...
    public withVariableName(variableName: string): ShowDetailsOfEnvironmentVariableV2Response {
    ...
    public withId(id: string): ShowDetailsOfEnvironmentVariableV2Response {
        this['id'] = id;
        return this;
    }
}