...
export class ShowAppQuotaRequest {
    ...
    public withInstanceId(instanceId: string): ShowAppQuotaRequest {
        this['instance_id'] = instanceId;
        return this;
    }
    ...
    public withAppQuotaId(appQuotaId: string): ShowAppQuotaRequest {
        this['app_quota_id'] = appQuotaId;
        return this;
    }
