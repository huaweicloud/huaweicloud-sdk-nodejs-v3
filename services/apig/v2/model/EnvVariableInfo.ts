...
export class EnvVariableInfo {
    ...
    public withVariableValue(variableValue: string): EnvVariableInfo {
        this['variable_value'] = variableValue;
        return this;
    }
    ...
    public withEnvId(envId: string): EnvVariableInfo {
        this['env_id'] = envId;
        return this;
    }
    ...
    public withGroupId(groupId: string): EnvVariableInfo {
    ...
    public withVariableName(variableName: string): EnvVariableInfo {
    ...
    public withId(id: string): EnvVariableInfo {
        this['id'] = id;
        return this;
    }
}