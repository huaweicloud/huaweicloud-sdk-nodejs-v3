...
export class AssociateDomainV2Response extends SdkResponse {
    ...
    public withIngressHttpPort(ingressHttpPort: number): AssociateDomainV2Response {
    ...
    public withIngressHttpsPort(ingressHttpsPort: number): AssociateDomainV2Response {
