...
export class UpdateHealthCheckRequest {
    ...
    public withVpcChannelId(vpcChannelId: string): UpdateHealthCheckRequest {
        this['vpc_channel_id'] = vpcChannelId;
        return this;
    }
    ...
    public withBody(body: VpcHealthConfig): UpdateHealthCheckRequest {
        this['body'] = body;
        return this;
    }
}