...
export class ShowDetailsOfMemberGroupResponse extends SdkResponse {
    ...
    public withMemberGroupName(memberGroupName: string): ShowDetailsOfMemberGroupResponse {
        this['member_group_name'] = memberGroupName;
        return this;
    }
    ...
    public withMemberGroupRemark(memberGroupRemark: string): ShowDetailsOfMemberGroupResponse {
    ...
    public withMemberGroupWeight(memberGroupWeight: number): ShowDetailsOfMemberGroupResponse {
    ...
    public withDictCode(dictCode: string): ShowDetailsOfMemberGroupResponse {
    ...
    public withMicroserviceVersion(microserviceVersion: string): ShowDetailsOfMemberGroupResponse {
    ...
    public withMicroservicePort(microservicePort: number): ShowDetailsOfMemberGroupResponse {
    ...
    public withMicroserviceLabels(microserviceLabels: Array<MicroserviceLabel>): ShowDetailsOfMemberGroupResponse {
    ...
    public withCreateTime(createTime: Date): ShowDetailsOfMemberGroupResponse {
    ...
    public withUpdateTime(updateTime: Date): ShowDetailsOfMemberGroupResponse {
