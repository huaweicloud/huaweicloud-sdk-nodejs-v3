...
export class UpdateApiGroupV2Response extends SdkResponse {
    public id?: string;
    public name?: string;
    public status?: UpdateApiGroupV2ResponseStatusEnum | number;
    ...
    public withId(id: string): UpdateApiGroupV2Response {
        this['id'] = id;
        return this;
    }
    public withName(name: string): UpdateApiGroupV2Response {
        this['name'] = name;
        return this;
    }
    public withStatus(status: UpdateApiGroupV2ResponseStatusEnum | number): UpdateApiGroupV2Response {
        this['status'] = status;
        return this;
    }
    public withSlDomain(slDomain: string): UpdateApiGroupV2Response {
        this['sl_domain'] = slDomain;
        return this;
    }
    ...
    public withRegisterTime(registerTime: Date): UpdateApiGroupV2Response {
        this['register_time'] = registerTime;
        return this;
    }
    ...
    public withUpdateTime(updateTime: Date): UpdateApiGroupV2Response {
        this['update_time'] = updateTime;
        return this;
    }
    ...
    public withOnSellStatus(onSellStatus: number): UpdateApiGroupV2Response {
        this['on_sell_status'] = onSellStatus;
        return this;
    }
    ...
    public withUrlDomains(urlDomains: Array<UrlDomain>): UpdateApiGroupV2Response {
    ...
    public withRemark(remark: string): UpdateApiGroupV2Response {
        this['remark'] = remark;
        return this;
    }
    public withCallLimits(callLimits: number): UpdateApiGroupV2Response {
    ...
    public withTimeInterval(timeInterval: number): UpdateApiGroupV2Response {
    ...
    public withTimeUnit(timeUnit: string): UpdateApiGroupV2Response {
    ...
    public withIsDefault(isDefault: number): UpdateApiGroupV2Response {
    ...
    public withVersion(version: string): UpdateApiGroupV2Response {
        this['version'] = version;
        return this;
    }
    public withRomaAppId(romaAppId: string): UpdateApiGroupV2Response {
    ...
    public withRomaAppName(romaAppName: string): UpdateApiGroupV2Response {
...
/**
    ...
    * @enum {string}
    */
export enum UpdateApiGroupV2ResponseStatusEnum {
    NUMBER_1 = 1
}
