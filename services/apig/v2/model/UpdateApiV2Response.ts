...
export class UpdateApiV2Response extends SdkResponse {
    public name?: string;
    public type?: UpdateApiV2ResponseTypeEnum | number;
    public version?: string;
    private 'req_protocol'?: UpdateApiV2ResponseReqProtocolEnum | string;
    private 'req_method'?: UpdateApiV2ResponseReqMethodEnum | string;
    ...
    public withName(name: string): UpdateApiV2Response {
        this['name'] = name;
        return this;
    }
    public withType(type: UpdateApiV2ResponseTypeEnum | number): UpdateApiV2Response {
        this['type'] = type;
        return this;
    }
    public withVersion(version: string): UpdateApiV2Response {
        this['version'] = version;
        return this;
    }
    public withReqProtocol(reqProtocol: UpdateApiV2ResponseReqProtocolEnum | string): UpdateApiV2Response {
        this['req_protocol'] = reqProtocol;
        return this;
    }
    public set reqProtocol(reqProtocol: UpdateApiV2ResponseReqProtocolEnum | string  | undefined) {
        this['req_protocol'] = reqProtocol;
    }
    public get reqProtocol(): UpdateApiV2ResponseReqProtocolEnum | string | undefined {
        return this['req_protocol'];
    }
    public withReqMethod(reqMethod: UpdateApiV2ResponseReqMethodEnum | string): UpdateApiV2Response {
        this['req_method'] = reqMethod;
        return this;
    }
    public set reqMethod(reqMethod: UpdateApiV2ResponseReqMethodEnum | string  | undefined) {
        this['req_method'] = reqMethod;
    }
    public get reqMethod(): UpdateApiV2ResponseReqMethodEnum | string | undefined {
        return this['req_method'];
    }
    public withReqUri(reqUri: string): UpdateApiV2Response {
        this['req_uri'] = reqUri;
        return this;
    }
    ...
    public withAuthType(authType: UpdateApiV2ResponseAuthTypeEnum | string): UpdateApiV2Response {
        this['auth_type'] = authType;
        return this;
    }
    public set authType(authType: UpdateApiV2ResponseAuthTypeEnum | string  | undefined) {
        this['auth_type'] = authType;
    }
    public get authType(): UpdateApiV2ResponseAuthTypeEnum | string | undefined {
        return this['auth_type'];
    }
    public withAuthOpt(authOpt: AuthOpt): UpdateApiV2Response {
    ...
    public set matchMode(matchMode: UpdateApiV2ResponseMatchModeEnum | string  | undefined) {
        this['match_mode'] = matchMode;
    }
    public get matchMode(): UpdateApiV2ResponseMatchModeEnum | string | undefined {
        return this['match_mode'];
    }
    public withBackendType(backendType: UpdateApiV2ResponseBackendTypeEnum | string): UpdateApiV2Response {
        this['backend_type'] = backendType;
        return this;
    }
    public set backendType(backendType: UpdateApiV2ResponseBackendTypeEnum | string  | undefined) {
        this['backend_type'] = backendType;
    }
    public get backendType(): UpdateApiV2ResponseBackendTypeEnum | string | undefined {
        return this['backend_type'];
    }
    public withRemark(remark: string): UpdateApiV2Response {
        this['remark'] = remark;
        return this;
    }
    public withGroupId(groupId: string): UpdateApiV2Response {
        this['group_id'] = groupId;
        return this;
    }
    ...
    public withBodyRemark(bodyRemark: string): UpdateApiV2Response {
    ...
    public withResultNormalSample(resultNormalSample: string): UpdateApiV2Response {
    ...
    public withResultFailureSample(resultFailureSample: string): UpdateApiV2Response {
    ...
    public withAuthorizerId(authorizerId: string): UpdateApiV2Response {
    ...
    public withTags(tags: Array<string>): UpdateApiV2Response {
        this['tags'] = tags;
        return this;
    }
    public withResponseId(responseId: string): UpdateApiV2Response {
    ...
    public withRomaAppId(romaAppId: string): UpdateApiV2Response {
    ...
    public withDomainName(domainName: string): UpdateApiV2Response {
    ...
    public withTag(tag: string): UpdateApiV2Response {
        this['tag'] = tag;
        return this;
    }
    public withContentType(contentType: UpdateApiV2ResponseContentTypeEnum | string): UpdateApiV2Response {
        this['content_type'] = contentType;
        return this;
    }
    public set contentType(contentType: UpdateApiV2ResponseContentTypeEnum | string  | undefined) {
        this['content_type'] = contentType;
    }
    ...
    public withStatus(status: number): UpdateApiV2Response {
        this['status'] = status;
        return this;
    }
    public withArrangeNecessary(arrangeNecessary: number): UpdateApiV2Response {
    ...
    public withRegisterTime(registerTime: Date): UpdateApiV2Response {
    ...
    public withUpdateTime(updateTime: Date): UpdateApiV2Response {
    ...
    public withGroupName(groupName: string): UpdateApiV2Response {
    ...
    public withGroupVersion(groupVersion: string): UpdateApiV2Response {
    ...
    public withRunEnvId(runEnvId: string): UpdateApiV2Response {
    ...
    public withRunEnvName(runEnvName: string): UpdateApiV2Response {
    ...
    public withPublishId(publishId: string): UpdateApiV2Response {
    ...
    public withPublishTime(publishTime: string): UpdateApiV2Response {
    ...
    public withRomaAppName(romaAppName: string): UpdateApiV2Response {
    ...
    public withLdApiId(ldApiId: string): UpdateApiV2Response {
    ...
    public withBackendApi(backendApi: BackendApi): UpdateApiV2Response {
    ...
    public withApiGroupInfo(apiGroupInfo: ApiGroupCommonInfo): UpdateApiV2Response {
    ...
    public withFuncInfo(funcInfo: ApiFunc): UpdateApiV2Response {
    ...
    public withMockInfo(mockInfo: ApiMock): UpdateApiV2Response {
    ...
    public withReqParams(reqParams: Array<ReqParam>): UpdateApiV2Response {
    ...
    public withBackendParams(backendParams: Array<BackendParam>): UpdateApiV2Response {
    ...
    public withPolicyFunctions(policyFunctions: Array<ApiPolicyFunctionResp>): UpdateApiV2Response {
    ...
    public withPolicyMocks(policyMocks: Array<ApiPolicyMockResp>): UpdateApiV2Response {
    ...
    public withPolicyHttps(policyHttps: Array<ApiPolicyHttpResp>): UpdateApiV2Response {
...
/**
    ...
    * @enum {string}
    */
export enum UpdateApiV2ResponseTypeEnum {
    NUMBER_1 = 1,
    NUMBER_2 = 2
}
/**
    ...
    * @enum {string}
    */
export enum UpdateApiV2ResponseReqProtocolEnum {
    HTTP = 'HTTP',
    HTTPS = 'HTTPS',
    BOTH = 'BOTH',
    GRPCS = 'GRPCS'
...
/**
    ...
    * @enum {string}
    */
export enum UpdateApiV2ResponseReqMethodEnum {
    GET = 'GET',
    POST = 'POST',
    PUT = 'PUT',
    DELETE = 'DELETE',
...
/**
    ...
    * @enum {string}
    */
export enum UpdateApiV2ResponseAuthTypeEnum {
    NONE = 'NONE',
    APP = 'APP',
    IAM = 'IAM',
...
/**
    ...
    * @enum {string}
    */
export enum UpdateApiV2ResponseMatchModeEnum {
    SWA = 'SWA',
    NORMAL = 'NORMAL'
}
/**
    ...
    * @enum {string}
    */
export enum UpdateApiV2ResponseBackendTypeEnum {
    HTTP = 'HTTP',
    FUNCTION = 'FUNCTION',
    MOCK = 'MOCK',
    GRPC = 'GRPC'
