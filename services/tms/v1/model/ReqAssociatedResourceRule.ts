...
export class ReqAssociatedResourceRule {
    ...
    public withSettingName(settingName: string): ReqAssociatedResourceRule {
        this['setting_name'] = settingName;
        return this;
    }
    ...
    public withTagKeys(tagKeys: Array<string>): ReqAssociatedResourceRule {
    ...
    public withExistingResourceStatus(existingResourceStatus: string): ReqAssociatedResourceRule {
    ...
    public withAutoDeleteStatus(autoDeleteStatus: string): ReqAssociatedResourceRule {
    ...
    public withRegionId(regionId: string): ReqAssociatedResourceRule {
        this['region_id'] = regionId;
        return this;
    }
