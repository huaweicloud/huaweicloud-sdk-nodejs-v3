...
export class CreateNet2CloudPhoneServerRequestBodyBandWidth {
    ...
    public withBandWidthId(bandWidthId: string): CreateNet2CloudPhoneServerRequestBodyBandWidth {
    ...
    public withBandWidthSize(bandWidthSize: number): CreateNet2CloudPhoneServerRequestBodyBandWidth {
    ...
    public withBandWidthChargeMode(bandWidthChargeMode: number): CreateNet2CloudPhoneServerRequestBodyBandWidth {
        this['band_width_charge_mode'] = bandWidthChargeMode;
        return this;
    }
    ...
    public withBandWidthShareType(bandWidthShareType: number): CreateNet2CloudPhoneServerRequestBodyBandWidth {
        this['band_width_share_type'] = bandWidthShareType;
        return this;
    }
