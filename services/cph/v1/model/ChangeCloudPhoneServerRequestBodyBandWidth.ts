...
export class ChangeCloudPhoneServerRequestBodyBandWidth {
    ...
    public withBandWidthId(bandWidthId: string): ChangeCloudPhoneServerRequestBodyBandWidth {
    ...
    public withBandWidthSize(bandWidthSize: number): ChangeCloudPhoneServerRequestBodyBandWidth {
    ...
    public withBandWidthChargeMode(bandWidthChargeMode: number): ChangeCloudPhoneServerRequestBodyBandWidth {
        this['band_width_charge_mode'] = bandWidthChargeMode;
        return this;
    }
    ...
    public withBandWidthShareType(bandWidthShareType: number): ChangeCloudPhoneServerRequestBodyBandWidth {
        this['band_width_share_type'] = bandWidthShareType;
        return this;
    }
