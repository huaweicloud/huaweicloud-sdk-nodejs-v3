...
export class InstallApkRequestBody {
    ...
    public withCommand(command: string): InstallApkRequestBody {
        this['command'] = command;
        return this;
    }
    public withContent(content: string): InstallApkRequestBody {
        this['content'] = content;
        return this;
    }
    public withPhoneIds(phoneIds: Array<string>): InstallApkRequestBody {
    ...
    public withServerIds(serverIds: Array<string>): InstallApkRequestBody {
