...
export class UninstallApkRequestBody {
    ...
    public withCommand(command: string): UninstallApkRequestBody {
        this['command'] = command;
        return this;
    }
    public withContent(content: string): UninstallApkRequestBody {
        this['content'] = content;
        return this;
    }
    public withPhoneIds(phoneIds: Array<string>): UninstallApkRequestBody {
    ...
    public withServerIds(serverIds: Array<string>): UninstallApkRequestBody {
