...
export class ModifySqlBlackListResponse extends SdkResponse {
    ...
    public withSqlBlackListFullCheck(sqlBlackListFullCheck: string): ModifySqlBlackListResponse {
    ...
    public withSqlBlackListPrefixCheck(sqlBlackListPrefixCheck: string): ModifySqlBlackListResponse {
    ...
    public withSqlBlackListRegexCheck(sqlBlackListRegexCheck: string): ModifySqlBlackListResponse {
