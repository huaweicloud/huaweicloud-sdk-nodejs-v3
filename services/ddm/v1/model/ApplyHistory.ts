...
export class ApplyHistory {
    ...
    public withTargetName(targetName: string): ApplyHistory {
    ...
    public withApplyResult(applyResult: string): ApplyHistory {
    ...
    public withAppliedAt(appliedAt: Date): ApplyHistory {
