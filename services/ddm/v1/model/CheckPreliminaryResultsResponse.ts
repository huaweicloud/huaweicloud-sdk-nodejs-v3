...
export class CheckPreliminaryResultsResponse extends SdkResponse {
    private 'pre_check_results'?: Array<PreCheckResult>;
    private 'job_id'?: string;
    public constructor() { 
        super();
    }
    public withPreCheckResults(preCheckResults: Array<PreCheckResult>): CheckPreliminaryResultsResponse {
    ...
    public withJobId(jobId: string): CheckPreliminaryResultsResponse {
        this['job_id'] = jobId;
        return this;
    }
