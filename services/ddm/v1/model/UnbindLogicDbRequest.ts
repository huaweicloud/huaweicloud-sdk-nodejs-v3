...
export class UnbindLogicDbRequest {
    ...
    public withInstanceId(instanceId: string): UnbindLogicDbRequest {
        this['instance_id'] = instanceId;
        return this;
    }
    ...
    public withLogicDbName(logicDbName: string): UnbindLogicDbRequest {
        this['logic_db_name'] = logicDbName;
        return this;
    }
