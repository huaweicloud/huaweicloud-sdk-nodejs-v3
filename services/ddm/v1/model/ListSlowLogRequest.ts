...
export class ListSlowLogRequest {
    ...
    public withCurPage(curPage: string): ListSlowLogRequest {
        this['curPage'] = curPage;
        return this;
    }
    public withPerPage(perPage: string): ListSlowLogRequest {
        this['perPage'] = perPage;
        return this;
    }
    public withStartDate(startDate: string): ListSlowLogRequest {
        this['startDate'] = startDate;
        return this;
    }
    public withEndDate(endDate: string): ListSlowLogRequest {
        this['endDate'] = endDate;
        return this;
    }
}