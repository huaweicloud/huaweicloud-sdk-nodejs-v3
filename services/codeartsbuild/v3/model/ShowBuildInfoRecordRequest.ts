...
export class ShowBuildInfoRecordRequest {
    ...
    public withJobId(jobId: string): ShowBuildInfoRecordRequest {
        this['job_id'] = jobId;
        return this;
    }
    ...
    public withBuildNo(buildNo: number): ShowBuildInfoRecordRequest {
        this['build_no'] = buildNo;
        return this;
    }
