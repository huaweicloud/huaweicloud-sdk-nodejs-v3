...
export class ListJunitCoverageSummaryRequest {
    ...
    public withJobId(jobId: string): ListJunitCoverageSummaryRequest {
        this['job_id'] = jobId;
        return this;
    }
    ...
    public withBuildNo(buildNo: number): ListJunitCoverageSummaryRequest {
        this['build_no'] = buildNo;
        return this;
    }
