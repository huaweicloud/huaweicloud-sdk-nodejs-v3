...
export class ListBuildParameterRequest {
    ...
    public withJobId(jobId: string): ListBuildParameterRequest {
        this['job_id'] = jobId;
        return this;
    }
    ...
    public withBuildNo(buildNo: number): ListBuildParameterRequest {
        this['build_no'] = buildNo;
        return this;
    }
