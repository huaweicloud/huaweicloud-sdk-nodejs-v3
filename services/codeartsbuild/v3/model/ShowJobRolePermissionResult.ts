...
export class ShowJobRolePermissionResult {
    public id?: number;
    ...
    public withId(id: number): ShowJobRolePermissionResult {
        this['id'] = id;
        return this;
    }
    public withRoleId(roleId: number): ShowJobRolePermissionResult {
        this['role_id'] = roleId;
        return this;
    }
    ...
    public withRoleName(roleName: string): ShowJobRolePermissionResult {
    ...
    public withJobId(jobId: string): ShowJobRolePermissionResult {
        this['job_id'] = jobId;
        return this;
    }
    ...
    public withIsModify(isModify: boolean): ShowJobRolePermissionResult {
    ...
    public withIsDelete(isDelete: boolean): ShowJobRolePermissionResult {
    ...
    public withIsView(isView: boolean): ShowJobRolePermissionResult {
        this['is_view'] = isView;
        return this;
    }
    ...
    public withIsExecute(isExecute: boolean): ShowJobRolePermissionResult {
    ...
    public withIsCopy(isCopy: boolean): ShowJobRolePermissionResult {
        this['is_copy'] = isCopy;
        return this;
    }
    ...
    public withIsForbidden(isForbidden: boolean): ShowJobRolePermissionResult {
    ...
    public withIsManager(isManager: boolean): ShowJobRolePermissionResult {
    ...
    public withCreateTime(createTime: string): ShowJobRolePermissionResult {
    ...
    public withLastUpdateTime(lastUpdateTime: string): ShowJobRolePermissionResult {
    ...
    public withCount(count: number): ShowJobRolePermissionResult {
        this['count'] = count;
        return this;
    }
}