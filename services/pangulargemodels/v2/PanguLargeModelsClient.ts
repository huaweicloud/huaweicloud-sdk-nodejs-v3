...
export const ParamCreater = function () {
    return {
        ...
        executeChatCompletion(executeChatCompletionRequest?: ExecuteChatCompletionRequest) {
            const options = {
                method: "POST",
                url: "/v2/{project_id}/pools/{pool_id}/deployments/{deployment_id}/chat/completions",
            ...
            throw new RequiredError('poolId','Required parameter poolId was null or undefined when calling executeChatCompletion.');
            }
            ...
            options.pathParams = { 'pool_id': poolId,'deployment_id': deploymentId, };
        ...
        executeTextCompletion(executeTextCompletionRequest?: ExecuteTextCompletionRequest) {
            const options = {
                method: "POST",
                url: "/v2/{project_id}/pools/{pool_id}/deployments/{deployment_id}/text/completions",
                contentType: "application/json",
                queryParams: {},
                pathParams: {},
                headers: {},
            ...
            if (poolId === null || poolId === undefined) {
            throw new RequiredError('poolId','Required parameter poolId was null or undefined when calling executeTextCompletion.');
            }
            if (deploymentId === null || deploymentId === undefined) {
