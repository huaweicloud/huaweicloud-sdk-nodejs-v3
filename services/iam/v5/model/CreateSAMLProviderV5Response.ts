...
export class CreateSAMLProviderV5Response extends SdkResponse {
    private 'saml_provider'?: InlineResponse201SamlProvider;
    public constructor() { 
        super();
    }
    public withSamlProvider(samlProvider: InlineResponse201SamlProvider): CreateSAMLProviderV5Response {
