...
export class InlineResponse200PageInfo {
    ...
    public withNextMarker(nextMarker: string): InlineResponse200PageInfo {
    ...
    public withCurrentCount(currentCount: number): InlineResponse200PageInfo {
        this['current_count'] = currentCount;
        return this;
    }
