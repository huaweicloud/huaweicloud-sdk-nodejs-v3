...
export class ListAttachedGroupPoliciesV5Response extends SdkResponse {
    private 'attached_policies'?: Array<AttachedPolicy>;
    private 'page_info'?: PageInfo;
    public constructor() { 
        super();
    }
    public withAttachedPolicies(attachedPolicies: Array<AttachedPolicy>): ListAttachedGroupPoliciesV5Response {
    ...
    public withPageInfo(pageInfo: PageInfo): ListAttachedGroupPoliciesV5Response {
