...
export class DisableMfaDeviceReqBody {
    ...
    public withUserId(userId: string): DisableMfaDeviceReqBody {
        this['user_id'] = userId;
        return this;
    }
    ...
    public withSerialNumber(serialNumber: string): DisableMfaDeviceReqBody {
        this['serial_number'] = serialNumber;
        return this;
    }
