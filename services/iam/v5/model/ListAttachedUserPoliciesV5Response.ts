...
export class ListAttachedUserPoliciesV5Response extends SdkResponse {
    private 'attached_policies'?: Array<AttachedPolicy>;
    private 'page_info'?: PageInfo;
    public constructor() { 
        super();
    }
    public withAttachedPolicies(attachedPolicies: Array<AttachedPolicy>): ListAttachedUserPoliciesV5Response {
    ...
    public withPageInfo(pageInfo: PageInfo): ListAttachedUserPoliciesV5Response {
