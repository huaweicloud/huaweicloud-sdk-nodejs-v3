...
export class Agency {
    ...
    public withUrn(urn: string): Agency {
        this['urn'] = urn;
        return this;
    }
    public withTrustPolicy(trustPolicy: string): Agency {
    ...
    public withCreatedAt(createdAt: Date): Agency {
        this['created_at'] = createdAt;
        return this;
    }
    ...
    public withDescription(description: string): Agency {
        this['description'] = description;
        return this;
    }
    public withMaxSessionDuration(maxSessionDuration: number): Agency {
        this['max_session_duration'] = maxSessionDuration;
        return this;
    }
    ...
    public withPath(path: string): Agency {
        this['path'] = path;
        return this;
    }
    ...
    public withTrustDomainId(trustDomainId: string): Agency {
    ...
    public withTrustDomainName(trustDomainName: string): Agency {
