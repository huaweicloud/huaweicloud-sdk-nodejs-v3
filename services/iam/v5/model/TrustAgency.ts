...
export class TrustAgency {
    ...
    public constructor(urn?: string, createdAt?: Date, maxSessionDuration?: number, path?: string, agencyId?: string, agencyName?: string) { 
        this['urn'] = urn;
    ...
    public withUrn(urn: string): TrustAgency {
        this['urn'] = urn;
        return this;
    }
    public withTrustPolicy(trustPolicy: string): TrustAgency {
    ...
    public withCreatedAt(createdAt: Date): TrustAgency {
        this['created_at'] = createdAt;
        return this;
    }
    ...
    public withDescription(description: string): TrustAgency {
        this['description'] = description;
        return this;
    }
    public withMaxSessionDuration(maxSessionDuration: number): TrustAgency {
        this['max_session_duration'] = maxSessionDuration;
        return this;
    }
    ...
    public withPath(path: string): TrustAgency {
        this['path'] = path;
        return this;
    }
    public withAgencyId(agencyId: string): TrustAgency {
        this['agency_id'] = agencyId;
        return this;
    }
    ...
    public withAgencyName(agencyName: string): TrustAgency {
        this['agency_name'] = agencyName;
        return this;
    }
    ...
    public withTrustDomainId(trustDomainId: string): TrustAgency {
    ...
    public withTrustDomainName(trustDomainName: string): TrustAgency {
