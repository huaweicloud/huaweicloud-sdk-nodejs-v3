...
export class EnableMfaDeviceReqBody {
    ...
    public withUserId(userId: string): EnableMfaDeviceReqBody {
        this['user_id'] = userId;
        return this;
    }
    ...
    public withSerialNumber(serialNumber: string): EnableMfaDeviceReqBody {
        this['serial_number'] = serialNumber;
        return this;
    }
    ...
    public withAuthenticationCodeFirst(authenticationCodeFirst: string): EnableMfaDeviceReqBody {
        this['authentication_code_first'] = authenticationCodeFirst;
        return this;
    }
    ...
    public withAuthenticationCodeSecond(authenticationCodeSecond: string): EnableMfaDeviceReqBody {
        this['authentication_code_second'] = authenticationCodeSecond;
        return this;
    }
