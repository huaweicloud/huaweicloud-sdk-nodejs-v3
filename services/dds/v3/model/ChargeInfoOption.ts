...
export class ChargeInfoOption {
    ...
    public withPeriodNum(periodNum: number): ChargeInfoOption {
    ...
    public withIsAutoRenew(isAutoRenew: boolean): ChargeInfoOption {
    ...
    public withIsAutoPay(isAutoPay: boolean): ChargeInfoOption {
