...
export class DownloadErrorlogRequestBody {
    private 'file_name_list'?: Array<string>;
    private 'node_id_list'?: Array<string>;
    public constructor() { 
    }
    public withFileNameList(fileNameList: Array<string>): DownloadErrorlogRequestBody {
    ...
    public withNodeIdList(nodeIdList: Array<string>): DownloadErrorlogRequestBody {
