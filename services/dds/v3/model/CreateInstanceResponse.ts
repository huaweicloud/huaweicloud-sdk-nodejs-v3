...
export class CreateInstanceResponse extends SdkResponse {
    ...
    public withDatastore(datastore: Datastore): CreateInstanceResponse {
    ...
    public withPort(port: number): CreateInstanceResponse {
        this['port'] = port;
        return this;
    }
    public withDiskEncryptionId(diskEncryptionId: string): CreateInstanceResponse {
    ...
    public withConfigurations(configurations: Array<CreateInstanceConfigurationsOption>): CreateInstanceResponse {
        this['configurations'] = configurations;
        return this;
    }
    public withFlavor(flavor: Array<CreateInstanceFlavorOption>): CreateInstanceResponse {
        this['flavor'] = flavor;
        return this;
    }
    public withBackupStrategy(backupStrategy: BackupStrategy): CreateInstanceResponse {
    ...
    public withDssPoolId(dssPoolId: string): CreateInstanceResponse {
    ...
    public withTags(tags: Array<TagWithKeyValue>): CreateInstanceResponse {
        this['tags'] = tags;
        return this;
    }
