...
export class BackupStrategyForItemResponse {
    ...
    public withStartTime(startTime: string): BackupStrategyForItemResponse {
        this['start_time'] = startTime;
        return this;
    }
    ...
    public withKeepDays(keepDays: number): BackupStrategyForItemResponse {
        this['keep_days'] = keepDays;
        return this;
    }
