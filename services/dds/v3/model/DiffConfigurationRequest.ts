...
export class DiffConfigurationRequest {
    ...
    public withSourceConfigurationId(sourceConfigurationId: string): DiffConfigurationRequest {
        this['source_configuration_id'] = sourceConfigurationId;
        return this;
    }
    ...
    public withTargetConfigurationId(targetConfigurationId: string): DiffConfigurationRequest {
        this['target_configuration_id'] = targetConfigurationId;
        return this;
    }
