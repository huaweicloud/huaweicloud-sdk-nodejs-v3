...
export class EnvironmentPermissionDetail {
    ...
    public withCanDelete(canDelete: boolean): EnvironmentPermissionDetail {
    ...
    public withCanDeploy(canDeploy: boolean): EnvironmentPermissionDetail {
    ...
    public withCanEdit(canEdit: boolean): EnvironmentPermissionDetail {
    ...
    public withCanManage(canManage: boolean): EnvironmentPermissionDetail {
    ...
    public withCanView(canView: boolean): EnvironmentPermissionDetail {
