...
export class CreateDependencyResponse extends SdkResponse {
    ...
    public owner?: string;
    public link?: string;
    public runtime?: CreateDependencyResponseRuntimeEnum;
    public etag?: string;
    public size?: number;
    public name?: string;
    ...
    public withRuntime(runtime: CreateDependencyResponseRuntimeEnum): CreateDependencyResponse {
...
/**
    ...
    * @enum {string}
    */
export enum CreateDependencyResponseRuntimeEnum {
    JAVA8 = 'Java8',
    JAVA11 = 'Java11',
