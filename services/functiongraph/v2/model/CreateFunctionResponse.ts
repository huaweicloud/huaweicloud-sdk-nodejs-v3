...
export class CreateFunctionResponse extends SdkResponse {
    ...
    public withUserDataEncryptKmsKeyId(userDataEncryptKmsKeyId: string): CreateFunctionResponse {
    ...
    public withCodeEncryptKmsKeyId(codeEncryptKmsKeyId: string): CreateFunctionResponse {
