...
export class StopPipelineNewResponse extends SdkResponse {
    private 'pipeline_id'?: string;
    private 'pipeline_name'?: string;
    public constructor() { 
        super();
    }
    public withPipelineId(pipelineId: string): StopPipelineNewResponse {
    ...
    public withPipelineName(pipelineName: string): StopPipelineNewResponse {
