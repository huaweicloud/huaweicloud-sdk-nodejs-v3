...
export class CloudPipelineClient {
    public static newBuilder(): ClientBuilder<CloudPipelineClient> {
            return new ClientBuilder<CloudPipelineClient>(newClient);
    }
...
function newClient(client: HcClient): CloudPipelineClient {
    return new CloudPipelineClient(client);
}
