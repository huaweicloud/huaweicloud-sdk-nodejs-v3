...
export class CreateSecuritySecrecyLevelResponse extends SdkResponse {
    ...
    public withSecrecyLevelId(secrecyLevelId: string): CreateSecuritySecrecyLevelResponse {
    ...
    public withSecrecyLevelName(secrecyLevelName: string): CreateSecuritySecrecyLevelResponse {
    ...
    public withSecrecyLevelNumber(secrecyLevelNumber: number): CreateSecuritySecrecyLevelResponse {
    ...
    public withDescription(description: string): CreateSecuritySecrecyLevelResponse {
        this['description'] = description;
        return this;
    }
    public withCreatedBy(createdBy: string): CreateSecuritySecrecyLevelResponse {
    ...
    public withCreatedAt(createdAt: number): CreateSecuritySecrecyLevelResponse {
    ...
    public withUpdatedBy(updatedBy: string): CreateSecuritySecrecyLevelResponse {
    ...
    public withUpdatedAt(updatedAt: number): CreateSecuritySecrecyLevelResponse {
    ...
    public withInstanceId(instanceId: string): CreateSecuritySecrecyLevelResponse {
