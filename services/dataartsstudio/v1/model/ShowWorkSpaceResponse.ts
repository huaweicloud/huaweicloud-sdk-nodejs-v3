...
export class ShowWorkSpaceResponse extends SdkResponse {
    ...
    public withBadRecordLocationName(badRecordLocationName: string): ShowWorkSpaceResponse {
    ...
    public withEpsId(epsId: string): ShowWorkSpaceResponse {
        this['eps_id'] = epsId;
        return this;
    }
    ...
    public withJobLogLocationName(jobLogLocationName: string): ShowWorkSpaceResponse {
    ...
    public withIsDefault(isDefault: number): ShowWorkSpaceResponse {
    ...
    public withOwnerName(ownerName: string): ShowWorkSpaceResponse {
    ...
    public withProjectId(projectId: string): ShowWorkSpaceResponse {
    ...
    public withDomainId(domainId: string): ShowWorkSpaceResponse {
    ...
    public withInstanceId(instanceId: string): ShowWorkSpaceResponse {
    ...
    public withCreateUser(createUser: string): ShowWorkSpaceResponse {
    ...
    public withMemberNum(memberNum: number): ShowWorkSpaceResponse {
    ...
    public withUpdateUser(updateUser: string): ShowWorkSpaceResponse {
