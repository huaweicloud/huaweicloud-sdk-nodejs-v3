...
export class StatisticForDetail {
    public id?: string;
    public name?: string;
    ...
    public withId(id: string): StatisticForDetail {
        this['id'] = id;
        return this;
    }
    public withName(name: string): StatisticForDetail {
        this['name'] = name;
        return this;
    }
    public withCallNum(callNum: number): StatisticForDetail {
    ...
    public withSuccessNum(successNum: number): StatisticForDetail {
    ...
    public withFailNum(failNum: number): StatisticForDetail {
    ...
    public withLegalNum(legalNum: number): StatisticForDetail {
    ...
    public withIllegalNum(illegalNum: number): StatisticForDetail {
    ...
    public withCostTimeAvg(costTimeAvg: number): StatisticForDetail {
    ...
    public withSuccessCostTimeAvg(successCostTimeAvg: number): StatisticForDetail {
    ...
    public withFailCostTimeAvg(failCostTimeAvg: number): StatisticForDetail {
    ...
    public withSuccessRate(successRate: number): StatisticForDetail {
    ...
    public withFailRate(failRate: number): StatisticForDetail {
    ...
    public withLegalRate(legalRate: number): StatisticForDetail {
    ...
    public withIllegalRate(illegalRate: number): StatisticForDetail {
