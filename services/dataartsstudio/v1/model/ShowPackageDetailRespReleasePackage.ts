import { ShowPackageDetailRespReleasePackagePackageApprovers } from './ShowPackageDetailRespReleasePackagePackageApprovers';


export class ShowPackageDetailRespReleasePackage {
    ...
    private 'package_approvers'?: Array<ShowPackageDetailRespReleasePackagePackageApprovers>;
    private 'package_id'?: string;
    private 'package_name'?: string;
    private 'project_id'?: string;
    private 'workspace_id'?: string;
    public constructor(packageApprovers?: Array<ShowPackageDetailRespReleasePackagePackageApprovers>) { 
        this['package_approvers'] = packageApprovers;
    }
    public withApplyTimestamp(applyTimestamp: number): ShowPackageDetailRespReleasePackage {
    ...
    public withApplyUserId(applyUserId: string): ShowPackageDetailRespReleasePackage {
    ...
    public withApplyUserName(applyUserName: string): ShowPackageDetailRespReleasePackage {
    ...
    public withDeleteFlag(deleteFlag: number): ShowPackageDetailRespReleasePackage {
    ...
    public withDeployStatus(deployStatus: number): ShowPackageDetailRespReleasePackage {
    ...
    public withDeployTimestamp(deployTimestamp: number): ShowPackageDetailRespReleasePackage {
    ...
    public withDeployUserId(deployUserId: string): ShowPackageDetailRespReleasePackage {
    ...
    public withDeployUserName(deployUserName: string): ShowPackageDetailRespReleasePackage {
    ...
    public withPackageApprovers(packageApprovers: Array<ShowPackageDetailRespReleasePackagePackageApprovers>): ShowPackageDetailRespReleasePackage {
        this['package_approvers'] = packageApprovers;
        return this;
    }
    public set packageApprovers(packageApprovers: Array<ShowPackageDetailRespReleasePackagePackageApprovers>  | undefined) {
        this['package_approvers'] = packageApprovers;
    }
    public get packageApprovers(): Array<ShowPackageDetailRespReleasePackagePackageApprovers> | undefined {
        return this['package_approvers'];
    }
    public withPackageId(packageId: string): ShowPackageDetailRespReleasePackage {
    ...
    public withPackageName(packageName: string): ShowPackageDetailRespReleasePackage {
    ...
    public withProjectId(projectId: string): ShowPackageDetailRespReleasePackage {
    ...
    public withWorkspaceId(workspaceId: string): ShowPackageDetailRespReleasePackage {
