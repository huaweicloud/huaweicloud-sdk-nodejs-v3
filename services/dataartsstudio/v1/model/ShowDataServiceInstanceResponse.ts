...
export class ShowDataServiceInstanceResponse extends SdkResponse {
    public id?: string;
    public name?: string;
    ...
    public withId(id: string): ShowDataServiceInstanceResponse {
        this['id'] = id;
        return this;
    }
    public withName(name: string): ShowDataServiceInstanceResponse {
        this['name'] = name;
        return this;
    }
    public withDescription(description: string): ShowDataServiceInstanceResponse {
        this['description'] = description;
        return this;
    }
    public withExternalAddress(externalAddress: string): ShowDataServiceInstanceResponse {
    ...
    public withIntranetAddress(intranetAddress: string): ShowDataServiceInstanceResponse {
    ...
    public withIntranetAddressIpv6(intranetAddressIpv6: string): ShowDataServiceInstanceResponse {
    ...
    public withPublicZoneId(publicZoneId: string): ShowDataServiceInstanceResponse {
    ...
    public withPublicZoneName(publicZoneName: string): ShowDataServiceInstanceResponse {
    ...
    public withPrivateZoneId(privateZoneId: string): ShowDataServiceInstanceResponse {
    ...
    public withPrivateZoneName(privateZoneName: string): ShowDataServiceInstanceResponse {
    ...
    public withEnterpriseProjectId(enterpriseProjectId: string): ShowDataServiceInstanceResponse {
    ...
    public withCreateTime(createTime: number): ShowDataServiceInstanceResponse {
    ...
    public withCreateUser(createUser: string): ShowDataServiceInstanceResponse {
    ...
    public withCurrentNamespacePublishApiNum(currentNamespacePublishApiNum: number): ShowDataServiceInstanceResponse {
    ...
    public withAllNamespacePublishApiNum(allNamespacePublishApiNum: number): ShowDataServiceInstanceResponse {
    ...
    public withApiPublishableNum(apiPublishableNum: number): ShowDataServiceInstanceResponse {
    ...
    public withDeletable(deletable: boolean): ShowDataServiceInstanceResponse {
        this['deletable'] = deletable;
        return this;
    }
    public withChargeStatus(chargeStatus: string): ShowDataServiceInstanceResponse {
    ...
    public withOrderId(orderId: string): ShowDataServiceInstanceResponse {
    ...
    public withOrderType(orderType: string): ShowDataServiceInstanceResponse {
    ...
    public withPeriodType(periodType: string): ShowDataServiceInstanceResponse {
    ...
    public withInstanceStatus(instanceStatus: string): ShowDataServiceInstanceResponse {
    ...
    public withNodeNum(nodeNum: number): ShowDataServiceInstanceResponse {
    ...
    public withFlavor(flavor: FlavorDTO): ShowDataServiceInstanceResponse {
        this['flavor'] = flavor;
        return this;
    }
    public withGatewayVersion(gatewayVersion: string): ShowDataServiceInstanceResponse {
    ...
    public withAvailabilityZone(availabilityZone: string): ShowDataServiceInstanceResponse {
    ...
    public withAvailabilityZoneName(availabilityZoneName: string): ShowDataServiceInstanceResponse {
    ...
    public withVpcId(vpcId: string): ShowDataServiceInstanceResponse {
        this['vpc_id'] = vpcId;
        return this;
    }
    ...
    public withSubnetId(subnetId: string): ShowDataServiceInstanceResponse {
    ...
    public withSecurityGroupId(securityGroupId: string): ShowDataServiceInstanceResponse {
    ...
    public withNodes(nodes: Array<InstanceNodeDTO>): ShowDataServiceInstanceResponse {
        this['nodes'] = nodes;
        return this;
    }
}