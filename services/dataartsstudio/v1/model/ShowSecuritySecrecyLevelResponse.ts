...
export class ShowSecuritySecrecyLevelResponse extends SdkResponse {
    ...
    public withSecrecyLevelId(secrecyLevelId: string): ShowSecuritySecrecyLevelResponse {
    ...
    public withSecrecyLevelName(secrecyLevelName: string): ShowSecuritySecrecyLevelResponse {
    ...
    public withSecrecyLevelNumber(secrecyLevelNumber: number): ShowSecuritySecrecyLevelResponse {
    ...
    public withDescription(description: string): ShowSecuritySecrecyLevelResponse {
        this['description'] = description;
        return this;
    }
    public withCreatedBy(createdBy: string): ShowSecuritySecrecyLevelResponse {
    ...
    public withCreatedAt(createdAt: number): ShowSecuritySecrecyLevelResponse {
    ...
    public withUpdatedBy(updatedBy: string): ShowSecuritySecrecyLevelResponse {
    ...
    public withUpdatedAt(updatedAt: number): ShowSecuritySecrecyLevelResponse {
    ...
    public withInstanceId(instanceId: string): ShowSecuritySecrecyLevelResponse {
