...
export class ShowApisDetailResponse extends SdkResponse {
    public id?: string;
    public name?: string;
    ...
    public withId(id: string): ShowApisDetailResponse {
        this['id'] = id;
        return this;
    }
    public withName(name: string): ShowApisDetailResponse {
        this['name'] = name;
        return this;
    }
    public withCallNum(callNum: number): ShowApisDetailResponse {
    ...
    public withSuccessNum(successNum: number): ShowApisDetailResponse {
    ...
    public withFailNum(failNum: number): ShowApisDetailResponse {
    ...
    public withLegalNum(legalNum: number): ShowApisDetailResponse {
    ...
    public withIllegalNum(illegalNum: number): ShowApisDetailResponse {
    ...
    public withCostTimeAvg(costTimeAvg: number): ShowApisDetailResponse {
    ...
    public withSuccessCostTimeAvg(successCostTimeAvg: number): ShowApisDetailResponse {
    ...
    public withFailCostTimeAvg(failCostTimeAvg: number): ShowApisDetailResponse {
    ...
    public withSuccessRate(successRate: number): ShowApisDetailResponse {
    ...
    public withFailRate(failRate: number): ShowApisDetailResponse {
    ...
    public withLegalRate(legalRate: number): ShowApisDetailResponse {
    ...
    public withIllegalRate(illegalRate: number): ShowApisDetailResponse {
