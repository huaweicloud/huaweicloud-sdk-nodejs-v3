...
export class ListFactoryTaskCompletionResYesterday {
    private 'record_time'?: number;
    private 'task_completion_num'?: number;
    public constructor() { 
    }
    public withRecordTime(recordTime: number): ListFactoryTaskCompletionResYesterday {
    ...
    public withTaskCompletionNum(taskCompletionNum: number): ListFactoryTaskCompletionResYesterday {
