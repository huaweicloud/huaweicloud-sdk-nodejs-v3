...
export class ShowTaskInfoResponse extends SdkResponse {
    public id?: string;
    public name?: string;
    ...
    public withId(id: string): ShowTaskInfoResponse {
        this['id'] = id;
        return this;
    }
    public withName(name: string): ShowTaskInfoResponse {
        this['name'] = name;
        return this;
    }
    public withDescription(description: string): ShowTaskInfoResponse {
        this['description'] = description;
        return this;
    }
    public withUserId(userId: string): ShowTaskInfoResponse {
        this['user_id'] = userId;
        return this;
    }
    ...
    public withCreateTime(createTime: string): ShowTaskInfoResponse {
    ...
    public withProjectId(projectId: string): ShowTaskInfoResponse {
    ...
    public withDirId(dirId: string): ShowTaskInfoResponse {
        this['dir_id'] = dirId;
        return this;
    }
    ...
    public withScheduleConfig(scheduleConfig: SchedulerInfo): ShowTaskInfoResponse {
    ...
    public withParameterConfig(parameterConfig: Array<CustomMetadata>): ShowTaskInfoResponse {
    ...
    public withUpdateTime(updateTime: string): ShowTaskInfoResponse {
    ...
    public withUserName(userName: string): ShowTaskInfoResponse {
    ...
    public withPath(path: string): ShowTaskInfoResponse {
        this['path'] = path;
        return this;
    }
    public withLastRunTime(lastRunTime: string): ShowTaskInfoResponse {
    ...
    public withStartTime(startTime: string): ShowTaskInfoResponse {
    ...
    public withEndTime(endTime: string): ShowTaskInfoResponse {
    ...
    public withNextRunTime(nextRunTime: string): ShowTaskInfoResponse {
    ...
    public withDutyPerson(dutyPerson: string): ShowTaskInfoResponse {
    ...
    public withUpdateType(updateType: string): ShowTaskInfoResponse {
    ...
    public withDataSourceType(dataSourceType: string): ShowTaskInfoResponse {
    ...
    public withTaskConfig(taskConfig: object): ShowTaskInfoResponse {
    ...
    public withDataSourceWorkspaceId(dataSourceWorkspaceId: string): ShowTaskInfoResponse {
