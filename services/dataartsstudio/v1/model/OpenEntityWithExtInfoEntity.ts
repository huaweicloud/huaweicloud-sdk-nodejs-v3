...
export class OpenEntityWithExtInfoEntity {
    ...
    public withAttributes(attributes: object): OpenEntityWithExtInfoEntity {
        this['attributes'] = attributes;
        return this;
    }
    public withConnection(connection: Connection): OpenEntityWithExtInfoEntity {
        this['connection'] = connection;
        return this;
    }
    public withCreateTime(createTime: number): OpenEntityWithExtInfoEntity {
    ...
    public withCreatedBy(createdBy: string): OpenEntityWithExtInfoEntity {
    ...
    public withDisplayText(displayText: string): OpenEntityWithExtInfoEntity {
    ...
    public withGuid(guid: string): OpenEntityWithExtInfoEntity {
        this['guid'] = guid;
        return this;
    }
    public withRelationshipAttributes(relationshipAttributes: object): OpenEntityWithExtInfoEntity {
    ...
    public withTypeName(typeName: string): OpenEntityWithExtInfoEntity {
    ...
    public withUpdatedBy(updatedBy: string): OpenEntityWithExtInfoEntity {
    ...
    public withUpdateTime(updateTime: number): OpenEntityWithExtInfoEntity {
    ...
    public withTags(tags: Array<TagHeader>): OpenEntityWithExtInfoEntity {
        this['tags'] = tags;
        return this;
    }
    public withClassificationNames(classificationNames: Array<string>): OpenEntityWithExtInfoEntity {
