...
export class MappingSourceTableVO {
    private 'table1_id'?: number;
    private 'table2_id'?: number;
    ...
    public constructor(table1Id?: number, table1Name?: string, joinType?: string, joinFields?: Array<MappingJoinFieldVO>) { 
        this['table1_id'] = table1Id;
        this['table1_name'] = table1Name;
        this['join_type'] = joinType;
        this['join_fields'] = joinFields;
    }
    public withTable1Id(table1Id: number): MappingSourceTableVO {
        this['table1_id'] = table1Id;
        return this;
    }
    public set table1Id(table1Id: number  | undefined) {
        this['table1_id'] = table1Id;
    }
    public get table1Id(): number | undefined {
        return this['table1_id'];
    }
    public withTable2Id(table2Id: number): MappingSourceTableVO {
        this['table2_id'] = table2Id;
        return this;
    }
    public set table2Id(table2Id: number  | undefined) {
        this['table2_id'] = table2Id;
    }
    public get table2Id(): number | undefined {
