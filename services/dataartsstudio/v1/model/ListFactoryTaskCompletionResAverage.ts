...
export class ListFactoryTaskCompletionResAverage {
    private 'record_time'?: number;
    private 'task_completion_num'?: number;
    public constructor() { 
    }
    public withRecordTime(recordTime: number): ListFactoryTaskCompletionResAverage {
    ...
    public withTaskCompletionNum(taskCompletionNum: number): ListFactoryTaskCompletionResAverage {
