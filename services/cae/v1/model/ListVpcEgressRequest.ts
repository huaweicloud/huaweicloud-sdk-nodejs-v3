...
export class ListVpcEgressRequest {
    ...
    public withXEnvironmentID(xEnvironmentID: string): ListVpcEgressRequest {
        this['X-Environment-ID'] = xEnvironmentID;
        return this;
    }
