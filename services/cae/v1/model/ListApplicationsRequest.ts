...
export class ListApplicationsRequest {
    ...
    public withXEnterpriseProjectID(xEnterpriseProjectID: string): ListApplicationsRequest {
    ...
    public withXEnvironmentID(xEnvironmentID: string): ListApplicationsRequest {
        this['X-Environment-ID'] = xEnvironmentID;
        return this;
    }
