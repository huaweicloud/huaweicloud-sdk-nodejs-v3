...
export class DeleteComponentRequest {
    ...
    public withXEnterpriseProjectID(xEnterpriseProjectID: string): DeleteComponentRequest {
    ...
    public withXEnvironmentID(xEnvironmentID: string): DeleteComponentRequest {
        this['X-Environment-ID'] = xEnvironmentID;
        return this;
    }
