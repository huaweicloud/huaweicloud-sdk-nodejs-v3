...
export class CreateApplicationResponse extends SdkResponse {
    ...
    public withApiVersion(apiVersion: ApiVersionObj): CreateApplicationResponse {
    ...
    public withKind(kind: ApplicationKindObj): CreateApplicationResponse {
        this['kind'] = kind;
        return this;
    }
    public withMetadata(metadata: ApplicationMetadata): CreateApplicationResponse {
