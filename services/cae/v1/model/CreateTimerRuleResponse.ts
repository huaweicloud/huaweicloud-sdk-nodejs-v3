...
export class CreateTimerRuleResponse extends SdkResponse {
    ...
    public withApiVersion(apiVersion: ApiVersionObj): CreateTimerRuleResponse {
    ...
    public withKind(kind: TimeRuleKindObj): CreateTimerRuleResponse {
        this['kind'] = kind;
        return this;
    }
    public withItems(items: Array<TimerRuleDetails>): CreateTimerRuleResponse {
        this['items'] = items;
        return this;
    }
}