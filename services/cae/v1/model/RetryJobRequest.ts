...
export class RetryJobRequest {
    ...
    public withJobId(jobId: string): RetryJobRequest {
        this['job_id'] = jobId;
        return this;
    }
    ...
    public withXEnterpriseProjectID(xEnterpriseProjectID: string): RetryJobRequest {
    ...
    public withXEnvironmentID(xEnvironmentID: string): RetryJobRequest {
        this['X-Environment-ID'] = xEnvironmentID;
        return this;
    }
