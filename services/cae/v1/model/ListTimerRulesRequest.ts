...
export class ListTimerRulesRequest {
    private 'X-Enterprise-Project-ID'?: string;
    private 'X-Environment-ID'?: string;
    public constructor(xEnvironmentID?: string) { 
        this['X-Environment-ID'] = xEnvironmentID;
    }
    public withXEnterpriseProjectID(xEnterpriseProjectID: string): ListTimerRulesRequest {
    ...
    public withXEnvironmentID(xEnvironmentID: string): ListTimerRulesRequest {
        this['X-Environment-ID'] = xEnvironmentID;
        return this;
    }
