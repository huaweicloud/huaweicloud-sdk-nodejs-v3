...
export class ListEipResponseBodySpecEgress {
    private 'bandwidth_size'?: number;
    public enabled?: boolean;
    private 'ip_list'?: Array<string>;
    public constructor() { 
    }
    public withBandwidthSize(bandwidthSize: number): ListEipResponseBodySpecEgress {
    ...
    public withEnabled(enabled: boolean): ListEipResponseBodySpecEgress {
        this['enabled'] = enabled;
        return this;
    }
    public withIpList(ipList: Array<string>): ListEipResponseBodySpecEgress {
        this['ip_list'] = ipList;
        return this;
    }
