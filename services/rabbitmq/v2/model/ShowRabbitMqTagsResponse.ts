...
export class ShowRabbitMqTagsResponse extends SdkResponse {
    ...
    public withTotal(total: number): ShowRabbitMqTagsResponse {
        this['total'] = total;
        return this;
    }
    public withNextOffset(nextOffset: number): ShowRabbitMqTagsResponse {
    ...
    public withPreviousOffset(previousOffset: number): ShowRabbitMqTagsResponse {
