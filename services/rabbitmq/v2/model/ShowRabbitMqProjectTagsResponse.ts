...
export class ShowRabbitMqProjectTagsResponse extends SdkResponse {
    ...
    public withTotal(total: number): ShowRabbitMqProjectTagsResponse {
        this['total'] = total;
        return this;
    }
    public withNextOffset(nextOffset: number): ShowRabbitMqProjectTagsResponse {
    ...
    public withPreviousOffset(previousOffset: number): ShowRabbitMqProjectTagsResponse {
