...
export class ShowInstanceExtendProductInfoRespIo {
    ...
    public withIoType(ioType: string): ShowInstanceExtendProductInfoRespIo {
        this['io_type'] = ioType;
        return this;
    }
    ...
    public withStorageSpecCode(storageSpecCode: string): ShowInstanceExtendProductInfoRespIo {
    ...
    public withAvailableZones(availableZones: Array<string>): ShowInstanceExtendProductInfoRespIo {
    ...
    public withUnavailableZones(unavailableZones: Array<string>): ShowInstanceExtendProductInfoRespIo {
    ...
    public withVolumeType(volumeType: string): ShowInstanceExtendProductInfoRespIo {
