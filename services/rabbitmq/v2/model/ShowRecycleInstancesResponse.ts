...
export class ShowRecycleInstancesResponse extends SdkResponse {
    ...
    public withRetentionDays(retentionDays: number): ShowRecycleInstancesResponse {
    ...
    public withDefaultUseRecycle(defaultUseRecycle: boolean): ShowRecycleInstancesResponse {
    ...
    public withRecycleInstances(recycleInstances: Array<InstanceRecycleInfo>): ShowRecycleInstancesResponse {
