...
export class PostPaidServerRootVolumeMetadata {
    private '__system__encrypted'?: string;
    private '__system__cmkid'?: string;
    public constructor() { 
    }
    public withSystemEncrypted(systemEncrypted: string): PostPaidServerRootVolumeMetadata {
    ...
    public withSystemCmkid(systemCmkid: string): PostPaidServerRootVolumeMetadata {
