...
export class PrePaidServerRootVolumeMetadata {
    private '__system__encrypted'?: string | undefined;
    private '__system__cmkid'?: string | undefined;
    public constructor() { 
    }
    public withSystemEncrypted(systemEncrypted: string): PrePaidServerRootVolumeMetadata {
    ...
    public withSystemCmkid(systemCmkid: string): PrePaidServerRootVolumeMetadata {
