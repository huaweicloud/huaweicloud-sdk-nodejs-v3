...
export class ShowOrganizationConformancePackRequest {
    ...
    public withOrganizationId(organizationId: string): ShowOrganizationConformancePackRequest {
        this['organization_id'] = organizationId;
        return this;
    }
    ...
    public withConformancePackId(conformancePackId: string): ShowOrganizationConformancePackRequest {
        this['conformance_pack_id'] = conformancePackId;
        return this;
    }
