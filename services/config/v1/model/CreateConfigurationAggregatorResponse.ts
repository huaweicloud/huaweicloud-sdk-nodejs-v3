...
export class CreateConfigurationAggregatorResponse extends SdkResponse {
    ...
    public withAggregatorName(aggregatorName: string): CreateConfigurationAggregatorResponse {
    ...
    public withAggregatorId(aggregatorId: string): CreateConfigurationAggregatorResponse {
    ...
    public withAggregatorUrn(aggregatorUrn: string): CreateConfigurationAggregatorResponse {
    ...
    public withAggregatorType(aggregatorType: string): CreateConfigurationAggregatorResponse {
    ...
    public withAccountAggregationSources(accountAggregationSources: AccountAggregationSource): CreateConfigurationAggregatorResponse {
    ...
    public withUpdatedAt(updatedAt: string): CreateConfigurationAggregatorResponse {
    ...
    public withCreatedAt(createdAt: string): CreateConfigurationAggregatorResponse {
