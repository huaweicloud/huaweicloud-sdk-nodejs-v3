...
export class UpdatePolicyAssignmentResponse extends SdkResponse {
    ...
    public withPolicyFilterV2(policyFilterV2: PolicyFilterDefinitionV2): UpdatePolicyAssignmentResponse {
    ...
    public withTargetType(targetType: string): UpdatePolicyAssignmentResponse {
    ...
    public withTargetId(targetId: string): UpdatePolicyAssignmentResponse {
