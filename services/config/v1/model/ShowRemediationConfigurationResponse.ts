...
export class ShowRemediationConfigurationResponse extends SdkResponse {
    ...
    public withTargetRegionId(targetRegionId: string): ShowRemediationConfigurationResponse {
    ...
    public withTargetProjectId(targetProjectId: string): ShowRemediationConfigurationResponse {
