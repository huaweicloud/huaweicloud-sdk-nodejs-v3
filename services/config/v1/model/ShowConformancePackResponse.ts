...
export class ShowConformancePackResponse extends SdkResponse {
    ...
    public withTemplateKey(templateKey: string): ShowConformancePackResponse {
    ...
    public withTemplateUri(templateUri: string): ShowConformancePackResponse {
    ...
    public withAgencyName(agencyName: string): ShowConformancePackResponse {
