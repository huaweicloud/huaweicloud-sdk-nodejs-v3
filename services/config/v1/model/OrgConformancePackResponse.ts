...
export class OrgConformancePackResponse {
    ...
    public withOrgConformancePackId(orgConformancePackId: string): OrgConformancePackResponse {
    ...
    public withOrgConformancePackName(orgConformancePackName: string): OrgConformancePackResponse {
    ...
    public withOwnerId(ownerId: string): OrgConformancePackResponse {
    ...
    public withOrganizationId(organizationId: string): OrgConformancePackResponse {
    ...
    public withOrgConformancePackUrn(orgConformancePackUrn: string): OrgConformancePackResponse {
    ...
    public withVarsStructure(varsStructure: Array<VarsStructure>): OrgConformancePackResponse {
    ...
    public withCreatedAt(createdAt: string): OrgConformancePackResponse {
    ...
    public withUpdatedAt(updatedAt: string): OrgConformancePackResponse {
