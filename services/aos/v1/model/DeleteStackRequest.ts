...
export class DeleteStackRequest {
    ...
    public withClientRequestId(clientRequestId: string): DeleteStackRequest {
        this['Client-Request-Id'] = clientRequestId;
        return this;
    }
    ...
    public withProjectId(projectId: string): DeleteStackRequest {
        this['project_id'] = projectId;
        return this;
    }
    ...
    public withStackName(stackName: string): DeleteStackRequest {
        this['stack_name'] = stackName;
        return this;
    }
    ...
    public withStackId(stackId: string): DeleteStackRequest {
