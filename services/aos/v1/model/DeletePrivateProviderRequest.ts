...
export class DeletePrivateProviderRequest {
    ...
    public withClientRequestId(clientRequestId: string): DeletePrivateProviderRequest {
        this['Client-Request-Id'] = clientRequestId;
        return this;
    }
    ...
    public withProviderName(providerName: string): DeletePrivateProviderRequest {
        this['provider_name'] = providerName;
        return this;
    }
    ...
    public withProviderId(providerId: string): DeletePrivateProviderRequest {
