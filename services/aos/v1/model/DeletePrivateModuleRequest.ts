...
export class DeletePrivateModuleRequest {
    ...
    public withClientRequestId(clientRequestId: string): DeletePrivateModuleRequest {
        this['Client-Request-Id'] = clientRequestId;
        return this;
    }
    ...
    public withModuleName(moduleName: string): DeletePrivateModuleRequest {
        this['module_name'] = moduleName;
        return this;
    }
    ...
    public withModuleId(moduleId: string): DeletePrivateModuleRequest {
