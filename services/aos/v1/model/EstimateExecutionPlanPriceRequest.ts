...
export class EstimateExecutionPlanPriceRequest {
    ...
    public withClientRequestId(clientRequestId: string): EstimateExecutionPlanPriceRequest {
        this['Client-Request-Id'] = clientRequestId;
        return this;
    }
    ...
    public withProjectId(projectId: string): EstimateExecutionPlanPriceRequest {
        this['project_id'] = projectId;
        return this;
    }
    ...
    public withStackName(stackName: string): EstimateExecutionPlanPriceRequest {
        this['stack_name'] = stackName;
        return this;
    }
    ...
    public withExecutionPlanName(executionPlanName: string): EstimateExecutionPlanPriceRequest {
        this['execution_plan_name'] = executionPlanName;
        return this;
    }
    ...
    public withStackId(stackId: string): EstimateExecutionPlanPriceRequest {
    ...
    public withExecutionPlanId(executionPlanId: string): EstimateExecutionPlanPriceRequest {
