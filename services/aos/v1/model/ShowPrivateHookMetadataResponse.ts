...
export class ShowPrivateHookMetadataResponse extends SdkResponse {
    ...
    public withHookName(hookName: string): ShowPrivateHookMetadataResponse {
        this['hook_name'] = hookName;
        return this;
    }
    ...
    public withHookId(hookId: string): ShowPrivateHookMetadataResponse {
        this['hook_id'] = hookId;
        return this;
    }
    ...
    public withHookDescription(hookDescription: string): ShowPrivateHookMetadataResponse {
    ...
    public withDefaultVersion(defaultVersion: string): ShowPrivateHookMetadataResponse {
    ...
    public withConfiguration(configuration: ConfigurationPrimitiveTypeHolderConfiguration): ShowPrivateHookMetadataResponse {
        this['configuration'] = configuration;
        return this;
    }
    public withCreateTime(createTime: string): ShowPrivateHookMetadataResponse {
    ...
    public withUpdateTime(updateTime: string): ShowPrivateHookMetadataResponse {
