...
export class GetExecutionPlanRequest {
    ...
    public withClientRequestId(clientRequestId: string): GetExecutionPlanRequest {
        this['Client-Request-Id'] = clientRequestId;
        return this;
    }
    ...
    public withProjectId(projectId: string): GetExecutionPlanRequest {
        this['project_id'] = projectId;
        return this;
    }
    ...
    public withStackName(stackName: string): GetExecutionPlanRequest {
        this['stack_name'] = stackName;
        return this;
    }
    ...
    public withExecutionPlanName(executionPlanName: string): GetExecutionPlanRequest {
        this['execution_plan_name'] = executionPlanName;
        return this;
    }
    ...
    public withStackId(stackId: string): GetExecutionPlanRequest {
    ...
    public withExecutionPlanId(executionPlanId: string): GetExecutionPlanRequest {
    ...
    public withExecutor(executor: string): GetExecutionPlanRequest {
