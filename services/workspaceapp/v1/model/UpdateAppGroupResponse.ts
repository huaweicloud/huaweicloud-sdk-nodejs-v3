...
import { BaseAppGroup } from './BaseAppGroup';

import { SdkResponse } from "@huaweicloud/huaweicloud-sdk-core/SdkResponse";

export class UpdateAppGroupResponse extends SdkResponse {
    public id?: string;
    public name?: string;
    ...
    public withId(id: string): UpdateAppGroupResponse {
        this['id'] = id;
        return this;
    }
    public withName(name: string): UpdateAppGroupResponse {
        this['name'] = name;
        return this;
    }
    public withAppServerGroupId(appServerGroupId: string): UpdateAppGroupResponse {
    ...
    public withAppServerGroupName(appServerGroupName: string): UpdateAppGroupResponse {
    ...
    public withDescription(description: string): UpdateAppGroupResponse {
        this['description'] = description;
        return this;
    }
    public withAuthorizationType(authorizationType: AuthorizationTypeEnum): UpdateAppGroupResponse {
    ...
    public withTenantId(tenantId: string): UpdateAppGroupResponse {
    ...
    public withAppType(appType: AppTypeEnum): UpdateAppGroupResponse {
    ...
    public withCreateAt(createAt: Date): UpdateAppGroupResponse {
    ...
    public withAppCount(appCount: number): UpdateAppGroupResponse {
