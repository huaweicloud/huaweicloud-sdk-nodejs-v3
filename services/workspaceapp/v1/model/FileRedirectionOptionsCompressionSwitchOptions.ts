...
export class FileRedirectionOptionsCompressionSwitchOptions {
    private 'compression_threshold'?: number;
    private 'minimum_compression_rate'?: number;
    public constructor() { 
    }
    public withCompressionThreshold(compressionThreshold: number): FileRedirectionOptionsCompressionSwitchOptions {
    ...
    public withMinimumCompressionRate(minimumCompressionRate: number): FileRedirectionOptionsCompressionSwitchOptions {
