...
export class UpdateScheduleTaskResponse extends SdkResponse {
    public id?: string;
    ...
    public withId(id: string): UpdateScheduleTaskResponse {
        this['id'] = id;
        return this;
    }
    public withTaskName(taskName: string): UpdateScheduleTaskResponse {
    ...
    public withLastStatus(lastStatus: ScheduleTaskStatus): UpdateScheduleTaskResponse {
    ...
    public withTaskType(taskType: ScheduleTaskTypeEnum): UpdateScheduleTaskResponse {
    ...
    public withTaskCron(taskCron: string): UpdateScheduleTaskResponse {
    ...
    public withNextExecutionTime(nextExecutionTime: string): UpdateScheduleTaskResponse {
    ...
    public withScheduleTaskPolicy(scheduleTaskPolicy: ScheduleTaskPolicy): UpdateScheduleTaskResponse {
    ...
    public withScheduledType(scheduledType: ScheduledTypeEnum): UpdateScheduleTaskResponse {
    ...
    public withDayInterval(dayInterval: number): UpdateScheduleTaskResponse {
    ...
    public withWeekList(weekList: string): UpdateScheduleTaskResponse {
    ...
    public withMonthList(monthList: string): UpdateScheduleTaskResponse {
    ...
    public withDateList(dateList: string): UpdateScheduleTaskResponse {
    ...
    public withTimeZone(timeZone: string): UpdateScheduleTaskResponse {
    ...
    public withScheduledDate(scheduledDate: string): UpdateScheduleTaskResponse {
    ...
    public withScheduledTime(scheduledTime: string): UpdateScheduleTaskResponse {
    ...
    public withExpireTime(expireTime: Date): UpdateScheduleTaskResponse {
    ...
    public withDescription(description: string): UpdateScheduleTaskResponse {
        this['description'] = description;
        return this;
    }
    public withIsEnable(isEnable: boolean): UpdateScheduleTaskResponse {
    ...
    public withCreateTime(createTime: Date): UpdateScheduleTaskResponse {
    ...
    public withUpdateTime(updateTime: Date): UpdateScheduleTaskResponse {
