...
export class SessionTypeEntity {
    ...
    public withResourceSpecCode(resourceSpecCode: string): SessionTypeEntity {
    ...
    public withSessionType(sessionType: string): SessionTypeEntity {
    ...
    public withResourceType(resourceType: string): SessionTypeEntity {
    ...
    public withCloudServiceType(cloudServiceType: string): SessionTypeEntity {
