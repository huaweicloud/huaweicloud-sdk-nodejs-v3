...
export class ListPolicyOfPolicyGroupRequest {
    ...
    public withPolicyGroupId(policyGroupId: string): ListPolicyOfPolicyGroupRequest {
        this['policy_group_id'] = policyGroupId;
        return this;
    }
    ...
    public withPolicyType(policyType: string): ListPolicyOfPolicyGroupRequest {
