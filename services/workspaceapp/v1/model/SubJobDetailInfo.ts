...
export class SubJobDetailInfo {
    ...
    public withId(id: string): SubJobDetailInfo {
        this['id'] = id;
        return this;
    }
    public withJobType(jobType: JobType): SubJobDetailInfo {
    ...
    public withJobResourceInfo(jobResourceInfo: JobResourceInfo): SubJobDetailInfo {
    ...
    public withBeginTime(beginTime: Date): SubJobDetailInfo {
    ...
    public withEndTime(endTime: Date): SubJobDetailInfo {
    ...
    public withStatus(status: JobDetailStatus): SubJobDetailInfo {
        this['status'] = status;
        return this;
    }
    public withErrorCode(errorCode: string): SubJobDetailInfo {
    ...
    public withErrorMessage(errorMessage: string): SubJobDetailInfo {
    ...
    public withProjectId(projectId: string): SubJobDetailInfo {
    ...
    public withJobId(jobId: string): SubJobDetailInfo {
        this['job_id'] = jobId;
        return this;
    }
