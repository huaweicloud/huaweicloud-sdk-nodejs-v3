...
export class AppGroup {
    ...
    public withId(id: string): AppGroup {
        this['id'] = id;
        return this;
    }
    public withName(name: string): AppGroup {
        this['name'] = name;
        return this;
    }
    public withAppServerGroupId(appServerGroupId: string): AppGroup {
    ...
    public withAppServerGroupName(appServerGroupName: string): AppGroup {
    ...
    public withDescription(description: string): AppGroup {
        this['description'] = description;
        return this;
    }
    public withAuthorizationType(authorizationType: AuthorizationTypeEnum): AppGroup {
    ...
    public withTenantId(tenantId: string): AppGroup {
    ...
    public withAppType(appType: AppTypeEnum): AppGroup {
    ...
    public withCreateAt(createAt: Date): AppGroup {
    ...
    public withAppCount(appCount: number): AppGroup {
