...
export class ShowAppDetailResponse extends SdkResponse {
    public id?: string;
    public name?: string;
    ...
    public withId(id: string): ShowAppDetailResponse {
        this['id'] = id;
        return this;
    }
    public withName(name: string): ShowAppDetailResponse {
        this['name'] = name;
        return this;
    }
    public withVersion(version: string): ShowAppDetailResponse {
        this['version'] = version;
        return this;
    }
    public withCommandParam(commandParam: string): ShowAppDetailResponse {
    ...
    public withExecutePath(executePath: string): ShowAppDetailResponse {
    ...
    public withWorkPath(workPath: string): ShowAppDetailResponse {
    ...
    public withIconPath(iconPath: string): ShowAppDetailResponse {
    ...
    public withIconIndex(iconIndex: number): ShowAppDetailResponse {
    ...
    public withDescription(description: string): ShowAppDetailResponse {
        this['description'] = description;
        return this;
    }
    public withAppGroupId(appGroupId: string): ShowAppDetailResponse {
    ...
    public withState(state: AppStateEnum): ShowAppDetailResponse {
        this['state'] = state;
        return this;
    }
    public withTenantId(tenantId: string): ShowAppDetailResponse {
    ...
    public withPublishAt(publishAt: Date): ShowAppDetailResponse {
    ...
    public withSourceType(sourceType: number): ShowAppDetailResponse {
    ...
    public withPublisher(publisher: string): ShowAppDetailResponse {
        this['publisher'] = publisher;
        return this;
    }
    public withIconUrl(iconUrl: string): ShowAppDetailResponse {
    ...
    public withPublishable(publishable: boolean): ShowAppDetailResponse {
        this['publishable'] = publishable;
        return this;
    }
    public withSandboxEnable(sandboxEnable: boolean): ShowAppDetailResponse {
