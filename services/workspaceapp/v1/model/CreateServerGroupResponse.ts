...
export class CreateServerGroupResponse extends SdkResponse {
    ...
    public withId(id: string): CreateServerGroupResponse {
        this['id'] = id;
        return this;
    }
    public withName(name: string): CreateServerGroupResponse {
        this['name'] = name;
        return this;
    }
    public withDescription(description: string): CreateServerGroupResponse {
        this['description'] = description;
        return this;
    }
    public withImageId(imageId: string): CreateServerGroupResponse {
    ...
    public withOsType(osType: OsTypeEnum): CreateServerGroupResponse {
        this['os_type'] = osType;
        return this;
    }
    ...
    public withProductId(productId: string): CreateServerGroupResponse {
    ...
    public withSubnetId(subnetId: string): CreateServerGroupResponse {
    ...
    public withSystemDiskType(systemDiskType: VolumeType): CreateServerGroupResponse {
    ...
    public withSystemDiskSize(systemDiskSize: number): CreateServerGroupResponse {
    ...
    public withIsVdi(isVdi: boolean): CreateServerGroupResponse {
        this['is_vdi'] = isVdi;
        return this;
    }
    ...
    public withExtraSessionType(extraSessionType: ExtraSessionTypeEnum): CreateServerGroupResponse {
    ...
    public withExtraSessionSize(extraSessionSize: number): CreateServerGroupResponse {
    ...
    public withAppType(appType: AppTypeEnum): CreateServerGroupResponse {
    ...
    public withCreateTime(createTime: Date): CreateServerGroupResponse {
    ...
    public withUpdateTime(updateTime: Date): CreateServerGroupResponse {
    ...
    public withStorageMountPolicy(storageMountPolicy: StorageFolderMountType): CreateServerGroupResponse {
    ...
    public withEnterpriseProjectId(enterpriseProjectId: string): CreateServerGroupResponse {
    ...
    public withPrimaryServerGroupIds(primaryServerGroupIds: Array<string>): CreateServerGroupResponse {
    ...
    public withSecondaryServerGroupIds(secondaryServerGroupIds: Array<string>): CreateServerGroupResponse {
    ...
    public withServerGroupStatus(serverGroupStatus: boolean): CreateServerGroupResponse {
    ...
    public withSiteType(siteType: string): CreateServerGroupResponse {
    ...
    public withSiteId(siteId: string): CreateServerGroupResponse {
        this['site_id'] = siteId;
        return this;
    }
    ...
    public withAppServerFlavorCount(appServerFlavorCount: number): CreateServerGroupResponse {
    ...
    public withAppServerCount(appServerCount: number): CreateServerGroupResponse {
    ...
    public withAppGroupCount(appGroupCount: number): CreateServerGroupResponse {
    ...
    public withImageName(imageName: string): CreateServerGroupResponse {
    ...
    public withProductInfo(productInfo: ServerProductInfo): CreateServerGroupResponse {
    ...
    public withSubnetName(subnetName: string): CreateServerGroupResponse {
    ...
    public withScalingPolicy(scalingPolicy: ScalingPolicy): CreateServerGroupResponse {
    ...
    public withTags(tags: Array<TmsTag>): CreateServerGroupResponse {
        this['tags'] = tags;
        return this;
    }
    public withOuName(ouName: string): CreateServerGroupResponse {
        this['ou_name'] = ouName;
        return this;
    }
