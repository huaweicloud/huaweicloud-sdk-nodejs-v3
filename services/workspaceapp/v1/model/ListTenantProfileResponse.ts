...
export class ListTenantProfileResponse extends SdkResponse {
    ...
    public withProjectId(projectId: string): ListTenantProfileResponse {
    ...
    public withProjectName(projectName: string): ListTenantProfileResponse {
    ...
    public withTenantDomainId(tenantDomainId: string): ListTenantProfileResponse {
    ...
    public withServiceStatus(serviceStatus: string): ListTenantProfileResponse {
    ...
    public withOpenWithAd(openWithAd: boolean): ListTenantProfileResponse {
    ...
    public withTenantDomainName(tenantDomainName: string): ListTenantProfileResponse {
    ...
    public withCreateTime(createTime: Date): ListTenantProfileResponse {
