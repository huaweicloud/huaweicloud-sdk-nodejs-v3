...
export class ValidateServerGroupResponse extends SdkResponse {
    public result?: boolean;
    private 'validate_rule'?: ValidateRuleEnum;
    public constructor() { 
        super();
    }
    public withResult(result: boolean): ValidateServerGroupResponse {
        this['result'] = result;
        return this;
    }
    public withValidateRule(validateRule: ValidateRuleEnum): ValidateServerGroupResponse {
