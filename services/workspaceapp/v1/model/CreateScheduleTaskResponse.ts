...
export class CreateScheduleTaskResponse extends SdkResponse {
    ...
    public withId(id: string): CreateScheduleTaskResponse {
        this['id'] = id;
        return this;
    }
    public withTaskName(taskName: string): CreateScheduleTaskResponse {
    ...
    public withLastStatus(lastStatus: ScheduleTaskStatus): CreateScheduleTaskResponse {
    ...
    public withTaskType(taskType: ScheduleTaskTypeEnum): CreateScheduleTaskResponse {
    ...
    public withTaskCron(taskCron: string): CreateScheduleTaskResponse {
    ...
    public withNextExecutionTime(nextExecutionTime: string): CreateScheduleTaskResponse {
    ...
    public withScheduleTaskPolicy(scheduleTaskPolicy: ScheduleTaskPolicy): CreateScheduleTaskResponse {
    ...
    public withScheduledType(scheduledType: ScheduledTypeEnum): CreateScheduleTaskResponse {
    ...
    public withDayInterval(dayInterval: number): CreateScheduleTaskResponse {
    ...
    public withWeekList(weekList: string): CreateScheduleTaskResponse {
    ...
    public withMonthList(monthList: string): CreateScheduleTaskResponse {
    ...
    public withDateList(dateList: string): CreateScheduleTaskResponse {
    ...
    public withTimeZone(timeZone: string): CreateScheduleTaskResponse {
    ...
    public withScheduledDate(scheduledDate: string): CreateScheduleTaskResponse {
    ...
    public withScheduledTime(scheduledTime: string): CreateScheduleTaskResponse {
    ...
    public withExpireTime(expireTime: Date): CreateScheduleTaskResponse {
    ...
    public withDescription(description: string): CreateScheduleTaskResponse {
        this['description'] = description;
        return this;
    }
    public withIsEnable(isEnable: boolean): CreateScheduleTaskResponse {
    ...
    public withCreateTime(createTime: Date): CreateScheduleTaskResponse {
    ...
    public withUpdateTime(updateTime: Date): CreateScheduleTaskResponse {
