...
export class CreateWarehouseAppResponse extends SdkResponse {
    public id?: string;
    ...
    public withId(id: string): CreateWarehouseAppResponse {
        this['id'] = id;
        return this;
    }
    public withAppId(appId: string): CreateWarehouseAppResponse {
        this['app_id'] = appId;
        return this;
    }
    ...
    public withTenantId(tenantId: string): CreateWarehouseAppResponse {
    ...
    public withAppName(appName: string): CreateWarehouseAppResponse {
    ...
    public withAppCategory(appCategory: AppCategoryEnum): CreateWarehouseAppResponse {
    ...
    public withOsType(osType: OsTypeEnum): CreateWarehouseAppResponse {
        this['os_type'] = osType;
        return this;
    }
    ...
    public withVersionId(versionId: string): CreateWarehouseAppResponse {
    ...
    public withVersionName(versionName: string): CreateWarehouseAppResponse {
    ...
    public withAppfileStorePath(appfileStorePath: string): CreateWarehouseAppResponse {
    ...
    public withAppFileSize(appFileSize: string): CreateWarehouseAppResponse {
    ...
    public withAppDescription(appDescription: string): CreateWarehouseAppResponse {
    ...
    public withAppiconStorePath(appiconStorePath: string): CreateWarehouseAppResponse {
    ...
    public withCreateTime(createTime: Date): CreateWarehouseAppResponse {
    ...
    public withModifyTime(modifyTime: Date): CreateWarehouseAppResponse {
    ...
    public withVerifyTime(verifyTime: Date): CreateWarehouseAppResponse {
    ...
    public withVerifyStatus(verifyStatus: VerifyStatusEnum): CreateWarehouseAppResponse {
    ...
    public withVerifyComment(verifyComment: string): CreateWarehouseAppResponse {
    ...
    public withAppIcon(appIcon: string): CreateWarehouseAppResponse {
