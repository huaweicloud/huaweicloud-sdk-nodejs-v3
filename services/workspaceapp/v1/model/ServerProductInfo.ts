...
export class ServerProductInfo {
    ...
    public withProductId(productId: string): ServerProductInfo {
    ...
    public withFlavorId(flavorId: string): ServerProductInfo {
    ...
    public withType(type: string): ServerProductInfo {
        this['type'] = type;
        return this;
    }
    public withArchitecture(architecture: string): ServerProductInfo {
        this['architecture'] = architecture;
        return this;
    }
    public withCpu(cpu: string): ServerProductInfo {
        this['cpu'] = cpu;
        return this;
    }
    public withCpuDesc(cpuDesc: string): ServerProductInfo {
    ...
    public withMemory(memory: string): ServerProductInfo {
        this['memory'] = memory;
        return this;
    }
    public withIsGpu(isGpu: boolean): ServerProductInfo {
        this['is_gpu'] = isGpu;
        return this;
    }
    ...
    public withSystemDiskType(systemDiskType: string): ServerProductInfo {
    ...
    public withSystemDiskSize(systemDiskSize: string): ServerProductInfo {
    ...
    public withGpuDesc(gpuDesc: string): ServerProductInfo {
    ...
    public withDescriptions(descriptions: string): ServerProductInfo {
        this['descriptions'] = descriptions;
        return this;
    }
    public withChargeMode(chargeMode: string): ServerProductInfo {
    ...
    public withContainDataDisk(containDataDisk: boolean): ServerProductInfo {
    ...
    public withResourceType(resourceType: string): ServerProductInfo {
    ...
    public withCloudServiceType(cloudServiceType: string): ServerProductInfo {
    ...
    public withVolumeProductType(volumeProductType: string): ServerProductInfo {
    ...
    public withSessions(sessions: number): ServerProductInfo {
        this['sessions'] = sessions;
        return this;
    }
    public withStatus(status: string): ServerProductInfo {
        this['status'] = status;
        return this;
    }
    public withCondOperationAz(condOperationAz: string): ServerProductInfo {
    ...
    public withSubProductList(subProductList: Array<string>): ServerProductInfo {
    ...
    public withDomainIds(domainIds: Array<string>): ServerProductInfo {
    ...
    public withPackageType(packageType: string): ServerProductInfo {
    ...
    public withExpireTime(expireTime: Date): ServerProductInfo {
    ...
    public withSupportGpuType(supportGpuType: string): ServerProductInfo {
