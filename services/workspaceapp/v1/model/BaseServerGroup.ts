...
export class BaseServerGroup {
    ...
    public withId(id: string): BaseServerGroup {
        this['id'] = id;
        return this;
    }
    public withName(name: string): BaseServerGroup {
        this['name'] = name;
        return this;
    }
    public withDescription(description: string): BaseServerGroup {
        this['description'] = description;
        return this;
    }
    public withImageId(imageId: string): BaseServerGroup {
    ...
    public withOsType(osType: OsTypeEnum): BaseServerGroup {
        this['os_type'] = osType;
        return this;
    }
    ...
    public withProductId(productId: string): BaseServerGroup {
    ...
    public withSubnetId(subnetId: string): BaseServerGroup {
    ...
    public withSystemDiskType(systemDiskType: VolumeType): BaseServerGroup {
    ...
    public withSystemDiskSize(systemDiskSize: number): BaseServerGroup {
    ...
    public withIsVdi(isVdi: boolean): BaseServerGroup {
        this['is_vdi'] = isVdi;
        return this;
    }
    ...
    public withExtraSessionType(extraSessionType: ExtraSessionTypeEnum): BaseServerGroup {
    ...
    public withExtraSessionSize(extraSessionSize: number): BaseServerGroup {
    ...
    public withAppType(appType: AppTypeEnum): BaseServerGroup {
    ...
    public withCreateTime(createTime: Date): BaseServerGroup {
    ...
    public withUpdateTime(updateTime: Date): BaseServerGroup {
    ...
    public withStorageMountPolicy(storageMountPolicy: StorageFolderMountType): BaseServerGroup {
    ...
    public withEnterpriseProjectId(enterpriseProjectId: string): BaseServerGroup {
    ...
    public withPrimaryServerGroupIds(primaryServerGroupIds: Array<string>): BaseServerGroup {
    ...
    public withSecondaryServerGroupIds(secondaryServerGroupIds: Array<string>): BaseServerGroup {
    ...
    public withServerGroupStatus(serverGroupStatus: boolean): BaseServerGroup {
    ...
    public withSiteType(siteType: string): BaseServerGroup {
    ...
    public withSiteId(siteId: string): BaseServerGroup {
        this['site_id'] = siteId;
        return this;
    }
