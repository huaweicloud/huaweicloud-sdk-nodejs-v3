...
export class UploadAppIconResponse extends SdkResponse {
    public id?: string;
    public name?: string;
    ...
    public withId(id: string): UploadAppIconResponse {
        this['id'] = id;
        return this;
    }
    public withName(name: string): UploadAppIconResponse {
        this['name'] = name;
        return this;
    }
    public withVersion(version: string): UploadAppIconResponse {
        this['version'] = version;
        return this;
    }
    public withCommandParam(commandParam: string): UploadAppIconResponse {
    ...
    public withExecutePath(executePath: string): UploadAppIconResponse {
    ...
    public withWorkPath(workPath: string): UploadAppIconResponse {
    ...
    public withIconPath(iconPath: string): UploadAppIconResponse {
    ...
    public withIconIndex(iconIndex: number): UploadAppIconResponse {
    ...
    public withDescription(description: string): UploadAppIconResponse {
        this['description'] = description;
        return this;
    }
    public withAppGroupId(appGroupId: string): UploadAppIconResponse {
    ...
    public withState(state: AppStateEnum): UploadAppIconResponse {
        this['state'] = state;
        return this;
    }
    public withTenantId(tenantId: string): UploadAppIconResponse {
    ...
    public withPublishAt(publishAt: Date): UploadAppIconResponse {
    ...
    public withSourceType(sourceType: number): UploadAppIconResponse {
    ...
    public withPublisher(publisher: string): UploadAppIconResponse {
        this['publisher'] = publisher;
        return this;
    }
    public withIconUrl(iconUrl: string): UploadAppIconResponse {
    ...
    public withPublishable(publishable: boolean): UploadAppIconResponse {
        this['publishable'] = publishable;
        return this;
    }
    public withSandboxEnable(sandboxEnable: boolean): UploadAppIconResponse {
    ...
    public withIsPreBoot(isPreBoot: boolean): UploadAppIconResponse {
    ...
    public withAppExtendedInfo(appExtendedInfo: AppExtendedInfo): UploadAppIconResponse {
