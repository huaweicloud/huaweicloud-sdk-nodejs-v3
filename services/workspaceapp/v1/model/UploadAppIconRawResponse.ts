...
export class UploadAppIconRawResponse extends SdkResponse {
    public id?: string;
    public name?: string;
    ...
    public withId(id: string): UploadAppIconRawResponse {
        this['id'] = id;
        return this;
    }
    public withName(name: string): UploadAppIconRawResponse {
        this['name'] = name;
        return this;
    }
    public withVersion(version: string): UploadAppIconRawResponse {
        this['version'] = version;
        return this;
    }
    public withCommandParam(commandParam: string): UploadAppIconRawResponse {
    ...
    public withExecutePath(executePath: string): UploadAppIconRawResponse {
    ...
    public withWorkPath(workPath: string): UploadAppIconRawResponse {
    ...
    public withIconPath(iconPath: string): UploadAppIconRawResponse {
    ...
    public withIconIndex(iconIndex: number): UploadAppIconRawResponse {
    ...
    public withDescription(description: string): UploadAppIconRawResponse {
        this['description'] = description;
        return this;
    }
    public withAppGroupId(appGroupId: string): UploadAppIconRawResponse {
    ...
    public withState(state: AppStateEnum): UploadAppIconRawResponse {
        this['state'] = state;
        return this;
    }
    public withTenantId(tenantId: string): UploadAppIconRawResponse {
    ...
    public withPublishAt(publishAt: Date): UploadAppIconRawResponse {
    ...
    public withSourceType(sourceType: number): UploadAppIconRawResponse {
    ...
    public withPublisher(publisher: string): UploadAppIconRawResponse {
        this['publisher'] = publisher;
        return this;
    }
    public withIconUrl(iconUrl: string): UploadAppIconRawResponse {
    ...
    public withPublishable(publishable: boolean): UploadAppIconRawResponse {
        this['publishable'] = publishable;
        return this;
    }
    public withSandboxEnable(sandboxEnable: boolean): UploadAppIconRawResponse {
    ...
    public withIsPreBoot(isPreBoot: boolean): UploadAppIconRawResponse {
    ...
    public withAppExtendedInfo(appExtendedInfo: AppExtendedInfo): UploadAppIconRawResponse {
