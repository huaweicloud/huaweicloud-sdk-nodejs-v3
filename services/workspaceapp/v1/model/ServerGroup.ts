...
export class ServerGroup {
    ...
    public withId(id: string): ServerGroup {
        this['id'] = id;
        return this;
    }
    public withName(name: string): ServerGroup {
        this['name'] = name;
        return this;
    }
    public withDescription(description: string): ServerGroup {
        this['description'] = description;
        return this;
    }
    public withImageId(imageId: string): ServerGroup {
    ...
    public withOsType(osType: OsTypeEnum): ServerGroup {
        this['os_type'] = osType;
        return this;
    }
    ...
    public withProductId(productId: string): ServerGroup {
    ...
    public withSubnetId(subnetId: string): ServerGroup {
    ...
    public withSystemDiskType(systemDiskType: VolumeType): ServerGroup {
    ...
    public withSystemDiskSize(systemDiskSize: number): ServerGroup {
    ...
    public withIsVdi(isVdi: boolean): ServerGroup {
        this['is_vdi'] = isVdi;
        return this;
    }
    ...
    public withExtraSessionType(extraSessionType: ExtraSessionTypeEnum): ServerGroup {
    ...
    public withExtraSessionSize(extraSessionSize: number): ServerGroup {
    ...
    public withAppType(appType: AppTypeEnum): ServerGroup {
    ...
    public withCreateTime(createTime: Date): ServerGroup {
    ...
    public withUpdateTime(updateTime: Date): ServerGroup {
    ...
    public withStorageMountPolicy(storageMountPolicy: StorageFolderMountType): ServerGroup {
    ...
    public withEnterpriseProjectId(enterpriseProjectId: string): ServerGroup {
    ...
    public withPrimaryServerGroupIds(primaryServerGroupIds: Array<string>): ServerGroup {
    ...
    public withSecondaryServerGroupIds(secondaryServerGroupIds: Array<string>): ServerGroup {
    ...
    public withServerGroupStatus(serverGroupStatus: boolean): ServerGroup {
    ...
    public withSiteType(siteType: string): ServerGroup {
    ...
    public withSiteId(siteId: string): ServerGroup {
        this['site_id'] = siteId;
        return this;
    }
    ...
    public withAppServerFlavorCount(appServerFlavorCount: number): ServerGroup {
    ...
    public withAppServerCount(appServerCount: number): ServerGroup {
    ...
    public withAppGroupCount(appGroupCount: number): ServerGroup {
    ...
    public withImageName(imageName: string): ServerGroup {
    ...
    public withScalingPolicy(scalingPolicy: ScalingPolicy): ServerGroup {
    ...
    public withTags(tags: Array<TmsTag>): ServerGroup {
        this['tags'] = tags;
        return this;
    }
    public withOuName(ouName: string): ServerGroup {
        this['ou_name'] = ouName;
        return this;
    }
