...
export class PublicipCreateResp {
    ...
    public status?: PublicipCreateRespStatusEnum | string;
    private 'tenant_id'?: string;
    public type?: string;
    private 'public_ipv6_address'?: string;
    private 'ip_version'?: PublicipCreateRespIpVersionEnum | number;
    ...
    public withStatus(status: PublicipCreateRespStatusEnum | string): PublicipCreateResp {
        this['status'] = status;
        return this;
    }
    ...
    public withIpVersion(ipVersion: PublicipCreateRespIpVersionEnum | number): PublicipCreateResp {
        this['ip_version'] = ipVersion;
        return this;
    }
    public set ipVersion(ipVersion: PublicipCreateRespIpVersionEnum | number  | undefined) {
        this['ip_version'] = ipVersion;
    }
    public get ipVersion(): PublicipCreateRespIpVersionEnum | number | undefined {
