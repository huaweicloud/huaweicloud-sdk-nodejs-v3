...
export class BatchDetachInternetBandwidthsGlobalEipRequestBody {
    private 'global_eips'?: Array<object>;
    public constructor(globalEips?: Array<object>) { 
        this['global_eips'] = globalEips;
    }
    public withGlobalEips(globalEips: Array<object>): BatchDetachInternetBandwidthsGlobalEipRequestBody {
        this['global_eips'] = globalEips;
        return this;
    }
