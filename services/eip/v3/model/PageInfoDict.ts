...
export class PageInfoDict {
    private 'previous_marker'?: string;
    private 'next_marker'?: string;
    private 'current_count'?: number;
    public constructor() { 
    }
    public withPreviousMarker(previousMarker: string): PageInfoDict {
    ...
    public withNextMarker(nextMarker: string): PageInfoDict {
    ...
    public withCurrentCount(currentCount: number): PageInfoDict {
