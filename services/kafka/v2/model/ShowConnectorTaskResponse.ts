...
export class ShowConnectorTaskResponse extends SdkResponse {
    ...
    public withTaskName(taskName: string): ShowConnectorTaskResponse {
    ...
    public withSourceTask(sourceTask: SmartConnectTaskRespSourceConfig): ShowConnectorTaskResponse {
    ...
    public withSinkType(sinkType: string): ShowConnectorTaskResponse {
    ...
    public withSinkTask(sinkTask: SmartConnectTaskRespSinkConfig): ShowConnectorTaskResponse {
    ...
    public withId(id: string): ShowConnectorTaskResponse {
        this['id'] = id;
        return this;
    }
    public withStatus(status: string): ShowConnectorTaskResponse {
        this['status'] = status;
        return this;
    }
    public withCreateTime(createTime: number): ShowConnectorTaskResponse {
