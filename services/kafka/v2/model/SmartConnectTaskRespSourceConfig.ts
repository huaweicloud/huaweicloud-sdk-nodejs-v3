...
export class SmartConnectTaskRespSourceConfig {
    ...
    public withReplicationFactor(replicationFactor: string): SmartConnectTaskRespSourceConfig {
    ...
    public withTaskNum(taskNum: string): SmartConnectTaskRespSourceConfig {
