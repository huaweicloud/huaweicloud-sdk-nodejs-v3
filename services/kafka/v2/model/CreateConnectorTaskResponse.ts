...
export class CreateConnectorTaskResponse extends SdkResponse {
    ...
    public withTaskName(taskName: string): CreateConnectorTaskResponse {
    ...
    public withTopics(topics: string): CreateConnectorTaskResponse {
        this['topics'] = topics;
        return this;
    }
    public withTopicsRegex(topicsRegex: string): CreateConnectorTaskResponse {
    ...
    public withSourceType(sourceType: string): CreateConnectorTaskResponse {
    ...
    public withSourceTask(sourceTask: SmartConnectTaskRespSourceConfig): CreateConnectorTaskResponse {
    ...
    public withSinkType(sinkType: string): CreateConnectorTaskResponse {
    ...
    public withSinkTask(sinkTask: SmartConnectTaskRespSinkConfig): CreateConnectorTaskResponse {
    ...
    public withId(id: string): CreateConnectorTaskResponse {
        this['id'] = id;
        return this;
    }
    public withStatus(status: string): CreateConnectorTaskResponse {
        this['status'] = status;
        return this;
    }
    public withCreateTime(createTime: number): CreateConnectorTaskResponse {
