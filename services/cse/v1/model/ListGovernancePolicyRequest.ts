...
export class ListGovernancePolicyRequest {
    ...
    public withContentType(contentType: string): ListGovernancePolicyRequest {
        this['Content-Type'] = contentType;
        return this;
    }
    ...
    public withXEngineId(xEngineId: string): ListGovernancePolicyRequest {
        this['x-engine-id'] = xEngineId;
        return this;
    }
    ...
    public withXEnterpriseProjectID(xEnterpriseProjectID: string): ListGovernancePolicyRequest {
        this['X-Enterprise-Project-ID'] = xEnterpriseProjectID;
        return this;
    }
    ...
    public withXEnvironment(xEnvironment: string): ListGovernancePolicyRequest {
    ...
    public withKind(kind: string): ListGovernancePolicyRequest {
        this['kind'] = kind;
        return this;
    }
}