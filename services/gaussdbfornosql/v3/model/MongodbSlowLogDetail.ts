...
export class MongodbSlowLogDetail {
    ...
    public withNodeName(nodeName: string): MongodbSlowLogDetail {
        this['node_name'] = nodeName;
        return this;
    }
    ...
    public withNodeId(nodeId: string): MongodbSlowLogDetail {
        this['node_id'] = nodeId;
        return this;
    }
    ...
    public withWholeMessage(wholeMessage: string): MongodbSlowLogDetail {
        this['whole_message'] = wholeMessage;
        return this;
    }
    ...
    public withOperateType(operateType: string): MongodbSlowLogDetail {
        this['operate_type'] = operateType;
        return this;
    }
    ...
    public withCostTime(costTime: number): MongodbSlowLogDetail {
        this['cost_time'] = costTime;
        return this;
    }
    ...
    public withLockTime(lockTime: number): MongodbSlowLogDetail {
        this['lock_time'] = lockTime;
        return this;
    }
    ...
    public withDocsReturned(docsReturned: number): MongodbSlowLogDetail {
        this['docs_returned'] = docsReturned;
        return this;
    }
    ...
    public withDocsScanned(docsScanned: number): MongodbSlowLogDetail {
        this['docs_scanned'] = docsScanned;
        return this;
    }
    ...
    public withDatabase(database: string): MongodbSlowLogDetail {
        this['database'] = database;
        return this;
    }
    public withCollection(collection: string): MongodbSlowLogDetail {
        this['collection'] = collection;
        return this;
    }
    public withLogTime(logTime: string): MongodbSlowLogDetail {
        this['log_time'] = logTime;
        return this;
    }
    ...
    public withLineNum(lineNum: string): MongodbSlowLogDetail {
        this['line_num'] = lineNum;
        return this;
    }
