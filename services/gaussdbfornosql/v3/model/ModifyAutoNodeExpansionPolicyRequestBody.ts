...
export class ModifyAutoNodeExpansionPolicyRequestBody {
    ...
    public withSwitchOption(switchOption: boolean): ModifyAutoNodeExpansionPolicyRequestBody {
        this['switch_option'] = switchOption;
        return this;
    }
    ...
    public withOverloadNodeThreshold(overloadNodeThreshold: number): ModifyAutoNodeExpansionPolicyRequestBody {
    ...
    public withCpuThreshold(cpuThreshold: number): ModifyAutoNodeExpansionPolicyRequestBody {
    ...
    public withMemThreshold(memThreshold: number): ModifyAutoNodeExpansionPolicyRequestBody {
    ...
    public withStep(step: number): ModifyAutoNodeExpansionPolicyRequestBody {
        this['step'] = step;
        return this;
    }
    public withNodeLimit(nodeLimit: number): ModifyAutoNodeExpansionPolicyRequestBody {
