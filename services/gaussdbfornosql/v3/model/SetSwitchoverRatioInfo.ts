...
export class SetSwitchoverRatioInfo {
    ...
    public withInstanceId(instanceId: string): SetSwitchoverRatioInfo {
        this['instance_id'] = instanceId;
        return this;
    }
    ...
    public withSwitchoverRatio(switchoverRatio: number): SetSwitchoverRatioInfo {
    ...
    public withSyncDelay(syncDelay: number): SetSwitchoverRatioInfo {
