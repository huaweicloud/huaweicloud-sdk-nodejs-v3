...
export class DifferentDetails {
    ...
    public withParameterName(parameterName: string): DifferentDetails {
        this['parameter_name'] = parameterName;
        return this;
    }
    ...
    public withSourceValue(sourceValue: string): DifferentDetails {
        this['source_value'] = sourceValue;
        return this;
    }
    ...
    public withTargetValue(targetValue: string): DifferentDetails {
        this['target_value'] = targetValue;
        return this;
    }
