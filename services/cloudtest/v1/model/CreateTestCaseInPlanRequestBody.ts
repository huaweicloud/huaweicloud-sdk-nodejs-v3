...
export class CreateTestCaseInPlanRequestBody {
    ...
    public withServiceId(serviceId: number): CreateTestCaseInPlanRequestBody {
        this['service_id'] = serviceId;
        return this;
    }
    ...
    public withTestcaseIdList(testcaseIdList: Array<string>): CreateTestCaseInPlanRequestBody {
        this['testcase_id_list'] = testcaseIdList;
        return this;
    }
