...
export class ShowTestCaseDetailResponse extends SdkResponse {
    ...
    public withTestcaseId(testcaseId: string): ShowTestCaseDetailResponse {
    ...
    public withProjectId(projectId: string): ShowTestCaseDetailResponse {
    ...
    public withServiceId(serviceId: number): ShowTestCaseDetailResponse {
    ...
    public withName(name: string): ShowTestCaseDetailResponse {
        this['name'] = name;
        return this;
    }
    public withTestcaseNumber(testcaseNumber: string): ShowTestCaseDetailResponse {
    ...
    public withRankId(rankId: number): ShowTestCaseDetailResponse {
        this['rank_id'] = rankId;
        return this;
    }
    ...
    public withStatusId(statusId: string): ShowTestCaseDetailResponse {
    ...
    public withAssignedUser(assignedUser: AssignedUserInfo): ShowTestCaseDetailResponse {
    ...
    public withExecuteCount(executeCount: number): ShowTestCaseDetailResponse {
    ...
    public withResultId(resultId: string): ShowTestCaseDetailResponse {
    ...
    public withExtendInfo(extendInfo: ExtendInfo): ShowTestCaseDetailResponse {
    ...
    public withErrorCode(errorCode: string): ShowTestCaseDetailResponse {
    ...
    public withErrorMsg(errorMsg: string): ShowTestCaseDetailResponse {
