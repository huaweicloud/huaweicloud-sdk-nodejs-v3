...
export class CasePassRateVo {
    private 'pass_rate'?: string;
    private 'result_number_list'?: Array<NameAndValueVo>;
    public constructor() { 
    }
    public withPassRate(passRate: string): CasePassRateVo {
    ...
    public withResultNumberList(resultNumberList: Array<NameAndValueVo>): CasePassRateVo {
