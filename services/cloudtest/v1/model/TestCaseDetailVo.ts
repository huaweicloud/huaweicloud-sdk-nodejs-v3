...
import { SimpleIssueVo } from './SimpleIssueVo';
import { TestCaseStepVo } from './TestCaseStepVo';


export class TestCaseDetailVo {
    public uri?: string;
    public type?: string;
    ...
    private 'last_modifier_name'?: string;
    private 'version_name'?: string;
    public steps?: Array<TestCaseStepVo>;
    private 'associate_defect'?: boolean;
    private 'associate_issue'?: boolean;
    private 'defect_list'?: Array<NameAndIdVo>;
    public constructor() { 
    }
    public withUri(uri: string): TestCaseDetailVo {
        this['uri'] = uri;
        return this;
    }
    public withType(type: string): TestCaseDetailVo {
        this['type'] = type;
        return this;
    }
    public withAuthor(author: string): TestCaseDetailVo {
        this['author'] = author;
        return this;
    }
    public withName(name: string): TestCaseDetailVo {
        this['name'] = name;
        return this;
    }
    public withRank(rank: number): TestCaseDetailVo {
        this['rank'] = rank;
        return this;
    }
    public withPreparation(preparation: string): TestCaseDetailVo {
        this['preparation'] = preparation;
        return this;
    }
    public withRemark(remark: string): TestCaseDetailVo {
        this['remark'] = remark;
        return this;
    }
    public withStage(stage: string): TestCaseDetailVo {
        this['stage'] = stage;
        return this;
    }
    public withActivity(activity: string): TestCaseDetailVo {
        this['activity'] = activity;
        return this;
    }
    public withKeywords(keywords: string): TestCaseDetailVo {
        this['keywords'] = keywords;
        return this;
    }
    public withMarket(market: string): TestCaseDetailVo {
        this['market'] = market;
        return this;
    }
    public withDesigner(designer: string): TestCaseDetailVo {
        this['designer'] = designer;
        return this;
    }
    public withTags(tags: string): TestCaseDetailVo {
        this['tags'] = tags;
        return this;
    }
    public withExecuteParameter(executeParameter: string): TestCaseDetailVo {
    ...
    public withRegion(region: string): TestCaseDetailVo {
        this['region'] = region;
        return this;
    }
    public withOwner(owner: string): TestCaseDetailVo {
        this['owner'] = owner;
        return this;
    }
    public withIssue(issue: SimpleIssueVo): TestCaseDetailVo {
        this['issue'] = issue;
        return this;
    }
    public withLastModifier(lastModifier: string): TestCaseDetailVo {
    ...
    public withLastModified(lastModified: Date): TestCaseDetailVo {
    ...
    public withLastModifiedTimestamp(lastModifiedTimestamp: number): TestCaseDetailVo {
    ...
    public withLastChangeTime(lastChangeTime: Date): TestCaseDetailVo {
    ...
    public withVersionUri(versionUri: string): TestCaseDetailVo {
    ...
    public withOriginUri(originUri: string): TestCaseDetailVo {
    ...
    public withParentUri(parentUri: string): TestCaseDetailVo {
    ...
    public withParentPath(parentPath: string): TestCaseDetailVo {
    ...
    public withCreationVersionUri(creationVersionUri: string): TestCaseDetailVo {
    ...
    public withCreationDate(creationDate: Date): TestCaseDetailVo {
    ...
    public withCreationDateTimestamp(creationDateTimestamp: number): TestCaseDetailVo {
    ...
    public withAuthorName(authorName: string): TestCaseDetailVo {
    ...
    public withComment(comment: string): TestCaseDetailVo {
        this['comment'] = comment;
        return this;
    }
    public withModelNumber(modelNumber: string): TestCaseDetailVo {
    ...
    public withCaseType(caseType: number): TestCaseDetailVo {
    ...
    public withPlatformType(platformType: number): TestCaseDetailVo {
    ...
    public withServiceType(serviceType: number): TestCaseDetailVo {
    ...
    public withServiceTypeName(serviceTypeName: string): TestCaseDetailVo {
    ...
    public withTestType(testType: number): TestCaseDetailVo {
    ...
    public withTestTypeName(testTypeName: string): TestCaseDetailVo {
    ...
    public withDesignNote(designNote: string): TestCaseDetailVo {
    ...
    public withTestStep(testStep: string): TestCaseDetailVo {
    ...
    public withExpectOutput(expectOutput: string): TestCaseDetailVo {
    ...
    public withEnvType(envType: string): TestCaseDetailVo {
    ...
    public withExePlatform(exePlatform: string): TestCaseDetailVo {
    ...
    public withTestcaseProject(testcaseProject: string): TestCaseDetailVo {
    ...
    public withSvnScriptPath(svnScriptPath: string): TestCaseDetailVo {
    ...
    public withMapRestrict(mapRestrict: string): TestCaseDetailVo {
    ...
    public withNetworkScriptName(networkScriptName: string): TestCaseDetailVo {
    ...
    public withAutoType(autoType: number): TestCaseDetailVo {
    ...
    public withToBeAutoExec(toBeAutoExec: number): TestCaseDetailVo {
    ...
    public withLastResult(lastResult: string): TestCaseDetailVo {
    ...
    public withLastResultUri(lastResultUri: string): TestCaseDetailVo {
    ...
    public withFeatureUri(featureUri: string): TestCaseDetailVo {
    ...
    public withFeatureName(featureName: string): TestCaseDetailVo {
    ...
    public withInterfaceName(interfaceName: string): TestCaseDetailVo {
    ...
    public withSnpNo(snpNo: string): TestCaseDetailVo {
        this['snp_no'] = snpNo;
        return this;
    }
    ...
    public withDrRelationId(drRelationId: string): TestCaseDetailVo {
    ...
    public withIssueName(issueName: string): TestCaseDetailVo {
    ...
    public withTestBaseNum(testBaseNum: string): TestCaseDetailVo {
    ...
    public withAutomaticallyExecuted(automaticallyExecuted: number): TestCaseDetailVo {
    ...
    public withFirstExecuteTime(firstExecuteTime: Date): TestCaseDetailVo {
    ...
    public withDetectType(detectType: string): TestCaseDetailVo {
    ...
    public withExecuteParam(executeParam: string): TestCaseDetailVo {
    ...
    public withTestFeature(testFeature: string): TestCaseDetailVo {
    ...
    public withIsContractTestcase(isContractTestcase: number): TestCaseDetailVo {
    ...
    public withTimeCost(timeCost: number): TestCaseDetailVo {
    ...
    public withBeAutoTypeTime(beAutoTypeTime: Date): TestCaseDetailVo {
    ...
    public withCompareNumber(compareNumber: string): TestCaseDetailVo {
    ...
    public withSceneFlag(sceneFlag: string): TestCaseDetailVo {
    ...
    public withBaseFlag(baseFlag: string): TestCaseDetailVo {
    ...
    public withParaValidator(paraValidator: string): TestCaseDetailVo {
    ...
    public withKnetNodeId(knetNodeId: string): TestCaseDetailVo {
    ...
    public withLastExeAuthor(lastExeAuthor: string): TestCaseDetailVo {
    ...
    public withCloudCarrier(cloudCarrier: string): TestCaseDetailVo {
    ...
    public withMarketPlace(marketPlace: string): TestCaseDetailVo {
    ...
    public withTestMindId(testMindId: string): TestCaseDetailVo {
    ...
    public withTestMindUrl(testMindUrl: string): TestCaseDetailVo {
    ...
    public withCommitUrl(commitUrl: string): TestCaseDetailVo {
    ...
    public withTestPatternNumber(testPatternNumber: string): TestCaseDetailVo {
    ...
    public withTestFactorNumber(testFactorNumber: string): TestCaseDetailVo {
    ...
    public withStatusCode(statusCode: string): TestCaseDetailVo {
    ...
    public withResultCode(resultCode: string): TestCaseDetailVo {
    ...
    public withReleaseId(releaseId: string): TestCaseDetailVo {
    ...
    public withLabelId(labelId: string): TestCaseDetailVo {
    ...
    public withLabels(labels: Array<LabelVo>): TestCaseDetailVo {
        this['labels'] = labels;
        return this;
    }
    public withModuleId(moduleId: string): TestCaseDetailVo {
    ...
    public withModuleName(moduleName: string): TestCaseDetailVo {
    ...
    public withModulePath(modulePath: string): TestCaseDetailVo {
    ...
    public withModulePathName(modulePathName: string): TestCaseDetailVo {
    ...
    public withExecuteLatestTime(executeLatestTime: Date): TestCaseDetailVo {
    ...
    public withExecuteDuration(executeDuration: string): TestCaseDetailVo {
    ...
    public withExecuteTimes(executeTimes: number): TestCaseDetailVo {
    ...
    public withIsKeyword(isKeyword: number): TestCaseDetailVo {
    ...
    public withReleaseDev(releaseDev: string): TestCaseDetailVo {
    ...
    public withNewCreated(newCreated: string): TestCaseDetailVo {
    ...
    public withProjectUuid(projectUuid: string): TestCaseDetailVo {
    ...
    public withCreationVersionName(creationVersionName: string): TestCaseDetailVo {
    ...
    public withFeaturePath(featurePath: string): TestCaseDetailVo {
    ...
    public withTestcaseUri(testcaseUri: string): TestCaseDetailVo {
    ...
    public withOwnerName(ownerName: string): TestCaseDetailVo {
    ...
    public withIteratorCaseUri(iteratorCaseUri: string): TestCaseDetailVo {
    ...
    public withScriptLink(scriptLink: string): TestCaseDetailVo {
    ...
    public withCustomField1(customField1: string): TestCaseDetailVo {
    ...
    public withCustomField2(customField2: string): TestCaseDetailVo {
    ...
    public withCustomField3(customField3: string): TestCaseDetailVo {
    ...
    public withCustomField4(customField4: string): TestCaseDetailVo {
    ...
    public withCustomField5(customField5: string): TestCaseDetailVo {
    ...
    public withCustomField6(customField6: string): TestCaseDetailVo {
    ...
    public withCustomField7(customField7: string): TestCaseDetailVo {
    ...
    public withCustomField8(customField8: string): TestCaseDetailVo {
    ...
    public withCustomField9(customField9: string): TestCaseDetailVo {
    ...
    public withCustomField10(customField10: string): TestCaseDetailVo {
    ...
    public withCustomField11(customField11: string): TestCaseDetailVo {
    ...
    public withCustomField12(customField12: string): TestCaseDetailVo {
    ...
    public withCustomField13(customField13: string): TestCaseDetailVo {
    ...
    public withCustomField14(customField14: string): TestCaseDetailVo {
    ...
    public withCustomField15(customField15: string): TestCaseDetailVo {
    ...
    public withCustomField16(customField16: string): TestCaseDetailVo {
    ...
    public withCustomField17(customField17: string): TestCaseDetailVo {
    ...
    public withCustomField18(customField18: string): TestCaseDetailVo {
    ...
    public withCustomField19(customField19: string): TestCaseDetailVo {
    ...
    public withCustomField20(customField20: string): TestCaseDetailVo {
    ...
    public withCustomField21(customField21: string): TestCaseDetailVo {
    ...
    public withCustomField22(customField22: string): TestCaseDetailVo {
    ...
    public withCustomField23(customField23: string): TestCaseDetailVo {
    ...
    public withCustomField24(customField24: string): TestCaseDetailVo {
    ...
    public withCustomField25(customField25: string): TestCaseDetailVo {
    ...
    public withLastModifierName(lastModifierName: string): TestCaseDetailVo {
        this['last_modifier_name'] = lastModifierName;
        return this;
    }
    public set lastModifierName(lastModifierName: string  | undefined) {
        this['last_modifier_name'] = lastModifierName;
    }
    public get lastModifierName(): string | undefined {
        return this['last_modifier_name'];
    }
    public withVersionName(versionName: string): TestCaseDetailVo {
    ...
    public withSteps(steps: Array<TestCaseStepVo>): TestCaseDetailVo {
        this['steps'] = steps;
        return this;
    }
    public withAssociateDefect(associateDefect: boolean): TestCaseDetailVo {
        this['associate_defect'] = associateDefect;
        return this;
    }
    public set associateDefect(associateDefect: boolean  | undefined) {
        this['associate_defect'] = associateDefect;
    }
    public get associateDefect(): boolean | undefined {
        return this['associate_defect'];
    }
    public withAssociateIssue(associateIssue: boolean): TestCaseDetailVo {
        this['associate_issue'] = associateIssue;
        return this;
    }
    public set associateIssue(associateIssue: boolean  | undefined) {
        this['associate_issue'] = associateIssue;
    }
    public get associateIssue(): boolean | undefined {
        return this['associate_issue'];
    }
    public withDefectList(defectList: Array<NameAndIdVo>): TestCaseDetailVo {
        this['defect_list'] = defectList;
        return this;
    }
    public set defectList(defectList: Array<NameAndIdVo>  | undefined) {
        this['defect_list'] = defectList;
    }
    public get defectList(): Array<NameAndIdVo> | undefined {
