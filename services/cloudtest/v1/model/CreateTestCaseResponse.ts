...
export class CreateTestCaseResponse extends SdkResponse {
    ...
    public withTestcaseId(testcaseId: string): CreateTestCaseResponse {
    ...
    public withProjectId(projectId: string): CreateTestCaseResponse {
    ...
    public withServiceId(serviceId: number): CreateTestCaseResponse {
    ...
    public withName(name: string): CreateTestCaseResponse {
        this['name'] = name;
        return this;
    }
    public withTestcaseNumber(testcaseNumber: string): CreateTestCaseResponse {
    ...
    public withRankId(rankId: number): CreateTestCaseResponse {
        this['rank_id'] = rankId;
        return this;
    }
    ...
    public withStatusId(statusId: string): CreateTestCaseResponse {
    ...
    public withAssignedUser(assignedUser: AssignedUserInfo): CreateTestCaseResponse {
    ...
    public withExecuteCount(executeCount: number): CreateTestCaseResponse {
    ...
    public withResultId(resultId: string): CreateTestCaseResponse {
    ...
    public withExtendInfo(extendInfo: ExtendInfo): CreateTestCaseResponse {
    ...
    public withErrorCode(errorCode: string): CreateTestCaseResponse {
    ...
    public withErrorMsg(errorMsg: string): CreateTestCaseResponse {
