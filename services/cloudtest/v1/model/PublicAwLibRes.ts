...
export class PublicAwLibRes {
    ...
    public withCreateTime(createTime: string): PublicAwLibRes {
    ...
    public withCreateTimeStamp(createTimeStamp: number): PublicAwLibRes {
    ...
    public withCreateTimeString(createTimeString: string): PublicAwLibRes {
    ...
    public withCreateUser(createUser: string): PublicAwLibRes {
    ...
    public withDocumentLink(documentLink: string): PublicAwLibRes {
    ...
    public withId(id: string): PublicAwLibRes {
        this['id'] = id;
        return this;
    }
    public withName(name: string): PublicAwLibRes {
        this['name'] = name;
        return this;
    }
    public withNetArea(netArea: Array<string>): PublicAwLibRes {
    ...
    public withObsTempUrl(obsTempUrl: string): PublicAwLibRes {
    ...
    public withProductLine(productLine: string): PublicAwLibRes {
    ...
    public withRepoBranch(repoBranch: string): PublicAwLibRes {
    ...
    public withRepoLibPath(repoLibPath: string): PublicAwLibRes {
    ...
    public withRepoPassword(repoPassword: string): PublicAwLibRes {
    ...
    public withRepoPrivateKey(repoPrivateKey: string): PublicAwLibRes {
    ...
    public withRepoUrl(repoUrl: string): PublicAwLibRes {
    ...
    public withRepoUsername(repoUsername: string): PublicAwLibRes {
    ...
    public withUpdateTime(updateTime: string): PublicAwLibRes {
    ...
    public withUpdateTimeStamp(updateTimeStamp: number): PublicAwLibRes {
    ...
    public withUpdateTimeString(updateTimeString: string): PublicAwLibRes {
    ...
    public withUpdateUser(updateUser: string): PublicAwLibRes {
