...
export class TestCaseInfo {
    ...
    public withSteps(steps: Array<TestCaseStepInfo>): TestCaseInfo {
        this['steps'] = steps;
        return this;
    }
    public withAttachments(attachments: Array<TestCaseAttachmentInfo>): TestCaseInfo {
        this['attachments'] = attachments;
        return this;
    }
    public withAuthor(author: string): TestCaseInfo {
        this['author'] = author;
        return this;
    }
    public withName(name: string): TestCaseInfo {
        this['name'] = name;
        return this;
    }
    public withRank(rank: number): TestCaseInfo {
        this['rank'] = rank;
        return this;
    }
    public withOwner(owner: string): TestCaseInfo {
        this['owner'] = owner;
        return this;
    }
    public withPreparation(preparation: string): TestCaseInfo {
        this['preparation'] = preparation;
        return this;
    }
    public withRemark(remark: string): TestCaseInfo {
        this['remark'] = remark;
        return this;
    }
    public withStage(stage: string): TestCaseInfo {
        this['stage'] = stage;
        return this;
    }
    public withActivity(activity: string): TestCaseInfo {
        this['activity'] = activity;
        return this;
    }
    public withKeywords(keywords: string): TestCaseInfo {
        this['keywords'] = keywords;
        return this;
    }
    public withMarket(market: string): TestCaseInfo {
        this['market'] = market;
        return this;
    }
    public withDesigner(designer: string): TestCaseInfo {
        this['designer'] = designer;
        return this;
    }
    public withTags(tags: string): TestCaseInfo {
        this['tags'] = tags;
        return this;
    }
    public withRegion(region: string): TestCaseInfo {
        this['region'] = region;
        return this;
    }
    public withRelateType(relateType: string): TestCaseInfo {
    ...
    public withServiceType(serviceType: number): TestCaseInfo {
    ...
    public withOnlyChangeScript(onlyChangeScript: string): TestCaseInfo {
    ...
    public withAddToIterator(addToIterator: string): TestCaseInfo {
    ...
    public withNeedUpdateRelation(needUpdateRelation: string): TestCaseInfo {
    ...
    public withCreationVersionUri(creationVersionUri: string): TestCaseInfo {
    ...
    public withModelNumber(modelNumber: string): TestCaseInfo {
    ...
    public withCaseType(caseType: number): TestCaseInfo {
    ...
    public withPlatformType(platformType: number): TestCaseInfo {
    ...
    public withTestType(testType: number): TestCaseInfo {
    ...
    public withDesignNote(designNote: string): TestCaseInfo {
    ...
    public withTestStep(testStep: string): TestCaseInfo {
    ...
    public withExpectOutput(expectOutput: string): TestCaseInfo {
    ...
    public withEnvType(envType: string): TestCaseInfo {
    ...
    public withExePlatform(exePlatform: string): TestCaseInfo {
    ...
    public withTestcaseProject(testcaseProject: string): TestCaseInfo {
    ...
    public withSvnScriptPath(svnScriptPath: string): TestCaseInfo {
    ...
    public withMapRestrict(mapRestrict: string): TestCaseInfo {
    ...
    public withNetworkScriptName(networkScriptName: string): TestCaseInfo {
    ...
    public withAutoType(autoType: number): TestCaseInfo {
    ...
    public withToBeAutoExec(toBeAutoExec: number): TestCaseInfo {
    ...
    public withLastResult(lastResult: string): TestCaseInfo {
    ...
    public withLastResultUri(lastResultUri: string): TestCaseInfo {
    ...
    public withFeatureUri(featureUri: string): TestCaseInfo {
    ...
    public withInterfaceName(interfaceName: string): TestCaseInfo {
    ...
    public withSnpNo(snpNo: string): TestCaseInfo {
        this['snp_no'] = snpNo;
        return this;
    }
    ...
    public withDrRelationId(drRelationId: string): TestCaseInfo {
    ...
    public withTestBaseNum(testBaseNum: string): TestCaseInfo {
    ...
    public withAutomaticallyExecuted(automaticallyExecuted: number): TestCaseInfo {
    ...
    public withFirstExecuteTime(firstExecuteTime: Date): TestCaseInfo {
    ...
    public withDetectType(detectType: string): TestCaseInfo {
    ...
    public withExecuteParam(executeParam: string): TestCaseInfo {
    ...
    public withTestFeature(testFeature: string): TestCaseInfo {
    ...
    public withIsContractTestcase(isContractTestcase: number): TestCaseInfo {
    ...
    public withTimeCost(timeCost: number): TestCaseInfo {
    ...
    public withCustomField1(customField1: string): TestCaseInfo {
    ...
    public withCustomField2(customField2: string): TestCaseInfo {
    ...
    public withCustomField3(customField3: string): TestCaseInfo {
    ...
    public withCustomField4(customField4: string): TestCaseInfo {
    ...
    public withCustomField5(customField5: string): TestCaseInfo {
    ...
    public withCustomField6(customField6: string): TestCaseInfo {
    ...
    public withCustomField7(customField7: string): TestCaseInfo {
    ...
    public withCustomField8(customField8: string): TestCaseInfo {
    ...
    public withCustomField9(customField9: string): TestCaseInfo {
    ...
    public withCustomField10(customField10: string): TestCaseInfo {
    ...
    public withCustomField11(customField11: string): TestCaseInfo {
    ...
    public withCustomField12(customField12: string): TestCaseInfo {
    ...
    public withCustomField13(customField13: string): TestCaseInfo {
    ...
    public withCustomField14(customField14: string): TestCaseInfo {
    ...
    public withCustomField15(customField15: string): TestCaseInfo {
    ...
    public withCustomField16(customField16: string): TestCaseInfo {
    ...
    public withCustomField17(customField17: string): TestCaseInfo {
    ...
    public withCustomField18(customField18: string): TestCaseInfo {
    ...
    public withCustomField19(customField19: string): TestCaseInfo {
    ...
    public withCustomField20(customField20: string): TestCaseInfo {
    ...
    public withCustomField21(customField21: string): TestCaseInfo {
    ...
    public withCustomField22(customField22: string): TestCaseInfo {
    ...
    public withCustomField23(customField23: string): TestCaseInfo {
    ...
    public withCustomField24(customField24: string): TestCaseInfo {
    ...
    public withCustomField25(customField25: string): TestCaseInfo {
    ...
    public withBeAutoTypeTime(beAutoTypeTime: Date): TestCaseInfo {
    ...
    public withCompareNumber(compareNumber: string): TestCaseInfo {
    ...
    public withSceneFlag(sceneFlag: string): TestCaseInfo {
    ...
    public withBaseFlag(baseFlag: string): TestCaseInfo {
    ...
    public withParaValidator(paraValidator: string): TestCaseInfo {
    ...
    public withKnetNodeId(knetNodeId: string): TestCaseInfo {
    ...
    public withLastExeAuthor(lastExeAuthor: string): TestCaseInfo {
    ...
    public withCloudCarrier(cloudCarrier: string): TestCaseInfo {
    ...
    public withMarketPlace(marketPlace: string): TestCaseInfo {
    ...
    public withTestMindId(testMindId: string): TestCaseInfo {
    ...
    public withTestMindUrl(testMindUrl: string): TestCaseInfo {
    ...
    public withCommitUrl(commitUrl: string): TestCaseInfo {
    ...
    public withTestPatternNumber(testPatternNumber: string): TestCaseInfo {
    ...
    public withTestFactorNumber(testFactorNumber: string): TestCaseInfo {
    ...
    public withStatusCode(statusCode: string): TestCaseInfo {
    ...
    public withResultCode(resultCode: string): TestCaseInfo {
    ...
    public withReleaseId(releaseId: string): TestCaseInfo {
    ...
    public withLabelId(labelId: string): TestCaseInfo {
    ...
    public withLabelNames(labelNames: Array<string>): TestCaseInfo {
    ...
    public withModuleId(moduleId: string): TestCaseInfo {
    ...
    public withExecuteLatestTime(executeLatestTime: Date): TestCaseInfo {
    ...
    public withExecuteDuration(executeDuration: string): TestCaseInfo {
    ...
    public withIsKeyword(isKeyword: number): TestCaseInfo {
    ...
    public withReleaseDev(releaseDev: string): TestCaseInfo {
    ...
    public withNewCreated(newCreated: number): TestCaseInfo {
    ...
    public withExecuteParameter(executeParameter: string): TestCaseInfo {
    ...
    public withProjectUuid(projectUuid: string): TestCaseInfo {
    ...
    public withVersionUri(versionUri: string): TestCaseInfo {
