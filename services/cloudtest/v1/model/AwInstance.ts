...
export class AwInstance {
    ...
    public withAliasRunaw(aliasRunaw: string): AwInstance {
    ...
    public withAuthenticationInfo(authenticationInfo: AuthInfo): AwInstance {
    ...
    public withAuthenticationType(authenticationType: string): AwInstance {
    ...
    public withAwDescription(awDescription: string): AwInstance {
    ...
    public withAwId(awId: string): AwInstance {
        this['aw_id'] = awId;
        return this;
    }
    ...
    public withAwType(awType: number): AwInstance {
        this['aw_type'] = awType;
        return this;
    }
    ...
    public withBasicAw(basicAw: BasicAw): AwInstance {
        this['basic_aw'] = basicAw;
        return this;
    }
    public set basicAw(basicAw: BasicAw  | undefined) {
        this['basic_aw'] = basicAw;
    }
    public get basicAw(): BasicAw | undefined {
        return this['basic_aw'];
    }
    public withBodyParamType(bodyParamType: string): AwInstance {
    ...
    public withByOrder(byOrder: number): AwInstance {
    ...
    public withChangeSign(changeSign: number): AwInstance {
        this['changeSign'] = changeSign;
        return this;
    }
    public withCheckPointList(checkPointList: Array<CheckPoint>): AwInstance {
    ...
    public withChildren(children: Array<AwInstance>): AwInstance {
        this['children'] = children;
        return this;
    }
    public withConditionStatement(conditionStatement: string): AwInstance {
    ...
    public withConditionType(conditionType: number): AwInstance {
    ...
    public withCreateTime(createTime: string): AwInstance {
    ...
    public withCreateTimeStamp(createTimeStamp: number): AwInstance {
    ...
    public withCreateTimeString(createTimeString: string): AwInstance {
    ...
    public withCreateUser(createUser: string): AwInstance {
    ...
    public withCustomHeader(customHeader: Array<AwParam>): AwInstance {
    ...
    public withDescription(description: string): AwInstance {
        this['description'] = description;
        return this;
    }
    public withErrorInfo(errorInfo: ErrorInfo): AwInstance {
    ...
    public withExtraInfo(extraInfo: ExtraInfo): AwInstance {
    ...
    public withFromOutside(fromOutside: number): AwInstance {
    ...
    public withHasLevel(hasLevel: number): AwInstance {
        this['hasLevel'] = hasLevel;
        return this;
    }
    public withHeaderArray(headerArray: Array<ArrayNode>): AwInstance {
    ...
    public withHisScript(hisScript: string): AwInstance {
    ...
    public withId(id: string): AwInstance {
        this['id'] = id;
        return this;
    }
    public withIsBasic(isBasic: number): AwInstance {
    ...
    public withIsContractAw(isContractAw: number): AwInstance {
    ...
    public withIsDisabled(isDisabled: number): AwInstance {
    ...
    public withIsSectestAw(isSectestAw: number): AwInstance {
    ...
    public withLevel(level: number): AwInstance {
        this['level'] = level;
        return this;
    }
    public withName(name: string): AwInstance {
        this['name'] = name;
        return this;
    }
    public withParamDependent(paramDependent: string): AwInstance {
    ...
    public withParamDependentEnabled(paramDependentEnabled: number): AwInstance {
    ...
    public withParamTypeAndValue(paramTypeAndValue: Array<AwParam>): AwInstance {
    ...
    public withProjectId(projectId: string): AwInstance {
        this['projectId'] = projectId;
        return this;
    }
    public withRegion(region: string): AwInstance {
        this['region'] = region;
        return this;
    }
    public withRelation(relation: string): AwInstance {
        this['relation'] = relation;
        return this;
    }
    public withRelationId(relationId: string): AwInstance {
    ...
    public withRelationType(relationType: number): AwInstance {
    ...
    public withRetryInterval(retryInterval: string): AwInstance {
    ...
    public withRetryTimes(retryTimes: string): AwInstance {
    ...
    public withScriptName(scriptName: string): AwInstance {
        this['scriptName'] = scriptName;
        return this;
    }
    public withServiceAndStage(serviceAndStage: string): AwInstance {
    ...
    public withSpecialType(specialType: number): AwInstance {
    ...
    public withUpdateTime(updateTime: string): AwInstance {
    ...
    public withUpdateTimeStamp(updateTimeStamp: number): AwInstance {
    ...
    public withUpdateTimeString(updateTimeString: string): AwInstance {
    ...
    public withUpdateUser(updateUser: string): AwInstance {
    ...
    public withUserId(userId: string): AwInstance {
        this['user_id'] = userId;
        return this;
    }
    ...
    public withVariableList(variableList: Array<AwVariable>): AwInstance {
