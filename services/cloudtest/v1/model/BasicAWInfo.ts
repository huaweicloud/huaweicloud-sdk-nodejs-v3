import { AwInstanceRes } from './AwInstanceRes';
import { AwParam } from './AwParam';
import { AwVariable } from './AwVariable';
import { CheckPoint } from './CheckPoint';
import { JsonNode } from './JsonNode';
import { PublicAwLibRes } from './PublicAwLibRes';
import { UploadFileRes } from './UploadFileRes';


export class BasicAWInfo {
    private 'aw_code'?: string;
    private 'aw_description'?: string;
    private 'aw_ins_list'?: Array<AwInstanceRes>;
    ...
    private 'public_aw_lib'?: PublicAwLibRes;
    ...
    public withAwCode(awCode: string): BasicAWInfo {
        this['aw_code'] = awCode;
        return this;
    }
    ...
    public withAwDescription(awDescription: string): BasicAWInfo {
    ...
    public withAwInsList(awInsList: Array<AwInstanceRes>): BasicAWInfo {
        this['aw_ins_list'] = awInsList;
        return this;
    }
    public set awInsList(awInsList: Array<AwInstanceRes>  | undefined) {
        this['aw_ins_list'] = awInsList;
    }
    public get awInsList(): Array<AwInstanceRes> | undefined {
        return this['aw_ins_list'];
    }
    public withAwMark(awMark: number): BasicAWInfo {
        this['aw_mark'] = awMark;
        return this;
    }
    ...
    public withAwOperationid(awOperationid: string): BasicAWInfo {
    ...
    public withAwTags(awTags: string): BasicAWInfo {
        this['aw_tags'] = awTags;
        return this;
    }
    ...
    public withAwType(awType: number): BasicAWInfo {
        this['aw_type'] = awType;
        return this;
    }
    ...
    public withAwUniqueid(awUniqueid: string): BasicAWInfo {
    ...
    public withByOrder(byOrder: number): BasicAWInfo {
    ...
    public withCataType(cataType: number): BasicAWInfo {
    ...
    public withChildList(childList: Array<BasicAWInfo>): BasicAWInfo {
        this['child_list'] = childList;
        return this;
    }
    public set childList(childList: Array<BasicAWInfo>  | undefined) {
        this['child_list'] = childList;
    }
    public get childList(): Array<BasicAWInfo> | undefined {
        return this['child_list'];
    }
    public withCreateTime(createTime: string): BasicAWInfo {
    ...
    public withCreateTimeStamp(createTimeStamp: number): BasicAWInfo {
    ...
    public withCreateTimeString(createTimeString: string): BasicAWInfo {
    ...
    public withCreateUser(createUser: string): BasicAWInfo {
    ...
    public withCreateUserId(createUserId: string): BasicAWInfo {
    ...
    public withCustomAwLibs(customAwLibs: Array<UploadFileRes>): BasicAWInfo {
        this['custom_aw_libs'] = customAwLibs;
        return this;
    }
    public set customAwLibs(customAwLibs: Array<UploadFileRes>  | undefined) {
        this['custom_aw_libs'] = customAwLibs;
    }
    public get customAwLibs(): Array<UploadFileRes> | undefined {
        return this['custom_aw_libs'];
    }
    public withDeleteTime(deleteTime: string): BasicAWInfo {
    ...
    public withDeleteUser(deleteUser: string): BasicAWInfo {
    ...
    public withDescription(description: string): BasicAWInfo {
        this['description'] = description;
        return this;
    }
    public withDftCheckPointList(dftCheckPointList: Array<CheckPoint>): BasicAWInfo {
    ...
    public withDftCustomHeader(dftCustomHeader: Array<AwParam>): BasicAWInfo {
    ...
    public withDftRetryInterval(dftRetryInterval: string): BasicAWInfo {
    ...
    public withDftRetryTimes(dftRetryTimes: string): BasicAWInfo {
    ...
    public withDftVariableList(dftVariableList: Array<AwVariable>): BasicAWInfo {
    ...
    public withExtraInfo(extraInfo: JsonNode): BasicAWInfo {
    ...
    public withGroupName(groupName: string): BasicAWInfo {
    ...
    public withHasCode(hasCode: number): BasicAWInfo {
    ...
    public withId(id: string): BasicAWInfo {
        this['id'] = id;
        return this;
    }
    public withImportPackage(importPackage: Array<string>): BasicAWInfo {
    ...
    public withInterfaceLabel(interfaceLabel: string): BasicAWInfo {
    ...
    public withIsFavorite(isFavorite: number): BasicAWInfo {
    ...
    public withIsFolder(isFolder: string): BasicAWInfo {
    ...
    public withKeywordVariableValue(keywordVariableValue: Array<AwVariable>): BasicAWInfo {
    ...
    public withMethod(method: string): BasicAWInfo {
        this['method'] = method;
        return this;
    }
    public withName(name: string): BasicAWInfo {
        this['name'] = name;
        return this;
    }
    public withNameView(nameView: string): BasicAWInfo {
        this['nameView'] = nameView;
        return this;
    }
    public withOriginProject(originProject: string): BasicAWInfo {
    ...
    public withOutputParamList(outputParamList: Array<AwVariable>): BasicAWInfo {
    ...
    public withPageNo(pageNo: number): BasicAWInfo {
        this['page_no'] = pageNo;
        return this;
    }
    ...
    public withPageSize(pageSize: number): BasicAWInfo {
    ...
    public withParamTypeAndDftValue(paramTypeAndDftValue: Array<AwParam>): BasicAWInfo {
    ...
    public withParentId(parentId: string): BasicAWInfo {
    ...
    public withProjectId(projectId: string): BasicAWInfo {
    ...
    public withProtocolType(protocolType: string): BasicAWInfo {
    ...
    public withPublicAwLib(publicAwLib: PublicAwLibRes): BasicAWInfo {
        this['public_aw_lib'] = publicAwLib;
        return this;
    }
    public set publicAwLib(publicAwLib: PublicAwLibRes  | undefined) {
        this['public_aw_lib'] = publicAwLib;
    }
    public get publicAwLib(): PublicAwLibRes | undefined {
        return this['public_aw_lib'];
    }
    public withPublicAwLibId(publicAwLibId: string): BasicAWInfo {
    ...
    public withRegion(region: string): BasicAWInfo {
        this['region'] = region;
        return this;
    }
    public withReturnType(returnType: string): BasicAWInfo {
    ...
    public withRootId(rootId: string): BasicAWInfo {
        this['root_id'] = rootId;
        return this;
    }
    ...
    public withSource(source: string): BasicAWInfo {
        this['source'] = source;
        return this;
    }
    public withSpecialType(specialType: number): BasicAWInfo {
    ...
    public withTmssCaseNumber(tmssCaseNumber: string): BasicAWInfo {
        this['tmssCaseNumber'] = tmssCaseNumber;
        return this;
    }
    public withTmssCaseId(tmssCaseId: string): BasicAWInfo {
    ...
    public withTotalPage(totalPage: number): BasicAWInfo {
    ...
    public withTotalSize(totalSize: number): BasicAWInfo {
    ...
    public withUpdateTime(updateTime: string): BasicAWInfo {
    ...
    public withUpdateTimeStamp(updateTimeStamp: number): BasicAWInfo {
    ...
    public withUpdateTimeString(updateTimeString: string): BasicAWInfo {
    ...
    public withUpdateUser(updateUser: string): BasicAWInfo {
    ...
    public withWarningMsg(warningMsg: string): BasicAWInfo {
        this['warningMsg'] = warningMsg;
        return this;
    }
    public withYamlName(yamlName: string): BasicAWInfo {
