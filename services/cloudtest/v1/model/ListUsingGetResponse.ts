...
export class ListUsingGetResponse extends SdkResponse {
    public list?: Array<DashboardDto>;
    ...
    public withList(list: Array<DashboardDto>): ListUsingGetResponse {
        this['list'] = list;
        return this;
    }
    public withPageNum(pageNum: number): ListUsingGetResponse {
    ...
    public withPageSize(pageSize: number): ListUsingGetResponse {
    ...
    public withTotalPage(totalPage: number): ListUsingGetResponse {
    ...
    public withTotalSize(totalSize: number): ListUsingGetResponse {
