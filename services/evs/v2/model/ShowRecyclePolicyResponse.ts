...
export class ShowRecyclePolicyResponse extends SdkResponse {
    ...
    public withSwitch(_switch: boolean): ShowRecyclePolicyResponse {
        this['switch'] = _switch;
        return this;
    }
    ...
    public withThresholdTime(thresholdTime: number): ShowRecyclePolicyResponse {
    ...
    public withKeepTime(keepTime: number): ShowRecyclePolicyResponse {
