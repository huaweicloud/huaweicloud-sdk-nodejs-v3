...
export class ListVolumesByTagsRequestBody {
    public action?: ListVolumesByTagsRequestBodyActionEnum | string;
    public limit?: number;
    public matches?: Array<Match>;
    public offset?: number;
    public tags?: Array<TagsForListVolumes>;
    public constructor(action?: string, tags?: Array<TagsForListVolumes>) { 
        this['action'] = action;
        this['tags'] = tags;
    }
    public withAction(action: ListVolumesByTagsRequestBodyActionEnum | string): ListVolumesByTagsRequestBody {
        this['action'] = action;
        return this;
    }
