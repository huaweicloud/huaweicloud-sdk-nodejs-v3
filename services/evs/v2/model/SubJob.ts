...
export class SubJob {
    ...
    public constructor(status?: string, entities?: SubJobEntities, jobId?: string, jobType?: string, beginTime?: string, endTime?: string, errorCode?: string, failReason?: string) { 
        this['status'] = status;
