...
export class UpdatePolicyStateResponse extends SdkResponse {
    ...
    public withDomainId(domainId: string): UpdatePolicyStateResponse {
    ...
    public withRegionId(regionId: string): UpdatePolicyStateResponse {
    ...
    public withResourceId(resourceId: string): UpdatePolicyStateResponse {
    ...
    public withResourceName(resourceName: string): UpdatePolicyStateResponse {
    ...
    public withResourceProvider(resourceProvider: string): UpdatePolicyStateResponse {
    ...
    public withResourceType(resourceType: string): UpdatePolicyStateResponse {
    ...
    public withTriggerType(triggerType: string): UpdatePolicyStateResponse {
    ...
    public withComplianceState(complianceState: string): UpdatePolicyStateResponse {
    ...
    public withPolicyAssignmentId(policyAssignmentId: string): UpdatePolicyStateResponse {
    ...
    public withPolicyAssignmentName(policyAssignmentName: string): UpdatePolicyStateResponse {
    ...
    public withPolicyDefinitionId(policyDefinitionId: string): UpdatePolicyStateResponse {
    ...
    public withEvaluationTime(evaluationTime: string): UpdatePolicyStateResponse {
