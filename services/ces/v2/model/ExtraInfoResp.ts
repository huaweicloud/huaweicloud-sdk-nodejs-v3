...
export class ExtraInfoResp {
    ...
    public withOriginMetricName(originMetricName: string): ExtraInfoResp {
    ...
    public withMetricPrefix(metricPrefix: string): ExtraInfoResp {
    ...
    public withMetricType(metricType: string): ExtraInfoResp {
    ...
    public withCustomProcName(customProcName: string): ExtraInfoResp {
