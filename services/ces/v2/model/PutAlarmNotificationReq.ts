...
export class PutAlarmNotificationReq {
    ...
    public withNotificationEnabled(notificationEnabled: boolean): PutAlarmNotificationReq {
        this['notification_enabled'] = notificationEnabled;
        return this;
    }
    ...
    public withAlarmNotifications(alarmNotifications: Array<Notification>): PutAlarmNotificationReq {
    ...
    public withOkNotifications(okNotifications: Array<Notification>): PutAlarmNotificationReq {
    ...
    public withNotificationBeginTime(notificationBeginTime: string): PutAlarmNotificationReq {
    ...
    public withNotificationEndTime(notificationEndTime: string): PutAlarmNotificationReq {
