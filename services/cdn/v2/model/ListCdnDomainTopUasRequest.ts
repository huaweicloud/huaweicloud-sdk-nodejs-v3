...
export class ListCdnDomainTopUasRequest {
    ...
    public withStartTime(startTime: number): ListCdnDomainTopUasRequest {
        this['start_time'] = startTime;
        return this;
    }
    ...
    public withEndTime(endTime: number): ListCdnDomainTopUasRequest {
        this['end_time'] = endTime;
        return this;
    }
    ...
    public withDomainName(domainName: string): ListCdnDomainTopUasRequest {
        this['domain_name'] = domainName;
        return this;
    }
    ...
    public withGroupBy(groupBy: string): ListCdnDomainTopUasRequest {
    ...
    public withStatType(statType: string): ListCdnDomainTopUasRequest {
        this['stat_type'] = statType;
        return this;
    }
    ...
    public withServiceArea(serviceArea: string): ListCdnDomainTopUasRequest {
    ...
    public withEnterpriseProjectId(enterpriseProjectId: string): ListCdnDomainTopUasRequest {
    ...
    public withIncludeRatio(includeRatio: boolean): ListCdnDomainTopUasRequest {
