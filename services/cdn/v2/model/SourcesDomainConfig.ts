...
export class SourcesDomainConfig {
    ...
    public withOriginType(originType: string): SourcesDomainConfig {
        this['origin_type'] = originType;
        return this;
    }
    ...
    public withOriginAddr(originAddr: string): SourcesDomainConfig {
        this['origin_addr'] = originAddr;
        return this;
    }
    ...
    public withPriority(priority: number): SourcesDomainConfig {
        this['priority'] = priority;
        return this;
    }
    public withObsWebHostingStatus(obsWebHostingStatus: string): SourcesDomainConfig {
    ...
    public withHttpPort(httpPort: number): SourcesDomainConfig {
    ...
    public withHttpsPort(httpsPort: number): SourcesDomainConfig {
    ...
    public withHostName(hostName: string): SourcesDomainConfig {
    ...
    public withObsBucketType(obsBucketType: string): SourcesDomainConfig {
