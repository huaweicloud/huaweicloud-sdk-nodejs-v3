...
export class Configs {
    ...
    public withClientCert(clientCert: ClientCert): Configs {
    ...
    public withHttpsTlsVersion(httpsTlsVersion: HttpsTlsVersion): Configs {
    ...
    public withFlowLimitStrategy(flowLimitStrategy: Array<FlowLimitStrategy>): Configs {
