...
export class InheritConfig {
    ...
    public withStatus(status: string): InheritConfig {
        this['status'] = status;
        return this;
    }
    public withInheritType(inheritType: string): InheritConfig {
    ...
    public withInheritTimeType(inheritTimeType: string): InheritConfig {
