...
export class ShowRecordSetWithLineRequest {
    ...
    public withZoneId(zoneId: string): ShowRecordSetWithLineRequest {
        this['zone_id'] = zoneId;
        return this;
    }
    ...
    public withRecordsetId(recordsetId: string): ShowRecordSetWithLineRequest {
        this['recordset_id'] = recordsetId;
        return this;
    }
