...
export class CreateRecordSetResponse extends SdkResponse {
    ...
    public withId(id: string): CreateRecordSetResponse {
        this['id'] = id;
        return this;
    }
    public withName(name: string): CreateRecordSetResponse {
        this['name'] = name;
        return this;
    }
    public withDescription(description: string): CreateRecordSetResponse {
        this['description'] = description;
        return this;
    }
    public withZoneId(zoneId: string): CreateRecordSetResponse {
        this['zone_id'] = zoneId;
        return this;
    }
    ...
    public withTtl(ttl: number): CreateRecordSetResponse {
        this['ttl'] = ttl;
        return this;
    }
    public withRecords(records: Array<string>): CreateRecordSetResponse {
        this['records'] = records;
        return this;
    }
    public withCreateAt(createAt: string): CreateRecordSetResponse {
    ...
    public withDefault(_default: boolean): CreateRecordSetResponse {
