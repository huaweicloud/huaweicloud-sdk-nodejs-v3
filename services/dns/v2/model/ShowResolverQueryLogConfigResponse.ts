...
export class ShowResolverQueryLogConfigResponse extends SdkResponse {
    private 'resolver_query_log_config'?: ResolverQueryLogConfig;
    public constructor() { 
        super();
    }
    public withResolverQueryLogConfig(resolverQueryLogConfig: ResolverQueryLogConfig): ShowResolverQueryLogConfigResponse {
