...
export class EnableDnssecConfigResponse extends SdkResponse {
    ...
    public withZoneName(zoneName: string): EnableDnssecConfigResponse {
    ...
    public withKeyTag(keyTag: number): EnableDnssecConfigResponse {
        this['key_tag'] = keyTag;
        return this;
    }
    ...
    public withFlag(flag: number): EnableDnssecConfigResponse {
        this['flag'] = flag;
        return this;
    }
    public withDigestAlgorithm(digestAlgorithm: string): EnableDnssecConfigResponse {
    ...
    public withDigestType(digestType: number): EnableDnssecConfigResponse {
    ...
    public withDigest(digest: string): EnableDnssecConfigResponse {
        this['digest'] = digest;
        return this;
    }
    public withSignature(signature: string): EnableDnssecConfigResponse {
        this['signature'] = signature;
        return this;
    }
    public withSignatureType(signatureType: number): EnableDnssecConfigResponse {
    ...
    public withKskPublicKey(kskPublicKey: string): EnableDnssecConfigResponse {
    ...
    public withDsRecord(dsRecord: string): EnableDnssecConfigResponse {
    ...
    public withCreatedAt(createdAt: string): EnableDnssecConfigResponse {
    ...
    public withUpdatedAt(updatedAt: string): EnableDnssecConfigResponse {
    ...
    public withStatus(status: string): EnableDnssecConfigResponse {
        this['status'] = status;
        return this;
    }
}