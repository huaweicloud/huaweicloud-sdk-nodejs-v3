...
export class RfsClient {
    public static newBuilder(): ClientBuilder<RfsClient> {
            let client = new ClientBuilder<RfsClient>(newClient);
            return client;
    }
...
function newClient(client: HcClient): RfsClient {
    return new RfsClient(client);
}
