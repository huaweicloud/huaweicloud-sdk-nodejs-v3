...
export class CreateTemplateVersionRequestBody {
    private 'version_description'?: string;
    private 'template_body'?: string;
    private 'template_uri'?: string;
    public constructor() { 
    }
    public withVersionDescription(versionDescription: string): CreateTemplateVersionRequestBody {
    ...
    public withTemplateBody(templateBody: string): CreateTemplateVersionRequestBody {
    ...
    public withTemplateUri(templateUri: string): CreateTemplateVersionRequestBody {
