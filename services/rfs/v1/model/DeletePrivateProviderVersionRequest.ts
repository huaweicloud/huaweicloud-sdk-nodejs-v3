...
export class DeletePrivateProviderVersionRequest {
    ...
    public withClientRequestId(clientRequestId: string): DeletePrivateProviderVersionRequest {
        this['Client-Request-Id'] = clientRequestId;
        return this;
    }
    ...
    public withProviderName(providerName: string): DeletePrivateProviderVersionRequest {
        this['provider_name'] = providerName;
        return this;
    }
    ...
    public withProviderVersion(providerVersion: string): DeletePrivateProviderVersionRequest {
        this['provider_version'] = providerVersion;
        return this;
    }
    ...
    public withProviderId(providerId: string): DeletePrivateProviderVersionRequest {
