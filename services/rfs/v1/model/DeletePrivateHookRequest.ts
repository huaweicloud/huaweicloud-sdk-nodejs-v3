...
export class DeletePrivateHookRequest {
    ...
    public withClientRequestId(clientRequestId: string): DeletePrivateHookRequest {
        this['Client-Request-Id'] = clientRequestId;
        return this;
    }
    ...
    public withHookName(hookName: string): DeletePrivateHookRequest {
        this['hook_name'] = hookName;
        return this;
    }
    ...
    public withHookId(hookId: string): DeletePrivateHookRequest {
        this['hook_id'] = hookId;
        return this;
    }
