...
export class RfsRegion {
    ...
    private static REGION_MAP: RegionMap = {
        "cn-north-4":RfsRegion.CN_NORTH_4,
        "cn-south-1":RfsRegion.CN_SOUTH_1,
        "cn-east-3":RfsRegion.CN_EAST_3,
        "cn-east-4":RfsRegion.CN_EAST_4,
        "cn-north-9":RfsRegion.CN_NORTH_9,
        "cn-southwest-2":RfsRegion.CN_SOUTHWEST_2,
        "ap-southeast-3":RfsRegion.AP_SOUTHEAST_3,
        "ap-southeast-2":RfsRegion.AP_SOUTHEAST_2,
        "ap-southeast-1":RfsRegion.AP_SOUTHEAST_1,
        "ap-southeast-4":RfsRegion.AP_SOUTHEAST_4,
        "my-kualalumpur-1":RfsRegion.MY_KUALALUMPUR_1,
        "me-east-1":RfsRegion.ME_EAST_1,
        "tr-west-1":RfsRegion.TR_WEST_1,
        "la-south-2":RfsRegion.LA_SOUTH_2,
        "sa-brazil-1":RfsRegion.SA_BRAZIL_1,
        "la-north-2":RfsRegion.LA_NORTH_2,
        "af-south-1":RfsRegion.AF_SOUTH_1,
        "eu-west-101":RfsRegion.EU_WEST_101,
        "na-mexico-1":RfsRegion.NA_MEXICO_1,
        "cn-north-11":RfsRegion.CN_NORTH_11,
        "cn-east-5":RfsRegion.CN_EAST_5,
        "af-north-1":RfsRegion.AF_NORTH_1,
        "cn-north-12":RfsRegion.CN_NORTH_12,
        "ap-southeast-5":RfsRegion.AP_SOUTHEAST_5,
        "cn-southwest-3":RfsRegion.CN_SOUTHWEST_3
    };
