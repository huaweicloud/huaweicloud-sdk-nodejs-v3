...
export class PutEventsResponse extends SdkResponse {
    ...
    public withFailedCount(failedCount: number): PutEventsResponse {
    ...
    public withEvents(events: Array<PutEventsRespEvents>): PutEventsResponse {
        this['events'] = events;
        return this;
    }
    public withXRequestId(xRequestId: string): PutEventsResponse {
