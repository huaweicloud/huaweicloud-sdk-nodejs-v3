...
export class PoliciesDisplayOptionsVideoQualityOptions {
    private 'average_video_quality'?: number;
    private 'lowest_video_quality'?: number;
    private 'highest_video_quality'?: number;
    public constructor() { 
    }
    public withAverageVideoQuality(averageVideoQuality: number): PoliciesDisplayOptionsVideoQualityOptions {
    ...
    public withLowestVideoQuality(lowestVideoQuality: number): PoliciesDisplayOptionsVideoQualityOptions {
    ...
    public withHighestVideoQuality(highestVideoQuality: number): PoliciesDisplayOptionsVideoQualityOptions {
