...
export class ShowCommonSkillResp {
    public id?: string;
    public slug?: string;
    ...
    public withId(id: string): ShowCommonSkillResp {
        this['id'] = id;
        return this;
    }
    public withSlug(slug: string): ShowCommonSkillResp {
        this['slug'] = slug;
        return this;
    }
    public withDisplayName(displayName: string): ShowCommonSkillResp {
    ...
    public withAliasName(aliasName: string): ShowCommonSkillResp {
    ...
    public withDescription(description: string): ShowCommonSkillResp {
        this['description'] = description;
        return this;
    }
    public withCategory(category: SkillCategoryEnum): ShowCommonSkillResp {
        this['category'] = category;
        return this;
    }
    public withTags(tags: Array<string>): ShowCommonSkillResp {
        this['tags'] = tags;
        return this;
    }
    public withOwnerType(ownerType: SkillOwnerTypeEnum): ShowCommonSkillResp {
    ...
    public withVisibilityScope(visibilityScope: VisibilityScopeEnum): ShowCommonSkillResp {
    ...
    public withVisibleDomainIds(visibleDomainIds: Array<string>): ShowCommonSkillResp {
    ...
    public withStatus(status: SkillStatusEnum): ShowCommonSkillResp {
        this['status'] = status;
        return this;
    }
    public withCurrentPackageId(currentPackageId: string): ShowCommonSkillResp {
    ...
    public withCover(cover: string): ShowCommonSkillResp {
        this['cover'] = cover;
        return this;
    }
    public withSource(source: SkillSourceEnum): ShowCommonSkillResp {
        this['source'] = source;
        return this;
    }
    public withSupportOsTypes(supportOsTypes: Array<string>): ShowCommonSkillResp {
    ...
    public withPackages(packages: Array<SkillPackageSummary>): ShowCommonSkillResp {
        this['packages'] = packages;
        return this;
    }
    public withCreateTime(createTime: string): ShowCommonSkillResp {
    ...
    public withUpdateTime(updateTime: string): ShowCommonSkillResp {
    ...
    public withAttachInstanceNumber(attachInstanceNumber: number): ShowCommonSkillResp {
