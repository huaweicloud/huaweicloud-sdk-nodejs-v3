...
export class ShowSkillResponse extends SdkResponse {
    public id?: string;
    public slug?: string;
    ...
    public withId(id: string): ShowSkillResponse {
        this['id'] = id;
        return this;
    }
    public withSlug(slug: string): ShowSkillResponse {
        this['slug'] = slug;
        return this;
    }
    public withDisplayName(displayName: string): ShowSkillResponse {
    ...
    public withAliasName(aliasName: string): ShowSkillResponse {
    ...
    public withDescription(description: string): ShowSkillResponse {
        this['description'] = description;
        return this;
    }
    public withCategory(category: SkillCategoryEnum): ShowSkillResponse {
        this['category'] = category;
        return this;
    }
    public withTags(tags: Array<string>): ShowSkillResponse {
        this['tags'] = tags;
        return this;
    }
    public withOwnerType(ownerType: SkillOwnerTypeEnum): ShowSkillResponse {
    ...
    public withVisibilityScope(visibilityScope: VisibilityScopeEnum): ShowSkillResponse {
    ...
    public withVisibleDomainIds(visibleDomainIds: Array<string>): ShowSkillResponse {
    ...
    public withStatus(status: SkillStatusEnum): ShowSkillResponse {
        this['status'] = status;
        return this;
    }
    public withCurrentPackageId(currentPackageId: string): ShowSkillResponse {
    ...
    public withCover(cover: string): ShowSkillResponse {
        this['cover'] = cover;
        return this;
    }
    public withSource(source: SkillSourceEnum): ShowSkillResponse {
        this['source'] = source;
        return this;
    }
    public withSupportOsTypes(supportOsTypes: Array<string>): ShowSkillResponse {
    ...
    public withPackages(packages: Array<SkillPackageSummary>): ShowSkillResponse {
        this['packages'] = packages;
        return this;
    }
    public withCreateTime(createTime: string): ShowSkillResponse {
    ...
    public withUpdateTime(updateTime: string): ShowSkillResponse {
    ...
    public withAttachInstanceNumber(attachInstanceNumber: number): ShowSkillResponse {
    ...
    public withXRequestId(xRequestId: string): ShowSkillResponse {
