...
export class CreateDeleteSubResourcesOrderRequestBody {
    ...
    public withDesktopIds(desktopIds: Array<string>): CreateDeleteSubResourcesOrderRequestBody {
    ...
    public withPromotionPlanId(promotionPlanId: string): CreateDeleteSubResourcesOrderRequestBody {
