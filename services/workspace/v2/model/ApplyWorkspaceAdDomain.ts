...
export class ApplyWorkspaceAdDomain {
    private 'domain_type'?: ApplyWorkspaceAdDomainDomainTypeEnum | string;
    ...
    public withDomainType(domainType: ApplyWorkspaceAdDomainDomainTypeEnum | string): ApplyWorkspaceAdDomain {
        this['domain_type'] = domainType;
        return this;
    }
    public set domainType(domainType: ApplyWorkspaceAdDomainDomainTypeEnum | string  | undefined) {
        this['domain_type'] = domainType;
    }
    public get domainType(): ApplyWorkspaceAdDomainDomainTypeEnum | string | undefined {
        return this['domain_type'];
    }
    public withDomainName(domainName: string): ApplyWorkspaceAdDomain {
    ...
    public withDomainAdminAccount(domainAdminAccount: string): ApplyWorkspaceAdDomain {
    ...
    public withDomainPassword(domainPassword: string): ApplyWorkspaceAdDomain {
    ...
    public withActiveDomainIp(activeDomainIp: string): ApplyWorkspaceAdDomain {
    ...
    public withActiveDomainName(activeDomainName: string): ApplyWorkspaceAdDomain {
    ...
    public withStandbyDomainIp(standbyDomainIp: string): ApplyWorkspaceAdDomain {
    ...
    public withStandbyDomainName(standbyDomainName: string): ApplyWorkspaceAdDomain {
    ...
    public withActiveDnsIp(activeDnsIp: string): ApplyWorkspaceAdDomain {
    ...
    public withStandbyDnsIp(standbyDnsIp: string): ApplyWorkspaceAdDomain {
    ...
    public withDeleteComputerObject(deleteComputerObject: number): ApplyWorkspaceAdDomain {
    ...
    public withUseLdaps(useLdaps: boolean): ApplyWorkspaceAdDomain {
...
/**
    ...
    * @enum {string}
    */
export enum ApplyWorkspaceAdDomainDomainTypeEnum {
    LITE_AS = 'LITE_AS',
    LOCAL_AD = 'LOCAL_AD'
}
