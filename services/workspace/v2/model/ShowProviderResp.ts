...
export class ShowProviderResp {
    ...
    public withId(id: string): ShowProviderResp {
        this['id'] = id;
        return this;
    }
    public withProviderType(providerType: string): ShowProviderResp {
    ...
    public withProviderId(providerId: string): ShowProviderResp {
    ...
    public withProviderName(providerName: string): ShowProviderResp {
    ...
    public withBaseUrl(baseUrl: string): ShowProviderResp {
    ...
    public withConnectionStatus(connectionStatus: string): ShowProviderResp {
    ...
    public withIsBuiltin(isBuiltin: boolean): ShowProviderResp {
    ...
    public withLastVerifyTime(lastVerifyTime: string): ShowProviderResp {
    ...
    public withCustomConfig(customConfig: object): ShowProviderResp {
    ...
    public withGroups(groups: Array<AttachModelGroupInfo>): ShowProviderResp {
        this['groups'] = groups;
        return this;
    }
    public withModels(models: Array<ModelItemResp>): ShowProviderResp {
        this['models'] = models;
        return this;
    }
    public withCreateTime(createTime: string): ShowProviderResp {
    ...
    public withUpdateTime(updateTime: string): ShowProviderResp {
    ...
    public withApiType(apiType: ApiType): ShowProviderResp {
