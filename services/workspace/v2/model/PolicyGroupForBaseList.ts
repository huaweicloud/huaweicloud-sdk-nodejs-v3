...
export class PolicyGroupForBaseList {
    ...
    public withPolicyGroupId(policyGroupId: string): PolicyGroupForBaseList {
    ...
    public withPolicyGroupName(policyGroupName: string): PolicyGroupForBaseList {
    ...
    public withPriority(priority: number): PolicyGroupForBaseList {
        this['priority'] = priority;
        return this;
    }
    public withUpdateTime(updateTime: string): PolicyGroupForBaseList {
    ...
    public withDescription(description: string): PolicyGroupForBaseList {
