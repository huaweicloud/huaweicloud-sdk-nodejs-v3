...
export class BatchDetachInstancesResponse extends SdkResponse {
    ...
    public withFailedOperationList(failedOperationList: Array<VmOperateResult>): BatchDetachInstancesResponse {
    ...
    public withJobId(jobId: string): BatchDetachInstancesResponse {
        this['job_id'] = jobId;
        return this;
    }
