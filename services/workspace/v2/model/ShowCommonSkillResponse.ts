...
export class ShowCommonSkillResponse extends SdkResponse {
    public id?: string;
    public slug?: string;
    ...
    public withId(id: string): ShowCommonSkillResponse {
        this['id'] = id;
        return this;
    }
    public withSlug(slug: string): ShowCommonSkillResponse {
        this['slug'] = slug;
        return this;
    }
    public withDisplayName(displayName: string): ShowCommonSkillResponse {
    ...
    public withAliasName(aliasName: string): ShowCommonSkillResponse {
    ...
    public withDescription(description: string): ShowCommonSkillResponse {
        this['description'] = description;
        return this;
    }
    public withCategory(category: SkillCategoryEnum): ShowCommonSkillResponse {
        this['category'] = category;
        return this;
    }
    public withTags(tags: Array<string>): ShowCommonSkillResponse {
        this['tags'] = tags;
        return this;
    }
    public withOwnerType(ownerType: SkillOwnerTypeEnum): ShowCommonSkillResponse {
    ...
    public withVisibilityScope(visibilityScope: VisibilityScopeEnum): ShowCommonSkillResponse {
    ...
    public withVisibleDomainIds(visibleDomainIds: Array<string>): ShowCommonSkillResponse {
    ...
    public withStatus(status: SkillStatusEnum): ShowCommonSkillResponse {
        this['status'] = status;
        return this;
    }
    public withCurrentPackageId(currentPackageId: string): ShowCommonSkillResponse {
    ...
    public withCover(cover: string): ShowCommonSkillResponse {
        this['cover'] = cover;
        return this;
    }
    public withSource(source: SkillSourceEnum): ShowCommonSkillResponse {
        this['source'] = source;
        return this;
    }
    public withSupportOsTypes(supportOsTypes: Array<string>): ShowCommonSkillResponse {
    ...
    public withPackages(packages: Array<SkillPackageSummary>): ShowCommonSkillResponse {
        this['packages'] = packages;
        return this;
    }
    public withCreateTime(createTime: string): ShowCommonSkillResponse {
    ...
    public withUpdateTime(updateTime: string): ShowCommonSkillResponse {
    ...
    public withAttachInstanceNumber(attachInstanceNumber: number): ShowCommonSkillResponse {
    ...
    public withXRequestId(xRequestId: string): ShowCommonSkillResponse {
