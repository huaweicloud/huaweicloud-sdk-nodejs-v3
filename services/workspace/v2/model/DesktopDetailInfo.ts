...
export class DesktopDetailInfo {
    ...
    private 'desktop_isv'?: DesktopDetailInfoDesktopIsvEnum | string;
    ...
    public withSecurityGroups(securityGroups: Array<SecurityGroup>): DesktopDetailInfo {
    ...
    public withJoinDomain(joinDomain: string): DesktopDetailInfo {
    ...
    public withDehId(dehId: string): DesktopDetailInfo {
        this['deh_id'] = dehId;
        return this;
    }
    ...
    public withPlatformKind(platformKind: number): DesktopDetailInfo {
    ...
    public withNeedApplyAdn(needApplyAdn: boolean): DesktopDetailInfo {
    ...
    public withDesktopIsv(desktopIsv: DesktopDetailInfoDesktopIsvEnum | string): DesktopDetailInfo {
        this['desktop_isv'] = desktopIsv;
        return this;
    }
    public set desktopIsv(desktopIsv: DesktopDetailInfoDesktopIsvEnum | string  | undefined) {
        this['desktop_isv'] = desktopIsv;
    }
    public get desktopIsv(): DesktopDetailInfoDesktopIsvEnum | string | undefined {
        return this['desktop_isv'];
    }
    public withCreationType(creationType: string): DesktopDetailInfo {
...
/**
    ...
    * @enum {string}
    */
export enum DesktopDetailInfoDesktopIsvEnum {
    DEFAULT = 'DEFAULT',
    ONEMOBILE = 'ONEMOBILE'
}
/**
