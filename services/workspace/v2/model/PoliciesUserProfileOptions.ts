...
export class PoliciesUserProfileOptions {
    ...
    public withUserProfileRule(userProfileRule: string): PoliciesUserProfileOptions {
    ...
    public withRedirExcludeCommonFolders(redirExcludeCommonFolders: string): PoliciesUserProfileOptions {
    ...
    public withRedirExcludeCopy0s(redirExcludeCopy0s: string): PoliciesUserProfileOptions {
    ...
    public withRedirExcludeCopy1s(redirExcludeCopy1s: string): PoliciesUserProfileOptions {
    ...
    public withRedirExcludeCopy2s(redirExcludeCopy2s: string): PoliciesUserProfileOptions {
    ...
    public withRedirExcludeCopy3s(redirExcludeCopy3s: string): PoliciesUserProfileOptions {
    ...
    public withRedirExcludeIncludes(redirExcludeIncludes: string): PoliciesUserProfileOptions {
