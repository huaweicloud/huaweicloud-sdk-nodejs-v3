...
export class UpdateSkillResponse extends SdkResponse {
    public id?: string;
    public slug?: string;
    ...
    public withId(id: string): UpdateSkillResponse {
        this['id'] = id;
        return this;
    }
    public withSlug(slug: string): UpdateSkillResponse {
        this['slug'] = slug;
        return this;
    }
    public withDisplayName(displayName: string): UpdateSkillResponse {
    ...
    public withAliasName(aliasName: string): UpdateSkillResponse {
    ...
    public withDescription(description: string): UpdateSkillResponse {
        this['description'] = description;
        return this;
    }
    public withCategory(category: SkillCategoryEnum): UpdateSkillResponse {
        this['category'] = category;
        return this;
    }
    public withTags(tags: Array<string>): UpdateSkillResponse {
        this['tags'] = tags;
        return this;
    }
    public withOwnerType(ownerType: SkillOwnerTypeEnum): UpdateSkillResponse {
    ...
    public withVisibilityScope(visibilityScope: VisibilityScopeEnum): UpdateSkillResponse {
    ...
    public withVisibleDomainIds(visibleDomainIds: Array<string>): UpdateSkillResponse {
    ...
    public withStatus(status: SkillStatusEnum): UpdateSkillResponse {
        this['status'] = status;
        return this;
    }
    public withCurrentPackageId(currentPackageId: string): UpdateSkillResponse {
    ...
    public withCover(cover: string): UpdateSkillResponse {
        this['cover'] = cover;
        return this;
    }
    public withSource(source: SkillSourceEnum): UpdateSkillResponse {
        this['source'] = source;
        return this;
    }
    public withSupportOsTypes(supportOsTypes: Array<string>): UpdateSkillResponse {
    ...
    public withPackages(packages: Array<SkillPackageSummary>): UpdateSkillResponse {
        this['packages'] = packages;
        return this;
    }
    public withCreateTime(createTime: string): UpdateSkillResponse {
    ...
    public withUpdateTime(updateTime: string): UpdateSkillResponse {
    ...
    public withAttachInstanceNumber(attachInstanceNumber: number): UpdateSkillResponse {
    ...
    public withXRequestId(xRequestId: string): UpdateSkillResponse {
