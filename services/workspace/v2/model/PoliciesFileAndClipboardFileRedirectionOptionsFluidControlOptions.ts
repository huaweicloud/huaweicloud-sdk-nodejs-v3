...
export class PoliciesFileAndClipboardFileRedirectionOptionsFluidControlOptions {
    ...
    public withGoodNetworkLatency(goodNetworkLatency: number): PoliciesFileAndClipboardFileRedirectionOptionsFluidControlOptions {
    ...
    public withNormalNetworkLatency(normalNetworkLatency: number): PoliciesFileAndClipboardFileRedirectionOptionsFluidControlOptions {
    ...
    public withPoorNetworkLatency(poorNetworkLatency: number): PoliciesFileAndClipboardFileRedirectionOptionsFluidControlOptions {
    ...
    public withReducingStep(reducingStep: number): PoliciesFileAndClipboardFileRedirectionOptionsFluidControlOptions {
    ...
    public withSlowIncreasingStep(slowIncreasingStep: number): PoliciesFileAndClipboardFileRedirectionOptionsFluidControlOptions {
    ...
    public withQuickIncreasingStep(quickIncreasingStep: number): PoliciesFileAndClipboardFileRedirectionOptionsFluidControlOptions {
    ...
    public withStartSpeed(startSpeed: number): PoliciesFileAndClipboardFileRedirectionOptionsFluidControlOptions {
    ...
    public withTestBlockSize(testBlockSize: number): PoliciesFileAndClipboardFileRedirectionOptionsFluidControlOptions {
    ...
    public withTestTimeGap(testTimeGap: number): PoliciesFileAndClipboardFileRedirectionOptionsFluidControlOptions {
