...
export class ShowRuleRestrictionResponse extends SdkResponse {
    ...
    public withAppRestrictRuleSwitch(appRestrictRuleSwitch: boolean): ShowRuleRestrictionResponse {
    ...
    public withAppControlMode(appControlMode: number): ShowRuleRestrictionResponse {
    ...
    public withAppPeriodicSwitch(appPeriodicSwitch: boolean): ShowRuleRestrictionResponse {
    ...
    public withAppPeriodicInterval(appPeriodicInterval: number): ShowRuleRestrictionResponse {
    ...
    public withAppForceKillProcSwitch(appForceKillProcSwitch: boolean): ShowRuleRestrictionResponse {
