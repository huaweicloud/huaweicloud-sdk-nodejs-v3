...
export class UpdateScreenRecordsTrafficLimitConfigRequestBodyConfigs {
    private 'site_id'?: string;
    private 'traffic_limit'?: number;
    public constructor() { 
    }
    public withSiteId(siteId: string): UpdateScreenRecordsTrafficLimitConfigRequestBodyConfigs {
        this['site_id'] = siteId;
        return this;
    }
    ...
    public withTrafficLimit(trafficLimit: number): UpdateScreenRecordsTrafficLimitConfigRequestBodyConfigs {
