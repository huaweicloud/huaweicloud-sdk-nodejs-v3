...
export class EstimateResizeRequestBody {
    ...
    public withDesktopIds(desktopIds: Array<string>): EstimateResizeRequestBody {
    ...
    public withPromotionPlanId(promotionPlanId: string): EstimateResizeRequestBody {
