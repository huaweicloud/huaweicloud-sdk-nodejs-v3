...
export class UploadAppResponse extends SdkResponse {
    public id?: string;
    ...
    public withId(id: string): UploadAppResponse {
        this['id'] = id;
        return this;
    }
    public withTenantId(tenantId: string): UploadAppResponse {
    ...
    public withName(name: string): UploadAppResponse {
        this['name'] = name;
        return this;
    }
    public withVersion(version: string): UploadAppResponse {
        this['version'] = version;
        return this;
    }
    public withDescription(description: string): UploadAppResponse {
        this['description'] = description;
        return this;
    }
    public withAuthorizationType(authorizationType: AssignType): UploadAppResponse {
    ...
    public withAppFileStore(appFileStore: FileStoreLink): UploadAppResponse {
    ...
    public withAppIconUrl(appIconUrl: string): UploadAppResponse {
    ...
    public withInstallType(installType: InstallType): UploadAppResponse {
    ...
    public withInstallCommand(installCommand: string): UploadAppResponse {
    ...
    public withUninstallCommand(uninstallCommand: string): UploadAppResponse {
    ...
    public withSupportOs(supportOs: OsTypeEnum): UploadAppResponse {
    ...
    public withStatus(status: AppStatusEnum): UploadAppResponse {
        this['status'] = status;
        return this;
    }
    public withApplicationSource(applicationSource: AppSourceType): UploadAppResponse {
    ...
    public withCreateTime(createTime: Date): UploadAppResponse {
    ...
    public withCatalogId(catalogId: string): UploadAppResponse {
    ...
    public withCatalog(catalog: string): UploadAppResponse {
        this['catalog'] = catalog;
        return this;
    }
    public withInstallInfo(installInfo: string): UploadAppResponse {
