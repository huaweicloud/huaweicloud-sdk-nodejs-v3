...
export class SimpleDesktopPoolInfo {
    ...
    public withSubnetIds(subnetIds: Array<string>): SimpleDesktopPoolInfo {
    ...
    public withTags(tags: Array<Tag>): SimpleDesktopPoolInfo {
        this['tags'] = tags;
        return this;
    }
    public withOuName(ouName: string): SimpleDesktopPoolInfo {
        this['ou_name'] = ouName;
        return this;
    }
    ...
    public withVpcId(vpcId: string): SimpleDesktopPoolInfo {
        this['vpc_id'] = vpcId;
        return this;
    }
