...
export class EstimateAddVolumeRequestBody {
    private 'desktop_pool_id'?: string;
    private 'desktop_ids'?: Array<string>;
    private 'promotion_plan_id'?: string;
    private 'handle_type'?: EstimateAddVolumeRequestBodyHandleTypeEnum | string;
    public constructor() { 
    }
    public withDesktopPoolId(desktopPoolId: string): EstimateAddVolumeRequestBody {
    ...
    public withDesktopIds(desktopIds: Array<string>): EstimateAddVolumeRequestBody {
    ...
    public withPromotionPlanId(promotionPlanId: string): EstimateAddVolumeRequestBody {
    ...
    public withHandleType(handleType: EstimateAddVolumeRequestBodyHandleTypeEnum | string): EstimateAddVolumeRequestBody {
        this['handle_type'] = handleType;
        return this;
    }
    public set handleType(handleType: EstimateAddVolumeRequestBodyHandleTypeEnum | string  | undefined) {
        this['handle_type'] = handleType;
    }
    public get handleType(): EstimateAddVolumeRequestBodyHandleTypeEnum | string | undefined {
...
/**
    ...
    * @enum {string}
    */
export enum EstimateAddVolumeRequestBodyHandleTypeEnum {
