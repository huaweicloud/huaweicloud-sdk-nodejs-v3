...
export class ModerationRegion {
    ...
    public static CN_SOUTHWEST_2 = new Region("cn-southwest-2", ["https://moderation.cn-southwest-2.myhuaweicloud.com"]);
    ...
    private static REGION_MAP: RegionMap = {
        ...
        "cn-southwest-2":ModerationRegion.CN_SOUTHWEST_2
    };
