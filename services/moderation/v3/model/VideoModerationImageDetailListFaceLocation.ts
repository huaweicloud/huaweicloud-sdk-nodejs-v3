...
export class VideoModerationImageDetailListFaceLocation {
    ...
    public withTopLeftX(topLeftX: number): VideoModerationImageDetailListFaceLocation {
    ...
    public withTopLeftY(topLeftY: number): VideoModerationImageDetailListFaceLocation {
    ...
    public withBottomRightX(bottomRightX: number): VideoModerationImageDetailListFaceLocation {
    ...
    public withBottomRightY(bottomRightY: number): VideoModerationImageDetailListFaceLocation {
