...
export class FaceLocationDetail {
    ...
    public withTopLeftX(topLeftX: number): FaceLocationDetail {
    ...
    public withTopLeftY(topLeftY: number): FaceLocationDetail {
    ...
    public withBottomRightX(bottomRightX: number): FaceLocationDetail {
    ...
    public withBottomRightY(bottomRightY: number): FaceLocationDetail {
