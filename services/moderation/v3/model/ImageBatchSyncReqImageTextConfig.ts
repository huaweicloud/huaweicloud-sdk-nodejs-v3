...
export class ImageBatchSyncReqImageTextConfig {
    private 'black_glossary_names'?: Array<string>;
    private 'white_glossary_names'?: Array<string>;
    public constructor() { 
    }
    public withBlackGlossaryNames(blackGlossaryNames: Array<string>): ImageBatchSyncReqImageTextConfig {
    ...
    public withWhiteGlossaryNames(whiteGlossaryNames: Array<string>): ImageBatchSyncReqImageTextConfig {
