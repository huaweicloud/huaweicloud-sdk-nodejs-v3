...
export class IamBpLoginProtectionDisabledDetails {
    ...
    public withUserId(userId: string): IamBpLoginProtectionDisabledDetails {
        this['user_id'] = userId;
        return this;
    }
    ...
    public withUserCreatedAt(userCreatedAt: Date): IamBpLoginProtectionDisabledDetails {
        this['user_created_at'] = userCreatedAt;
        return this;
    }
