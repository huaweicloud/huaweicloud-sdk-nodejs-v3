...
export class ShowArchiveRuleRequest {
    ...
    public withAnalyzerId(analyzerId: string): ShowArchiveRuleRequest {
        this['analyzer_id'] = analyzerId;
        return this;
    }
    ...
    public withArchiveRuleId(archiveRuleId: string): ShowArchiveRuleRequest {
        this['archive_rule_id'] = archiveRuleId;
        return this;
    }
