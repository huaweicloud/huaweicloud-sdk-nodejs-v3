...
import { ShowSubscribesRequest } from './model/ShowSubscribesRequest';
import { ShowSubscribesResponse } from './model/ShowSubscribesResponse';
...
export class FrsClient {
     ...
     * 人脸比对是将两个人脸进行比对，来判断是否为同一个人，返回比对置信度。如果传入的图片中包含多个人脸，选取最大的人脸进行比对。
     * @summary 人脸比对
     * @param {any} image1File 本地图片文件，图片不能超过8MB，建议小于1MB。上传文件时，请求格式为multipart。
     * @param {any} image2File 本地图片文件，图片不能超过8MB，建议小于1MB。上传文件时，请求格式为multipart。
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     */
     ...
     * @summary 人脸检测
     * @param {any} imageFile 本地图片文件，图片不能超过8MB，建议小于1MB。上传文件时，请求格式为multipart。
     * @param {string} [attributes] 是否返回人脸属性，希望获取的属性列表，多个属性间使用逗号（,）隔开。目前支持的属性有： • 0：人脸姿态 • 1：性别 • 2：年龄 • 3：人脸关键点 • 4：装束（帽子、眼镜） • 5：笑脸
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     */
     ...
     * @throws {RequiredError}
     */
    public showSubscribes(): Promise<ShowSubscribesResponse> {
        const options = ParamCreater().showSubscribes();
        options['responseHeaders'] = [''];
        // @ts-ignore
        return this.hcClient.sendRequest(options);
    }
...
export const ParamCreater = function () {
    return {
        ...
        addFacesByBase64(addFacesByBase64Request?: AddFacesByBase64Request) {
            const options = {
                method: "POST",
                url: "/v1/{project_id}/face-sets/{face_set_name}/faces",
        ...
        batchDeleteFaces(batchDeleteFacesRequest?: BatchDeleteFacesRequest) {
            const options = {
                method: "DELETE",
                url: "/v1/{project_id}/face-sets/{face_set_name}/faces/batch",
                contentType: "application/json",
                queryParams: {},
                pathParams: {},
                headers: {},
        ...
        compareFaceByBase64(compareFaceByBase64Request?: CompareFaceByBase64Request) {
            const options = {
                method: "POST",
                url: "/v1/{project_id}/face-compare",
                contentType: "application/json",
                queryParams: {},
                pathParams: {},
                headers: {},
        ...
        deleteFaceSet(deleteFaceSetRequest?: DeleteFaceSetRequest) {
            const options = {
                method: "DELETE",
                url: "/v1/{project_id}/face-sets/{face_set_name}",
                contentType: "application/json",
                queryParams: {},
                pathParams: {},
                headers: {},
        ...
        searchFaceByBase64(searchFaceByBase64Request?: SearchFaceByBase64Request) {
            const options = {
                method: "POST",
                url: "/v1/{project_id}/face-sets/{face_set_name}/search",
                contentType: "application/json",
                queryParams: {},
                pathParams: {},
                headers: {},
