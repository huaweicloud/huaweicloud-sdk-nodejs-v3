...
export class SearchEnvTopologyResponse extends SdkResponse {
    ...
    public withNodeList(nodeList: Array<TopoNode>): SearchEnvTopologyResponse {
    ...
    public withLineList(lineList: Array<TopoLine>): SearchEnvTopologyResponse {
    ...
    public withCollectorConfig(collectorConfig: { [key: string]: CollectorConfigModel; }): SearchEnvTopologyResponse {
    ...
    public withRealStartTime(realStartTime: number): SearchEnvTopologyResponse {
    ...
    public withRealEndTime(realEndTime: number): SearchEnvTopologyResponse {
