...
import { ListRelationBucketsRequest } from './model/ListRelationBucketsRequest';
import { ListRelationBucketsResponse } from './model/ListRelationBucketsResponse';
import { ListRelationColumnRequest } from './model/ListRelationColumnRequest';
import { ListRelationColumnResponse } from './model/ListRelationColumnResponse';
import { ListRelationDbRequest } from './model/ListRelationDbRequest';
import { ListRelationDbResponse } from './model/ListRelationDbResponse';
import { ListRelationFileRequest } from './model/ListRelationFileRequest';
import { ListRelationFileResponse } from './model/ListRelationFileResponse';
import { ListRelationTableRequest } from './model/ListRelationTableRequest';
import { ListRelationTableResponse } from './model/ListRelationTableResponse';
...
import { RelationSimpleInfo } from './model/RelationSimpleInfo';
...
export class DscClient {
     ...
     * @param {number} riskStart 起始风险等级
     * @param {number} riskEnd 终止风险等级
     * @param {string} [assetsName] 资产名称
     * @param {number} [offset] 页码
     * @param {number} [limit] 分页大小
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     */
    public listRelationBuckets(listRelationBucketsRequest?: ListRelationBucketsRequest): Promise<ListRelationBucketsResponse> {
        const options = ParamCreater().listRelationBuckets(listRelationBucketsRequest);
     ...
     * @throws {RequiredError}
     */
    public listRelationColumn(listRelationColumnRequest?: ListRelationColumnRequest): Promise<ListRelationColumnResponse> {
        const options = ParamCreater().listRelationColumn(listRelationColumnRequest);
     ...
     * @throws {RequiredError}
     */
    public listRelationDb(listRelationDbRequest?: ListRelationDbRequest): Promise<ListRelationDbResponse> {
        const options = ParamCreater().listRelationDb(listRelationDbRequest);
     ...
     * @throws {RequiredError}
     */
    public listRelationFile(listRelationFileRequest?: ListRelationFileRequest): Promise<ListRelationFileResponse> {
        const options = ParamCreater().listRelationFile(listRelationFileRequest);
     ...
     * @throws {RequiredError}
     */
    public listRelationTable(listRelationTableRequest?: ListRelationTableRequest): Promise<ListRelationTableResponse> {
        const options = ParamCreater().listRelationTable(listRelationTableRequest);
...
export const ParamCreater = function () {
    return {
         ...
         * Please refer to HUAWEI cloud API Explorer for details.
         */
        listRelationBuckets(listRelationBucketsRequest?: ListRelationBucketsRequest) {
            const options = {
                method: "GET",
                url: "/v1/{project_id}/sdg/server/relation/jobs/{job_id}/obs/buckets",
                contentType: "application/json",
                queryParams: {},
                pathParams: {},
                headers: {}
            ...
            if (listRelationBucketsRequest !== null && listRelationBucketsRequest !== undefined) {
                if (listRelationBucketsRequest instanceof ListRelationBucketsRequest) {
                    jobId = listRelationBucketsRequest.jobId;
                    riskStart = listRelationBucketsRequest.riskStart;
                    riskEnd = listRelationBucketsRequest.riskEnd;
                    assetsName = listRelationBucketsRequest.assetsName;
                    offset = listRelationBucketsRequest.offset;
                    limit = listRelationBucketsRequest.limit;
                } else {
                    jobId = listRelationBucketsRequest['job_id'];
                    riskStart = listRelationBucketsRequest['risk_start'];
                    riskEnd = listRelationBucketsRequest['risk_end'];
                    assetsName = listRelationBucketsRequest['assets_name'];
                    offset = listRelationBucketsRequest['offset'];
                    limit = listRelationBucketsRequest['limit'];
                }
            }
            ...
            throw new RequiredError('jobId','Required parameter jobId was null or undefined when calling listRelationBuckets.');
            }
            if (riskStart === null || riskStart === undefined) {
                throw new RequiredError('riskStart','Required parameter riskStart was null or undefined when calling listRelationBuckets.');
            }
            if (riskStart !== null && riskStart !== undefined) {
                localVarQueryParameter['risk_start'] = riskStart;
            }
            if (riskEnd === null || riskEnd === undefined) {
                throw new RequiredError('riskEnd','Required parameter riskEnd was null or undefined when calling listRelationBuckets.');
            }
            if (riskEnd !== null && riskEnd !== undefined) {
                localVarQueryParameter['risk_end'] = riskEnd;
            }
            if (assetsName !== null && assetsName !== undefined) {
                localVarQueryParameter['assets_name'] = assetsName;
            }
            if (offset !== null && offset !== undefined) {
                localVarQueryParameter['offset'] = offset;
            }
         ...
         * Please refer to HUAWEI cloud API Explorer for details.
         */
        listRelationColumn(listRelationColumnRequest?: ListRelationColumnRequest) {
            const options = {
                method: "GET",
                url: "/v1/{project_id}/sdg/server/relation/jobs/{job_id}/dbs/{table_id}/columns",
                contentType: "application/json",
                queryParams: {},
                pathParams: {},
                headers: {}
            ...
            if (listRelationColumnRequest !== null && listRelationColumnRequest !== undefined) {
                if (listRelationColumnRequest instanceof ListRelationColumnRequest) {
                    jobId = listRelationColumnRequest.jobId;
                    tableId = listRelationColumnRequest.tableId;
                    riskStart = listRelationColumnRequest.riskStart;
                    riskEnd = listRelationColumnRequest.riskEnd;
                    assetsName = listRelationColumnRequest.assetsName;
                    offset = listRelationColumnRequest.offset;
                    limit = listRelationColumnRequest.limit;
                } else {
                    jobId = listRelationColumnRequest['job_id'];
                    tableId = listRelationColumnRequest['table_id'];
                    riskStart = listRelationColumnRequest['risk_start'];
                    riskEnd = listRelationColumnRequest['risk_end'];
                    assetsName = listRelationColumnRequest['assets_name'];
                    offset = listRelationColumnRequest['offset'];
                    limit = listRelationColumnRequest['limit'];
                }
            }
            ...
            if (jobId === null || jobId === undefined) {
            throw new RequiredError('jobId','Required parameter jobId was null or undefined when calling listRelationColumn.');
            }
            if (tableId === null || tableId === undefined) {
            throw new RequiredError('tableId','Required parameter tableId was null or undefined when calling listRelationColumn.');
            }
            if (riskStart === null || riskStart === undefined) {
                throw new RequiredError('riskStart','Required parameter riskStart was null or undefined when calling listRelationColumn.');
            }
            if (riskStart !== null && riskStart !== undefined) {
                localVarQueryParameter['risk_start'] = riskStart;
            }
            if (riskEnd === null || riskEnd === undefined) {
                throw new RequiredError('riskEnd','Required parameter riskEnd was null or undefined when calling listRelationColumn.');
            }
            if (riskEnd !== null && riskEnd !== undefined) {
                localVarQueryParameter['risk_end'] = riskEnd;
            }
            ...
            options.queryParams = localVarQueryParameter;
            options.pathParams = { 'job_id': jobId,'table_id': tableId, };
            options.headers = localVarHeaderParameter;
            return options;
        },
         ...
         * Please refer to HUAWEI cloud API Explorer for details.
         */
        listRelationDb(listRelationDbRequest?: ListRelationDbRequest) {
            const options = {
                method: "GET",
                url: "/v1/{project_id}/sdg/server/relation/jobs/{job_id}/dbs",
                contentType: "application/json",
                queryParams: {},
                pathParams: {},
                headers: {}
            ...
            if (listRelationDbRequest !== null && listRelationDbRequest !== undefined) {
                if (listRelationDbRequest instanceof ListRelationDbRequest) {
                    jobId = listRelationDbRequest.jobId;
                    riskStart = listRelationDbRequest.riskStart;
                    riskEnd = listRelationDbRequest.riskEnd;
                    assetsName = listRelationDbRequest.assetsName;
                    offset = listRelationDbRequest.offset;
                    limit = listRelationDbRequest.limit;
                } else {
                    jobId = listRelationDbRequest['job_id'];
                    riskStart = listRelationDbRequest['risk_start'];
                    riskEnd = listRelationDbRequest['risk_end'];
                    assetsName = listRelationDbRequest['assets_name'];
                    offset = listRelationDbRequest['offset'];
                    limit = listRelationDbRequest['limit'];
                }
            }
            ...
            if (jobId === null || jobId === undefined) {
            throw new RequiredError('jobId','Required parameter jobId was null or undefined when calling listRelationDb.');
            }
            if (riskStart === null || riskStart === undefined) {
                throw new RequiredError('riskStart','Required parameter riskStart was null or undefined when calling listRelationDb.');
            }
            if (riskStart !== null && riskStart !== undefined) {
                localVarQueryParameter['risk_start'] = riskStart;
            }
            if (riskEnd === null || riskEnd === undefined) {
                throw new RequiredError('riskEnd','Required parameter riskEnd was null or undefined when calling listRelationDb.');
            }
            if (riskEnd !== null && riskEnd !== undefined) {
                localVarQueryParameter['risk_end'] = riskEnd;
            }
         ...
         * Please refer to HUAWEI cloud API Explorer for details.
         */
        listRelationFile(listRelationFileRequest?: ListRelationFileRequest) {
            const options = {
                method: "GET",
                url: "/v1/{project_id}/sdg/server/relation/jobs/{job_id}/obs/{bucket_id}/files",
                contentType: "application/json",
                queryParams: {},
                pathParams: {},
                headers: {}
            ...
            if (listRelationFileRequest !== null && listRelationFileRequest !== undefined) {
                if (listRelationFileRequest instanceof ListRelationFileRequest) {
                    jobId = listRelationFileRequest.jobId;
                    bucketId = listRelationFileRequest.bucketId;
                    riskStart = listRelationFileRequest.riskStart;
                    riskEnd = listRelationFileRequest.riskEnd;
                    offset = listRelationFileRequest.offset;
                    size = listRelationFileRequest.size;
                    assetsName = listRelationFileRequest.assetsName;
                    limit = listRelationFileRequest.limit;
                } else {
                    jobId = listRelationFileRequest['job_id'];
                    bucketId = listRelationFileRequest['bucket_id'];
                    riskStart = listRelationFileRequest['risk_start'];
                    riskEnd = listRelationFileRequest['risk_end'];
                    offset = listRelationFileRequest['offset'];
                    size = listRelationFileRequest['size'];
                    assetsName = listRelationFileRequest['assets_name'];
                    limit = listRelationFileRequest['limit'];
                }
            }
            ...
            if (jobId === null || jobId === undefined) {
            throw new RequiredError('jobId','Required parameter jobId was null or undefined when calling listRelationFile.');
            }
            if (bucketId === null || bucketId === undefined) {
            throw new RequiredError('bucketId','Required parameter bucketId was null or undefined when calling listRelationFile.');
            }
            if (riskStart === null || riskStart === undefined) {
                throw new RequiredError('riskStart','Required parameter riskStart was null or undefined when calling listRelationFile.');
            }
            if (riskStart !== null && riskStart !== undefined) {
                localVarQueryParameter['risk_start'] = riskStart;
            }
            if (riskEnd === null || riskEnd === undefined) {
                throw new RequiredError('riskEnd','Required parameter riskEnd was null or undefined when calling listRelationFile.');
            }
            if (riskEnd !== null && riskEnd !== undefined) {
                localVarQueryParameter['risk_end'] = riskEnd;
            }
            if (offset === null || offset === undefined) {
                throw new RequiredError('offset','Required parameter offset was null or undefined when calling listRelationFile.');
            }
            if (offset !== null && offset !== undefined) {
                localVarQueryParameter['offset'] = offset;
            }
            if (size === null || size === undefined) {
                throw new RequiredError('size','Required parameter size was null or undefined when calling listRelationFile.');
            }
            if (size !== null && size !== undefined) {
            ...
            options.queryParams = localVarQueryParameter;
            options.pathParams = { 'job_id': jobId,'bucket_id': bucketId, };
            options.headers = localVarHeaderParameter;
            return options;
        },
         ...
         * Please refer to HUAWEI cloud API Explorer for details.
         */
        listRelationTable(listRelationTableRequest?: ListRelationTableRequest) {
            const options = {
                method: "GET",
                url: "/v1/{project_id}/sdg/server/relation/jobs/{job_id}/dbs/{db_id}/tables",
                contentType: "application/json",
                queryParams: {},
                pathParams: {},
                headers: {}
            ...
            if (listRelationTableRequest !== null && listRelationTableRequest !== undefined) {
                if (listRelationTableRequest instanceof ListRelationTableRequest) {
                    jobId = listRelationTableRequest.jobId;
                    dbId = listRelationTableRequest.dbId;
                    riskStart = listRelationTableRequest.riskStart;
                    riskEnd = listRelationTableRequest.riskEnd;
                    offset = listRelationTableRequest.offset;
                    size = listRelationTableRequest.size;
                    assetsName = listRelationTableRequest.assetsName;
                    limit = listRelationTableRequest.limit;
                } else {
                    jobId = listRelationTableRequest['job_id'];
                    dbId = listRelationTableRequest['db_id'];
                    riskStart = listRelationTableRequest['risk_start'];
                    riskEnd = listRelationTableRequest['risk_end'];
                    offset = listRelationTableRequest['offset'];
                    size = listRelationTableRequest['size'];
                    assetsName = listRelationTableRequest['assets_name'];
                    limit = listRelationTableRequest['limit'];
                }
            }
            ...
            if (jobId === null || jobId === undefined) {
            throw new RequiredError('jobId','Required parameter jobId was null or undefined when calling listRelationTable.');
            }
            if (dbId === null || dbId === undefined) {
            throw new RequiredError('dbId','Required parameter dbId was null or undefined when calling listRelationTable.');
            }
            if (riskStart === null || riskStart === undefined) {
                throw new RequiredError('riskStart','Required parameter riskStart was null or undefined when calling listRelationTable.');
            }
            if (riskStart !== null && riskStart !== undefined) {
                localVarQueryParameter['risk_start'] = riskStart;
            }
            if (riskEnd === null || riskEnd === undefined) {
                throw new RequiredError('riskEnd','Required parameter riskEnd was null or undefined when calling listRelationTable.');
            }
            if (riskEnd !== null && riskEnd !== undefined) {
                localVarQueryParameter['risk_end'] = riskEnd;
            }
            if (offset === null || offset === undefined) {
                throw new RequiredError('offset','Required parameter offset was null or undefined when calling listRelationTable.');
            }
            if (offset !== null && offset !== undefined) {
                localVarQueryParameter['offset'] = offset;
            }
            if (size === null || size === undefined) {
                throw new RequiredError('size','Required parameter size was null or undefined when calling listRelationTable.');
            }
            if (size !== null && size !== undefined) {
                localVarQueryParameter['size'] = size;
            }
            ...
            options.queryParams = localVarQueryParameter;
            options.pathParams = { 'job_id': jobId,'db_id': dbId, };
            options.headers = localVarHeaderParameter;
            return options;
        },
