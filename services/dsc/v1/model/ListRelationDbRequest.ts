...
export class ListRelationDbRequest {
    ...
    public withJobId(jobId: string): ListRelationDbRequest {
        this['job_id'] = jobId;
        return this;
    }
    ...
    public withAssetsName(assetsName: string): ListRelationDbRequest {
    ...
    public withRiskStart(riskStart: number): ListRelationDbRequest {
        this['risk_start'] = riskStart;
        return this;
    }
    ...
    public withRiskEnd(riskEnd: number): ListRelationDbRequest {
        this['risk_end'] = riskEnd;
        return this;
    }
    ...
    public withOffset(offset: number): ListRelationDbRequest {
        this['offset'] = offset;
        return this;
    }
    public withLimit(limit: number): ListRelationDbRequest {
        this['limit'] = limit;
        return this;
    }
}