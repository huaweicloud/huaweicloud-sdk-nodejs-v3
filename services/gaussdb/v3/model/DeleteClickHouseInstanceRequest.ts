...
export class DeleteClickHouseInstanceRequest {
    ...
    public withInstanceId(instanceId: string): DeleteClickHouseInstanceRequest {
        this['instance_id'] = instanceId;
        return this;
    }
    ...
    public withClickhouseInstanceId(clickhouseInstanceId: string): DeleteClickHouseInstanceRequest {
        this['clickhouse_instance_id'] = clickhouseInstanceId;
        return this;
    }
    ...
    public withXLanguage(xLanguage: string): DeleteClickHouseInstanceRequest {
