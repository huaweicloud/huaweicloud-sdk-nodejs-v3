...
export class SetDdlLogPolicyResponse extends SdkResponse {
    ...
    public withDdlLogs(ddlLogs: Array<DdlLogInfo>): SetDdlLogPolicyResponse {
    ...
    public withTotalCount(totalCount: number): SetDdlLogPolicyResponse {
    ...
    public withKeeyDays(keeyDays: number): SetDdlLogPolicyResponse {
    ...
    public withSwitchStatus(switchStatus: string): SetDdlLogPolicyResponse {
