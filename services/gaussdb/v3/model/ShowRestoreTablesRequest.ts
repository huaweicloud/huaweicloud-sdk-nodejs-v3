...
export class ShowRestoreTablesRequest {
    ...
    public withRestoreTime(restoreTime: string): ShowRestoreTablesRequest {
        this['restore_time'] = restoreTime;
        return this;
    }
    ...
    public withLastTableInfo(lastTableInfo: string): ShowRestoreTablesRequest {
        this['last_table_info'] = lastTableInfo;
        return this;
    }
    ...
    public withDatabaseName(databaseName: string): ShowRestoreTablesRequest {
    ...
    public withTableName(tableName: string): ShowRestoreTablesRequest {
