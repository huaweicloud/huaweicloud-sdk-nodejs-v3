...
export class ShowGaussMySqlBackupPolicyResponse extends SdkResponse {
    private 'backup_policy'?: BackupPolicy;
    public constructor() { 
        super();
    }
    public withBackupPolicy(backupPolicy: BackupPolicy): ShowGaussMySqlBackupPolicyResponse {
