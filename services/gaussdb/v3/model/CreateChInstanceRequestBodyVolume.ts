...
export class CreateChInstanceRequestBodyVolume {
    ...
    public withIoType(ioType: string): CreateChInstanceRequestBodyVolume {
        this['io_type'] = ioType;
        return this;
    }
    ...
    public withCapacityInGb(capacityInGb: number): CreateChInstanceRequestBodyVolume {
        this['capacity_in_gb'] = capacityInGb;
        return this;
    }
