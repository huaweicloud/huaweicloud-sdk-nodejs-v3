...
export class GroupParameterDiffInfo {
    public name?: string;
    private 'source_value'?: string;
    private 'target_value'?: string;
    public constructor() { 
    }
    public withName(name: string): GroupParameterDiffInfo {
        this['name'] = name;
        return this;
    }
    public withSourceValue(sourceValue: string): GroupParameterDiffInfo {
    ...
    public withTargetValue(targetValue: string): GroupParameterDiffInfo {
