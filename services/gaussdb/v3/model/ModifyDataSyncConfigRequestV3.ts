...
export class ModifyDataSyncConfigRequestV3 {
    ...
    public withSourceNodeId(sourceNodeId: string): ModifyDataSyncConfigRequestV3 {
    ...
    public withSourceDatabaseName(sourceDatabaseName: string): ModifyDataSyncConfigRequestV3 {
    ...
    public withTaskName(taskName: string): ModifyDataSyncConfigRequestV3 {
    ...
    public withDbConfigs(dbConfigs: Array<DbConfig>): ModifyDataSyncConfigRequestV3 {
    ...
    public withTablesConfigs(tablesConfigs: Array<TablesConfig>): ModifyDataSyncConfigRequestV3 {
    ...
    public withTableReplConfig(tableReplConfig: TableReplConfig): ModifyDataSyncConfigRequestV3 {
    ...
    public withTargetDatabaseName(targetDatabaseName: string): ModifyDataSyncConfigRequestV3 {
