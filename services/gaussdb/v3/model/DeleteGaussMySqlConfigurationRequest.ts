...
export class DeleteGaussMySqlConfigurationRequest {
    private 'X-Language'?: string;
    private 'configuration_id'?: string;
    public constructor(configurationId?: string) { 
        this['configuration_id'] = configurationId;
    }
    public withXLanguage(xLanguage: string): DeleteGaussMySqlConfigurationRequest {
    ...
    public withConfigurationId(configurationId: string): DeleteGaussMySqlConfigurationRequest {
        this['configuration_id'] = configurationId;
        return this;
    }
