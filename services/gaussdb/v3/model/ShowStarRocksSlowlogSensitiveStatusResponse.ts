...
export class ShowStarRocksSlowlogSensitiveStatusResponse extends SdkResponse {
    private 'open_slow_log_switch'?: string;
    public constructor() { 
        super();
    }
    public withOpenSlowLogSwitch(openSlowLogSwitch: string): ShowStarRocksSlowlogSensitiveStatusResponse {
