...
export class ListStarRocksDataReplicationConfigResponse extends SdkResponse {
    ...
    public withSourceInstanceId(sourceInstanceId: string): ListStarRocksDataReplicationConfigResponse {
    ...
    public withSourceNodeId(sourceNodeId: string): ListStarRocksDataReplicationConfigResponse {
    ...
    public withDatabaseInfo(databaseInfo: DataBaseInfo): ListStarRocksDataReplicationConfigResponse {
    ...
    public withTableInfos(tableInfos: Array<TableConfigCheckResult>): ListStarRocksDataReplicationConfigResponse {
    ...
    public withTableReplConfig(tableReplConfig: TableReplConfig): ListStarRocksDataReplicationConfigResponse {
    ...
    public withNewTableReplConfig(newTableReplConfig: TableReplConfig): ListStarRocksDataReplicationConfigResponse {
    ...
    public withTargetDatabaseName(targetDatabaseName: string): ListStarRocksDataReplicationConfigResponse {
    ...
    public withIsTablesChange(isTablesChange: boolean): ListStarRocksDataReplicationConfigResponse {
    ...
    public withLastErrorOfAlterTable(lastErrorOfAlterTable: string): ListStarRocksDataReplicationConfigResponse {
