...
export class CreateChLtsConfigRequestBodyLogConfigs {
    ...
    public withInstanceId(instanceId: string): CreateChLtsConfigRequestBodyLogConfigs {
        this['instance_id'] = instanceId;
        return this;
    }
    ...
    public withLogType(logType: string): CreateChLtsConfigRequestBodyLogConfigs {
        this['log_type'] = logType;
        return this;
    }
    ...
    public withLtsGroupId(ltsGroupId: string): CreateChLtsConfigRequestBodyLogConfigs {
        this['lts_group_id'] = ltsGroupId;
        return this;
    }
    ...
    public withLtsStreamId(ltsStreamId: string): CreateChLtsConfigRequestBodyLogConfigs {
        this['lts_stream_id'] = ltsStreamId;
        return this;
    }
