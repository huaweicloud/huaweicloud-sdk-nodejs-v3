...
export class LtsConfig {
    ...
    public withLogType(logType: string): LtsConfig {
    ...
    public withLtsGroupId(ltsGroupId: string): LtsConfig {
    ...
    public withLtsStreamId(ltsStreamId: string): LtsConfig {
    ...
    public withEnabled(enabled: boolean): LtsConfig {
