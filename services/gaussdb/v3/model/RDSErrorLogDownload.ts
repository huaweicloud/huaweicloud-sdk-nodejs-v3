...
export class RDSErrorLogDownload {
    ...
    public withJobId(jobId: string): RDSErrorLogDownload {
        this['job_id'] = jobId;
        return this;
    }
    ...
    public withFileName(fileName: string): RDSErrorLogDownload {
    ...
    public withStatus(status: string): RDSErrorLogDownload {
        this['status'] = status;
        return this;
    }
    public withFileSize(fileSize: string): RDSErrorLogDownload {
    ...
    public withFileLink(fileLink: string): RDSErrorLogDownload {
    ...
    public withCreateAt(createAt: number): RDSErrorLogDownload {
    ...
    public withUpdatedAt(updatedAt: number): RDSErrorLogDownload {
