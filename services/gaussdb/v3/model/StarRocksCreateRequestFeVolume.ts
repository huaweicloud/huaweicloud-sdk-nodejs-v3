...
export class StarRocksCreateRequestFeVolume {
    ...
    public withIoType(ioType: string): StarRocksCreateRequestFeVolume {
        this['io_type'] = ioType;
        return this;
    }
    ...
    public withCapacityInGb(capacityInGb: number): StarRocksCreateRequestFeVolume {
        this['capacity_in_gb'] = capacityInGb;
        return this;
    }
