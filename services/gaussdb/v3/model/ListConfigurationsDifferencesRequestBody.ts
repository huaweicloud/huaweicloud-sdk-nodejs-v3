...
export class ListConfigurationsDifferencesRequestBody {
    ...
    public withSourceConfigurationId(sourceConfigurationId: string): ListConfigurationsDifferencesRequestBody {
        this['source_configuration_id'] = sourceConfigurationId;
        return this;
    }
    ...
    public withTargetConfigurationId(targetConfigurationId: string): ListConfigurationsDifferencesRequestBody {
        this['target_configuration_id'] = targetConfigurationId;
        return this;
    }
