...
export class PublisherVO {
    ...
    public withPublisherUniqueId(publisherUniqueId: string): PublisherVO {
    ...
    public withUserId(userId: string): PublisherVO {
        this['user_id'] = userId;
        return this;
    }
    ...
    public withTenantId(tenantId: string): PublisherVO {
    ...
    public withDescription(description: string): PublisherVO {
        this['description'] = description;
        return this;
    }
    public withLogoUrl(logoUrl: string): PublisherVO {
    ...
    public withWebsite(website: string): PublisherVO {
        this['website'] = website;
        return this;
    }
    public withSupportUrl(supportUrl: string): PublisherVO {
    ...
    public withSourceUrl(sourceUrl: string): PublisherVO {
    ...
    public withEnName(enName: string): PublisherVO {
        this['en_name'] = enName;
        return this;
    }
    ...
    public withName(name: string): PublisherVO {
        this['name'] = name;
        return this;
    }
    public withAuthStatus(authStatus: string): PublisherVO {
    ...
    public withIsDelete(isDelete: number): PublisherVO {
    ...
    public withLastUpdateUserName(lastUpdateUserName: string): PublisherVO {
    ...
    public withLastUpdateUserId(lastUpdateUserId: string): PublisherVO {
    ...
    public withLastUpdateTime(lastUpdateTime: string): PublisherVO {
