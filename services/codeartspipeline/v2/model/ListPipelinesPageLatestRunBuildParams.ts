...
export class ListPipelinesPageLatestRunBuildParams {
    ...
    public withSourceCodehubId(sourceCodehubId: string): ListPipelinesPageLatestRunBuildParams {
    ...
    public withSourceCodehubUrl(sourceCodehubUrl: string): ListPipelinesPageLatestRunBuildParams {
    ...
    public withSourceCodehubHttpUrl(sourceCodehubHttpUrl: string): ListPipelinesPageLatestRunBuildParams {
