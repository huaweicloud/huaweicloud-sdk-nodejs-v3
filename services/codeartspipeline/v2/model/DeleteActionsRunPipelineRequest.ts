...
export class DeleteActionsRunPipelineRequest {
    ...
    public withDomainId(domainId: string): DeleteActionsRunPipelineRequest {
        this['domain_id'] = domainId;
        return this;
    }
    ...
    public withPipelineId(pipelineId: string): DeleteActionsRunPipelineRequest {
        this['pipeline_id'] = pipelineId;
        return this;
    }
    ...
    public withPipelineRunId(pipelineRunId: string): DeleteActionsRunPipelineRequest {
        this['pipeline_run_id'] = pipelineRunId;
        return this;
    }
