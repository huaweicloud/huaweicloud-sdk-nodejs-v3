...
export class RunPipelineSourceParamsBuildParams {
    ...
    public withSourceCodehubId(sourceCodehubId: string): RunPipelineSourceParamsBuildParams {
    ...
    public withSourceCodehubUrl(sourceCodehubUrl: string): RunPipelineSourceParamsBuildParams {
    ...
    public withSourceCodehubHttpUrl(sourceCodehubHttpUrl: string): RunPipelineSourceParamsBuildParams {
    ...
    public withVirtualMergeBranch(virtualMergeBranch: string): RunPipelineSourceParamsBuildParams {
        this['virtual_merge_branch'] = virtualMergeBranch;
        return this;
    }
    public set virtualMergeBranch(virtualMergeBranch: string  | undefined) {
        this['virtual_merge_branch'] = virtualMergeBranch;
    }
    public get virtualMergeBranch(): string | undefined {
