...
export class ShowPipelineArtifactsRequest {
    ...
    public withPipelineId(pipelineId: string): ShowPipelineArtifactsRequest {
        this['pipeline_id'] = pipelineId;
        return this;
    }
    ...
    public withPipelineRunId(pipelineRunId: string): ShowPipelineArtifactsRequest {
        this['pipeline_run_id'] = pipelineRunId;
        return this;
    }
