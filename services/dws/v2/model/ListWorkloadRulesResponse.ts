...
export class ListWorkloadRulesResponse extends SdkResponse {
    ...
    public withWorkloadResCode(workloadResCode: number): ListWorkloadRulesResponse {
    ...
    public withWorkloadResStr(workloadResStr: string): ListWorkloadRulesResponse {
    ...
    public withItems(items: Array<ExceptRuleBo>): ListWorkloadRulesResponse {
        this['items'] = items;
        return this;
    }
    public withCount(count: number): ListWorkloadRulesResponse {
        this['count'] = count;
        return this;
    }
}