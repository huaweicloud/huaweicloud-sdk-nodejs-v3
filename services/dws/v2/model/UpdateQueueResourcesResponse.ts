...
export class UpdateQueueResourcesResponse extends SdkResponse {
    private 'workload_res_code'?: number;
    private 'workload_res_str'?: string;
    public constructor() { 
        super();
    }
    public withWorkloadResCode(workloadResCode: number): UpdateQueueResourcesResponse {
    ...
    public withWorkloadResStr(workloadResStr: string): UpdateQueueResourcesResponse {
