...
export class StopWorkloadPlanResponse extends SdkResponse {
    private 'workload_res_code'?: number;
    private 'workload_res_str'?: string;
    public constructor() { 
        super();
    }
    public withWorkloadResCode(workloadResCode: number): StopWorkloadPlanResponse {
    ...
    public withWorkloadResStr(workloadResStr: string): StopWorkloadPlanResponse {
