...
export class DeleteLogicalClusterRequest {
    ...
    public withClusterId(clusterId: string): DeleteLogicalClusterRequest {
        this['cluster_id'] = clusterId;
        return this;
    }
    ...
    public withLogicalClusterId(logicalClusterId: string): DeleteLogicalClusterRequest {
        this['logical_cluster_id'] = logicalClusterId;
        return this;
    }
