...
export class RestoreTableRequestBody {
    ...
    public withCaseSensitive(caseSensitive: boolean): RestoreTableRequestBody {
        this['case_sensitive'] = caseSensitive;
        return this;
    }
    ...
    public withDatabase(database: string): RestoreTableRequestBody {
        this['database'] = database;
        return this;
    }
    public withRestoreTableList(restoreTableList: Array<TableDetail>): RestoreTableRequestBody {
        this['restore_table_list'] = restoreTableList;
        return this;
    }
    ...
    public withTargetTableList(targetTableList: Array<TableDetail>): RestoreTableRequestBody {
        this['target_table_list'] = targetTableList;
        return this;
    }
