...
import { ExtFineGrainedSnapshotDetail } from './ExtFineGrainedSnapshotDetail';
...
export class Snapshots {
    ...
    public withDatastore(datastore: Datastore): Snapshots {
        this['datastore'] = datastore;
        return this;
    }
    public withClusterName(clusterName: string): Snapshots {
    ...
    public withUpdated(updated: string): Snapshots {
        this['updated'] = updated;
        return this;
    }
    public withBakExpectedStartTime(bakExpectedStartTime: string): Snapshots {
    ...
    public withBakKeepDay(bakKeepDay: number): Snapshots {
    ...
    public withBakPeriod(bakPeriod: string): Snapshots {
    ...
    public withDbUser(dbUser: string): Snapshots {
        this['db_user'] = dbUser;
        return this;
    }
    ...
    public withProgress(progress: string): Snapshots {
    ...
    public withBaseBackupKey(baseBackupKey: string): Snapshots {
    ...
    public withBackupDevice(backupDevice: string): Snapshots {
    ...
    public withTotalBackupSize(totalBackupSize: number): Snapshots {
    ...
    public withBaseBackupName(baseBackupName: string): Snapshots {
    ...
    public withSupportInplaceRestore(supportInplaceRestore: boolean): Snapshots {
    ...
    public withFineGrainedBackup(fineGrainedBackup: boolean): Snapshots {
    ...
    public set fineGrainedBackupDetail(fineGrainedBackupDetail: ExtFineGrainedSnapshotDetail  | undefined) {
        this['fine_grained_backup_detail'] = fineGrainedBackupDetail;
    }
    public get fineGrainedBackupDetail(): ExtFineGrainedSnapshotDetail | undefined {
        return this['fine_grained_backup_detail'];
    }
    public withGuestAgentVersion(guestAgentVersion: string): Snapshots {
    ...
    public withClusterStatus(clusterStatus: string): Snapshots {
    ...
    public withClusterTaskStatus(clusterTaskStatus: string): Snapshots {
    ...
    public withSupportFineGrainedCrossVersionRestore(supportFineGrainedCrossVersionRestore: boolean): Snapshots {
    ...
    public withSupportFineGrainedAsymmetricRestore(supportFineGrainedAsymmetricRestore: boolean): Snapshots {
