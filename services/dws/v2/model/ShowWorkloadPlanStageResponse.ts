...
export class ShowWorkloadPlanStageResponse extends SdkResponse {
    ...
    public withWorkloadResCode(workloadResCode: number): ShowWorkloadPlanStageResponse {
    ...
    public withWorkloadResStr(workloadResStr: string): ShowWorkloadPlanStageResponse {
    ...
    public withWorkloadPlanStage(workloadPlanStage: PlanStage): ShowWorkloadPlanStageResponse {
