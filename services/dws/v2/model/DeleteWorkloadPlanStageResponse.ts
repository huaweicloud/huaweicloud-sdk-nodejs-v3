...
export class DeleteWorkloadPlanStageResponse extends SdkResponse {
    private 'workload_res_code'?: number;
    private 'workload_res_str'?: string;
    public constructor() { 
        super();
    }
    public withWorkloadResCode(workloadResCode: number): DeleteWorkloadPlanStageResponse {
    ...
    public withWorkloadResStr(workloadResStr: string): DeleteWorkloadPlanStageResponse {
