...
export class UpdateQueueBaseInfoResponse extends SdkResponse {
    private 'workload_res_code'?: number;
    private 'workload_res_str'?: string;
    public constructor() { 
        super();
    }
    public withWorkloadResCode(workloadResCode: number): UpdateQueueBaseInfoResponse {
    ...
    public withWorkloadResStr(workloadResStr: string): UpdateQueueBaseInfoResponse {
