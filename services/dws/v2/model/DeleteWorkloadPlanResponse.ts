...
export class DeleteWorkloadPlanResponse extends SdkResponse {
    private 'workload_res_code'?: number;
    private 'workload_res_str'?: string;
    public constructor() { 
        super();
    }
    public withWorkloadResCode(workloadResCode: number): DeleteWorkloadPlanResponse {
    ...
    public withWorkloadResStr(workloadResStr: string): DeleteWorkloadPlanResponse {
