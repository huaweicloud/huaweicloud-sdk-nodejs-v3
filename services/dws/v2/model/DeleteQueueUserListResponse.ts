...
export class DeleteQueueUserListResponse extends SdkResponse {
    private 'workload_res_code'?: number;
    private 'workload_res_str'?: string;
    public constructor() { 
        super();
    }
    public withWorkloadResCode(workloadResCode: number): DeleteQueueUserListResponse {
    ...
    public withWorkloadResStr(workloadResStr: string): DeleteQueueUserListResponse {
