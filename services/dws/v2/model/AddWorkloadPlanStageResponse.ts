...
export class AddWorkloadPlanStageResponse extends SdkResponse {
    private 'workload_res_code'?: number;
    private 'workload_res_str'?: string;
    public constructor() { 
        super();
    }
    public withWorkloadResCode(workloadResCode: number): AddWorkloadPlanStageResponse {
    ...
    public withWorkloadResStr(workloadResStr: string): AddWorkloadPlanStageResponse {
