...
export class SwitchPlanStageResponse extends SdkResponse {
    private 'workload_res_code'?: number;
    private 'workload_res_str'?: string;
    public constructor() { 
        super();
    }
    public withWorkloadResCode(workloadResCode: number): SwitchPlanStageResponse {
    ...
    public withWorkloadResStr(workloadResStr: string): SwitchPlanStageResponse {
