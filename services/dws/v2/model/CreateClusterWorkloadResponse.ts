...
export class CreateClusterWorkloadResponse extends SdkResponse {
    private 'workload_res_code'?: number | undefined;
    private 'workload_res_str'?: string | undefined;
    public constructor() { 
        super();
    }
    public withWorkloadResCode(workloadResCode: number): CreateClusterWorkloadResponse {
    ...
    public withWorkloadResStr(workloadResStr: string): CreateClusterWorkloadResponse {
