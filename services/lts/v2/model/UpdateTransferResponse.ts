...
export class UpdateTransferResponse extends SdkResponse {
    ...
    public withLogGroupId(logGroupId: string): UpdateTransferResponse {
    ...
    public withLogGroupName(logGroupName: string): UpdateTransferResponse {
    ...
    public withLogStreams(logStreams: Array<CreateTransferResponseBodyLogStreams>): UpdateTransferResponse {
    ...
    public withLogTransferId(logTransferId: string): UpdateTransferResponse {
    ...
    public withLogTransferInfo(logTransferInfo: CreateTransferResponseBodyLogTransferInfo): UpdateTransferResponse {
