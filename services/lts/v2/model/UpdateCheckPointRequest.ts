import { ConsumerShardCheckpointInfo } from './ConsumerShardCheckpointInfo';


export class UpdateCheckPointRequest {
    private 'group_id'?: string;
    private 'stream_id'?: string;
    private 'consumer_group_name'?: string;
    private 'consumer_name'?: string;
    private 'Content-Type'?: string;
    public body?: Array<ConsumerShardCheckpointInfo>;
    ...
    public withGroupId(groupId: string): UpdateCheckPointRequest {
        this['group_id'] = groupId;
        return this;
    }
    ...
    public withStreamId(streamId: string): UpdateCheckPointRequest {
        this['stream_id'] = streamId;
        return this;
    }
    ...
    public withConsumerGroupName(consumerGroupName: string): UpdateCheckPointRequest {
        this['consumer_group_name'] = consumerGroupName;
        return this;
    }
    ...
    public withConsumerName(consumerName: string): UpdateCheckPointRequest {
        this['consumer_name'] = consumerName;
        return this;
    }
    ...
    public withContentType(contentType: string): UpdateCheckPointRequest {
        this['Content-Type'] = contentType;
        return this;
    }
    ...
    public withBody(body: Array<ConsumerShardCheckpointInfo>): UpdateCheckPointRequest {
        this['body'] = body;
        return this;
    }
}