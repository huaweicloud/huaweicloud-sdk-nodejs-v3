...
export class ShowMemberGroupAndStreamRequest {
    ...
    public withMemberAccountId(memberAccountId: string): ShowMemberGroupAndStreamRequest {
        this['member_account_id'] = memberAccountId;
        return this;
    }
    ...
    public withContentType(contentType: string): ShowMemberGroupAndStreamRequest {
        this['Content-Type'] = contentType;
        return this;
    }
