...
export class UpdateAccessConfigResponse extends SdkResponse {
    ...
    public withLogSplitSize(logSplitSize: number): UpdateAccessConfigResponse {
    ...
    public withRecursiveDepth(recursiveDepth: number): UpdateAccessConfigResponse {
    ...
    public withAccessConfigTypeSource(accessConfigTypeSource: string): UpdateAccessConfigResponse {
