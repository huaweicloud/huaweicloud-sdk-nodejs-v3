...
export class CreateAccessConfigResponse extends SdkResponse {
    ...
    public withAccessConfigType(accessConfigType: CreateAccessConfigResponseAccessConfigTypeEnum): CreateAccessConfigResponse {
        this['access_config_type'] = accessConfigType;
        return this;
    }
    public set accessConfigType(accessConfigType: CreateAccessConfigResponseAccessConfigTypeEnum | undefined) {
        this['access_config_type'] = accessConfigType;
    }
