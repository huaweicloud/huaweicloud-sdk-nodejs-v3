...
export class ShowDatasetStatisticsRequest {
    ...
    public withLeagueId(leagueId: string): ShowDatasetStatisticsRequest {
        this['league_id'] = leagueId;
        return this;
    }
    ...
    public withStartDate(startDate: string): ShowDatasetStatisticsRequest {
    ...
    public withEndDate(endDate: string): ShowDatasetStatisticsRequest {
