...
export class ListSqlJobRequest {
    ...
    public withLeagueId(leagueId: string): ListSqlJobRequest {
        this['league_id'] = leagueId;
        return this;
    }
    ...
    public withLimit(limit: number): ListSqlJobRequest {
        this['limit'] = limit;
        return this;
    }
    public withOffset(offset: number): ListSqlJobRequest {
        this['offset'] = offset;
        return this;
    }
}