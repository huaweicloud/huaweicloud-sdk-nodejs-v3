...
export class ListFlJobRequest {
    ...
    public withLeagueId(leagueId: string): ListFlJobRequest {
        this['league_id'] = leagueId;
        return this;
    }
    ...
    public withLimit(limit: number): ListFlJobRequest {
        this['limit'] = limit;
        return this;
    }
    public withOffset(offset: number): ListFlJobRequest {
        this['offset'] = offset;
        return this;
    }
}