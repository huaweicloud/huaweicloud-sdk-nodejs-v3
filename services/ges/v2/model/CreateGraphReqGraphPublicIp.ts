...
export class CreateGraphReqGraphPublicIp {
    private 'public_bind_type'?: string | undefined;
    private 'eip_id'?: string | undefined;
    public constructor() { 
    }
    public withPublicBindType(publicBindType: string): CreateGraphReqGraphPublicIp {
    ...
    public withEipId(eipId: string): CreateGraphReqGraphPublicIp {
        this['eip_id'] = eipId;
        return this;
    }
