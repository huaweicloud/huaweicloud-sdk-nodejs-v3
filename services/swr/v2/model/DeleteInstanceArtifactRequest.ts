...
export class DeleteInstanceArtifactRequest {
    ...
    public withInstanceId(instanceId: string): DeleteInstanceArtifactRequest {
        this['instance_id'] = instanceId;
        return this;
    }
    ...
    public withNamespaceName(namespaceName: string): DeleteInstanceArtifactRequest {
        this['namespace_name'] = namespaceName;
        return this;
    }
    ...
    public withRepositoryName(repositoryName: string): DeleteInstanceArtifactRequest {
        this['repository_name'] = repositoryName;
        return this;
    }
    ...
    public withReference(reference: string): DeleteInstanceArtifactRequest {
        this['reference'] = reference;
        return this;
    }
}