...
export class ShowInstanceRegistryRequest {
    ...
    public withInstanceId(instanceId: string): ShowInstanceRegistryRequest {
        this['instance_id'] = instanceId;
        return this;
    }
    ...
    public withRegistryId(registryId: number): ShowInstanceRegistryRequest {
        this['registry_id'] = registryId;
        return this;
    }
