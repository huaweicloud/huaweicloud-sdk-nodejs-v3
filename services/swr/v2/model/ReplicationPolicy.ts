...
export class ReplicationPolicy {
    ...
    public withId(id: number): ReplicationPolicy {
        this['id'] = id;
        return this;
    }
    public withName(name: string): ReplicationPolicy {
        this['name'] = name;
        return this;
    }
    public withDescription(description: string): ReplicationPolicy {
        this['description'] = description;
        return this;
    }
    public withSrcRegistry(srcRegistry: ReplicationRegistry): ReplicationPolicy {
    ...
    public withDestRegistry(destRegistry: ReplicationRegistry): ReplicationPolicy {
    ...
    public withDestNamespace(destNamespace: string): ReplicationPolicy {
    ...
    public withFilters(filters: Array<Filter>): ReplicationPolicy {
        this['filters'] = filters;
        return this;
    }
    public withRepoScopeMode(repoScopeMode: string): ReplicationPolicy {
    ...
    public withTrigger(trigger: TriggerConfig): ReplicationPolicy {
        this['trigger'] = trigger;
        return this;
    }
    public withOverride(override: boolean): ReplicationPolicy {
        this['override'] = override;
        return this;
    }
    public withEnabled(enabled: boolean): ReplicationPolicy {
        this['enabled'] = enabled;
        return this;
    }
    public withCreatedAt(createdAt: string): ReplicationPolicy {
    ...
    public withUpdatedAt(updatedAt: string): ReplicationPolicy {
