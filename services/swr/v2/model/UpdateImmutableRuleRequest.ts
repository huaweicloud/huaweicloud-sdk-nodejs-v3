import { UpdateImmutableRuleBody } from './UpdateImmutableRuleBody';


export class UpdateImmutableRuleRequest {
    private 'instance_id'?: string;
    private 'namespace_name'?: string;
    private 'immutable_rule_id'?: number;
    public body?: UpdateImmutableRuleBody;
    ...
    public withInstanceId(instanceId: string): UpdateImmutableRuleRequest {
        this['instance_id'] = instanceId;
        return this;
    }
    ...
    public withNamespaceName(namespaceName: string): UpdateImmutableRuleRequest {
        this['namespace_name'] = namespaceName;
        return this;
    }
    ...
    public withImmutableRuleId(immutableRuleId: number): UpdateImmutableRuleRequest {
        this['immutable_rule_id'] = immutableRuleId;
        return this;
    }
    ...
    public withBody(body: UpdateImmutableRuleBody): UpdateImmutableRuleRequest {
        this['body'] = body;
        return this;
    }
}