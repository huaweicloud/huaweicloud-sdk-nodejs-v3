...
export class ShowInstanceRepositoryRequest {
    ...
    public withInstanceId(instanceId: string): ShowInstanceRepositoryRequest {
        this['instance_id'] = instanceId;
        return this;
    }
    ...
    public withNamespaceName(namespaceName: string): ShowInstanceRepositoryRequest {
        this['namespace_name'] = namespaceName;
        return this;
    }
    ...
    public withRepositoryName(repositoryName: string): ShowInstanceRepositoryRequest {
        this['repository_name'] = repositoryName;
        return this;
    }
