...
export class StartManualScanningRequest {
    ...
    public withInstanceId(instanceId: string): StartManualScanningRequest {
        this['instance_id'] = instanceId;
        return this;
    }
    ...
    public withNamespaceName(namespaceName: string): StartManualScanningRequest {
        this['namespace_name'] = namespaceName;
        return this;
    }
    ...
    public withRepositoryName(repositoryName: string): StartManualScanningRequest {
        this['repository_name'] = repositoryName;
        return this;
    }
    ...
    public withReference(reference: string): StartManualScanningRequest {
        this['reference'] = reference;
        return this;
    }
}