...
export class ShowInstanceSignPolicyRequest {
    ...
    public withInstanceId(instanceId: string): ShowInstanceSignPolicyRequest {
        this['instance_id'] = instanceId;
        return this;
    }
    ...
    public withNamespaceName(namespaceName: string): ShowInstanceSignPolicyRequest {
        this['namespace_name'] = namespaceName;
        return this;
    }
    ...
    public withPolicyId(policyId: number): ShowInstanceSignPolicyRequest {
        this['policy_id'] = policyId;
        return this;
    }
