...
export class ShowInstanceRepositoryResponse extends SdkResponse {
    public id?: number;
    public name?: string;
    ...
    public withId(id: number): ShowInstanceRepositoryResponse {
        this['id'] = id;
        return this;
    }
    public withName(name: string): ShowInstanceRepositoryResponse {
        this['name'] = name;
        return this;
    }
    public withNamespaceName(namespaceName: string): ShowInstanceRepositoryResponse {
    ...
    public withNamespaceId(namespaceId: number): ShowInstanceRepositoryResponse {
    ...
    public withTagCount(tagCount: number): ShowInstanceRepositoryResponse {
    ...
    public withPullCount(pullCount: number): ShowInstanceRepositoryResponse {
    ...
    public withArtifactCount(artifactCount: number): ShowInstanceRepositoryResponse {
    ...
    public withDescription(description: string): ShowInstanceRepositoryResponse {
        this['description'] = description;
        return this;
    }
    public withCreatedAt(createdAt: string): ShowInstanceRepositoryResponse {
    ...
    public withUpdatedAt(updatedAt: string): ShowInstanceRepositoryResponse {
