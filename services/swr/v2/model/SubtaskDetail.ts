...
export class SubtaskDetail {
    ...
    public constructor(id?: number, jobId?: string, namespace?: string, repository?: string, tag?: string, digest?: string, status?: string, statusText?: string, startTime?: string, endTime?: string) { 
        this['id'] = id;
        this['job_id'] = jobId;
    ...
    public withJobId(jobId: string): SubtaskDetail {
        this['job_id'] = jobId;
        return this;
    }
