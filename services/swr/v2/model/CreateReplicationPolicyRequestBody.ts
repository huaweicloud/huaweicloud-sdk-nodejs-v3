...
export class CreateReplicationPolicyRequestBody {
    public name?: string;
    ...
    public withName(name: string): CreateReplicationPolicyRequestBody {
        this['name'] = name;
        return this;
    }
    public withDescription(description: string): CreateReplicationPolicyRequestBody {
        this['description'] = description;
        return this;
    }
    public withSrcRegistry(srcRegistry: ReplicationRegistry): CreateReplicationPolicyRequestBody {
    ...
    public withDestRegistry(destRegistry: ReplicationRegistry): CreateReplicationPolicyRequestBody {
    ...
    public withDestNamespace(destNamespace: string): CreateReplicationPolicyRequestBody {
    ...
    public withFilters(filters: Array<Filter>): CreateReplicationPolicyRequestBody {
        this['filters'] = filters;
        return this;
    }
    public withRepoScopeMode(repoScopeMode: string): CreateReplicationPolicyRequestBody {
        this['repo_scope_mode'] = repoScopeMode;
        return this;
    }
    ...
    public withTrigger(trigger: TriggerConfig): CreateReplicationPolicyRequestBody {
        this['trigger'] = trigger;
        return this;
    }
    public withOverride(override: boolean): CreateReplicationPolicyRequestBody {
        this['override'] = override;
        return this;
    }
    public withEnabled(enabled: boolean): CreateReplicationPolicyRequestBody {
        this['enabled'] = enabled;
        return this;
    }
}