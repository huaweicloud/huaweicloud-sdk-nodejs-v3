...
export class ListOperationRequest {
    private 'account_id'?: string;
    private 'organizational_unit_id'?: string;
    public constructor() { 
    }
    public withAccountId(accountId: string): ListOperationRequest {
    ...
    public withOrganizationalUnitId(organizationalUnitId: string): ListOperationRequest {
