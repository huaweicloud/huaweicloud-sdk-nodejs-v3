...
export class OrganizationalPercentageDetail {
    private 'percentage_name'?: string;
    private 'percentage_status'?: string;
    public constructor() { 
    }
    public withPercentageName(percentageName: string): OrganizationalPercentageDetail {
    ...
    public withPercentageStatus(percentageStatus: string): OrganizationalPercentageDetail {
