...
export class ListOperationResponse extends SdkResponse {
    ...
    public withOperationId(operationId: string): ListOperationResponse {
    ...
    public withPercentageComplete(percentageComplete: number): ListOperationResponse {
    ...
    public withStatus(status: string): ListOperationResponse {
        this['status'] = status;
        return this;
    }
    public withPercentageDetails(percentageDetails: Array<OrganizationalPercentageDetail>): ListOperationResponse {
    ...
    public withMessage(message: string): ListOperationResponse {
