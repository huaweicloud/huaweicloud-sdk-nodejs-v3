...
export class ManagedAccount {
    ...
    public withLandingZoneVersion(landingZoneVersion: string): ManagedAccount {
    ...
    public withManageAccountId(manageAccountId: string): ManagedAccount {
    ...
    public withAccountId(accountId: string): ManagedAccount {
    ...
    public withAccountName(accountName: string): ManagedAccount {
    ...
    public withAccountType(accountType: string): ManagedAccount {
    ...
    public withOwner(owner: string): ManagedAccount {
        this['owner'] = owner;
        return this;
    }
    public withState(state: string): ManagedAccount {
        this['state'] = state;
        return this;
    }
    public withMessage(message: string): ManagedAccount {
        this['message'] = message;
        return this;
    }
    public withParentOrganizationalUnitId(parentOrganizationalUnitId: string): ManagedAccount {
    ...
    public withParentOrganizationalUnitName(parentOrganizationalUnitName: string): ManagedAccount {
    ...
    public withIdentityStoreUserName(identityStoreUserName: string): ManagedAccount {
    ...
    public withBlueprintProductId(blueprintProductId: string): ManagedAccount {
    ...
    public withBlueprintProductVersion(blueprintProductVersion: string): ManagedAccount {
    ...
    public withBlueprintStatus(blueprintStatus: string): ManagedAccount {
    ...
    public withIsBlueprintHasMultiAccountResource(isBlueprintHasMultiAccountResource: boolean): ManagedAccount {
    ...
    public withRegions(regions: Array<RegionManagedList>): ManagedAccount {
        this['regions'] = regions;
        return this;
    }
    public withCreatedAt(createdAt: Date): ManagedAccount {
    ...
    public withUpdatedAt(updatedAt: Date): ManagedAccount {
