...
export class ListControlsForOrganizationalUnitResponse extends SdkResponse {
    private 'control_summaries'?: Array<TargetControl>;
    private 'page_info'?: PageInfoDto;
    public constructor() { 
        super();
    }
    public withControlSummaries(controlSummaries: Array<TargetControl>): ListControlsForOrganizationalUnitResponse {
    ...
    public withPageInfo(pageInfo: PageInfoDto): ListControlsForOrganizationalUnitResponse {
