...
export class ShowManagedOrganizationalUnitRequest {
    ...
    public withManagedOrganizationalUnitId(managedOrganizationalUnitId: string): ShowManagedOrganizationalUnitRequest {
        this['managed_organizational_unit_id'] = managedOrganizationalUnitId;
        return this;
    }
