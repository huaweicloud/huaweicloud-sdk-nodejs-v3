...
export class ManagedOrganizationalUnit {
    ...
    public withManageAccountId(manageAccountId: string): ManagedOrganizationalUnit {
    ...
    public withOrganizationalUnitId(organizationalUnitId: string): ManagedOrganizationalUnit {
    ...
    public withOrganizationalUnitName(organizationalUnitName: string): ManagedOrganizationalUnit {
    ...
    public withOrganizationalUnitStatus(organizationalUnitStatus: string): ManagedOrganizationalUnit {
    ...
    public withOrganizationalUnitType(organizationalUnitType: OrganizationalUnitType): ManagedOrganizationalUnit {
    ...
    public withParentOrganizationalUnitId(parentOrganizationalUnitId: string): ManagedOrganizationalUnit {
    ...
    public withParentOrganizationalUnitName(parentOrganizationalUnitName: string): ManagedOrganizationalUnit {
    ...
    public withCreatedAt(createdAt: Date): ManagedOrganizationalUnit {
    ...
    public withLandingZoneVersion(landingZoneVersion: string): ManagedOrganizationalUnit {
    ...
    public withUpdatedAt(updatedAt: Date): ManagedOrganizationalUnit {
    ...
    public withMessage(message: string): ManagedOrganizationalUnit {
