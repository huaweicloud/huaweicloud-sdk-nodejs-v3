...
export class RegisterOrganizationalUnitResponse extends SdkResponse {
    private 'organizational_unit_operation_id'?: string;
    public constructor() { 
        super();
    }
    public withOrganizationalUnitOperationId(organizationalUnitOperationId: string): RegisterOrganizationalUnitResponse {
