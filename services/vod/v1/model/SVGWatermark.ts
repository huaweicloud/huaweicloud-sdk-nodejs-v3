...
export class SVGWatermark {
    ...
    public withDx(dx: string): SVGWatermark {
        this['dx'] = dx;
        return this;
    }
    public withDy(dy: string): SVGWatermark {
        this['dy'] = dy;
        return this;
    }
    public withReferpos(referpos: string): SVGWatermark {
        this['referpos'] = referpos;
        return this;
    }
    public withTimelineStart(timelineStart: string): SVGWatermark {
    ...
    public withTimelineDuration(timelineDuration: string): SVGWatermark {
    ...
    public withRandomTimeMin(randomTimeMin: number): SVGWatermark {
    ...
    public withRandomTimeMax(randomTimeMax: number): SVGWatermark {
    ...
    public withWidth(width: string): SVGWatermark {
        this['width'] = width;
        return this;
    }
    public withHeight(height: string): SVGWatermark {
        this['height'] = height;
        return this;
    }
}