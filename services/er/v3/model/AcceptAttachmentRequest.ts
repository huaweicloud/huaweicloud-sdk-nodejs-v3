...
export class AcceptAttachmentRequest {
    ...
    public withErId(erId: string): AcceptAttachmentRequest {
        this['er_id'] = erId;
        return this;
    }
    ...
    public withAttachmentId(attachmentId: string): AcceptAttachmentRequest {
        this['attachment_id'] = attachmentId;
        return this;
    }
