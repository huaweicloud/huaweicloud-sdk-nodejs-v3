...
export class ShowVirtualGatewayResponse extends SdkResponse {
    private 'virtual_gateway'?: VirtualGateway;
    private 'request_id'?: string;
    public constructor() { 
        super();
    }
    public withVirtualGateway(virtualGateway: VirtualGateway): ShowVirtualGatewayResponse {
    ...
    public withRequestId(requestId: string): ShowVirtualGatewayResponse {
