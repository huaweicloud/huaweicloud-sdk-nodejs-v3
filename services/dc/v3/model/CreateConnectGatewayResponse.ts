...
export class CreateConnectGatewayResponse extends SdkResponse {
    private 'request_id'?: string;
    private 'connect_gateway'?: ConnectGatewayResponse;
    public constructor() { 
        super();
    }
    public withRequestId(requestId: string): CreateConnectGatewayResponse {
    ...
    public withConnectGateway(connectGateway: ConnectGatewayResponse): CreateConnectGatewayResponse {
