...
export class ExternalCreateGlobalDcGateway {
    public id?: string;
    ...
    public withId(id: string): ExternalCreateGlobalDcGateway {
        this['id'] = id;
        return this;
    }
    public withTenantId(tenantId: string): ExternalCreateGlobalDcGateway {
    ...
    public withName(name: string): ExternalCreateGlobalDcGateway {
        this['name'] = name;
        return this;
    }
    public withDescription(description: string): ExternalCreateGlobalDcGateway {
        this['description'] = description;
        return this;
    }
    public withEnterpriseProjectId(enterpriseProjectId: string): ExternalCreateGlobalDcGateway {
    ...
    public withAddressFamily(addressFamily: string): ExternalCreateGlobalDcGateway {
    ...
    public withGlobalCenterNetworkId(globalCenterNetworkId: string): ExternalCreateGlobalDcGateway {
    ...
    public withSiteNetworkId(siteNetworkId: string): ExternalCreateGlobalDcGateway {
    ...
    public withCloudConnectionId(cloudConnectionId: string): ExternalCreateGlobalDcGateway {
    ...
    public withBgpAsn(bgpAsn: number): ExternalCreateGlobalDcGateway {
        this['bgp_asn'] = bgpAsn;
        return this;
    }
    ...
    public withRegionId(regionId: string): ExternalCreateGlobalDcGateway {
    ...
    public withLocationName(locationName: string): ExternalCreateGlobalDcGateway {
    ...
    public withCurrentPeerLinkCount(currentPeerLinkCount: number): ExternalCreateGlobalDcGateway {
    ...
    public withAvailablePeerLinkCount(availablePeerLinkCount: number): ExternalCreateGlobalDcGateway {
    ...
    public withAdminStateUp(adminStateUp: boolean): ExternalCreateGlobalDcGateway {
    ...
    public withStatus(status: string): ExternalCreateGlobalDcGateway {
        this['status'] = status;
        return this;
    }
    public withCreatedTime(createdTime: Date): ExternalCreateGlobalDcGateway {
    ...
    public withUpdatedTime(updatedTime: Date): ExternalCreateGlobalDcGateway {
