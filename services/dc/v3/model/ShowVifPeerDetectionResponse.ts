...
export class ShowVifPeerDetectionResponse extends SdkResponse {
    private 'request_id'?: string;
    private 'vif_peer_detection'?: VifPeerDetection;
    public constructor() { 
        super();
    }
    public withRequestId(requestId: string): ShowVifPeerDetectionResponse {
    ...
    public withVifPeerDetection(vifPeerDetection: VifPeerDetection): ShowVifPeerDetectionResponse {
