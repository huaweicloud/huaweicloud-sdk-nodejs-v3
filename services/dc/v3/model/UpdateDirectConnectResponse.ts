...
export class UpdateDirectConnectResponse extends SdkResponse {
    private 'request_id'?: string;
    private 'direct_connect'?: DirectConnect;
    public constructor() { 
        super();
    }
    public withRequestId(requestId: string): UpdateDirectConnectResponse {
    ...
    public withDirectConnect(directConnect: DirectConnect): UpdateDirectConnectResponse {
