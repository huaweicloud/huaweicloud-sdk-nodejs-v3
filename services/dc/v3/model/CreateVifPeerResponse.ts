...
export class CreateVifPeerResponse extends SdkResponse {
    private 'request_id'?: string;
    private 'vif_peer'?: VifPeer;
    public constructor() { 
        super();
    }
    public withRequestId(requestId: string): CreateVifPeerResponse {
    ...
    public withVifPeer(vifPeer: VifPeer): CreateVifPeerResponse {
