...
export class CreateVirtualGatewayResponse extends SdkResponse {
    private 'virtual_gateway'?: VirtualGateway;
    private 'request_id'?: string;
    public constructor() { 
        super();
    }
    public withVirtualGateway(virtualGateway: VirtualGateway): CreateVirtualGatewayResponse {
    ...
    public withRequestId(requestId: string): CreateVirtualGatewayResponse {
