...
export class ShowVirtualInterfaceResponse extends SdkResponse {
    private 'request_id'?: string;
    private 'virtual_interface'?: VirtualInterface;
    public constructor() { 
        super();
    }
    public withRequestId(requestId: string): ShowVirtualInterfaceResponse {
    ...
    public withVirtualInterface(virtualInterface: VirtualInterface): ShowVirtualInterfaceResponse {
