...
export class HotfixRollbackInfos {
    ...
    public withVersion(version: string): HotfixRollbackInfos {
        this['version'] = version;
        return this;
    }
    public withCommonPatch(commonPatch: string): HotfixRollbackInfos {
    ...
    public withBackupSensitive(backupSensitive: boolean): HotfixRollbackInfos {
    ...
    public withDescripition(descripition: string): HotfixRollbackInfos {
