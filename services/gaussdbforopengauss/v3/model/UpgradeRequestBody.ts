...
export class UpgradeRequestBody {
    ...
    public withUpgradeType(upgradeType: string): UpgradeRequestBody {
        this['upgrade_type'] = upgradeType;
        return this;
    }
    ...
    public withUpgradeAction(upgradeAction: string): UpgradeRequestBody {
    ...
    public withTargetVersion(targetVersion: string): UpgradeRequestBody {
    ...
    public withUpgradeShardNum(upgradeShardNum: number): UpgradeRequestBody {
    ...
    public withUpgradeAz(upgradeAz: string): UpgradeRequestBody {
