...
export class ListDatabaseVolumeResponse extends SdkResponse {
    private 'database_volumes'?: Array<DatabaseVolumeResult>;
    private 'total_count'?: number;
    public constructor() { 
        super();
    }
    public withDatabaseVolumes(databaseVolumes: Array<DatabaseVolumeResult>): ListDatabaseVolumeResponse {
    ...
    public withTotalCount(totalCount: number): ListDatabaseVolumeResponse {
