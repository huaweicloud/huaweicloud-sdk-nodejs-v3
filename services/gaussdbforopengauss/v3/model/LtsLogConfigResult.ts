...
export class LtsLogConfigResult {
    ...
    public withLogType(logType: string): LtsLogConfigResult {
    ...
    public withLtsGroupId(ltsGroupId: string): LtsLogConfigResult {
    ...
    public withLtsStreamId(ltsStreamId: string): LtsLogConfigResult {
    ...
    public withEnabled(enabled: boolean): LtsLogConfigResult {
