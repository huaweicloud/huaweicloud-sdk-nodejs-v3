...
export class ShowDcPointRequest {
    ...
    public withEdgeNodeId(edgeNodeId: string): ShowDcPointRequest {
        this['edge_node_id'] = edgeNodeId;
        return this;
    }
    ...
    public withDsId(dsId: string): ShowDcPointRequest {
        this['ds_id'] = dsId;
        return this;
    }
    ...
    public withPointId(pointId: string): ShowDcPointRequest {
        this['point_id'] = pointId;
        return this;
    }
    ...
    public withDeviceId(deviceId: string): ShowDcPointRequest {
    ...
    public withProperty(property: string): ShowDcPointRequest {
