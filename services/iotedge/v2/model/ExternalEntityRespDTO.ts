...
export class ExternalEntityRespDTO {
    ...
    public withNodeId(nodeId: string): ExternalEntityRespDTO {
        this['node_id'] = nodeId;
        return this;
    }
    ...
    public withSpaceId(spaceId: string): ExternalEntityRespDTO {
    ...
    public withExternalId(externalId: string): ExternalEntityRespDTO {
    ...
    public withProtocol(protocol: string): ExternalEntityRespDTO {
        this['protocol'] = protocol;
        return this;
    }
    public withConnectionType(connectionType: string): ExternalEntityRespDTO {
    ...
    public withCreateTime(createTime: string): ExternalEntityRespDTO {
    ...
    public withLastModifyTime(lastModifyTime: string): ExternalEntityRespDTO {
