...
export class CreateDsResponse extends SdkResponse {
    ...
    public withDsId(dsId: string): CreateDsResponse {
        this['ds_id'] = dsId;
        return this;
    }
    ...
    public withConfig(config: object): CreateDsResponse {
        this['config'] = config;
        return this;
    }
    public withName(name: string): CreateDsResponse {
        this['name'] = name;
        return this;
    }
    public withEdgeNodeId(edgeNodeId: string): CreateDsResponse {
    ...
    public withModuleId(moduleId: string): CreateDsResponse {
    ...
    public withTplId(tplId: string): CreateDsResponse {
        this['tpl_id'] = tplId;
        return this;
    }
    ...
    public withQualityReport(qualityReport: boolean): CreateDsResponse {
    ...
    public withEdgeAppName(edgeAppName: string): CreateDsResponse {
    ...
    public withConnectionInfo(connectionInfo: object): CreateDsResponse {
    ...
    public withModuleState(moduleState: string): CreateDsResponse {
    ...
    public withCount(count: number): CreateDsResponse {
        this['count'] = count;
        return this;
    }
    public withCreateTime(createTime: string): CreateDsResponse {
    ...
    public withUpdateTime(updateTime: string): CreateDsResponse {
    ...
    public withSynchronized(_synchronized: boolean): CreateDsResponse {
    ...
    public withSynchronizedTime(synchronizedTime: string): CreateDsResponse {
