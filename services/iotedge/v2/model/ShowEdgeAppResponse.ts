...
export class ShowEdgeAppResponse extends SdkResponse {
    ...
    public withEdgeAppId(edgeAppId: string): ShowEdgeAppResponse {
    ...
    public withDescription(description: string): ShowEdgeAppResponse {
        this['description'] = description;
        return this;
    }
    public withCreateTime(createTime: string): ShowEdgeAppResponse {
    ...
    public withUpdateTime(updateTime: string): ShowEdgeAppResponse {
    ...
    public withLastPublishedVersion(lastPublishedVersion: string): ShowEdgeAppResponse {
    ...
    public withAppType(appType: string): ShowEdgeAppResponse {
    ...
    public withFunctionType(functionType: string): ShowEdgeAppResponse {
    ...
    public withDeployType(deployType: string): ShowEdgeAppResponse {
    ...
    public withProtocol(protocol: string): ShowEdgeAppResponse {
        this['protocol'] = protocol;
        return this;
    }
    public withEdgeAppName(edgeAppName: string): ShowEdgeAppResponse {
