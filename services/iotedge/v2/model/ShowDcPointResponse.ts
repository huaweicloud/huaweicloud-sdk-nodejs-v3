...
export class ShowDcPointResponse extends SdkResponse {
    ...
    public withPointId(pointId: string): ShowDcPointResponse {
    ...
    public withName(name: string): ShowDcPointResponse {
        this['name'] = name;
        return this;
    }
    public withCollectionConfig(collectionConfig: object): ShowDcPointResponse {
    ...
    public withDeviceId(deviceId: string): ShowDcPointResponse {
    ...
    public withProperty(property: string): ShowDcPointResponse {
        this['property'] = property;
        return this;
    }
    public withDataType(dataType: string): ShowDcPointResponse {
    ...
    public withDsId(dsId: string): ShowDcPointResponse {
        this['ds_id'] = dsId;
        return this;
    }
    ...
    public withProcessingConfig(processingConfig: ProcessingConfigDTO): ShowDcPointResponse {
    ...
    public withCreateTime(createTime: string): ShowDcPointResponse {
    ...
    public withUpdateTime(updateTime: string): ShowDcPointResponse {
