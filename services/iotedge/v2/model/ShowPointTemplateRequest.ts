...
export class ShowPointTemplateRequest {
    ...
    public withEdgeNodeId(edgeNodeId: string): ShowPointTemplateRequest {
        this['edge_node_id'] = edgeNodeId;
        return this;
    }
    ...
    public withDsId(dsId: string): ShowPointTemplateRequest {
        this['ds_id'] = dsId;
        return this;
    }
