...
export class QueryApplicationBriefResponseDTO {
    ...
    public withDescription(description: string): QueryApplicationBriefResponseDTO {
        this['description'] = description;
        return this;
    }
    public withCreateTime(createTime: string): QueryApplicationBriefResponseDTO {
    ...
    public withUpdateTime(updateTime: string): QueryApplicationBriefResponseDTO {
    ...
    public withLastPublishedVersion(lastPublishedVersion: string): QueryApplicationBriefResponseDTO {
    ...
    public withAppType(appType: string): QueryApplicationBriefResponseDTO {
    ...
    public withFunctionType(functionType: string): QueryApplicationBriefResponseDTO {
    ...
    public withDeployType(deployType: string): QueryApplicationBriefResponseDTO {
    ...
    public withProtocol(protocol: string): QueryApplicationBriefResponseDTO {
        this['protocol'] = protocol;
        return this;
    }
    public withEdgeAppName(edgeAppName: string): QueryApplicationBriefResponseDTO {
