import { UpdateEdgeModuleReqDTO } from './UpdateEdgeModuleReqDTO';


export class UpdateModuleRequest {
    private 'edge_node_id'?: string;
    private 'module_id'?: string;
    public body?: UpdateEdgeModuleReqDTO;
    public constructor(edgeNodeId?: string, moduleId?: string) { 
        this['edge_node_id'] = edgeNodeId;
        this['module_id'] = moduleId;
    }
    public withEdgeNodeId(edgeNodeId: string): UpdateModuleRequest {
        this['edge_node_id'] = edgeNodeId;
        return this;
    }
    ...
    public withBody(body: UpdateEdgeModuleReqDTO): UpdateModuleRequest {
        this['body'] = body;
        return this;
    }
}