...
export class ExecuteDeviceControlsSetResponse extends SdkResponse {
    private 'result_code'?: number;
    private 'result_desc'?: string;
    public constructor() { 
        super();
    }
    public withResultCode(resultCode: number): ExecuteDeviceControlsSetResponse {
    ...
    public withResultDesc(resultDesc: string): ExecuteDeviceControlsSetResponse {
