...
export class ShowModuleShadowRequest {
    ...
    public withEdgeNodeId(edgeNodeId: string): ShowModuleShadowRequest {
        this['edge_node_id'] = edgeNodeId;
        return this;
    }
    ...
    public withModuleId(moduleId: string): ShowModuleShadowRequest {
        this['module_id'] = moduleId;
        return this;
    }
