...
export class SynchronizeDcConfigsRequest {
    ...
    public withEdgeNodeId(edgeNodeId: string): SynchronizeDcConfigsRequest {
        this['edge_node_id'] = edgeNodeId;
        return this;
    }
    ...
    public withDsId(dsId: string): SynchronizeDcConfigsRequest {
        this['ds_id'] = dsId;
        return this;
    }
