...
export class CreateDcPointResponse extends SdkResponse {
    ...
    public withPointId(pointId: string): CreateDcPointResponse {
    ...
    public withName(name: string): CreateDcPointResponse {
        this['name'] = name;
        return this;
    }
    public withCollectionConfig(collectionConfig: object): CreateDcPointResponse {
    ...
    public withDeviceId(deviceId: string): CreateDcPointResponse {
    ...
    public withProperty(property: string): CreateDcPointResponse {
        this['property'] = property;
        return this;
    }
    public withDataType(dataType: string): CreateDcPointResponse {
    ...
    public withDsId(dsId: string): CreateDcPointResponse {
        this['ds_id'] = dsId;
        return this;
    }
    ...
    public withProcessingConfig(processingConfig: ProcessingConfigDTO): CreateDcPointResponse {
    ...
    public withUpdateTime(updateTime: string): CreateDcPointResponse {
