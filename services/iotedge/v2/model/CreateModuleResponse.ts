...
export class CreateModuleResponse extends SdkResponse {
    ...
    private 'app_type'?: CreateModuleResponseAppTypeEnum | string;
    private 'function_type'?: CreateModuleResponseFunctionTypeEnum | string;
    private 'container_settings'?: ModuleContainerSettingsResDTO;
    public constructor() { 
        super();
    }
    public withEdgeAppId(edgeAppId: string): CreateModuleResponse {
    ...
    public withAppVersion(appVersion: string): CreateModuleResponse {
    ...
    public withNodeId(nodeId: string): CreateModuleResponse {
        this['node_id'] = nodeId;
        return this;
    }
    ...
    public withModuleName(moduleName: string): CreateModuleResponse {
    ...
    public withModuleId(moduleId: string): CreateModuleResponse {
    ...
    public withCreateTime(createTime: string): CreateModuleResponse {
    ...
    public withUpdateTime(updateTime: string): CreateModuleResponse {
    ...
    public withAppType(appType: CreateModuleResponseAppTypeEnum | string): CreateModuleResponse {
        this['app_type'] = appType;
        return this;
    }
    public set appType(appType: CreateModuleResponseAppTypeEnum | string  | undefined) {
        this['app_type'] = appType;
    }
    public get appType(): CreateModuleResponseAppTypeEnum | string | undefined {
        return this['app_type'];
    }
    public withFunctionType(functionType: CreateModuleResponseFunctionTypeEnum | string): CreateModuleResponse {
        this['function_type'] = functionType;
        return this;
    }
    public set functionType(functionType: CreateModuleResponseFunctionTypeEnum | string  | undefined) {
        this['function_type'] = functionType;
    }
    public get functionType(): CreateModuleResponseFunctionTypeEnum | string | undefined {
        return this['function_type'];
    }
    public withContainerSettings(containerSettings: ModuleContainerSettingsResDTO): CreateModuleResponse {
...
/**
    ...
    * @enum {string}
    */
export enum CreateModuleResponseStateEnum {
    PENDING = 'PENDING',
...
/**
    ...
    * @enum {string}
    */
export enum CreateModuleResponseAppTypeEnum {
...
/**
    ...
    * @enum {string}
    */
export enum CreateModuleResponseFunctionTypeEnum {
