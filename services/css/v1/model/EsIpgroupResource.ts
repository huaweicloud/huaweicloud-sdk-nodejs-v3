...
export class EsIpgroupResource {
    private 'ipgroup_id'?: string;
    private 'enable_ipgroup'?: boolean;
    public type?: string;
    public constructor() { 
    }
    public withIpgroupId(ipgroupId: string): EsIpgroupResource {
    ...
    public withEnableIpgroup(enableIpgroup: boolean): EsIpgroupResource {
    ...
    public withType(type: string): EsIpgroupResource {
        this['type'] = type;
        return this;
    }
}