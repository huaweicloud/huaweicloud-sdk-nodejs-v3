...
export class CreateWorkflowResponse extends SdkResponse {
    ...
    public withType(type: string): CreateWorkflowResponse {
        this['type'] = type;
        return this;
    }
    ...
    public withTags(tags: { [key: string]: string; }): CreateWorkflowResponse {
        this['tags'] = tags;
        return this;
    }
    public withCreateTime(createTime: number): CreateWorkflowResponse {
    ...
    public withCreateBy(createBy: string): CreateWorkflowResponse {
    ...
    public withUpdateTime(updateTime: number): CreateWorkflowResponse {
    ...
    public withUpdateBy(updateBy: string): CreateWorkflowResponse {
    ...
    public withTemplateName(templateName: string): CreateWorkflowResponse {
    ...
    public withTemplateId(templateId: string): CreateWorkflowResponse {
    ...
    public withInput(input: { [key: string]: object; }): CreateWorkflowResponse {
        this['input'] = input;
        return this;
    }
    public withLastExecutionId(lastExecutionId: string): CreateWorkflowResponse {
    ...
    public withStatus(status: string): CreateWorkflowResponse {
        this['status'] = status;
        return this;
    }
    public withCitationUrns(citationUrns: Array<string>): CreateWorkflowResponse {
    ...
    public withLastExecutionEndTime(lastExecutionEndTime: number): CreateWorkflowResponse {
    ...
    public withLastExecutionStartTime(lastExecutionStartTime: number): CreateWorkflowResponse {
    ...
    public withQuote(quote: Array<string>): CreateWorkflowResponse {
        this['quote'] = quote;
        return this;
    }
    public withJobName(jobName: string): CreateWorkflowResponse {
    ...
    public withJobId(jobId: string): CreateWorkflowResponse {
        this['job_id'] = jobId;
        return this;
    }
    ...
    public withServiceScenario(serviceScenario: string): CreateWorkflowResponse {
    ...
    public withServiceName(serviceName: string): CreateWorkflowResponse {
    ...
    public withTaskType(taskType: string): CreateWorkflowResponse {
    ...
    public withProjectId(projectId: string): CreateWorkflowResponse {
    ...
    public withWorkflowId(workflowId: string): CreateWorkflowResponse {
    ...
    public withTaskStatus(taskStatus: string): CreateWorkflowResponse {
    ...
    public withNodes(nodes: Array<Node>): CreateWorkflowResponse {
        this['nodes'] = nodes;
        return this;
    }
    public withEditTime(editTime: number): CreateWorkflowResponse {
    ...
    public withExecutionActionRules(executionActionRules: Array<string>): CreateWorkflowResponse {
    ...
    public withExecutionPermission(executionPermission: Array<string>): CreateWorkflowResponse {
    ...
    public withGlobalParameters(globalParameters: Array<Parameter>): CreateWorkflowResponse {
    ...
    public withIsDelete(isDelete: boolean): CreateWorkflowResponse {
    ...
    public withSteps(steps: Array<Step>): CreateWorkflowResponse {
        this['steps'] = steps;
        return this;
    }
    public withOutput(output: string): CreateWorkflowResponse {
        this['output'] = output;
        return this;
    }
    public withTriggerId(triggerId: string): CreateWorkflowResponse {
    ...
    public withTriggerStatus(triggerStatus: string): CreateWorkflowResponse {
    ...
    public withApproveId(approveId: string): CreateWorkflowResponse {
    ...
    public withTemplateI18n(templateI18n: WorkFlowModel): CreateWorkflowResponse {
    ...
    public withEnterpriseProjectId(enterpriseProjectId: string): CreateWorkflowResponse {
    ...
    public withLastExecuteBy(lastExecuteBy: string): CreateWorkflowResponse {
