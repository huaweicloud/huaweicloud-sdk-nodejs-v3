...
export class Template {
    ...
    public withApproveInfo(approveInfo: ApproveInfo): Template {
    ...
    public withCreateBy(createBy: string): Template {
    ...
    public withCreateTime(createTime: number): Template {
    ...
    public withEnterpriseProjectId(enterpriseProjectId: string): Template {
    ...
    public withIsCollect(isCollect: boolean): Template {
    ...
    public withIsPublish(isPublish: boolean): Template {
    ...
    public withJobId(jobId: string): Template {
        this['job_id'] = jobId;
        return this;
    }
    ...
    public withJobVersion(jobVersion: number): Template {
    ...
    public withNeedSynchronize(needSynchronize: boolean): Template {
    ...
    public withNodes(nodes: Array<Node>): Template {
        this['nodes'] = nodes;
        return this;
    }
    public withParameters(parameters: Array<Parameter>): Template {
        this['parameters'] = parameters;
        return this;
    }
    public withProjectId(projectId: string): Template {
    ...
    public withQuote(quote: Array<string>): Template {
        this['quote'] = quote;
        return this;
    }
    public withRateControl(rateControl: RateControl): Template {
    ...
    public withShareType(shareType: string): Template {
    ...
    public withSteps(steps: Array<Step>): Template {
        this['steps'] = steps;
        return this;
    }
    public withUpdateBy(updateBy: string): Template {
    ...
    public withUpdateTime(updateTime: number): Template {
