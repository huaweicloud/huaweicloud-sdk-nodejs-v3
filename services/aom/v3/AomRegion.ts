...
export class AomRegion {
    ...
    public static AE_AD_1 = new Region("ae-ad-1", ["https://aom.ae-ad-1.myhuaweicloud.com"]);
    ...
    public static CN_NORTH_12 = new Region("cn-north-12", ["https://aom.cn-north-12.myhuaweicloud.com"]);
    public static CN_EAST_5 = new Region("cn-east-5", ["https://aom.cn-east-5.myhuaweicloud.com"]);
    public static CN_EAST_4 = new Region("cn-east-4", ["https://aom.cn-east-4.myhuaweicloud.com"]);
    public static CN_NORTH_11 = new Region("cn-north-11", ["https://aom.cn-north-11.myhuaweicloud.com"]);
    public static CN_SOUTHWEST_3 = new Region("cn-southwest-3", ["https://aom.cn-southwest-3.myhuaweicloud.com"]);
    ...
    private static REGION_MAP: RegionMap = {
        ...
        "cn-north-12":AomRegion.CN_NORTH_12,
        "cn-east-5":AomRegion.CN_EAST_5,
        "cn-east-4":AomRegion.CN_EAST_4,
        "cn-north-11":AomRegion.CN_NORTH_11,
        "cn-southwest-3":AomRegion.CN_SOUTHWEST_3
    };
