...
export class Dashboard {
    ...
    public withProjectId(projectId: string): Dashboard {
    ...
    public withDashboardType(dashboardType: string): Dashboard {
    ...
    public withDashboardTitle(dashboardTitle: string): Dashboard {
    ...
    public withDashboardTitleEn(dashboardTitleEn: string): Dashboard {
    ...
    public withDashboardId(dashboardId: string): Dashboard {
    ...
    public withVersion(version: string): Dashboard {
        this['version'] = version;
        return this;
    }
    public withEnterpriseProjectId(enterpriseProjectId: string): Dashboard {
    ...
    public withFolderName(folderName: string): Dashboard {
    ...
    public withFolderId(folderId: string): Dashboard {
    ...
    public withSyncData(syncData: string): Dashboard {
    ...
    public withIsCreateAction(isCreateAction: boolean): Dashboard {
    ...
    public withDashboardTags(dashboardTags: Array<{ [key: string]: string; }>): Dashboard {
    ...
    public withIsFavorite(isFavorite: boolean): Dashboard {
    ...
    public withCreated(created: number): Dashboard {
        this['created'] = created;
        return this;
    }
    public withUpdated(updated: number): Dashboard {
        this['updated'] = updated;
        return this;
    }
    public withCreatedBy(createdBy: string): Dashboard {
    ...
    public withUpdatedBy(updatedBy: string): Dashboard {
    ...
    public withCharts(charts: object): Dashboard {
        this['charts'] = charts;
        return this;
    }
    public withTemplating(templating: object): Dashboard {
        this['templating'] = templating;
        return this;
    }
    public withDisplay(display: boolean): Dashboard {
        this['display'] = display;
        return this;
    }
    public withQueryCount(queryCount: number): Dashboard {
    ...
    public withTimeRange(timeRange: string): Dashboard {
