...
export class MyanmarDriverLicenseResult {
    ...
    private 'card_number_en'?: string;
    public name?: string;
    private 'name_en'?: string;
    private 'nrc_id'?: string;
    private 'nrc_id_en'?: string;
    public birth?: string;
    private 'birth_en'?: string;
    private 'blood_group'?: string;
    private 'blood_group_en'?: string;
    private 'expiried_date'?: string;
    private 'expiried_date_en'?: string;
    ...
    public get cardNumberEn(): string | undefined {
    ...
    public get nrcIdEn(): string | undefined {
    ...
    public get birthEn(): string | undefined {
    ...
    public get bloodGroupEn(): string | undefined {
    ...
    public get expiriedDate(): string | undefined {
    ...
    public get expiriedDateEn(): string | undefined {
