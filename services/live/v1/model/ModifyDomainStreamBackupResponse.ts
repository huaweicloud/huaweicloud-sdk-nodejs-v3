...
export class ModifyDomainStreamBackupResponse extends SdkResponse {
    private 'publish_domain'?: string;
    private 'stream_backup_enable'?: boolean;
    public constructor() { 
        super();
    }
    public withPublishDomain(publishDomain: string): ModifyDomainStreamBackupResponse {
    ...
    public withStreamBackupEnable(streamBackupEnable: boolean): ModifyDomainStreamBackupResponse {
