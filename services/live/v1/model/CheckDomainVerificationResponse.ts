...
export class CheckDomainVerificationResponse extends SdkResponse {
    ...
    public withDomain(domain: string): CheckDomainVerificationResponse {
        this['domain'] = domain;
        return this;
    }
    public withVerifyContent(verifyContent: string): CheckDomainVerificationResponse {
    ...
    public withVerifyResult(verifyResult: boolean): CheckDomainVerificationResponse {
