...
export class ListHlsConfigResponse extends SdkResponse {
    private 'push_domain'?: string;
    public application?: Array<PushDomainApplication>;
    public constructor() { 
        super();
    }
    public withPushDomain(pushDomain: string): ListHlsConfigResponse {
    ...
    public withApplication(application: Array<PushDomainApplication>): ListHlsConfigResponse {
