...
export class ShowRecordRuleResponse extends SdkResponse {
    ...
    private 'record_type'?: ShowRecordRuleResponseRecordTypeEnum | string;
    ...
    public withRecordType(recordType: ShowRecordRuleResponseRecordTypeEnum | string): ShowRecordRuleResponse {
        this['record_type'] = recordType;
        return this;
    }
    public set recordType(recordType: ShowRecordRuleResponseRecordTypeEnum | string  | undefined) {
        this['record_type'] = recordType;
    }
    public get recordType(): ShowRecordRuleResponseRecordTypeEnum | string | undefined {
