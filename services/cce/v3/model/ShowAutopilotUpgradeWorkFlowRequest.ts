...
export class ShowAutopilotUpgradeWorkFlowRequest {
    ...
    public withClusterId(clusterId: string): ShowAutopilotUpgradeWorkFlowRequest {
        this['cluster_id'] = clusterId;
        return this;
    }
    ...
    public withUpgradeWorkflowId(upgradeWorkflowId: string): ShowAutopilotUpgradeWorkFlowRequest {
        this['upgrade_workflow_id'] = upgradeWorkflowId;
        return this;
    }
    ...
    public withContentType(contentType: string): ShowAutopilotUpgradeWorkFlowRequest {
        this['Content-Type'] = contentType;
        return this;
    }
