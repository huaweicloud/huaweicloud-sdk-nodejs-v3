...
export class ListAutopilotAddonTemplatesRequest {
    private 'Content-Type'?: string;
    private 'addon_template_name'?: string;
    public constructor(contentType?: string) { 
        this['Content-Type'] = contentType;
    }
    public withContentType(contentType: string): ListAutopilotAddonTemplatesRequest {
        this['Content-Type'] = contentType;
        return this;
    }
    ...
    public withAddonTemplateName(addonTemplateName: string): ListAutopilotAddonTemplatesRequest {
