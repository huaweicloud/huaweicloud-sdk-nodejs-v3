...
export class ShowNodePoolRequest {
    ...
    public withClusterId(clusterId: string): ShowNodePoolRequest {
        this['cluster_id'] = clusterId;
        return this;
    }
    ...
    public withNodepoolId(nodepoolId: string): ShowNodePoolRequest {
        this['nodepool_id'] = nodepoolId;
        return this;
    }
    ...
    public withContentType(contentType: string): ShowNodePoolRequest {
        this['Content-Type'] = contentType;
        return this;
    }
    ...
    public withErrorStatus(errorStatus: string): ShowNodePoolRequest {
