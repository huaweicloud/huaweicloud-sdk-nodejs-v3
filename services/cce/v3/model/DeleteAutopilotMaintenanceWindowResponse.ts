...
export class DeleteAutopilotMaintenanceWindowResponse extends SdkResponse {
    ...
    public withWeeklyPeriod(weeklyPeriod: string): DeleteAutopilotMaintenanceWindowResponse {
    ...
    public withStartTime(startTime: string): DeleteAutopilotMaintenanceWindowResponse {
    ...
    public withDurationHours(durationHours: number): DeleteAutopilotMaintenanceWindowResponse {
    ...
    public withUpgradeScope(upgradeScope: string): DeleteAutopilotMaintenanceWindowResponse {
