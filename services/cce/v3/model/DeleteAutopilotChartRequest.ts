...
export class DeleteAutopilotChartRequest {
    ...
    public withChartId(chartId: string): DeleteAutopilotChartRequest {
        this['chart_id'] = chartId;
        return this;
    }
    ...
    public withContentType(contentType: string): DeleteAutopilotChartRequest {
        this['Content-Type'] = contentType;
        return this;
    }
