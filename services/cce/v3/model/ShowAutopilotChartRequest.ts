...
export class ShowAutopilotChartRequest {
    ...
    public withChartId(chartId: string): ShowAutopilotChartRequest {
        this['chart_id'] = chartId;
        return this;
    }
    ...
    public withContentType(contentType: string): ShowAutopilotChartRequest {
        this['Content-Type'] = contentType;
        return this;
    }
