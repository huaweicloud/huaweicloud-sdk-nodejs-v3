...
export class UpgradeWorkFlowUpdateRequest {
    ...
    public withClusterId(clusterId: string): UpgradeWorkFlowUpdateRequest {
        this['cluster_id'] = clusterId;
        return this;
    }
    ...
    public withUpgradeWorkflowId(upgradeWorkflowId: string): UpgradeWorkFlowUpdateRequest {
        this['upgrade_workflow_id'] = upgradeWorkflowId;
        return this;
    }
    ...
    public withContentType(contentType: string): UpgradeWorkFlowUpdateRequest {
        this['Content-Type'] = contentType;
        return this;
    }
    ...
    public withBody(body: UpgradeWorkFlowUpdateRequestBody): UpgradeWorkFlowUpdateRequest {
        this['body'] = body;
        return this;
    }
}