...
export class ReleaseResp {
    ...
    public withChartName(chartName: string): ReleaseResp {
    ...
    public withChartPublic(chartPublic: boolean): ReleaseResp {
    ...
    public withChartVersion(chartVersion: string): ReleaseResp {
    ...
    public withClusterId(clusterId: string): ReleaseResp {
    ...
    public withClusterName(clusterName: string): ReleaseResp {
    ...
    public withCreateAt(createAt: string): ReleaseResp {
    ...
    public withDescription(description: string): ReleaseResp {
        this['description'] = description;
        return this;
    }
    public withName(name: string): ReleaseResp {
        this['name'] = name;
        return this;
    }
    public withNamespace(namespace: string): ReleaseResp {
        this['namespace'] = namespace;
        return this;
    }
    public withParameters(parameters: string): ReleaseResp {
        this['parameters'] = parameters;
        return this;
    }
    public withResources(resources: string): ReleaseResp {
        this['resources'] = resources;
        return this;
    }
    public withStatus(status: string): ReleaseResp {
        this['status'] = status;
        return this;
    }
    public withStatusDescription(statusDescription: string): ReleaseResp {
    ...
    public withUpdateAt(updateAt: string): ReleaseResp {
    ...
    public withValues(values: string): ReleaseResp {
        this['values'] = values;
        return this;
    }
    public withVersion(version: number): ReleaseResp {
