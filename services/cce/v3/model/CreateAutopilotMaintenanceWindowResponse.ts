...
export class CreateAutopilotMaintenanceWindowResponse extends SdkResponse {
    ...
    public withWeeklyPeriod(weeklyPeriod: string): CreateAutopilotMaintenanceWindowResponse {
    ...
    public withStartTime(startTime: string): CreateAutopilotMaintenanceWindowResponse {
    ...
    public withDurationHours(durationHours: number): CreateAutopilotMaintenanceWindowResponse {
    ...
    public withUpgradeScope(upgradeScope: string): CreateAutopilotMaintenanceWindowResponse {
