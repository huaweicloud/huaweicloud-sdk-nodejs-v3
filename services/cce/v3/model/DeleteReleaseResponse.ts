...
export class DeleteReleaseResponse extends SdkResponse {
    ...
    public withChartName(chartName: string): DeleteReleaseResponse {
    ...
    public withChartPublic(chartPublic: boolean): DeleteReleaseResponse {
    ...
    public withChartVersion(chartVersion: string): DeleteReleaseResponse {
    ...
    public withClusterId(clusterId: string): DeleteReleaseResponse {
    ...
    public withClusterName(clusterName: string): DeleteReleaseResponse {
    ...
    public withCreateAt(createAt: string): DeleteReleaseResponse {
    ...
    public withDescription(description: string): DeleteReleaseResponse {
        this['description'] = description;
        return this;
    }
    public withName(name: string): DeleteReleaseResponse {
        this['name'] = name;
        return this;
    }
    public withNamespace(namespace: string): DeleteReleaseResponse {
        this['namespace'] = namespace;
        return this;
    }
    public withParameters(parameters: string): DeleteReleaseResponse {
        this['parameters'] = parameters;
        return this;
    }
    public withResources(resources: string): DeleteReleaseResponse {
        this['resources'] = resources;
        return this;
    }
    public withStatus(status: string): DeleteReleaseResponse {
        this['status'] = status;
        return this;
    }
    public withStatusDescription(statusDescription: string): DeleteReleaseResponse {
    ...
    public withUpdateAt(updateAt: string): DeleteReleaseResponse {
    ...
    public withValues(values: string): DeleteReleaseResponse {
        this['values'] = values;
        return this;
    }
    public withVersion(version: number): DeleteReleaseResponse {
