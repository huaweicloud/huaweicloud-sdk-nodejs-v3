...
export class ShowClusterConfigResponse extends SdkResponse {
    private 'ttl_in_days'?: number;
    private 'log_configs'?: Array<ClusterLogConfigLogConfigs>;
    public constructor() { 
        super();
    }
    public withTtlInDays(ttlInDays: number): ShowClusterConfigResponse {
    ...
    public withLogConfigs(logConfigs: Array<ClusterLogConfigLogConfigs>): ShowClusterConfigResponse {
