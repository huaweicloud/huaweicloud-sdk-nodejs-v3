...
export class BatchDeleteVpnUsersResponse extends SdkResponse {
    private 'request_id'?: string;
    private 'header-response-token'?: string;
    public constructor() { 
        super();
    }
    public withRequestId(requestId: string): BatchDeleteVpnUsersResponse {
    ...
    public withHeaderResponseToken(headerResponseToken: string): BatchDeleteVpnUsersResponse {
