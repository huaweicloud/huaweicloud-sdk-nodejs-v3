...
export class DeleteVpnUserGroupRequest {
    ...
    public withVpnServerId(vpnServerId: string): DeleteVpnUserGroupRequest {
        this['vpn_server_id'] = vpnServerId;
        return this;
    }
    ...
    public withGroupId(groupId: string): DeleteVpnUserGroupRequest {
        this['group_id'] = groupId;
        return this;
    }
