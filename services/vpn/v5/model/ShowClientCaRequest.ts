...
export class ShowClientCaRequest {
    ...
    public withVpnServerId(vpnServerId: string): ShowClientCaRequest {
        this['vpn_server_id'] = vpnServerId;
        return this;
    }
    ...
    public withClientCaCertificateId(clientCaCertificateId: string): ShowClientCaRequest {
        this['client_ca_certificate_id'] = clientCaCertificateId;
        return this;
    }
