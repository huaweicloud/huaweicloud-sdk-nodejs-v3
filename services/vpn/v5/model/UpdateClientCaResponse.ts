...
export class UpdateClientCaResponse extends SdkResponse {
    private 'request_id'?: string;
    private 'header-response-token'?: string;
    public constructor() { 
        super();
    }
    public withRequestId(requestId: string): UpdateClientCaResponse {
    ...
    public withHeaderResponseToken(headerResponseToken: string): UpdateClientCaResponse {
