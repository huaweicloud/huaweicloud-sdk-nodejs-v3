...
export class UpdateResponseVpnConnection {
    ...
    public withTunnelLocalAddressV6(tunnelLocalAddressV6: string): UpdateResponseVpnConnection {
    ...
    public withTunnelPeerAddressV6(tunnelPeerAddressV6: string): UpdateResponseVpnConnection {
