...
export class UpdateVpnServerResponse extends SdkResponse {
    private 'request_id'?: string;
    private 'header-response-token'?: string;
    public constructor() { 
        super();
    }
    public withRequestId(requestId: string): UpdateVpnServerResponse {
    ...
    public withHeaderResponseToken(headerResponseToken: string): UpdateVpnServerResponse {
