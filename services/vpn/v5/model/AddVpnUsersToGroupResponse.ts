...
export class AddVpnUsersToGroupResponse extends SdkResponse {
    private 'request_id'?: string;
    private 'header-response-token'?: string;
    public constructor() { 
        super();
    }
    public withRequestId(requestId: string): AddVpnUsersToGroupResponse {
    ...
    public withHeaderResponseToken(headerResponseToken: string): AddVpnUsersToGroupResponse {
