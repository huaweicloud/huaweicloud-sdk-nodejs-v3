...
export class UpdateVpnUserPasswordResponse extends SdkResponse {
    private 'request_id'?: string;
    private 'header-response-token'?: string;
    public constructor() { 
        super();
    }
    public withRequestId(requestId: string): UpdateVpnUserPasswordResponse {
    ...
    public withHeaderResponseToken(headerResponseToken: string): UpdateVpnUserPasswordResponse {
