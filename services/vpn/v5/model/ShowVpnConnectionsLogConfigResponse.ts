...
export class ShowVpnConnectionsLogConfigResponse extends SdkResponse {
    ...
    public withLogConfig(logConfig: ConnectionsLogConfig): ShowVpnConnectionsLogConfigResponse {
    ...
    public withRequestId(requestId: string): ShowVpnConnectionsLogConfigResponse {
    ...
    public withHeaderResponseToken(headerResponseToken: string): ShowVpnConnectionsLogConfigResponse {
