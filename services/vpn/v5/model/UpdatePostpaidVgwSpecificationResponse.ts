...
export class UpdatePostpaidVgwSpecificationResponse extends SdkResponse {
    ...
    public withVpnGateway(vpnGateway: UpdateResponseVpnGateway): UpdatePostpaidVgwSpecificationResponse {
    ...
    public withRequestId(requestId: string): UpdatePostpaidVgwSpecificationResponse {
    ...
    public withHeaderResponseToken(headerResponseToken: string): UpdatePostpaidVgwSpecificationResponse {
