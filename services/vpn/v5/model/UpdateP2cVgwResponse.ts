...
export class UpdateP2cVgwResponse extends SdkResponse {
    ...
    public withP2cVpnGateway(p2cVpnGateway: ResponseP2cVgw): UpdateP2cVgwResponse {
    ...
    public withRequestId(requestId: string): UpdateP2cVgwResponse {
    ...
    public withHeaderResponseToken(headerResponseToken: string): UpdateP2cVgwResponse {
