...
export class ResetVpnUserPasswordResponse extends SdkResponse {
    private 'request_id'?: string;
    private 'header-response-token'?: string;
    public constructor() { 
        super();
    }
    public withRequestId(requestId: string): ResetVpnUserPasswordResponse {
    ...
    public withHeaderResponseToken(headerResponseToken: string): ResetVpnUserPasswordResponse {
