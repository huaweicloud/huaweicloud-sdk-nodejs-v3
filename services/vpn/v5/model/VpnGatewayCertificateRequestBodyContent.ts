...
export class VpnGatewayCertificateRequestBodyContent {
    public name?: string;
    ...
    public withName(name: string): VpnGatewayCertificateRequestBodyContent {
        this['name'] = name;
        return this;
    }
    public withCertificate(certificate: string): VpnGatewayCertificateRequestBodyContent {
        this['certificate'] = certificate;
        return this;
    }
    public withPrivateKey(privateKey: string): VpnGatewayCertificateRequestBodyContent {
        this['private_key'] = privateKey;
        return this;
    }
    ...
    public withCertificateChain(certificateChain: string): VpnGatewayCertificateRequestBodyContent {
        this['certificate_chain'] = certificateChain;
        return this;
    }
    ...
    public withEncCertificate(encCertificate: string): VpnGatewayCertificateRequestBodyContent {
        this['enc_certificate'] = encCertificate;
        return this;
    }
    ...
    public withEncPrivateKey(encPrivateKey: string): VpnGatewayCertificateRequestBodyContent {
        this['enc_private_key'] = encPrivateKey;
        return this;
    }
