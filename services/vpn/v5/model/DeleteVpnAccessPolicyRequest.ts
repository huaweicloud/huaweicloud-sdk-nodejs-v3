...
export class DeleteVpnAccessPolicyRequest {
    ...
    public withVpnServerId(vpnServerId: string): DeleteVpnAccessPolicyRequest {
        this['vpn_server_id'] = vpnServerId;
        return this;
    }
    ...
    public withPolicyId(policyId: string): DeleteVpnAccessPolicyRequest {
        this['policy_id'] = policyId;
        return this;
    }
