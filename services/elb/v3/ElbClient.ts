...
import { BatchCreateLoadBalancerOption } from './model/BatchCreateLoadBalancerOption';
import { BatchCreateLoadBalancersRequest } from './model/BatchCreateLoadBalancersRequest';
import { BatchCreateLoadBalancersRequestBody } from './model/BatchCreateLoadBalancersRequestBody';
...
import { BatchDeleteCertificatesRequestBody } from './model/BatchDeleteCertificatesRequestBody';
import { BatchDeleteCertificatesResp } from './model/BatchDeleteCertificatesResp';
...
import { BatchDeleteListenersRequestBody } from './model/BatchDeleteListenersRequestBody';
...
import { BatchDeleteLoadbalancersRequestBody } from './model/BatchDeleteLoadbalancersRequestBody';
...
import { BatchDeletePoolsRequestBody } from './model/BatchDeletePoolsRequestBody';
import { BatchDeletePoolsResp } from './model/BatchDeletePoolsResp';
...
import { BatchDisableDomainIPsRequestBody } from './model/BatchDisableDomainIPsRequestBody';
...
import { BatchEnableDomainIPsRequestBody } from './model/BatchEnableDomainIPsRequestBody';
...
import { ChangeListenerTagsRequestBody } from './model/ChangeListenerTagsRequestBody';
...
import { ChangeLoadbalancerTagsRequestBody } from './model/ChangeLoadbalancerTagsRequestBody';
import { ChangeLoadbalancerTagsResponse } from './model/ChangeLoadbalancerTagsResponse';
import { ChangeResourceTagOption } from './model/ChangeResourceTagOption';
import { CloneListenerOption } from './model/CloneListenerOption';
import { CloneListenerRequest } from './model/CloneListenerRequest';
import { CloneListenerRequestBody } from './model/CloneListenerRequestBody';
import { CloneListenerResp } from './model/CloneListenerResp';
...
import { CloneLoadbalancerRequestBody } from './model/CloneLoadbalancerRequestBody';
import { CloneLoadbalancerResponse } from './model/CloneLoadbalancerResponse';
import { CloneLoadbalancerResponseBodyLoadbalancerList } from './model/CloneLoadbalancerResponseBodyLoadbalancerList';
...
import { CreateCorsConfig } from './model/CreateCorsConfig';
...
import { DeleteLoadBalancerCascadeOption } from './model/DeleteLoadBalancerCascadeOption';
import { DeleteLoadBalancerCascadeRequest } from './model/DeleteLoadBalancerCascadeRequest';
import { DeleteLoadBalancerCascadeRequestBody } from './model/DeleteLoadBalancerCascadeRequestBody';
import { DeleteLoadBalancerCascadeResponse } from './model/DeleteLoadBalancerCascadeResponse';
...
import { DeletePoolCascadeRequest } from './model/DeletePoolCascadeRequest';
...
import { DnsConfigResponseBody } from './model/DnsConfigResponseBody';
import { DnsIp } from './model/DnsIp';
import { DnsIpResponse } from './model/DnsIpResponse';
import { EipInfo } from './model/EipInfo';
import { EipNode } from './model/EipNode';
...
import { ListenerNode } from './model/ListenerNode';
...
import { LoadBalancerTopologyResult } from './model/LoadBalancerTopologyResult';
...
import { PolicyLabel } from './model/PolicyLabel';
...
import { ResPortRange } from './model/ResPortRange';
...
import { ShowIpGroupRelatedListenersRequest } from './model/ShowIpGroupRelatedListenersRequest';
import { ShowIpGroupRelatedListenersResponse } from './model/ShowIpGroupRelatedListenersResponse';
...
import { SubnetMappingList } from './model/SubnetMappingList';
import { SystemDefaultDnsConfigRequestBody } from './model/SystemDefaultDnsConfigRequestBody';
...
import { TopologyEdge } from './model/TopologyEdge';
import { TopologyLabels } from './model/TopologyLabels';
import { TopologyNodes } from './model/TopologyNodes';
...
import { UpdateIpGroupIpOption } from './model/UpdateIpGroupIpOption';
...
import { UpdateSystemDefaultDomainConfigRequestBody } from './model/UpdateSystemDefaultDomainConfigRequestBody';
...
import { UpdateUserDefinedDomainConfigRequestBody } from './model/UpdateUserDefinedDomainConfigRequestBody';
...
import { UserDefinedDnsConfigRequestBody } from './model/UserDefinedDnsConfigRequestBody';
...
export class ElbClient {
     ...
     *
     * @summary 批量创建负载均衡器
     * @param {BatchCreateLoadBalancersRequestBody} batchCreateLoadBalancersRequestBody This is a auto create Body Object
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     */
    public batchCreateLoadBalancers(batchCreateLoadBalancersRequest?: BatchCreateLoadBalancersRequest): Promise<BatchCreateLoadBalancersResponse> {
        const options = ParamCreater().batchCreateLoadBalancers(batchCreateLoadBalancersRequest);
     ...
     * @throws {RequiredError}
     */
    public batchDeleteCertificates(batchDeleteCertificatesRequest?: BatchDeleteCertificatesRequest): Promise<BatchDeleteCertificatesResponse> {
        const options = ParamCreater().batchDeleteCertificates(batchDeleteCertificatesRequest);
     ...
     * @throws {RequiredError}
     */
    public batchDeleteListeners(batchDeleteListenersRequest?: BatchDeleteListenersRequest): Promise<BatchDeleteListenersResponse> {
        const options = ParamCreater().batchDeleteListeners(batchDeleteListenersRequest);
     ...
     * @throws {RequiredError}
     */
    public batchDeleteLoadbalancers(batchDeleteLoadbalancersRequest?: BatchDeleteLoadbalancersRequest): Promise<BatchDeleteLoadbalancersResponse> {
        const options = ParamCreater().batchDeleteLoadbalancers(batchDeleteLoadbalancersRequest);
     ...
     * @throws {RequiredError}
     */
    public batchDeletePools(batchDeletePoolsRequest?: BatchDeletePoolsRequest): Promise<BatchDeletePoolsResponse> {
        const options = ParamCreater().batchDeletePools(batchDeletePoolsRequest);
     ...
     * @throws {RequiredError}
     */
    public batchDisableDomainIPs(batchDisableDomainIPsRequest?: BatchDisableDomainIPsRequest): Promise<BatchDisableDomainIPsResponse> {
        const options = ParamCreater().batchDisableDomainIPs(batchDisableDomainIPsRequest);
     ...
     * @throws {RequiredError}
     */
    public batchEnableDomainIPs(batchEnableDomainIPsRequest?: BatchEnableDomainIPsRequest): Promise<BatchEnableDomainIPsResponse> {
        const options = ParamCreater().batchEnableDomainIPs(batchEnableDomainIPsRequest);
     ...
     * @throws {RequiredError}
     */
    public changeListenerTags(changeListenerTagsRequest?: ChangeListenerTagsRequest): Promise<ChangeListenerTagsResponse> {
        const options = ParamCreater().changeListenerTags(changeListenerTagsRequest);
     ...
     * @throws {RequiredError}
     */
    public changeLoadbalancerTags(changeLoadbalancerTagsRequest?: ChangeLoadbalancerTagsRequest): Promise<ChangeLoadbalancerTagsResponse> {
        const options = ParamCreater().changeLoadbalancerTags(changeLoadbalancerTagsRequest);
     ...
     * @throws {RequiredError}
     */
    public cloneListener(cloneListenerRequest?: CloneListenerRequest): Promise<CloneListenerResponse> {
        const options = ParamCreater().cloneListener(cloneListenerRequest);
     ...
     * @throws {RequiredError}
     */
    public cloneLoadbalancer(cloneLoadbalancerRequest?: CloneLoadbalancerRequest): Promise<CloneLoadbalancerResponse> {
        const options = ParamCreater().cloneLoadbalancer(cloneLoadbalancerRequest);
     ...
     * Please refer to HUAWEI cloud API Explorer for details.
     *
     * @summary 级联删除负载均衡器及关联EIP
     * @param {string} loadbalancerId **参数解释**：负载均衡器ID。  **约束限制**：不涉及  **取值范围**：不涉及  **默认取值**：不涉及
     * @param {DeleteLoadBalancerCascadeRequestBody} deleteLoadBalancerCascadeRequestBody This is a auto create Body Object
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     */
    public deleteLoadBalancerCascade(deleteLoadBalancerCascadeRequest?: DeleteLoadBalancerCascadeRequest): Promise<DeleteLoadBalancerCascadeResponse> {
        const options = ParamCreater().deleteLoadBalancerCascade(deleteLoadBalancerCascadeRequest);
     ...
     * @throws {RequiredError}
     */
    public deletePoolCascade(deletePoolCascadeRequest?: DeletePoolCascadeRequest): Promise<DeletePoolCascadeResponse> {
        const options = ParamCreater().deletePoolCascade(deletePoolCascadeRequest);
     ...
     * @throws {RequiredError}
     */
    public listAllL7Rules(listAllL7RulesRequest?: ListAllL7RulesRequest): Promise<ListAllL7RulesResponse> {
        const options = ParamCreater().listAllL7Rules(listAllL7RulesRequest);
     ...
     * @param {number} [limit] **参数解释**：每页返回的个数。  **约束限制**：不涉及  **取值范围**：0-2000  **默认取值**：2000
     * @param {boolean} [pageReverse] **参数解释**：是否反向查询。  **约束限制**： - 必须与limit一起使用。 - 当page_reverse&#x3D;true时，若要查询上一页，marker取值为当前页返回值的previous_marker。  **取值范围**： - true：查询上一页。 - false：查询下一页。  **默认取值**：false
     * @param {Array<string>} [name] **参数解释**：后端服务器名称。 支持多值查询，查询条件格式：*name&#x3D;xxx&amp;name&#x3D;xxx*。  **约束限制**：不涉及  **取值范围**：不涉及  **默认取值**：不涉及
     * @param {Array<number>} [weight] **参数解释**：后端服务器的权重，请求按权重在同一后端服务器组下的后端服务器间分发。权重为0的后端不再接受新的请求。当后端服务器所在的后端服务器组的lb_algorithm的取值为SOURCE_IP时，该字段无效。 支持多值查询，查询条件格式：*weight&#x3D;xxx&amp;weight&#x3D;xxx*。  **约束限制**：不涉及  **取值范围**：不涉及  **默认取值**：不涉及
     * @param {boolean} [adminStateUp] **参数解释**：后端服务器的管理状态。  **约束限制**：不涉及  **取值范围**：true、false  **默认取值**：不涉及
     * @param {Array<string>} [subnetCidrId] **参数解释**：后端服务器所在的子网ID。该子网和后端服务器关联的负载均衡器的子网必须在同一VPC下。只支持指定IPv4的子网ID。 支持多值查询，查询条件格式：***subnet_cidr_id&#x3D;xxx&amp;subnet_cidr_id&#x3D;xxx*。  **约束限制**：不涉及  **取值范围**：不涉及  **默认取值**：不涉及
     * @param {Array<string>} [address] **参数解释**：后端服务器的对应的IP地址，这个IP必须在subnet_cidr_id字段的子网网段中。例如：192.168.3.11。 支持多值查询，查询条件格式：*address&#x3D;xxx&amp;address&#x3D;xxx*。  **约束限制**：不涉及  **取值范围**：不涉及  **默认取值**：不涉及
     * @param {Array<number>} [protocolPort] **参数解释**：后端服务器端口号。 支持多值查询，查询条件格式：*protocol_port&#x3D;xxx&amp;protocol_port&#x3D;xxx*。  **约束限制**：不涉及  **取值范围**：不涉及  **默认取值**：不涉及
     * @param {Array<string>} [id] **参数解释**：后端服务器ID。 支持多值查询，查询条件格式：*id&#x3D;xxx&amp;id&#x3D;xxx*。  **约束限制**：不涉及  **取值范围**：不涉及  **默认取值**：不涉及
     * @param {Array<string>} [operatingStatus] **参数解释**：后端服务器的健康状态。 支持多值查询，查询条件格式：*operating_status&#x3D;xxx&amp;operating_status&#x3D;*。  **约束限制**：不涉及  **取值范围**： - NO_MONITOR：后端服务器所在的服务器组没有开启健康检查。 - INITIAL：初始化中，表示负载均衡实例配置了健康检查，但查不到数据。 - ONLINE：后端服务器正常。 - OFFLINE：后端服务器关联的ECS服务器不存在或已关机。 - UNKNOWN：未关联LB实例的pool下的member，或者创建后从未关联ECS的云服务器类型member，状态置为UNKNOWN。  **默认取值**：不涉及
     ...
     * @param {Array<string>} [ipVersion] **参数解释**：IP版本。 支持多值查询，查询条件格式：*ip_version&#x3D;xxx&amp;ip_version&#x3D;xxx*。  **约束限制**：不涉及  **取值范围**：v4、v6  **默认取值**：不涉及
     * @param {Array<string>} [poolId] **参数解释**：member所属的服务器组ID。 支持多值查询，查询条件格式：*pool_id&#x3D;xxx&amp;pool_id&#x3D;xxx*。  **约束限制**：不涉及  **取值范围**：不涉及  **默认取值**：不涉及
     * @param {Array<string>} [loadbalancerId] **参数解释**：负载均衡器ID。 支持多值查询，查询条件格式：*loadbalancer_id&#x3D;xxx&amp;loadbalancer_id&#x3D;xxx*。  **约束限制**：不涉及  **取值范围**：不涉及  **默认取值**：不涉及
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     */
     ...
     * @param {number} [limit] **参数解释**：每页返回的个数。  **约束限制**：不涉及  **取值范围**：0-2000  **默认取值**：2000
     * @param {boolean} [pageReverse] **参数解释**：是否反向查询。  **约束限制**： - 必须与limit一起使用。 - 当page_reverse&#x3D;true时，若要查询上一页，marker取值为当前页返回值的previous_marker。  **取值范围**： - true：查询上一页。 - false：查询下一页。  **默认取值**：false
     * @param {Array<string>} [id] **参数解释**：证书ID。 支持多值查询，查询条件格式：*id&#x3D;xxx&amp;id&#x3D;xxx*。  **约束限制**：不涉及  **取值范围**：不涉及  **默认取值**：不涉及
     * @param {Array<string>} [name] **参数解释**：证书的名称。 支持多值查询，查询条件格式：*name&#x3D;xxx&amp;name&#x3D;xxx*。  **约束限制**：不涉及  **取值范围**：不涉及  **默认取值**：不涉及
     * @param {Array<string>} [description] **参数解释**：证书的描述。 支持多值查询，查询条件格式：*description&#x3D;xxx&amp;description&#x3D;xxx*。  **约束限制**：不涉及  **取值范围**：不涉及  **默认取值**：不涉及
     ...
     * @param {number} [limit] **参数解释**：每页返回的个数。  **约束限制**：不涉及  **取值范围**：0-2000  **默认取值**：2000
     * @param {boolean} [pageReverse] **参数解释**：是否反向查询。  **约束限制**： - 必须与limit一起使用。 - 当page_reverse&#x3D;true时，若要查询上一页，marker取值为当前页返回值的previous_marker。  **取值范围**： - true：查询上一页。 - false：查询下一页。  **默认取值**：false
     * @param {Array<string>} [ipAddress] **参数解释**：IPv4或IPv6地址。 支持多值查询，查询条件格式： *ip_address&#x3D;xxx&amp;ip_address&#x3D;xxx*。  **约束限制**：必须是当前负载均衡器绑定的私网地址或者公网地址。  **取值范围**：不涉及  **默认取值**：不涉及
     * @param {boolean} [enable] **参数解释**：IP地址是否已加入到域名解析。  **约束限制**：不涉及  **取值范围**： - true：已加入域名解析。 - false：未加入域名解析。  **默认取值**：不涉及
     * @param {Array<string>} [type] **参数解释**：IP地址类型。 支持多值查询，查询条件格式： *type&#x3D;xxx&amp;type&#x3D;xxx*。  **约束限制**：不涉及  **取值范围**： - vip：私网IP。 - eip：公网IP。  **默认取值**：不涉及
     * @param {Array<string>} [domainName] **参数解释**：当前IP地址关联的负载均衡实例域名。 支持多值查询，查询条件格式： *domain_name&#x3D;xxx&amp;domain_name&#x3D;xxx*。  **约束限制**： - 如果IP为私网类型，则这里为负载均衡实例的私网域名。 - 如果IP为公网类型，则这里为负载均衡实例的公网域名。  **取值范围**：不涉及  **默认取值**：不涉及
     ...
     * @throws {RequiredError}
     */
    public listDomainIPs(listDomainIPsRequest?: ListDomainIPsRequest): Promise<ListDomainIPsResponse> {
        const options = ParamCreater().listDomainIPs(listDomainIPsRequest);
     ...
     * Please refer to HUAWEI cloud API Explorer for details.
     *
     * @summary 查询当前租户ELB服务的特性配置
     * @param {string} [feature] **参数解释**：特性名称。  **约束限制**：不涉及  **取值范围**：不涉及  **默认取值**：不涉及
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     */
    public listFeatureConfigs(listFeatureConfigsRequest?: ListFeatureConfigsRequest): Promise<ListFeatureConfigsResponse> {
        const options = ParamCreater().listFeatureConfigs(listFeatureConfigsRequest);
     ...
     * @param {boolean} [listAll] **参数解释**：是否查询当前租户所有的弹性上限规格。  **约束限制**：不涉及  **取值范围**： - true：查询当前租户所有的弹性上限规格（l4_elastic_max、l7_elastic_max）。 - false：查询租户弹性上限规格中最大的规格（l4类型优先比较cps指标，然后是带宽；l7类型优先比较https cps指标然后是qps指标）。  **默认取值**：不涉及
     * @param {boolean} [flavorSoldOut] **参数解释**：[是否售罄。](tag:hws)[是否无法购买该规格的LB。](tag:hws_hk,hws_eu,hws_eu_wb,hws_test,fcs,dt,ctc,cmcc,tm,sbc,hk_sbc,hk_tm,hk_vdf,srg,ct)  **约束限制**：不涉及  **取值范围**： - true：[已售罄，将](tag:hws)无法购买该规格的LB。 - false：[未售罄，](tag:hws)可购买该规格的LB。  **默认取值**：不涉及
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     */
     ...
     * @param {number} [limit] **参数解释**：每页返回的个数。  **约束限制**：不涉及  **取值范围**：0-2000  **默认取值**：2000
     * @param {boolean} [pageReverse] **参数解释**：是否反向查询。  **约束限制**： - 必须与limit一起使用。 - 当page_reverse&#x3D;true时，若要查询上一页，marker取值为当前页返回值的previous_marker。  **取值范围**： - true：查询上一页。 - false：查询下一页。  **默认取值**：false
     * @param {Array<string>} [id] **参数解释**：健康检查ID。 支持多值查询，查询条件格式：*id&#x3D;xxx&amp;id&#x3D;xxx****。  **约束限制**：不涉及  **取值范围**：不涉及  **默认取值**：不涉及
     * @param {Array<number>} [monitorPort] **参数解释**：健康检查端口号。 支持多值查询，查询条件格式：***monitor_port&#x3D;xxx&amp;monitor_port&#x3D;xxx***。  **约束限制**：不涉及  **取值范围**：不涉及  **默认取值**：不涉及
     * @param {Array<string>} [domainName] **参数解释**：发送健康检查请求的域名。 支持多值查询，查询条件格式：**domain_name&#x3D;xxx&amp;domain_name&#x3D;xxx**。  **约束限制**：不涉及  **取值范围**：以数字或字母开头，只能包含数字、字母、’-’、’.’。  **默认取值**：不涉及
     * @param {Array<string>} [name] **参数解释**：健康检查名称。 支持多值查询，查询条件格式：*name&#x3D;xxx&amp;name&#x3D;xxx*。  **约束限制**：不涉及  **取值范围**：不涉及  **默认取值**：不涉及
     * @param {Array<number>} [delay] **参数解释**：健康检查间隔。 支持多值查询，查询条件格式：*delay&#x3D;xxx&amp;delay&#x3D;xxx*。  **约束限制**：不涉及  **取值范围**：1-50，单位：秒。  **默认取值**：不涉及
     * @param {Array<number>} [maxRetries] **参数解释**：健康检查连续成功多少次后，将后端服务器的健康检查状态由OFFLINE判定为ONLINE。 支持多值查询，查询条件格式：*******max_retries&#x3D;xxx&amp;max_retries&#x3D;xxx*******。  **约束限制**：不涉及  **取值范围**：1-10  **默认取值**：不涉及
     ...
     * @param {Array<string>} [type] **参数解释**：健康检查请求协议。 支持多值查询，查询条件格式：*****type&#x3D;xxx&amp;type&#x3D;xxx*****。  **约束限制**：不涉及  **取值范围**：TCP、UDP_CONNECT、HTTP、HTTPS、TLS、GRPC[和GRPCS](tag:not_open)。  **默认取值**：不涉及
     ...
     * @param {Array<string>} [id] **参数解释**：转发策略ID。 支持多值查询，查询条件格式：*id&#x3D;xxx&amp;id&#x3D;xxx*。  **约束限制**：不涉及  **取值范围**：不涉及  **默认取值**：不涉及
     * @param {Array<string>} [name] **参数解释**：转发策略名称。 支持多值查询，查询条件格式：**name&#x3D;xxx&amp;name&#x3D;xxx**。  **约束限制**：不涉及  **取值范围**：不涉及  **默认取值**：不涉及
     * @param {Array<string>} [description] **参数解释**：转发策略额描述信息。 支持多值查询，查询条件格式：*description&#x3D;xxx&amp;description&#x3D;xxx*。  **约束限制**：不涉及  **取值范围**：不涉及  **默认取值**：不涉及
     * @param {boolean} [adminStateUp] **参数解释**：转发策略的管理状态。  **约束限制**：不涉及  **取值范围**：不涉及  **默认取值**：不涉及
     * @param {Array<string>} [listenerId] **参数解释**：转发策略所属的监听器ID。 支持多值查询，查询条件格式：*******listener_id&#x3D;xxx&amp;listener_id&#x3D;xxx*******。  **约束限制**：不涉及  **取值范围**：不涉及  **默认取值**：不涉及
     * @param {Array<number>} [position] **参数解释**：转发策略的优先级。 支持多值查询，查询条件格式：****position&#x3D;xxx&amp;position&#x3D;xxx****。  **约束限制**：不涉及  **取值范围**：不涉及  **默认取值**：不涉及
     * @param {Array<string>} [action] **参数解释**：转发策略的转发动作。 支持多值查询，查询条件格式：*****action&#x3D;xxx&amp;action&#x3D;xxx*****。  **约束限制**：不涉及  **取值范围**： - REDIRECT_TO_POOL：转发到后端服务器组。 - REDIRECT_TO_LISTENER：重定向到监听器。 - REDIRECT_TO_URL：重定向到URL。 - FIXED_RESPONSE：返回固定响应体。  **默认取值**：不涉及
     * @param {Array<string>} [redirectUrl] **参数解释**：转发到的url。 支持多值查询，查询条件格式：****redirect_url&#x3D;xxx&amp;redirect_url&#x3D;xxx****。  **约束限制**：不涉及  **取值范围**：不涉及  **默认取值**：不涉及  不支持该字段，请勿使用。
     * @param {Array<string>} [redirectPoolId] **参数解释**：转发到pool的ID。 支持多值查询，查询条件格式：***redirect_pool_id&#x3D;xxx&amp;redirect_pool_id&#x3D;xxx***。  **约束限制**：不涉及  **取值范围**：不涉及  **默认取值**：不涉及
     * @param {Array<string>} [redirectListenerId] **参数解释**：转发到的listener的ID。 支持多值查询，查询条件格式：**redirect_listener_id&#x3D;xxx&amp;redirect_listener_id&#x3D;xxx**。  **约束限制**：不涉及  **取值范围**：不涉及  **默认取值**：不涉及
     * @param {Array<string>} [provisioningStatus] **参数解释**：转发策略的配置状态。 支持多值查询，查询条件格式：*provisioning_status&#x3D;xxx&amp;provisioning_status&#x3D;xxx*。  **约束限制**：不涉及  **取值范围**： - ACTIVE: 表示正常。 - ERROR: 表示当前策略与同一监听器下的其他策略存在相同的规则配置。  **默认取值**：不涉及
     * @param {boolean} [displayAllRules] **参数解释**：是否显示转发策略下的rule详细信息。  **约束限制**：不涉及  **取值范围**： - true：显示policy下面的rule的详细信息。 - false：只显示policy下面的rule的id信息。  **默认取值**：不涉及
     * @param {Array<number>} [priority] **参数解释**：转发策略的优先级。数值越小，优先级越高。 支持多值查询，查询条件格式：*priority&#x3D;xxx&amp;priority&#x3D;xxx*。  **约束限制**：不涉及  **取值范围**：不涉及  **默认取值**：不涉及  [不支持该字段，请勿使用。](tag:hcso_dt)
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     */
     ...
     * @param {boolean} [adminStateUp] **参数解释**：监听器的管理状态。  **约束限制**：不涉及  **取值范围**：不涉及  **默认取值**：不涉及  [不支持该字段，请勿使用。](tag:dt,hcso_dt)
     * @param {boolean} [includeRecycleBin] **参数解释**：查询结果是否包含回收站负载均衡器的监听器  **约束限制**：不涉及  **取值范围**： - true ：包含回收站elb的监听器。 - false：不包含回收站elb的监听器。  **默认取值**：不涉及
     * @param {Array<number>} [connectionLimit] **参数解释**：监听器的最大连接数。 支持多值查询，查询条件格式：*connection_limit&#x3D;xxx&amp;connection_limit&#x3D;xxx*。  **约束限制**：不涉及  **取值范围**：不涉及  **默认取值**：不涉及
     * @param {Array<string>} [defaultPoolId] **参数解释**：监听器的默认后端服务器组ID。当请求没有匹配的转发策略时，转发到默认后端服务器组上处理。 支持多值查询，查询条件格式：*default_pool_id&#x3D;xxx&amp;default_pool_id&#x3D;xxx*。  **约束限制**：不涉及  **取值范围**：不涉及  **默认取值**：不涉及
     * @param {Array<string>} [id] **参数解释**：监听器ID。 支持多值查询，查询条件格式：*id&#x3D;xxx&amp;id&#x3D;xxx*。  **约束限制**：不涉及  **取值范围**：不涉及  **默认取值**：不涉及
     * @param {Array<string>} [name] **参数解释**：监听器名称。 支持多值查询，查询条件格式：*name&#x3D;xxx&amp;name&#x3D;xxx*。  **约束限制**：不涉及  **取值范围**：不涉及  **默认取值**：不涉及
     * @param {boolean} [http2Enable] **参数解释**：客户端与LB之间的HTTPS请求的HTTP2功能的开启状态。 开启后，可提升客户端与LB间的访问性能，但LB与后端服务器间仍采用HTTP1.X协议。  **约束限制**：不涉及  **取值范围**：true 开启，false 不开启。  **默认取值**：不涉及  [不支持QUIC。](tag:tm,hws_eu,g42,hk_g42,hcso_dt,dt)
     * @param {Array<string>} [loadbalancerId] **参数解释**：监听器所属的负载均衡器ID。 支持多值查询，查询条件格式：*loadbalancer_id&#x3D;xxx&amp;loadbalancer_id&#x3D;xxx*。  **约束限制**：不涉及  **取值范围**：不涉及  **默认取值**：不涉及
     * @param {Array<string>} [tlsCiphersPolicy] **参数解释**：监听器使用的安全策略。 支持多值查询，查询条件格式：*tls_ciphers_policy&#x3D;xxx&amp;tls_ciphers_policy&#x3D;xxx*。  **约束限制**：不涉及  **取值范围**：不涉及  **默认取值**：不涉及
     ...
     * @param {Array<string>} [memberDeviceId] **参数解释**：后端服务器对应的弹性云服务器的ID。仅用于查询条件，不作为响应参数字段。 支持多值查询，查询条件格式：*member_device_id&#x3D;xxx&amp;member_device_id&#x3D;xxx*。  **约束限制**：不涉及  **取值范围**：不涉及  **默认取值**：不涉及
     ...
     * @param {boolean} [enableMemberRetry] **参数解释**：是否开启后端服务器的重试。  **约束限制**：不涉及  **取值范围**：true 开启，false 不开启。  **默认取值**：不涉及
     * @param {Array<number>} [memberTimeout] **参数解释**：等待后端服务器响应超时时间。请求转发后端服务器后，在等待超时member_timeout时长没有响应，负载均衡将终止等待，并返回HTTP504错误码。 支持多值查询，查询条件格式：*member_timeout&#x3D;xxx&amp;member_timeout&#x3D;xxx*。  **约束限制**：不涉及  **取值范围**：不涉及  **默认取值**：不涉及
     * @param {Array<number>} [clientTimeout] **参数解释**：等待客户端请求超时时间，包括两种情况： - 读取整个客户端请求头的超时时长：如果客户端未在超时时长内发送完整个请求头，则请求将被中断 - 两个连续body体的数据包到达LB的时间间隔，超出client_timeout将会断开连接。 支持多值查询，查询条件格式：*client_timeout&#x3D;xxx&amp;client_timeout&#x3D;xxx*。  **约束限制**：不涉及  **取值范围**：不涉及  **默认取值**：不涉及
     * @param {Array<number>} [keepaliveTimeout] **参数解释**：客户端连接空闲超时时间。在超过keepalive_timeout时长一直没有请求，负载均衡会暂时中断当前连接，直到下一次请求时重新建立新的连接。 支持多值查询，查询条件格式：*keepalive_timeout&#x3D;xxx&amp;keepalive_timeout&#x3D;xxx*。  **约束限制**：不涉及  **取值范围**：不涉及  **默认取值**：不涉及
     * @param {boolean} [transparentClientIpEnable] **参数解释**：是否开启后客户端IP地址将透传到后端服务器。 [仅作用于共享型LB的TCP/UDP监听器。](tag:hws,hws_hk,ocb,ctc,g42,tm,cmcc,hk_g42,hws_ocb,hk_vdf,srg,fcs,dt,hk_tm)  **约束限制**：不涉及  **取值范围**：true开启，false不开启。  **默认取值**：不涉及
     * @param {boolean} [proxyProtocolEnable] **参数解释**：是否开启proxy_protocol。  **约束限制**：不涉及  **取值范围**：true开启，false不开启。  **默认取值**：不涉及
     * @param {boolean} [enhanceL7policyEnable] **参数解释**：是否开启高级转发策略功能。开启高级转发策略后，支持更灵活的转发策略和转发规则设置。  **约束限制**：不涉及  **取值范围**：true开启，false不开启。  **默认取值**：不涉及  [荷兰region不支持该字段，请勿使用。](tag:dt)
     * @param {Array<string>} [memberInstanceId] **参数解释**：后端服务器ID。仅用于查询条件，不作为响应参数字段。 支持多值查询，查询条件格式：*member_instance_id&#x3D;xxx&amp;member_instance_id&#x3D;xxx*。  **约束限制**：不涉及  **取值范围**：不涉及  **默认取值**：不涉及
     * @param {Array<string>} [protectionStatus] **参数解释**：修改保护状态。 支持多值查询，查询条件格式：*protection_status&#x3D;xxx&amp;protection_status&#x3D;xxx*。  **约束限制**：不涉及  **取值范围**： - nonProtection: 不保护，默认值为nonProtection - consoleProtection: 控制台修改保护  **默认取值**：不涉及
     * @param {boolean} [sslEarlyDataEnable] **参数解释**：是否开启监听器0-RTT功能。  **约束限制**：不涉及  **取值范围**：true开启，false不开启。  **默认取值**：不涉及
     * @param {boolean} [nat64Enable] **参数解释**：是否开启nat64地址转换功能。  **约束限制**：不涉及  **取值范围**：true开启，false不开启。  **默认取值**：不涉及
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     */
     ...
     * @param {boolean} [includeRecycleBin] **参数解释**：查询结果是否包含回收站负载均衡器  **约束限制**：不涉及  **取值范围**： - true ：包含回收站elb。 - false：不包含回收站elb。  **默认取值**：不涉及
     ...
     * @param {Array<string>} [l7ScaleFlavorId] **参数解释**：七层弹性Flavor ID。 支持多值查询，查询条件格式： *l7_scale_flavor_id&#x3D;xxx&amp;l7_scale_flavor_id&#x3D;xxx*。  **约束限制**：不涉及  **取值范围**：不涉及  **默认取值**：不涉及  不支持该字段，请勿使用。
     ...
     * @param {string} [logTopicId] **参数解释**：LB实例绑定的logtank的topic id信息。 支持多值查询，查询条件格式： *log_topic_id&#x3D;xxx&amp;log_topic_id&#x3D;xxx*。  **约束限制**：不涉及  **取值范围**：不涉及  **默认取值**：不涉及
     ...
     * Please refer to HUAWEI cloud API Explorer for details.
     *
     * @summary 查询指定ELB实例的特性配置
     * @param {string} loadbalancerId **参数解释**：负载均衡器ID。  **约束限制**：不涉及  **取值范围**：不涉及  **默认取值**：不涉及
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     */
    public listLoadbalancerFeature(listLoadbalancerFeatureRequest?: ListLoadbalancerFeatureRequest): Promise<ListLoadbalancerFeatureResponse> {
        const options = ParamCreater().listLoadbalancerFeature(listLoadbalancerFeatureRequest);
     ...
     * @param {Array<string>} [id] **参数解释**：云日志记录ID。 支持多值查询，查询条件格式：id&#x3D;xxx&amp;id&#x3D;xxx。  **约束限制**：不涉及  **取值范围**：不涉及  **默认取值**：不涉及
     * @param {Array<string>} [loadbalancerId] **参数解释**：负载均衡器ID。 支持多值查询，查询条件格式：loadbalancer_id&#x3D;xxx&amp;loadbalancer_id&#x3D;xxx。  **约束限制**：不涉及  **取值范围**：不涉及  **默认取值**：不涉及
     * @param {Array<string>} [logGroupId] **参数解释**：云日志分组ID。 支持多值查询，查询条件格式：log_group_id&#x3D;xxx&amp;log_group_id&#x3D;xxx。  **约束限制**：不涉及  **取值范围**：不涉及  **默认取值**：不涉及
     * @param {Array<string>} [logTopicId] **参数解释**：云日志主题ID 支持多值查询，查询条件格式：log_topic_id&#x3D;xxx&amp;log_topic_id&#x3D;xxx。  **约束限制**：不涉及  **取值范围**：不涉及  **默认取值**：不涉及
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     */
     ...
     * @param {number} [limit] **参数解释**：每页返回的个数。  **约束限制**：不涉及  **取值范围**：0-2000  **默认取值**：2000
     * @param {boolean} [pageReverse] **参数解释**：是否反向查询。  **约束限制**： - 必须与limit一起使用。 - 当page_reverse&#x3D;true时，若要查询上一页，marker取值为当前页返回值的previous_marker。  **取值范围**： - true：查询上一页。 - false：查询下一页。  **默认取值**：false
     * @param {Array<string>} [description] **参数解释**：后端服务器组的描述信息。 支持多值查询，查询条件格式：*description&#x3D;xxx&amp;description&#x3D;xxx*。  **约束限制**：不涉及  **取值范围**：不涉及  **默认取值**：不涉及
     * @param {Array<string>} [healthmonitorId] **参数解释**：后端服务器组关联的健康检查的ID。 支持多值查询，查询条件格式：*healthmonitor_id&#x3D;xxx&amp;healthmonitor_id&#x3D;xxx*。  **约束限制**：不涉及  **取值范围**：不涉及  **默认取值**：不涉及
     ...
     * @param {Array<string>} [memberAddress] **参数解释**：后端服务器的IP地址。 支持多值查询，查询条件格式：*member_address&#x3D;xxx&amp;member_address&#x3D;xxx*。  **约束限制**：仅用于查询条件，不作为响应参数字段。  **取值范围**：不涉及  **默认取值**：不涉及
     * @param {Array<string>} [memberDeviceId] **参数解释**：后端服务器对应的弹性云服务器的ID。 支持多值查询，查询条件格式：*member_device_id&#x3D;xxx&amp;member_device_id&#x3D;xxx*。  **约束限制**：仅用于查询条件，不作为响应参数字段。  **取值范围**：不涉及  **默认取值**：不涉及
     * @param {Array<string>} [listenerId] **参数解释**：关联的监听器ID，包括通过l7policy关联的。 支持多值查询，查询条件格式：*listener_id&#x3D;xxx&amp;listener_id&#x3D;xxx*。  **约束限制**：不涉及  **取值范围**：不涉及  **默认取值**：不涉及
     * @param {Array<string>} [memberInstanceId] **参数解释**：后端服务器ID。 支持多值查询，查询条件格式：*member_instance_id&#x3D;xxx&amp;member_instance_id&#x3D;xxx*。  **约束限制**：仅用于查询条件，不作为响应参数字段。  **取值范围**：不涉及  **默认取值**：不涉及
     ...
     * @param {number} [limit] **参数解释**：每页返回的个数。  **约束限制**：不涉及  **取值范围**：0-2000  **默认取值**：2000
     * @param {boolean} [pageReverse] **参数解释**：是否反向查询。  **约束限制**： - 必须与limit一起使用。 - 当page_reverse&#x3D;true时，若要查询上一页，marker取值为当前页返回值的previous_marker。  **取值范围**： - true：查询上一页。 - false：查询下一页。  **默认取值**：false
     * @param {Array<string>} [name] **参数解释**：后端服务器名称。注意：该名称并非ECS名称。 支持多值查询，查询条件格式：*name&#x3D;xxx&amp;name&#x3D;xxx*。  **约束限制**：不涉及  **取值范围**：不涉及  **默认取值**：不涉及
     * @param {Array<number>} [weight] **参数解释**：后端服务器的权重，请求将根据pool配置的负载均衡算法和后端服务器的权重进行负载分发。 权重值越大，分发的请求越多。权重为0的后端不再接受新的请求。 支持多值查询，查询条件格式：*weight&#x3D;xxx&amp;weight&#x3D;xxx*。  **约束限制**：不涉及  **取值范围**：0-100  **默认取值**：不涉及
     * @param {boolean} [adminStateUp] **参数解释**：后端服务器的管理状态。  **约束限制**：不涉及  **取值范围**：true、false  **默认取值**：不涉及
     * @param {Array<string>} [subnetCidrId] **参数解释**：后端服务器所在子网的IPv4子网ID或IPv6子网ID。 支持多值查询，查询条件格式：***subnet_cidr_id&#x3D;xxx&amp;subnet_cidr_id&#x3D;xxx*。  **约束限制**：不涉及  **取值范围**：不涉及  **默认取值**：不涉及
     * @param {Array<string>} [address] **参数解释**：后端服务器对应的IPv4或IPv6地址。 支持多值查询，查询条件格式：*address&#x3D;xxx&amp;address&#x3D;xxx*。  **约束限制**：不涉及  **取值范围**：不涉及  **默认取值**：不涉及
     * @param {Array<number>} [protocolPort] **参数解释**：后端服务器业务端口号。 支持多值查询，查询条件格式：*protocol_port&#x3D;xxx&amp;protocol_port&#x3D;xxx*。  **约束限制**：不涉及  **取值范围**：不涉及  **默认取值**：不涉及
     * @param {Array<string>} [id] **参数解释**：后端服务器ID。 支持多值查询，查询条件格式：*id&#x3D;xxx&amp;id&#x3D;xxx*。  **约束限制**：不涉及  **取值范围**：不涉及  **默认取值**：不涉及
     * @param {Array<string>} [operatingStatus] **参数解释**：后端服务器的健康状态。 支持多值查询，查询条件格式：*operating_status&#x3D;xxx&amp;operating_status&#x3D;xxx*。  **约束限制**：不涉及  **取值范围**： - NO_MONITOR：后端服务器所在的服务器组没有开启健康检查。 - INITIAL：初始化中，表示负载均衡实例配置了健康检查，但查不到数据。 - ONLINE：后端服务器正常。 - OFFLINE：后端服务器关联的ECS服务器不存在或已关机。 - UNKNOWN：未关联LB实例的pool下的member，或者创建后从未关联ECS的云服务器类型member，状态置为UNKNOWN。  **默认取值**：不涉及
     * @param {Array<string>} [enterpriseProjectId] **参数解释**：资源所属的企业项目ID。 支持多值查询，查询条件格式：*enterprise_project_id&#x3D;xxx&amp;enterprise_project_id&#x3D;xxx*。  **约束限制**： - 如果enterprise_project_id不传值，默认查询所有企业项目下的资源，鉴权按照细粒度权限鉴权，必须在用户组下分配elb:members:list权限。 - 如果enterprise_project_id传值，鉴权按照企业项目权限鉴权，分为传入具体eps_id和all_granted_eps两种场景，前者查询指定eps_id的eps下的资源，后者查询的是所有有list权限的eps下的资源。  **取值范围**：不涉及  **默认取值**：不涉及  [不支持该字段，请勿使用。](tag:dt,hcso_dt)
     * @param {Array<string>} [ipVersion] **参数解释**：当前后端服务器的IP地址版本。  **约束限制**：不涉及  **取值范围**：v4、v6。  **默认取值**：不涉及
     * @param {Array<string>} [memberType] **参数解释**：后端服务器的类型。 支持多值查询，查询条件格式：*member_type&#x3D;xxx&amp;member_type&#x3D;xxx*。  **约束限制**：不涉及  **取值范围**： - ip：跨VPC的member。 - instance：关联到ECS的member。  **默认取值**：不涉及
     * @param {Array<string>} [instanceId] **参数解释**：member关联的ECS实例ID，空表示跨VPC场景的member。 支持多值查询，查询条件格式：*instance_id&#x3D;xxx&amp;instance_id&#x3D;xxx*。  **约束限制**：不涉及  **取值范围**：不涉及  **默认取值**：不涉及
     * @param {Array<string>} [availabilityZone] **参数解释**：后端服务器的可用区。 支持多值查询，查询条件格式：*availability_zone&#x3D;xxx&amp;availability_zone&#x3D;xxx*。  **约束限制**：不涉及  **取值范围**：不涉及  **默认取值**：不涉及
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     */
     ...
     * @param {boolean} [pageReverse] **参数解释**：是否反向查询。  **约束限制**： - 必须与limit一起使用。 - 当page_reverse&#x3D;true时，若要查询上一页，marker取值为当前页返回值的previous_marker。  **取值范围**： - true：查询上一页。 - false：查询下一页。  **默认取值**：false
     * @param {Array<string>} [description] **参数解释**：后端服务器组的描述信息 支持多值查询，查询条件格式：*description&#x3D;xxx&amp;description&#x3D;xxx*。  **约束限制**：不涉及  **取值范围**：不涉及  **默认取值**：不涉及
     * @param {boolean} [adminStateUp] **参数解释**：后端服务器组的管理状态。  **约束限制**：不涉及  **取值范围**：不涉及  **默认取值**：不涉及  [不支持该字段，请勿使用。](tag:dt,hcso_dt)
     * @param {Array<string>} [healthmonitorId] **参数解释**：后端服务器组关联的健康检查的ID。 支持多值查询，查询条件格式：*healthmonitor_id&#x3D;xxx&amp;healthmonitor_id&#x3D;xxx*。  **约束限制**：不涉及  **取值范围**：不涉及  **默认取值**：不涉及
     * @param {Array<string>} [id] **参数解释**：后端服务器组的ID。 支持多值查询，查询条件格式：*id&#x3D;xxx&amp;id&#x3D;xxx*。  **约束限制**：不涉及  **取值范围**：不涉及  **默认取值**：不涉及
     * @param {Array<string>} [name] **参数解释**：后端服务器组的名称。 支持多值查询，查询条件格式：*name&#x3D;xxx&amp;name&#x3D;xxx*。  **约束限制**：不涉及  **取值范围**：不涉及  **默认取值**：不涉及
     * @param {Array<string>} [loadbalancerId] **参数解释**：后端服务器组绑定的负载均衡器ID。 支持多值查询，查询条件格式：*loadbalancer_id&#x3D;xxx&amp;loadbalancer_id&#x3D;xxx*。  **约束限制**：不涉及  **取值范围**：不涉及  **默认取值**：不涉及
     ...
     * @param {Array<string>} [memberAddress] **参数解释**：后端服务器的IP地址。仅用于查询条件，不作为响应参数字段。 支持多值查询，查询条件格式：*member_address&#x3D;xxx&amp;member_address&#x3D;xxx*。  **约束限制**：不涉及  **取值范围**：不涉及  **默认取值**：不涉及
     * @param {Array<string>} [memberDeviceId] **参数解释**：后端服务器对应的弹性云服务器的ID。仅用于查询条件，不作为响应参数字段。 支持多值查询，查询条件格式：*member_device_id&#x3D;xxx&amp;member_device_id&#x3D;xxx*。  **约束限制**：不涉及  **取值范围**：不涉及  **默认取值**：不涉及
     * @param {boolean} [memberDeletionProtectionEnable] **参数解释**：是否开启删除保护。  **约束限制**：不涉及  **取值范围**：false 不开启，true 开启，不传查询全部。  **默认取值**：不涉及  [不支持该字段，请勿使用。](tag:hws_eu,g42,hk_g42)  [荷兰region不支持该字段，请勿使用。](tag:dt)
     * @param {Array<string>} [listenerId] **参数解释**：关联的监听器ID，包括通过l7policy关联的。 支持多值查询，查询条件格式：*listener_id&#x3D;xxx&amp;listener_id&#x3D;xxx*。  **约束限制**：不涉及  **取值范围**：不涉及  **默认取值**：不涉及
     * @param {Array<string>} [memberInstanceId] **参数解释**：后端服务器ID。仅用于查询条件，不作为响应参数字段。 支持多值查询，查询条件格式：*member_instance_id&#x3D;xxx&amp;member_instance_id&#x3D;xxx*。  **约束限制**：不涉及  **取值范围**：不涉及  **默认取值**：不涉及
     * @param {Array<string>} [vpcId] **参数解释**：后端服务器组关联的虚拟私有云的ID。  **约束限制**：不涉及  **取值范围**：不涉及  **默认取值**：不涉及
     * @param {Array<string>} [type] **参数解释**：后端服务器组的类型。  **约束限制**：不涉及  **取值范围**： - instance：允许任意类型的后端，type指定为该类型时，vpc_id是必选字段。 - ip：只能添加IP类型后端，type指定为该类型时，vpc_id不允许指定。 - 空字符串（\&quot;\&quot;）：允许任意类型的后端  **默认取值**：不涉及
     * @param {Array<string>} [protectionStatus] **参数解释**：修改保护状态,  **约束限制**：不涉及  **取值范围**： - nonProtection: 不保护，默认值为nonProtection - consoleProtection: 控制台修改保护  **默认取值**：不涉及
     * @param {boolean} [connectionDrain] **参数解释**：查询是否开启延迟注销的功能，查询条件格式：*connection_drain&#x3D;true或者*connection_drain&#x3D;false  **约束限制**：不涉及  **取值范围**：不涉及  **默认取值**：不涉及
     * @param {string} [poolHealth] **参数解释**：查询是否开启后端全下线转发功能，查询条件格式：*pool_health&#x3D;minimum_healthy_member_count&#x3D;0或者*pool_health&#x3D;minimum_healthy_member_count&#x3D;1  **约束限制**：不涉及  **取值范围**：不涉及  **默认取值**：不涉及
     * @param {boolean} [anyPortEnable] **参数解释**：后端是否开启全端口转发。开启后，后端服务器端口与前端监听器端口保持一致。  **约束限制**：不涉及  **取值范围**：false 不开启，true 开启。  **默认取值**：不涉及
     * @param {string} [publicBorderGroup] **参数解释**：公网边界组。 支持多值查询，查询条件格式：*public_border_group&#x3D;xxx&amp;public_border_group&#x3D;xxx*。  **约束限制**：不涉及  **取值范围**： - center：表示中心站点的公网边界组 - 边缘站点名称：表示边缘站点的公网边界组  **默认取值**：不涉及
     * @param {number} [quicCidLen] **参数解释**：查询相同QUIC CID策略配置的后端服务器组，仅用于查询条件，不作为响应参数字段。 支持多值查询，查询条件格式：*quic_cid_len&#x3D;3&amp;quic_cid_len&#x3D;5*  **约束限制**：不涉及  **取值范围**：不涉及  **默认取值**：不涉及
     * @param {number} [quicCidOffset] **参数解释**：查询相同QUIC CID策略配置的后端服务器组，仅用于查询条件，不作为响应参数字段。 支持多值查询，查询条件格式：*quic_cid_offset&#x3D;1&amp;quic_cid_offset&#x3D;3*  **约束限制**：不涉及  **取值范围**：不涉及  **默认取值**：不涉及
     * @param {Array<string>} [azAffinity] **参数解释**：查询后端服务器组可用区亲和性策略是否开启。示例如下： \&quot;az_affinity\&quot;: {             \&quot;enable\&quot;: \&quot;true\&quot;         } 支持多值查询，查询条件格式： *az_affinity&#x3D;enable&#x3D;true&amp;az_affinity&#x3D;enable&#x3D;false*。  **约束限制**：不涉及  **取值范围**：不涉及  **默认取值**：不涉及
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     */
     ...
     * @param {Array<string>} [virsubnetId] **参数解释**：子网端口所在下联面子网网络ID。  **约束限制**：不涉及  **取值范围**：不涉及  **默认取值**：不涉及  支持多值查询，查询条件格式：*virsubnet_id&#x3D;xxx&amp;virsubnet_id&#x3D;xxx*。
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     */
     ...
     * @throws {RequiredError}
     */
    public showLoadBalancerTopology(showLoadBalancerTopologyRequest?: ShowLoadBalancerTopologyRequest): Promise<ShowLoadBalancerTopologyResponse> {
        const options = ParamCreater().showLoadBalancerTopology(showLoadBalancerTopologyRequest);
     ...
     * @throws {RequiredError}
     */
    public updateSystemDefaultDomainConfig(updateSystemDefaultDomainConfigRequest?: UpdateSystemDefaultDomainConfigRequest): Promise<UpdateSystemDefaultDomainConfigResponse> {
        const options = ParamCreater().updateSystemDefaultDomainConfig(updateSystemDefaultDomainConfigRequest);
     ...
     * @throws {RequiredError}
     */
    public updateUserDefinedDomainConfig(updateUserDefinedDomainConfigRequest?: UpdateUserDefinedDomainConfigRequest): Promise<UpdateUserDefinedDomainConfigResponse> {
        const options = ParamCreater().updateUserDefinedDomainConfig(updateUserDefinedDomainConfigRequest);
     ...
     * @param {UpgradeV3RequestBody} upgradeLoadbalancerRequestBody **参数解释**：负载均衡器升级请求体。  **约束限制**：不涉及  **取值范围**：不涉及  **默认取值**：不涉及
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     */
    public upgradeLoadbalancer(upgradeLoadbalancerRequest?: UpgradeLoadbalancerRequest): Promise<UpgradeLoadbalancerResponse> {
        const options = ParamCreater().upgradeLoadbalancer(upgradeLoadbalancerRequest);
     ...
     * @param {string} [scene] **参数解释**：计算共享型升级为独享型ELB负载均衡器实例的所需预占IP。  **约束限制**： - 仅支持共享型升级为独享型ELB场景。 - 必须同时传入loadbalancer_id。  **取值范围**：UPGRADE - 共享型升级为独享型ELB场景。  **默认取值**：不涉及
     * @param {boolean} [nat64Enable] **参数解释**：开启地址转换。传入该字段表示计算创建LB及该LB下开启/不开启地址转换特性的监听器所需要的预占IP，或者指定LB创建开启/不开启地址转换特性的监听器所需要的新增预占IP。  **约束限制**： - 仅支持计算ELB实例开启NAT64特性场景。  **取值范围**： - true：开启地址转换特性。 - false：不开启地址转换特性。  **默认取值**：false
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     */
     ...
     * @param {number} [limit] **参数解释**：每页返回的个数。  **约束限制**：不涉及  **取值范围**：0-2000  **默认取值**：2000
     * @param {boolean} [pageReverse] **参数解释**：是否反向查询。  **约束限制**： - 必须与limit一起使用。 - 当page_reverse&#x3D;true时，若要查询上一页，marker取值为当前页返回值的previous_marker。  **取值范围**： - true：查询上一页。 - false：查询下一页。  **默认取值**：false
     * @param {Array<string>} [id] **参数解释**：IP地址组的ID。  **约束限制**：不涉及  **取值范围**：不涉及  **默认取值**：不涉及
     * @param {Array<string>} [name] **参数解释**：IP地址组的名称。  **约束限制**：不涉及  **取值范围**：不涉及  **默认取值**：不涉及
     * @param {Array<string>} [description] **参数解释**：IP地址组的描述。  **约束限制**：不涉及  **取值范围**：不涉及  **默认取值**：不涉及
     * @param {Array<string>} [ipList] **参数解释**：IP地址组的IP地址。若一次传入多个，则查询满足任意一个IP地址的所有IP地址组。 注意：不管是单个IP、网段还是连续地址段，都全匹配查询。比如存在IP地址组的IP地址是127.0.0.1-127.0.0.10，则需要传入ip_list&#x3D;127.0.0.1-127.0.0.10 才能查询到。  **约束限制**：不涉及  **取值范围**：不涉及  **默认取值**：不涉及
     ...
     * Please refer to HUAWEI cloud API Explorer for details.
     *
     * @summary 查询IP地址组关联的监听器列表
     * @param {string} ipgroupId **参数解释**：IP地址组ID。  **约束限制**：不涉及  **取值范围**：不涉及  **默认取值**：不涉及
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     */
    public showIpGroupRelatedListeners(showIpGroupRelatedListenersRequest?: ShowIpGroupRelatedListenersRequest): Promise<ShowIpGroupRelatedListenersResponse> {
        const options = ParamCreater().showIpGroupRelatedListeners(showIpGroupRelatedListenersRequest);
...
export const ParamCreater = function () {
    return {
         ...
         * Please refer to HUAWEI cloud API Explorer for details.
         */
        batchCreateLoadBalancers(batchCreateLoadBalancersRequest?: BatchCreateLoadBalancersRequest) {
            const options = {
                method: "POST",
                url: "/v3/{project_id}/elb/loadbalancers/batch-create",
                contentType: "application/json;charset=UTF-8",
                queryParams: {},
                pathParams: {},
                headers: {},
            ...
            if (batchCreateLoadBalancersRequest !== null && batchCreateLoadBalancersRequest !== undefined) {
                if (batchCreateLoadBalancersRequest instanceof BatchCreateLoadBalancersRequest) {
                    body = batchCreateLoadBalancersRequest.body
                } else {
                    body = batchCreateLoadBalancersRequest['body'];
                }
            }
        ...
        batchDeleteCertificates(batchDeleteCertificatesRequest?: BatchDeleteCertificatesRequest) {
            ...
            if (batchDeleteCertificatesRequest !== null && batchDeleteCertificatesRequest !== undefined) {
                if (batchDeleteCertificatesRequest instanceof BatchDeleteCertificatesRequest) {
        ...
        batchDeleteListeners(batchDeleteListenersRequest?: BatchDeleteListenersRequest) {
            ...
            if (batchDeleteListenersRequest !== null && batchDeleteListenersRequest !== undefined) {
                if (batchDeleteListenersRequest instanceof BatchDeleteListenersRequest) {
        ...
        batchDeleteLoadbalancers(batchDeleteLoadbalancersRequest?: BatchDeleteLoadbalancersRequest) {
            ...
            if (batchDeleteLoadbalancersRequest !== null && batchDeleteLoadbalancersRequest !== undefined) {
                if (batchDeleteLoadbalancersRequest instanceof BatchDeleteLoadbalancersRequest) {
        ...
        batchDeletePools(batchDeletePoolsRequest?: BatchDeletePoolsRequest) {
            ...
            if (batchDeletePoolsRequest !== null && batchDeletePoolsRequest !== undefined) {
                if (batchDeletePoolsRequest instanceof BatchDeletePoolsRequest) {
        ...
        batchDisableDomainIPs(batchDisableDomainIPsRequest?: BatchDisableDomainIPsRequest) {
            ...
            if (batchDisableDomainIPsRequest !== null && batchDisableDomainIPsRequest !== undefined) {
                if (batchDisableDomainIPsRequest instanceof BatchDisableDomainIPsRequest) {
        ...
        batchEnableDomainIPs(batchEnableDomainIPsRequest?: BatchEnableDomainIPsRequest) {
            ...
            if (batchEnableDomainIPsRequest !== null && batchEnableDomainIPsRequest !== undefined) {
                if (batchEnableDomainIPsRequest instanceof BatchEnableDomainIPsRequest) {
        ...
        changeListenerTags(changeListenerTagsRequest?: ChangeListenerTagsRequest) {
            ...
            if (changeListenerTagsRequest !== null && changeListenerTagsRequest !== undefined) {
                if (changeListenerTagsRequest instanceof ChangeListenerTagsRequest) {
        ...
        changeLoadbalancerTags(changeLoadbalancerTagsRequest?: ChangeLoadbalancerTagsRequest) {
            ...
            if (changeLoadbalancerTagsRequest !== null && changeLoadbalancerTagsRequest !== undefined) {
                if (changeLoadbalancerTagsRequest instanceof ChangeLoadbalancerTagsRequest) {
        ...
        cloneListener(cloneListenerRequest?: CloneListenerRequest) {
            ...
            if (cloneListenerRequest !== null && cloneListenerRequest !== undefined) {
                if (cloneListenerRequest instanceof CloneListenerRequest) {
         ...
         * Please refer to HUAWEI cloud API Explorer for details.
         */
        cloneLoadbalancer(cloneLoadbalancerRequest?: CloneLoadbalancerRequest) {
            const options = {
                method: "POST",
                url: "/v3/{project_id}/elb/loadbalancers/{loadbalancer_id}/clone",
                contentType: "application/json;charset=UTF-8",
                queryParams: {},
                pathParams: {},
                headers: {},
            ...
            if (cloneLoadbalancerRequest !== null && cloneLoadbalancerRequest !== undefined) {
                if (cloneLoadbalancerRequest instanceof CloneLoadbalancerRequest) {
                    loadbalancerId = cloneLoadbalancerRequest.loadbalancerId;
                    body = cloneLoadbalancerRequest.body
                } else {
                    loadbalancerId = cloneLoadbalancerRequest['loadbalancer_id'];
                    body = cloneLoadbalancerRequest['body'];
                }
            }
            ...
            if (loadbalancerId === null || loadbalancerId === undefined) {
            throw new RequiredError('loadbalancerId','Required parameter loadbalancerId was null or undefined when calling cloneLoadbalancer.');
            }
            if (body === null || body === undefined) {
                throw new RequiredError('body','Required parameter body was null or undefined when calling body.');
            }
         ...
         * Please refer to HUAWEI cloud API Explorer for details.
         */
        deleteLoadBalancerCascade(deleteLoadBalancerCascadeRequest?: DeleteLoadBalancerCascadeRequest) {
            const options = {
                method: "POST",
                url: "/v3/{project_id}/elb/loadbalancers/{loadbalancer_id}/delete-cascade",
                contentType: "application/json;charset=UTF-8",
                queryParams: {},
                pathParams: {},
                headers: {},
            ...
            if (deleteLoadBalancerCascadeRequest !== null && deleteLoadBalancerCascadeRequest !== undefined) {
                if (deleteLoadBalancerCascadeRequest instanceof DeleteLoadBalancerCascadeRequest) {
                    loadbalancerId = deleteLoadBalancerCascadeRequest.loadbalancerId;
                    body = deleteLoadBalancerCascadeRequest.body
                } else {
                    loadbalancerId = deleteLoadBalancerCascadeRequest['loadbalancer_id'];
                    body = deleteLoadBalancerCascadeRequest['body'];
                }
            }
            ...
            if (loadbalancerId === null || loadbalancerId === undefined) {
            throw new RequiredError('loadbalancerId','Required parameter loadbalancerId was null or undefined when calling deleteLoadBalancerCascade.');
            }
            if (body === null || body === undefined) {
                throw new RequiredError('body','Required parameter body was null or undefined when calling body.');
            }
         ...
         * Please refer to HUAWEI cloud API Explorer for details.
         */
        deletePoolCascade(deletePoolCascadeRequest?: DeletePoolCascadeRequest) {
            const options = {
                method: "DELETE",
                url: "/v3/{project_id}/elb/pools/{pool_id}/delete-cascade",
                contentType: "application/json",
                queryParams: {},
                pathParams: {},
                headers: {}
            ...
            if (deletePoolCascadeRequest !== null && deletePoolCascadeRequest !== undefined) {
                if (deletePoolCascadeRequest instanceof DeletePoolCascadeRequest) {
                    poolId = deletePoolCascadeRequest.poolId;
                } else {
                    poolId = deletePoolCascadeRequest['pool_id'];
                }
            }

        
            if (poolId === null || poolId === undefined) {
            throw new RequiredError('poolId','Required parameter poolId was null or undefined when calling deletePoolCascade.');
            }
        ...
        listAvailabilityZones(listAvailabilityZonesRequest?: ListAvailabilityZonesRequest) {
            ...
            if (listAvailabilityZonesRequest !== null && listAvailabilityZonesRequest !== undefined) {
                if (listAvailabilityZonesRequest instanceof ListAvailabilityZonesRequest) {
                    ...
                    loadbalancerId = listAvailabilityZonesRequest.loadbalancerId;
                } else {
                    publicBorderGroup = listAvailabilityZonesRequest['public_border_group'];
                    loadbalancerId = listAvailabilityZonesRequest['loadbalancer_id'];
                }
            }
        ...
        listCertificates(listCertificatesRequest?: ListCertificatesRequest) {
            ...
            if (scmCertificateId !== null && scmCertificateId !== undefined) {
                localVarQueryParameter['scm_certificate_id'] = scmCertificateId;
            }
        ...
        listDomainIPs(listDomainIPsRequest?: ListDomainIPsRequest) {
            ...
            if (listDomainIPsRequest !== null && listDomainIPsRequest !== undefined) {
                if (listDomainIPsRequest instanceof ListDomainIPsRequest) {
                    ...
                    ipAddress = listDomainIPsRequest.ipAddress;
                    enable = listDomainIPsRequest.enable;
                    type = listDomainIPsRequest.type;
                    domainName = listDomainIPsRequest.domainName;
                    enterpriseProjectId = listDomainIPsRequest.enterpriseProjectId;
                } else {
                    loadbalancerId = listDomainIPsRequest['loadbalancer_id'];
                    marker = listDomainIPsRequest['marker'];
                    limit = listDomainIPsRequest['limit'];
                    pageReverse = listDomainIPsRequest['page_reverse'];
                    ipAddress = listDomainIPsRequest['ip_address'];
                    enable = listDomainIPsRequest['enable'];
                    type = listDomainIPsRequest['type'];
                    domainName = listDomainIPsRequest['domain_name'];
                    enterpriseProjectId = listDomainIPsRequest['enterprise_project_id'];
                }
            }
         ...
         * Please refer to HUAWEI cloud API Explorer for details.
         */
        listFeatureConfigs(listFeatureConfigsRequest?: ListFeatureConfigsRequest) {
            const options = {
                method: "GET",
                url: "/v3/{project_id}/elb/feature/configs",
                contentType: "application/json",
                queryParams: {},
                pathParams: {},
                headers: {}
            ...
            if (listFeatureConfigsRequest !== null && listFeatureConfigsRequest !== undefined) {
                if (listFeatureConfigsRequest instanceof ListFeatureConfigsRequest) {
                    feature = listFeatureConfigsRequest.feature;
                } else {
                    feature = listFeatureConfigsRequest['feature'];
                }
            }
        ...
        listFlavors(listFlavorsRequest?: ListFlavorsRequest) {
            ...
            if (listFlavorsRequest !== null && listFlavorsRequest !== undefined) {
                if (listFlavorsRequest instanceof ListFlavorsRequest) {
                    ...
                    publicBorderGroup = listFlavorsRequest.publicBorderGroup;
                    category = listFlavorsRequest.category;
                    listAll = listFlavorsRequest.listAll;
                    flavorSoldOut = listFlavorsRequest.flavorSoldOut;
                } else {
                    marker = listFlavorsRequest['marker'];
                    limit = listFlavorsRequest['limit'];
                    ...
                    type = listFlavorsRequest['type'];
                    shared = listFlavorsRequest['shared'];
                    publicBorderGroup = listFlavorsRequest['public_border_group'];
                    category = listFlavorsRequest['category'];
                    listAll = listFlavorsRequest['list_all'];
                    flavorSoldOut = listFlavorsRequest['flavor_sold_out'];
                }
            }
            ...
            if (listAll !== null && listAll !== undefined) {
                localVarQueryParameter['list_all'] = listAll;
            }
            if (flavorSoldOut !== null && flavorSoldOut !== undefined) {
                localVarQueryParameter['flavor_sold_out'] = flavorSoldOut;
            }
        ...
        listJobs(listJobsRequest?: ListJobsRequest) {
            ...
            if (listJobsRequest !== null && listJobsRequest !== undefined) {
                if (listJobsRequest instanceof ListJobsRequest) {
                    ...
                    status = listJobsRequest['status'];
                    errorCode = listJobsRequest['error_code'];
                    resourceId = listJobsRequest['resource_id'];
                    beginTime = listJobsRequest['begin_time'];
                }
            }
            ...
            if (errorCode !== null && errorCode !== undefined) {
                localVarQueryParameter['error_code'] = errorCode;
            }
        ...
        listListeners(listListenersRequest?: ListListenersRequest) {
            ...
            if (listListenersRequest !== null && listListenersRequest !== undefined) {
                if (listListenersRequest instanceof ListListenersRequest) {
                    ...
                    sslEarlyDataEnable = listListenersRequest.sslEarlyDataEnable;
                    nat64Enable = listListenersRequest.nat64Enable;
                } else {
                    limit = listListenersRequest['limit'];
                    marker = listListenersRequest['marker'];
                    ...
                    sslEarlyDataEnable = listListenersRequest['ssl_early_data_enable'];
                    nat64Enable = listListenersRequest['nat64_enable'];
                }
            }
            ...
            if (sslEarlyDataEnable !== null && sslEarlyDataEnable !== undefined) {
                localVarQueryParameter['ssl_early_data_enable'] = sslEarlyDataEnable;
            }
            if (nat64Enable !== null && nat64Enable !== undefined) {
                localVarQueryParameter['nat64_enable'] = nat64Enable;
            }
         ...
         * Please refer to HUAWEI cloud API Explorer for details.
         */
        listLoadbalancerFeature(listLoadbalancerFeatureRequest?: ListLoadbalancerFeatureRequest) {
            const options = {
                method: "GET",
                url: "/v3/{project_id}/elb/loadbalancers/{loadbalancer_id}/features",
                contentType: "application/json",
                queryParams: {},
                pathParams: {},
                headers: {}
            ...
            if (listLoadbalancerFeatureRequest !== null && listLoadbalancerFeatureRequest !== undefined) {
                if (listLoadbalancerFeatureRequest instanceof ListLoadbalancerFeatureRequest) {
                    loadbalancerId = listLoadbalancerFeatureRequest.loadbalancerId;
                } else {
                    loadbalancerId = listLoadbalancerFeatureRequest['loadbalancer_id'];
                }
            }

        
            if (loadbalancerId === null || loadbalancerId === undefined) {
            throw new RequiredError('loadbalancerId','Required parameter loadbalancerId was null or undefined when calling listLoadbalancerFeature.');
            }
        ...
        listPools(listPoolsRequest?: ListPoolsRequest) {
            ...
            if (quicCidLen !== null && quicCidLen !== undefined) {
                localVarQueryParameter['quic_cid_len'] = quicCidLen;
            }
        ...
        showJob(showJobRequest?: ShowJobRequest) {
            const options = {
                method: "GET",
                url: "/v3/{project_id}/elb/jobs/{job_id}",
                contentType: "application/json",
                queryParams: {},
                pathParams: {},
                headers: {}
        ...
        showLoadBalancerTopology(showLoadBalancerTopologyRequest?: ShowLoadBalancerTopologyRequest) {
            ...
            if (showLoadBalancerTopologyRequest !== null && showLoadBalancerTopologyRequest !== undefined) {
                if (showLoadBalancerTopologyRequest instanceof ShowLoadBalancerTopologyRequest) {
        ...
        updateSystemDefaultDomainConfig(updateSystemDefaultDomainConfigRequest?: UpdateSystemDefaultDomainConfigRequest) {
            ...
            if (updateSystemDefaultDomainConfigRequest !== null && updateSystemDefaultDomainConfigRequest !== undefined) {
                if (updateSystemDefaultDomainConfigRequest instanceof UpdateSystemDefaultDomainConfigRequest) {
        ...
        updateUserDefinedDomainConfig(updateUserDefinedDomainConfigRequest?: UpdateUserDefinedDomainConfigRequest) {
            ...
            if (updateUserDefinedDomainConfigRequest !== null && updateUserDefinedDomainConfigRequest !== undefined) {
                if (updateUserDefinedDomainConfigRequest instanceof UpdateUserDefinedDomainConfigRequest) {
         ...
         * Please refer to HUAWEI cloud API Explorer for details.
         */
        upgradeLoadbalancer(upgradeLoadbalancerRequest?: UpgradeLoadbalancerRequest) {
            const options = {
                method: "POST",
                url: "/v3/{project_id}/elb/loadbalancers/{loadbalancer_id}/upgrade",
                contentType: "application/json;charset=UTF-8",
                queryParams: {},
                pathParams: {},
                headers: {},
            ...
            if (upgradeLoadbalancerRequest !== null && upgradeLoadbalancerRequest !== undefined) {
                if (upgradeLoadbalancerRequest instanceof UpgradeLoadbalancerRequest) {
                    loadbalancerId = upgradeLoadbalancerRequest.loadbalancerId;
                    body = upgradeLoadbalancerRequest.body
                } else {
                    loadbalancerId = upgradeLoadbalancerRequest['loadbalancer_id'];
                    body = upgradeLoadbalancerRequest['body'];
                }
            }
            ...
            if (loadbalancerId === null || loadbalancerId === undefined) {
            throw new RequiredError('loadbalancerId','Required parameter loadbalancerId was null or undefined when calling upgradeLoadbalancer.');
            }
            if (body === null || body === undefined) {
                throw new RequiredError('body','Required parameter body was null or undefined when calling body.');
            }
        ...
        countPreoccupyIpNum(countPreoccupyIpNumRequest?: CountPreoccupyIpNumRequest) {
            ...
            if (countPreoccupyIpNumRequest !== null && countPreoccupyIpNumRequest !== undefined) {
                if (countPreoccupyIpNumRequest instanceof CountPreoccupyIpNumRequest) {
                    ...
                    scene = countPreoccupyIpNumRequest.scene;
                    nat64Enable = countPreoccupyIpNumRequest.nat64Enable;
                } else {
                    ...
                    scene = countPreoccupyIpNumRequest['scene'];
                    nat64Enable = countPreoccupyIpNumRequest['nat64_enable'];
                }
            }
         ...
         * Please refer to HUAWEI cloud API Explorer for details.
         */
        showIpGroupRelatedListeners(showIpGroupRelatedListenersRequest?: ShowIpGroupRelatedListenersRequest) {
            const options = {
                method: "GET",
                url: "/v3/{project_id}/elb/ipgroups/{ipgroup_id}/related-listeners",
                contentType: "application/json",
                queryParams: {},
                pathParams: {},
                headers: {}
            ...
            if (showIpGroupRelatedListenersRequest !== null && showIpGroupRelatedListenersRequest !== undefined) {
                if (showIpGroupRelatedListenersRequest instanceof ShowIpGroupRelatedListenersRequest) {
                    ipgroupId = showIpGroupRelatedListenersRequest.ipgroupId;
                } else {
                    ipgroupId = showIpGroupRelatedListenersRequest['ipgroup_id'];
                }
            }

        
            if (ipgroupId === null || ipgroupId === undefined) {
            throw new RequiredError('ipgroupId','Required parameter ipgroupId was null or undefined when calling showIpGroupRelatedListeners.');
            }
