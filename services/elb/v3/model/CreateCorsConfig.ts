...
export class CreateCorsConfig {
    ...
    public withAllowOrigin(allowOrigin: Array<string>): CreateCorsConfig {
    ...
    public withAllowMethods(allowMethods: Array<string>): CreateCorsConfig {
    ...
    public withAllowHeaders(allowHeaders: Array<string>): CreateCorsConfig {
    ...
    public withExposeHeaders(exposeHeaders: Array<string>): CreateCorsConfig {
    ...
    public withAllowCredentials(allowCredentials: boolean): CreateCorsConfig {
    ...
    public withMaxAge(maxAge: number): CreateCorsConfig {
        this['max_age'] = maxAge;
        return this;
    }
