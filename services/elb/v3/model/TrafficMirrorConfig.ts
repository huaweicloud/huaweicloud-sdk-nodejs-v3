...
export class TrafficMirrorConfig {
    private 'target_ids'?: Array<string>;
    private 'mirror_request_body_enable'?: boolean;
    public constructor() { 
    }
    public withTargetIds(targetIds: Array<string>): TrafficMirrorConfig {
    ...
    public withMirrorRequestBodyEnable(mirrorRequestBodyEnable: boolean): TrafficMirrorConfig {
