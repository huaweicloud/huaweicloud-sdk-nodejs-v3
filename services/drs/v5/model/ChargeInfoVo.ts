...
export class ChargeInfoVo {
    ...
    public withChargeMode(chargeMode: string): ChargeInfoVo {
    ...
    public withPeriodType(periodType: string): ChargeInfoVo {
    ...
    public withPeriodNum(periodNum: number): ChargeInfoVo {
    ...
    public withIsAutoRenew(isAutoRenew: boolean): ChargeInfoVo {
    ...
    public withIsAutoPay(isAutoPay: boolean): ChargeInfoVo {
