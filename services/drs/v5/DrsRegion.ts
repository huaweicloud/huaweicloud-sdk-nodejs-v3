...
export class DrsRegion {
    ...
    public static RU_NORTHWEST_2 = new Region("ru-northwest-2", ["https://drs.ru-northwest-2.myhuaweicloud.com"]);
    public static AP_SOUTHEAST_5 = new Region("ap-southeast-5", ["https://drs.ap-southeast-5.myhuaweicloud.com"]);
    public static CN_EAST_5 = new Region("cn-east-5", ["https://drs.cn-east-5.myhuaweicloud.com"]);
    public static CN_NORTH_12 = new Region("cn-north-12", ["https://drs.cn-north-12.myhuaweicloud.com"]);
    public static CN_EAST_4 = new Region("cn-east-4", ["https://drs.cn-east-4.myhuaweicloud.com"]);
    public static CN_SOUTHWEST_3 = new Region("cn-southwest-3", ["https://drs.cn-southwest-3.myhuaweicloud.com"]);
    public static CN_NORTH_11 = new Region("cn-north-11", ["https://drs.cn-north-11.myhuaweicloud.com"]);
    public static AF_NORTH_1 = new Region("af-north-1", ["https://drs.af-north-1.myhuaweicloud.com"]);
    public static ME_EAST_1 = new Region("me-east-1", ["https://drs.me-east-1.myhuaweicloud.com"]);
    ...
    private static REGION_MAP: RegionMap = {
        ...
        "ru-northwest-2":DrsRegion.RU_NORTHWEST_2,
        "ap-southeast-5":DrsRegion.AP_SOUTHEAST_5,
        "cn-east-5":DrsRegion.CN_EAST_5,
        "cn-north-12":DrsRegion.CN_NORTH_12,
        "cn-east-4":DrsRegion.CN_EAST_4,
        "cn-southwest-3":DrsRegion.CN_SOUTHWEST_3,
        "cn-north-11":DrsRegion.CN_NORTH_11,
        "af-north-1":DrsRegion.AF_NORTH_1,
        "me-east-1":DrsRegion.ME_EAST_1
    };
