...
export class KerberosVO {
    private 'krb5_conf_file'?: string;
    private 'key_tab_file'?: string;
    private 'domain_name'?: string;
    private 'user_principal'?: string;
    public constructor() { 
    }
    ...
    public get krb5ConfFile(): string | undefined {
    ...
    public get keyTabFile(): string | undefined {
    ...
    public get userPrincipal(): string | undefined {
