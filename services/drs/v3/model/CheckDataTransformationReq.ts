...
export class CheckDataTransformationReq {
    ...
    private 'object_info'?: Array<DatabaseObjectVO>;
    private 'transformation_info'?: TransformationInfo;
    private 'config_transformation'?: ConfigTransformationVo;
    public constructor(transformationInfo?: TransformationInfo) { 
    ...
    public get objectInfo(): Array<DatabaseObjectVO> | undefined {
