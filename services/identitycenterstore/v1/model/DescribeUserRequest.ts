...
export class DescribeUserRequest {
    ...
    public withXSecurityToken(xSecurityToken: string): DescribeUserRequest {
    ...
    public withIdentityStoreId(identityStoreId: string): DescribeUserRequest {
        this['identity_store_id'] = identityStoreId;
        return this;
    }
    ...
    public withUserId(userId: string): DescribeUserRequest {
        this['user_id'] = userId;
        return this;
    }
