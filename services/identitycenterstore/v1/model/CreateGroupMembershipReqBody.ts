...
export class CreateGroupMembershipReqBody {
    ...
    public withGroupId(groupId: string): CreateGroupMembershipReqBody {
        this['group_id'] = groupId;
        return this;
    }
    ...
    public withMemberId(memberId: MemberIdDto): CreateGroupMembershipReqBody {
        this['member_id'] = memberId;
        return this;
    }
