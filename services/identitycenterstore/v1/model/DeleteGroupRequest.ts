...
export class DeleteGroupRequest {
    ...
    public withXSecurityToken(xSecurityToken: string): DeleteGroupRequest {
    ...
    public withIdentityStoreId(identityStoreId: string): DeleteGroupRequest {
        this['identity_store_id'] = identityStoreId;
        return this;
    }
    ...
    public withGroupId(groupId: string): DeleteGroupRequest {
        this['group_id'] = groupId;
        return this;
    }
