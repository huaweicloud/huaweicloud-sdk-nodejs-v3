...
export class GetUserIdRequest {
    ...
    public withIdentityStoreId(identityStoreId: string): GetUserIdRequest {
        this['identity_store_id'] = identityStoreId;
        return this;
    }
    ...
    public withBody(body: GetUserIdReqBody): GetUserIdRequest {
        this['body'] = body;
        return this;
    }
}