...
export class EnableExternalIdPConfigurationForDirectoryRequest {
    ...
    public withIdentityStoreId(identityStoreId: string): EnableExternalIdPConfigurationForDirectoryRequest {
        this['identity_store_id'] = identityStoreId;
        return this;
    }
    ...
    public withIdpId(idpId: string): EnableExternalIdPConfigurationForDirectoryRequest {
        this['idp_id'] = idpId;
        return this;
    }
    ...
    public withXSecurityToken(xSecurityToken: string): EnableExternalIdPConfigurationForDirectoryRequest {
