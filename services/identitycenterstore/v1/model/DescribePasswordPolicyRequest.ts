...
export class DescribePasswordPolicyRequest {
    private 'X-Security-Token'?: string;
    private 'identity_store_id'?: string;
    public constructor(identityStoreId?: string) { 
        this['identity_store_id'] = identityStoreId;
    }
    public withXSecurityToken(xSecurityToken: string): DescribePasswordPolicyRequest {
    ...
    public withIdentityStoreId(identityStoreId: string): DescribePasswordPolicyRequest {
        this['identity_store_id'] = identityStoreId;
        return this;
    }
