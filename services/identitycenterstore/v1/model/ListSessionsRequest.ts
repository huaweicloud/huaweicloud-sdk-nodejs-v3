...
export class ListSessionsRequest {
    ...
    public withXSecurityToken(xSecurityToken: string): ListSessionsRequest {
    ...
    public withIdentityStoreId(identityStoreId: string): ListSessionsRequest {
        this['identity_store_id'] = identityStoreId;
        return this;
    }
    ...
    public withUserId(userId: string): ListSessionsRequest {
        this['user_id'] = userId;
        return this;
    }
