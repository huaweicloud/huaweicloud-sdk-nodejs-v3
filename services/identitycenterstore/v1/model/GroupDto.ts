...
export class GroupDto {
    ...
    public withDisplayName(displayName: string): GroupDto {
    ...
    public withExternalId(externalId: string): GroupDto {
    ...
    public withExternalIds(externalIds: Array<ExternalIdDto>): GroupDto {
    ...
    public withGroupId(groupId: string): GroupDto {
        this['group_id'] = groupId;
        return this;
    }
    ...
    public withIdentityStoreId(identityStoreId: string): GroupDto {
        this['identity_store_id'] = identityStoreId;
        return this;
    }
    ...
    public withCreatedAt(createdAt: number): GroupDto {
    ...
    public withCreatedBy(createdBy: string): GroupDto {
    ...
    public withUpdatedAt(updatedAt: number): GroupDto {
    ...
    public withUpdatedBy(updatedBy: string): GroupDto {
