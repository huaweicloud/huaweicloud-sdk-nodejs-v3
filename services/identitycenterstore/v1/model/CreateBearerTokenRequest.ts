...
export class CreateBearerTokenRequest {
    ...
    public withIdentityStoreId(identityStoreId: string): CreateBearerTokenRequest {
        this['identity_store_id'] = identityStoreId;
        return this;
    }
    ...
    public withTenantId(tenantId: string): CreateBearerTokenRequest {
        this['tenant_id'] = tenantId;
        return this;
    }
    ...
    public withXSecurityToken(xSecurityToken: string): CreateBearerTokenRequest {
