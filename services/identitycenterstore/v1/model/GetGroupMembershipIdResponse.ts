...
export class GetGroupMembershipIdResponse extends SdkResponse {
    private 'identity_store_id'?: string;
    private 'membership_id'?: string;
    public constructor() { 
        super();
    }
    public withIdentityStoreId(identityStoreId: string): GetGroupMembershipIdResponse {
    ...
    public withMembershipId(membershipId: string): GetGroupMembershipIdResponse {
