...
export class DeleteExternalIdPConfigurationForDirectoryRequest {
    ...
    public withXSecurityToken(xSecurityToken: string): DeleteExternalIdPConfigurationForDirectoryRequest {
    ...
    public withIdentityStoreId(identityStoreId: string): DeleteExternalIdPConfigurationForDirectoryRequest {
        this['identity_store_id'] = identityStoreId;
        return this;
    }
    ...
    public withIdpId(idpId: string): DeleteExternalIdPConfigurationForDirectoryRequest {
        this['idp_id'] = idpId;
        return this;
    }
