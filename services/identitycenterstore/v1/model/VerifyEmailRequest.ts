...
export class VerifyEmailRequest {
    ...
    public withXSecurityToken(xSecurityToken: string): VerifyEmailRequest {
    ...
    public withIdentityStoreId(identityStoreId: string): VerifyEmailRequest {
        this['identity_store_id'] = identityStoreId;
        return this;
    }
    ...
    public withUserId(userId: string): VerifyEmailRequest {
        this['user_id'] = userId;
        return this;
    }
