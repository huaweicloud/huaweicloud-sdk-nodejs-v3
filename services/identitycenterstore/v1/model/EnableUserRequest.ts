...
export class EnableUserRequest {
    ...
    public withXSecurityToken(xSecurityToken: string): EnableUserRequest {
    ...
    public withIdentityStoreId(identityStoreId: string): EnableUserRequest {
        this['identity_store_id'] = identityStoreId;
        return this;
    }
    ...
    public withUserId(userId: string): EnableUserRequest {
        this['user_id'] = userId;
        return this;
    }
