...
export class ListExternalIdPCertificatesRequest {
    ...
    public withXSecurityToken(xSecurityToken: string): ListExternalIdPCertificatesRequest {
    ...
    public withIdentityStoreId(identityStoreId: string): ListExternalIdPCertificatesRequest {
        this['identity_store_id'] = identityStoreId;
        return this;
    }
    ...
    public withIdpId(idpId: string): ListExternalIdPCertificatesRequest {
        this['idp_id'] = idpId;
        return this;
    }
