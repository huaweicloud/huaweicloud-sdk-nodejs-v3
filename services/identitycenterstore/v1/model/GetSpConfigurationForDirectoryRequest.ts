...
export class GetSpConfigurationForDirectoryRequest {
    private 'identity_store_id'?: string;
    private 'X-Security-Token'?: string;
    public constructor(identityStoreId?: string) { 
        this['identity_store_id'] = identityStoreId;
    }
    public withIdentityStoreId(identityStoreId: string): GetSpConfigurationForDirectoryRequest {
        this['identity_store_id'] = identityStoreId;
        return this;
    }
    ...
    public withXSecurityToken(xSecurityToken: string): GetSpConfigurationForDirectoryRequest {
