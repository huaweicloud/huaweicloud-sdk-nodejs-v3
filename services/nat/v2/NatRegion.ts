...
export class NatRegion {
    ...
    public static AP_SOUTHEAST_5 = new Region("ap-southeast-5", ["https://nat.ap-southeast-5.myhuaweicloud.com"]);
    public static CN_SOUTHWEST_3 = new Region("cn-southwest-3", ["https://nat.cn-southwest-3.myhuaweicloud.com"]);
    public static CN_NORTH_12 = new Region("cn-north-12", ["https://nat.cn-north-12.myhuaweicloud.com"]);
    public static CN_EAST_4 = new Region("cn-east-4", ["https://nat.cn-east-4.myhuaweicloud.com"]);
    public static CN_EAST_5 = new Region("cn-east-5", ["https://nat.cn-east-5.myhuaweicloud.com"]);
    public static CN_NORTH_11 = new Region("cn-north-11", ["https://nat.cn-north-11.myhuaweicloud.com"]);
    ...
    private static REGION_MAP: RegionMap = {
        ...
        "ap-southeast-5":NatRegion.AP_SOUTHEAST_5,
        "cn-southwest-3":NatRegion.CN_SOUTHWEST_3,
        "cn-north-12":NatRegion.CN_NORTH_12,
        "cn-east-4":NatRegion.CN_EAST_4,
        "cn-east-5":NatRegion.CN_EAST_5,
        "cn-north-11":NatRegion.CN_NORTH_11
    };
