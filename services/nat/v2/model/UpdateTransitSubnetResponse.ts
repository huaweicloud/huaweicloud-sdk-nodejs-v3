...
export class UpdateTransitSubnetResponse extends SdkResponse {
    private 'transit_subnet'?: TransitSubnet;
    private 'request_id'?: string;
    public constructor() { 
        super();
    }
    public withTransitSubnet(transitSubnet: TransitSubnet): UpdateTransitSubnetResponse {
    ...
    public withRequestId(requestId: string): UpdateTransitSubnetResponse {
