...
export class CreatePrivateSnatResponse extends SdkResponse {
    private 'snat_rule'?: PrivateSnat;
    private 'request_id'?: string;
    public constructor() { 
        super();
    }
    public withSnatRule(snatRule: PrivateSnat): CreatePrivateSnatResponse {
    ...
    public withRequestId(requestId: string): CreatePrivateSnatResponse {
