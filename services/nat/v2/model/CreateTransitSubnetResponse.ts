...
export class CreateTransitSubnetResponse extends SdkResponse {
    private 'transit_subnet'?: TransitSubnet;
    private 'request_id'?: string;
    public constructor() { 
        super();
    }
    public withTransitSubnet(transitSubnet: TransitSubnet): CreateTransitSubnetResponse {
    ...
    public withRequestId(requestId: string): CreateTransitSubnetResponse {
