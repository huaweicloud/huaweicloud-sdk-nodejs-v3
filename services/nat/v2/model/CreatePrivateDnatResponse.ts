...
export class CreatePrivateDnatResponse extends SdkResponse {
    private 'dnat_rule'?: PrivateDnat;
    private 'request_id'?: string;
    public constructor() { 
        super();
    }
    public withDnatRule(dnatRule: PrivateDnat): CreatePrivateDnatResponse {
    ...
    public withRequestId(requestId: string): CreatePrivateDnatResponse {
