...
export class CreateNatGatewayDnatRuleResponse extends SdkResponse {
    private 'dnat_rule'?: NatGatewayDnatRuleResponseBody;
    public constructor() { 
        super();
    }
    public withDnatRule(dnatRule: NatGatewayDnatRuleResponseBody): CreateNatGatewayDnatRuleResponse {
