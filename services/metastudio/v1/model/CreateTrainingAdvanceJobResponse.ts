...
export class CreateTrainingAdvanceJobResponse extends SdkResponse {
    ...
    public withJobId(jobId: string): CreateTrainingAdvanceJobResponse {
        this['job_id'] = jobId;
        return this;
    }
    ...
    public withTrainingDataUploadingUrl(trainingDataUploadingUrl: string): CreateTrainingAdvanceJobResponse {
    ...
    public withSegmentUploadingUrl(segmentUploadingUrl: CreateTrainingJobRspSegmentUploadingUrl): CreateTrainingAdvanceJobResponse {
    ...
    public withAuthorizationLetterUploadingUrl(authorizationLetterUploadingUrl: string): CreateTrainingAdvanceJobResponse {
