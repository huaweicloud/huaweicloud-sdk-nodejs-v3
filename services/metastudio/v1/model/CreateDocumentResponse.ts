...
export class CreateDocumentResponse extends SdkResponse {
    ...
    public withDocumentId(documentId: string): CreateDocumentResponse {
    ...
    public withKnowledgeLibraryId(knowledgeLibraryId: string): CreateDocumentResponse {
    ...
    public withFileName(fileName: string): CreateDocumentResponse {
    ...
    public withFileSize(fileSize: number): CreateDocumentResponse {
    ...
    public withFileType(fileType: string): CreateDocumentResponse {
    ...
    public withSplitType(splitType: number): CreateDocumentResponse {
    ...
    public withChunkSize(chunkSize: number): CreateDocumentResponse {
    ...
    public withChunkType(chunkType: string): CreateDocumentResponse {
    ...
    public withSeparators(separators: Array<string>): CreateDocumentResponse {
        this['separators'] = separators;
        return this;
    }
    public withCreateTime(createTime: string): CreateDocumentResponse {
    ...
    public withUpdateTime(updateTime: string): CreateDocumentResponse {
    ...
    public withDocumentTaskInfo(documentTaskInfo: DocumentTaskInfo): CreateDocumentResponse {
