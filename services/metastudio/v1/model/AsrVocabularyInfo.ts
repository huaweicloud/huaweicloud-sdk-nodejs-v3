...
export class AsrVocabularyInfo {
    ...
    public withAsrVocabularyId(asrVocabularyId: string): AsrVocabularyInfo {
    ...
    public withVocabularyType(vocabularyType: AsrVocabularyTypeEnum): AsrVocabularyInfo {
    ...
    public withName(name: string): AsrVocabularyInfo {
        this['name'] = name;
        return this;
    }
    public withContent(content: string): AsrVocabularyInfo {
        this['content'] = content;
        return this;
    }
    public withLanguage(language: LanguageEnum): AsrVocabularyInfo {
        this['language'] = language;
        return this;
    }
    public withCreateTime(createTime: string): AsrVocabularyInfo {
    ...
    public withUpdateTime(updateTime: string): AsrVocabularyInfo {
