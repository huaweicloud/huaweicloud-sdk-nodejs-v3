...
export class CreateTrainingMiddleJobResponse extends SdkResponse {
    ...
    public withJobId(jobId: string): CreateTrainingMiddleJobResponse {
        this['job_id'] = jobId;
        return this;
    }
    ...
    public withTrainingDataUploadingUrl(trainingDataUploadingUrl: string): CreateTrainingMiddleJobResponse {
    ...
    public withSegmentUploadingUrl(segmentUploadingUrl: CreateTrainingJobRspSegmentUploadingUrl): CreateTrainingMiddleJobResponse {
    ...
    public withAuthorizationLetterUploadingUrl(authorizationLetterUploadingUrl: string): CreateTrainingMiddleJobResponse {
