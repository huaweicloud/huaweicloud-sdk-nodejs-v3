...
export class ShowDialogReportConfigResponse extends SdkResponse {
    ...
    public withProjectId(projectId: string): ShowDialogReportConfigResponse {
    ...
    public withObsBucketName(obsBucketName: string): ShowDialogReportConfigResponse {
    ...
    public withObsEndpoint(obsEndpoint: string): ShowDialogReportConfigResponse {
    ...
    public withEnableDialogReport(enableDialogReport: boolean): ShowDialogReportConfigResponse {
    ...
    public withCreateTime(createTime: string): ShowDialogReportConfigResponse {
    ...
    public withUpdateTime(updateTime: string): ShowDialogReportConfigResponse {
    ...
    public withXRequestId(xRequestId: string): ShowDialogReportConfigResponse {
