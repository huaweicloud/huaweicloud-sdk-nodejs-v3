...
export class TtscAssetFileInfo {
    ...
    public withFileId(fileId: string): TtscAssetFileInfo {
        this['file_id'] = fileId;
        return this;
    }
    ...
    public withFileName(fileName: string): TtscAssetFileInfo {
    ...
    public withFileMd5(fileMd5: string): TtscAssetFileInfo {
    ...
    public withFileSize(fileSize: number): TtscAssetFileInfo {
    ...
    public withFileType(fileType: string): TtscAssetFileInfo {
    ...
    public withAssetFileCategory(assetFileCategory: string): TtscAssetFileInfo {
    ...
    public withDownloadUrl(downloadUrl: string): TtscAssetFileInfo {
    ...
    public withState(state: string): TtscAssetFileInfo {
        this['state'] = state;
        return this;
    }
    public withReason(reason: string): TtscAssetFileInfo {
        this['reason'] = reason;
        return this;
    }
}