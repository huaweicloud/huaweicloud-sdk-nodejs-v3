...
export class Update2dModelTrainingJobResponse extends SdkResponse {
    ...
    public withJobId(jobId: string): Update2dModelTrainingJobResponse {
        this['job_id'] = jobId;
        return this;
    }
    ...
    public withTrainingVideoUploadUrl(trainingVideoUploadUrl: Array<string>): Update2dModelTrainingJobResponse {
    ...
    public withActionVideoUploadUrl(actionVideoUploadUrl: Array<string>): Update2dModelTrainingJobResponse {
    ...
    public withAudioUploadUrl(audioUploadUrl: string): Update2dModelTrainingJobResponse {
    ...
    public withCoverUploadUrl(coverUploadUrl: string): Update2dModelTrainingJobResponse {
    ...
    public withIdCardImage1UploadUrl(idCardImage1UploadUrl: string): Update2dModelTrainingJobResponse {
    ...
    public withIdCardImage2UploadUrl(idCardImage2UploadUrl: string): Update2dModelTrainingJobResponse {
    ...
    public withGrantFileUploadUrl(grantFileUploadUrl: string): Update2dModelTrainingJobResponse {
