...
export class UpdateVideoScriptResponse extends SdkResponse {
    ...
    public withScriptId(scriptId: string): UpdateVideoScriptResponse {
    ...
    public withAudioFiles(audioFiles: ShootScriptAudioFiles): UpdateVideoScriptResponse {
    ...
    public withXRequestId(xRequestId: string): UpdateVideoScriptResponse {
