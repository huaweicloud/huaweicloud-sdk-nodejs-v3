...
export class CreateTrainingBasicJobResponse extends SdkResponse {
    ...
    public withJobId(jobId: string): CreateTrainingBasicJobResponse {
        this['job_id'] = jobId;
        return this;
    }
    ...
    public withTrainingDataUploadingUrl(trainingDataUploadingUrl: string): CreateTrainingBasicJobResponse {
    ...
    public withSegmentUploadingUrl(segmentUploadingUrl: CreateTrainingJobRspSegmentUploadingUrl): CreateTrainingBasicJobResponse {
    ...
    public withAuthorizationLetterUploadingUrl(authorizationLetterUploadingUrl: string): CreateTrainingBasicJobResponse {
