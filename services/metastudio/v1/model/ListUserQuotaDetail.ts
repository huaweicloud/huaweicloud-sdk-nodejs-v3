...
export class ListUserQuotaDetail {
    ...
    public withModelingCount2dModel(modelingCount2dModel: number): ListUserQuotaDetail {
    ...
    public withModelingCount2dModelFlexus(modelingCount2dModelFlexus: number): ListUserQuotaDetail {
    ...
    public withVideoTime2dModel(videoTime2dModel: number): ListUserQuotaDetail {
    ...
    public withVideoTimeFlexus2dModel(videoTimeFlexus2dModel: number): ListUserQuotaDetail {
    ...
    public withVoiceCloneBasic(voiceCloneBasic: number): ListUserQuotaDetail {
    ...
    public withVoiceCloneMiddle(voiceCloneMiddle: number): ListUserQuotaDetail {
    ...
    public withVoiceCloneAdvance(voiceCloneAdvance: number): ListUserQuotaDetail {
    ...
    public withVoiceCloneFlexus(voiceCloneFlexus: number): ListUserQuotaDetail {
