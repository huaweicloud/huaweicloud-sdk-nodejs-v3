...
export class ShowAudioRecordConfigResponse extends SdkResponse {
    ...
    public withProjectId(projectId: string): ShowAudioRecordConfigResponse {
    ...
    public withObsBucketName(obsBucketName: string): ShowAudioRecordConfigResponse {
    ...
    public withObsEndpoint(obsEndpoint: string): ShowAudioRecordConfigResponse {
    ...
    public withEnableAudioRecord(enableAudioRecord: boolean): ShowAudioRecordConfigResponse {
    ...
    public withCreateTime(createTime: string): ShowAudioRecordConfigResponse {
    ...
    public withUpdateTime(updateTime: string): ShowAudioRecordConfigResponse {
    ...
    public withXRequestId(xRequestId: string): ShowAudioRecordConfigResponse {
