...
export class ShowRoleResponse extends SdkResponse {
    ...
    public withRoleId(roleId: string): ShowRoleResponse {
        this['role_id'] = roleId;
        return this;
    }
    ...
    public withName(name: string): ShowRoleResponse {
        this['name'] = name;
        return this;
    }
    public withDescription(description: string): ShowRoleResponse {
        this['description'] = description;
        return this;
    }
    public withRoleBusinessList(roleBusinessList: Array<RoleBusinessInfo>): ShowRoleResponse {
    ...
    public withLlmSource(llmSource: LlmSourceEnum): ShowRoleResponse {
    ...
    public withLlmConfigId(llmConfigId: string): ShowRoleResponse {
    ...
    public withPluginConfigList(pluginConfigList: Array<RolePluginConfigInfo>): ShowRoleResponse {
    ...
    public withMcpServerInfoList(mcpServerInfoList: Array<McpServerBaseInfo>): ShowRoleResponse {
    ...
    public withInstructionLibraryId(instructionLibraryId: string): ShowRoleResponse {
    ...
    public withCreateTime(createTime: string): ShowRoleResponse {
    ...
    public withUpdateTime(updateTime: string): ShowRoleResponse {
    ...
    public withXRequestId(xRequestId: string): ShowRoleResponse {
