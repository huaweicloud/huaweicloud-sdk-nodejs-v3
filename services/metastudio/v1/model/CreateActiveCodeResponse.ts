...
export class CreateActiveCodeResponse extends SdkResponse {
    ...
    public withActiveCodeId(activeCodeId: string): CreateActiveCodeResponse {
    ...
    public withActiveCode(activeCode: string): CreateActiveCodeResponse {
    ...
    public withRobotId(robotId: string): CreateActiveCodeResponse {
    ...
    public withRoomId(roomId: string): CreateActiveCodeResponse {
        this['room_id'] = roomId;
        return this;
    }
    ...
    public withValidPeriod(validPeriod: number): CreateActiveCodeResponse {
    ...
    public withExpireTime(expireTime: string): CreateActiveCodeResponse {
    ...
    public withCreateTime(createTime: string): CreateActiveCodeResponse {
    ...
    public withUpdateTime(updateTime: string): CreateActiveCodeResponse {
    ...
    public withXRequestId(xRequestId: string): CreateActiveCodeResponse {
