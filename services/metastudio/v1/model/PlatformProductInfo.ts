...
export class PlatformProductInfo {
    private 'product_id'?: string;
    private 'product_title'?: string;
    public constructor() { 
    }
    public withProductId(productId: string): PlatformProductInfo {
    ...
    public withProductTitle(productTitle: string): PlatformProductInfo {
