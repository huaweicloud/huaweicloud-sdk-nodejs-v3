...
export class BatchDeleteDedicatedHostTagsRequest {
    ...
    public withDedicatedHostId(dedicatedHostId: string): BatchDeleteDedicatedHostTagsRequest {
        this['dedicated_host_id'] = dedicatedHostId;
        return this;
    }
    ...
    public withBody(body: ReqSetOrDeleteTags): BatchDeleteDedicatedHostTagsRequest {
        this['body'] = body;
        return this;
    }
}