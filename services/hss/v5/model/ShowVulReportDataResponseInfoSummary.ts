...
export class ShowVulReportDataResponseInfoSummary {
    ...
    public withVulNumRepairNecessity(vulNumRepairNecessity: number): ShowVulReportDataResponseInfoSummary {
    ...
    public withVulNumUnfixed(vulNumUnfixed: number): ShowVulReportDataResponseInfoSummary {
    ...
    public withVulNumLinux(vulNumLinux: number): ShowVulReportDataResponseInfoSummary {
    ...
    public withVulNumWindows(vulNumWindows: number): ShowVulReportDataResponseInfoSummary {
    ...
    public withVulNumWebCms(vulNumWebCms: number): ShowVulReportDataResponseInfoSummary {
    ...
    public withVulNumApp(vulNumApp: number): ShowVulReportDataResponseInfoSummary {
    ...
    public withHostNumRisk(hostNumRisk: number): ShowVulReportDataResponseInfoSummary {
    ...
    public withHostNumHighRisk(hostNumHighRisk: number): ShowVulReportDataResponseInfoSummary {
    ...
    public withHostNumMediumRisk(hostNumMediumRisk: number): ShowVulReportDataResponseInfoSummary {
    ...
    public withHostNumLowRisk(hostNumLowRisk: number): ShowVulReportDataResponseInfoSummary {
    ...
    public withAffectAssetNumImportant(affectAssetNumImportant: number): ShowVulReportDataResponseInfoSummary {
    ...
    public withAffectAssetNumCommon(affectAssetNumCommon: number): ShowVulReportDataResponseInfoSummary {
    ...
    public withAffectAssetNumTest(affectAssetNumTest: number): ShowVulReportDataResponseInfoSummary {
