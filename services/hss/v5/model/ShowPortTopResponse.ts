...
export class ShowPortTopResponse extends SdkResponse {
    private 'total_num'?: number;
    private 'data_list'?: Array<CommonTopResponseInfo>;
    public constructor() { 
        super();
    }
    public withTotalNum(totalNum: number): ShowPortTopResponse {
    ...
    public withDataList(dataList: Array<CommonTopResponseInfo>): ShowPortTopResponse {
