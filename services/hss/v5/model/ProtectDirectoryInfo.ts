...
export class ProtectDirectoryInfo {
    ...
    public constructor(protectDirectory?: string) { 
        this['protect_directory'] = protectDirectory;
    }
    public withProtectDirectory(protectDirectory: string): ProtectDirectoryInfo {
        this['protect_directory'] = protectDirectory;
        return this;
    }
    ...
    public withExcludeChildDirectoryList(excludeChildDirectoryList: Array<string>): ProtectDirectoryInfo {
    ...
    public withExcludeFileList(excludeFileList: Array<string>): ProtectDirectoryInfo {
    ...
    public withBackupDirectory(backupDirectory: string): ProtectDirectoryInfo {
