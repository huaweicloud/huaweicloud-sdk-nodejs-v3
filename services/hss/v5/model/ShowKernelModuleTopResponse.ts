...
export class ShowKernelModuleTopResponse extends SdkResponse {
    private 'total_num'?: number;
    private 'data_list'?: Array<CommonTopResponseInfo>;
    public constructor() { 
        super();
    }
    public withTotalNum(totalNum: number): ShowKernelModuleTopResponse {
    ...
    public withDataList(dataList: Array<CommonTopResponseInfo>): ShowKernelModuleTopResponse {
