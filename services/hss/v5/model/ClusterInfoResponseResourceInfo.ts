...
export class ClusterInfoResponseResourceInfo {
    public mode?: string;
    private 'cpu_limit'?: string;
    private 'mem_limit'?: string;
    public constructor() { 
    }
    public withMode(mode: string): ClusterInfoResponseResourceInfo {
        this['mode'] = mode;
        return this;
    }
    public withCpuLimit(cpuLimit: string): ClusterInfoResponseResourceInfo {
    ...
    public withMemLimit(memLimit: string): ClusterInfoResponseResourceInfo {
