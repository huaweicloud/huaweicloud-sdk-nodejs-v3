...
export class ShowJarPackageTopResponse extends SdkResponse {
    private 'total_num'?: number;
    private 'data_list'?: Array<CommonTopResponseInfo>;
    public constructor() { 
        super();
    }
    public withTotalNum(totalNum: number): ShowJarPackageTopResponse {
    ...
    public withDataList(dataList: Array<CommonTopResponseInfo>): ShowJarPackageTopResponse {
