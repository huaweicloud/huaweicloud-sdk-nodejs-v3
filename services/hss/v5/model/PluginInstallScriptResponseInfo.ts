...
export class PluginInstallScriptResponseInfo {
    private 'package_type'?: string;
    public cmd?: string;
    private 'package_download_url'?: string;
    public constructor() { 
    }
    public withPackageType(packageType: string): PluginInstallScriptResponseInfo {
    ...
    public withCmd(cmd: string): PluginInstallScriptResponseInfo {
        this['cmd'] = cmd;
        return this;
    }
    public withPackageDownloadUrl(packageDownloadUrl: string): PluginInstallScriptResponseInfo {
