...
export class ExportEventRequestResponse extends SdkResponse {
    private 'record_total_num'?: number;
    private 'task_id'?: string;
    public constructor() { 
        super();
    }
    public withRecordTotalNum(recordTotalNum: number): ExportEventRequestResponse {
    ...
    public withTaskId(taskId: string): ExportEventRequestResponse {
        this['task_id'] = taskId;
        return this;
    }
