...
export class ShowWebFrameworkTopResponse extends SdkResponse {
    private 'total_num'?: number;
    private 'data_list'?: Array<CommonTopResponseInfo>;
    public constructor() { 
        super();
    }
    public withTotalNum(totalNum: number): ShowWebFrameworkTopResponse {
    ...
    public withDataList(dataList: Array<CommonTopResponseInfo>): ShowWebFrameworkTopResponse {
