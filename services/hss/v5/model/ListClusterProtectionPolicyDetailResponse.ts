...
export class ListClusterProtectionPolicyDetailResponse extends SdkResponse {
    ...
    public withTotalNum(totalNum: number): ListClusterProtectionPolicyDetailResponse {
    ...
    public withXAuthToken(xAuthToken: string): ListClusterProtectionPolicyDetailResponse {
    ...
    public withProjectId(projectId: string): ListClusterProtectionPolicyDetailResponse {
    ...
    public withEnterpriseProjectId(enterpriseProjectId: string): ListClusterProtectionPolicyDetailResponse {
    ...
    public withRegion(region: string): ListClusterProtectionPolicyDetailResponse {
        this['region'] = region;
        return this;
    }
    public withGeneralPolicyNum(generalPolicyNum: number): ListClusterProtectionPolicyDetailResponse {
    ...
    public withMaliciousImagePolicyNum(maliciousImagePolicyNum: number): ListClusterProtectionPolicyDetailResponse {
    ...
    public withSecurityPolicyNum(securityPolicyNum: number): ListClusterProtectionPolicyDetailResponse {
    ...
    public withDataList(dataList: Array<ClusterPolicyResponseInfo>): ListClusterProtectionPolicyDetailResponse {
