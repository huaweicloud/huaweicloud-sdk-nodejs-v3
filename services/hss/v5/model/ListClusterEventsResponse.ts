...
export class ListClusterEventsResponse extends SdkResponse {
    ...
    public withTotalNum(totalNum: number): ListClusterEventsResponse {
    ...
    public withLastUpdateTime(lastUpdateTime: number): ListClusterEventsResponse {
    ...
    public withDataList(dataList: Array<ClusterEventResponseInfo>): ListClusterEventsResponse {
