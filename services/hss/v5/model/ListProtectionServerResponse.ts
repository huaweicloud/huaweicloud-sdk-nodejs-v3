...
export class ListProtectionServerResponse extends SdkResponse {
    private 'total_num'?: number;
    private 'data_list'?: Array<ProtectionServerInfo>;
    public constructor() { 
        super();
    }
    public withTotalNum(totalNum: number): ListProtectionServerResponse {
    ...
    public withDataList(dataList: Array<ProtectionServerInfo>): ListProtectionServerResponse {
