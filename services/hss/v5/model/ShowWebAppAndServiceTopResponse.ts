...
export class ShowWebAppAndServiceTopResponse extends SdkResponse {
    private 'total_num'?: number;
    private 'data_list'?: Array<CommonTopResponseInfo>;
    public constructor() { 
        super();
    }
    public withTotalNum(totalNum: number): ShowWebAppAndServiceTopResponse {
    ...
    public withDataList(dataList: Array<CommonTopResponseInfo>): ShowWebAppAndServiceTopResponse {
