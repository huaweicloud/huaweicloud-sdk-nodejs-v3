...
export class ShowEventAttackTagRequest {
    ...
    public withRegion(region: string): ShowEventAttackTagRequest {
        this['region'] = region;
        return this;
    }
    public withEnterpriseProjectId(enterpriseProjectId: string): ShowEventAttackTagRequest {
    ...
    public withLastDays(lastDays: number): ShowEventAttackTagRequest {
    ...
    public withCategory(category: string): ShowEventAttackTagRequest {
        this['category'] = category;
        return this;
    }
    public withHostName(hostName: string): ShowEventAttackTagRequest {
    ...
    public withHostId(hostId: string): ShowEventAttackTagRequest {
        this['host_id'] = hostId;
        return this;
    }
    ...
    public withPrivateIp(privateIp: string): ShowEventAttackTagRequest {
    ...
    public withPublicIp(publicIp: string): ShowEventAttackTagRequest {
    ...
    public withContainerName(containerName: string): ShowEventAttackTagRequest {
    ...
    public withEventType(eventType: number): ShowEventAttackTagRequest {
    ...
    public withHandleStatus(handleStatus: string): ShowEventAttackTagRequest {
    ...
    public withSeverity(severity: string): ShowEventAttackTagRequest {
        this['severity'] = severity;
        return this;
    }
    public withSeverityList(severityList: Array<string>): ShowEventAttackTagRequest {
    ...
    public withAttackTag(attackTag: string): ShowEventAttackTagRequest {
    ...
    public withAssetValue(assetValue: string): ShowEventAttackTagRequest {
    ...
    public withTagList(tagList: Array<string>): ShowEventAttackTagRequest {
    ...
    public withAttCk(attCk: string): ShowEventAttackTagRequest {
        this['att_ck'] = attCk;
        return this;
    }
    ...
    public withEventName(eventName: string): ShowEventAttackTagRequest {
