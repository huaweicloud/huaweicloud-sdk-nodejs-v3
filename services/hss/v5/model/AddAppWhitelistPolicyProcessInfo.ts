...
export class AddAppWhitelistPolicyProcessInfo {
    ...
    public withProcessName(processName: string): AddAppWhitelistPolicyProcessInfo {
    ...
    public withProcessPath(processPath: string): AddAppWhitelistPolicyProcessInfo {
    ...
    public withProcessHash(processHash: string): AddAppWhitelistPolicyProcessInfo {
    ...
    public withContainerId(containerId: string): AddAppWhitelistPolicyProcessInfo {
    ...
    public withCmdline(cmdline: string): AddAppWhitelistPolicyProcessInfo {
        this['cmdline'] = cmdline;
        return this;
    }
    public withFileSize(fileSize: number): AddAppWhitelistPolicyProcessInfo {
