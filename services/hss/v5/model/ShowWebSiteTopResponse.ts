...
export class ShowWebSiteTopResponse extends SdkResponse {
    private 'total_num'?: number;
    private 'data_list'?: Array<CommonTopResponseInfo>;
    public constructor() { 
        super();
    }
    public withTotalNum(totalNum: number): ShowWebSiteTopResponse {
    ...
    public withDataList(dataList: Array<CommonTopResponseInfo>): ShowWebSiteTopResponse {
