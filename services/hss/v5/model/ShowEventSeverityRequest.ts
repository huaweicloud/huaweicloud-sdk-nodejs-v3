...
export class ShowEventSeverityRequest {
    ...
    public withRegion(region: string): ShowEventSeverityRequest {
        this['region'] = region;
        return this;
    }
    public withEnterpriseProjectId(enterpriseProjectId: string): ShowEventSeverityRequest {
    ...
    public withBeginTime(beginTime: number): ShowEventSeverityRequest {
    ...
    public withEndTime(endTime: number): ShowEventSeverityRequest {
    ...
    public withLastDays(lastDays: number): ShowEventSeverityRequest {
    ...
    public withCategory(category: string): ShowEventSeverityRequest {
        this['category'] = category;
        return this;
    }
    public withHostName(hostName: string): ShowEventSeverityRequest {
    ...
    public withHostId(hostId: string): ShowEventSeverityRequest {
        this['host_id'] = hostId;
        return this;
    }
    ...
    public withPrivateIp(privateIp: string): ShowEventSeverityRequest {
    ...
    public withPublicIp(publicIp: string): ShowEventSeverityRequest {
    ...
    public withContainerName(containerName: string): ShowEventSeverityRequest {
    ...
    public withEventType(eventType: number): ShowEventSeverityRequest {
    ...
    public withHandleStatus(handleStatus: string): ShowEventSeverityRequest {
    ...
    public withSeverity(severity: string): ShowEventSeverityRequest {
        this['severity'] = severity;
        return this;
    }
    public withSeverityList(severityList: Array<string>): ShowEventSeverityRequest {
    ...
    public withAttackTag(attackTag: string): ShowEventSeverityRequest {
    ...
    public withAssetValue(assetValue: string): ShowEventSeverityRequest {
    ...
    public withTagList(tagList: Array<string>): ShowEventSeverityRequest {
    ...
    public withAttCk(attCk: string): ShowEventSeverityRequest {
        this['att_ck'] = attCk;
        return this;
    }
    ...
    public withEventName(eventName: string): ShowEventSeverityRequest {
