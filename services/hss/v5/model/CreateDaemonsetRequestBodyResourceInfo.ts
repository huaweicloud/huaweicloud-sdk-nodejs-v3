...
export class CreateDaemonsetRequestBodyResourceInfo {
    public mode?: string;
    private 'cpu_limit'?: string;
    private 'mem_limit'?: string;
    public constructor() { 
    }
    public withMode(mode: string): CreateDaemonsetRequestBodyResourceInfo {
        this['mode'] = mode;
        return this;
    }
    public withCpuLimit(cpuLimit: string): CreateDaemonsetRequestBodyResourceInfo {
    ...
    public withMemLimit(memLimit: string): CreateDaemonsetRequestBodyResourceInfo {
