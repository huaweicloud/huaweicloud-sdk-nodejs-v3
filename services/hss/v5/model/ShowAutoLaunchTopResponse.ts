...
export class ShowAutoLaunchTopResponse extends SdkResponse {
    private 'total_num'?: number;
    private 'data_list'?: Array<CommonTopResponseInfo>;
    public constructor() { 
        super();
    }
    public withTotalNum(totalNum: number): ShowAutoLaunchTopResponse {
    ...
    public withDataList(dataList: Array<CommonTopResponseInfo>): ShowAutoLaunchTopResponse {
