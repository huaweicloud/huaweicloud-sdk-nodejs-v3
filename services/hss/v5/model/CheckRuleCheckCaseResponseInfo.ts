...
export class CheckRuleCheckCaseResponseInfo {
    private 'check_description'?: string;
    private 'current_value'?: string;
    private 'suggest_value'?: string;
    public constructor() { 
    }
    public withCheckDescription(checkDescription: string): CheckRuleCheckCaseResponseInfo {
    ...
    public withCurrentValue(currentValue: string): CheckRuleCheckCaseResponseInfo {
    ...
    public withSuggestValue(suggestValue: string): CheckRuleCheckCaseResponseInfo {
