...
export class EventWhiteRuleListRequestInfo {
    ...
    public withScope(scope: boolean): EventWhiteRuleListRequestInfo {
        this['scope'] = scope;
        return this;
    }
    public withAgentIds(agentIds: Array<string>): EventWhiteRuleListRequestInfo {
    ...
    public withInstanceIds(instanceIds: Array<string>): EventWhiteRuleListRequestInfo {
