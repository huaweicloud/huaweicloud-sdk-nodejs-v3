...
export class ListVulHostVulsResponse extends SdkResponse {
    private 'data_list'?: Array<VulUrgentResponseInfoDataList>;
    private 'total_num'?: number;
    public constructor() { 
        super();
    }
    public withDataList(dataList: Array<VulUrgentResponseInfoDataList>): ListVulHostVulsResponse {
    ...
    public withTotalNum(totalNum: number): ListVulHostVulsResponse {
