...
export class ImageAppsInfo {
    ...
    public withAppName(appName: string): ImageAppsInfo {
    ...
    public withAppType(appType: string): ImageAppsInfo {
    ...
    public withAppVersion(appVersion: string): ImageAppsInfo {
    ...
    public withVulNum(vulNum: number): ImageAppsInfo {
        this['vul_num'] = vulNum;
        return this;
    }
