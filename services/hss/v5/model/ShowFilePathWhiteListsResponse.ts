...
export class ShowFilePathWhiteListsResponse extends SdkResponse {
    private 'default_path'?: Array<string>;
    private 'customized_path'?: Array<string>;
    public constructor() { 
        super();
    }
    public withDefaultPath(defaultPath: Array<string>): ShowFilePathWhiteListsResponse {
    ...
    public withCustomizedPath(customizedPath: Array<string>): ShowFilePathWhiteListsResponse {
