...
export class CustomRuleConfigRequestInfo {
    ...
    public withRuleName(ruleName: string): CustomRuleConfigRequestInfo {
        this['rule_name'] = ruleName;
        return this;
    }
    ...
    public withIsAllHost(isAllHost: boolean): CustomRuleConfigRequestInfo {
    ...
    public withCustomRuleValueInfo(customRuleValueInfo: CustomRuleValueInfo): CustomRuleConfigRequestInfo {
        this['custom_rule_value_info'] = customRuleValueInfo;
        return this;
    }
    ...
    public withAgentIds(agentIds: Array<string>): CustomRuleConfigRequestInfo {
