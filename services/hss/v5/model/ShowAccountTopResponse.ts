...
export class ShowAccountTopResponse extends SdkResponse {
    private 'total_num'?: number;
    private 'data_list'?: Array<CommonTopResponseInfo>;
    public constructor() { 
        super();
    }
    public withTotalNum(totalNum: number): ShowAccountTopResponse {
    ...
    public withDataList(dataList: Array<CommonTopResponseInfo>): ShowAccountTopResponse {
