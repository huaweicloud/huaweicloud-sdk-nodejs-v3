...
export class AppWhitelistHostResponseInfo {
    ...
    public withHostId(hostId: string): AppWhitelistHostResponseInfo {
        this['host_id'] = hostId;
        return this;
    }
    ...
    public withHostName(hostName: string): AppWhitelistHostResponseInfo {
    ...
    public withPublicIp(publicIp: string): AppWhitelistHostResponseInfo {
    ...
    public withPrivateIp(privateIp: string): AppWhitelistHostResponseInfo {
