...
export class VulScanPolicyResponseInfoTime {
    ...
    public withDayPart(dayPart: Array<number>): VulScanPolicyResponseInfoTime {
    ...
    public withHourPart(hourPart: number): VulScanPolicyResponseInfoTime {
    ...
    public withMinutePart(minutePart: number): VulScanPolicyResponseInfoTime {
    ...
    public withNextScanTime(nextScanTime: number): VulScanPolicyResponseInfoTime {
    ...
    public withTimezoneOffset(timezoneOffset: number): VulScanPolicyResponseInfoTime {
