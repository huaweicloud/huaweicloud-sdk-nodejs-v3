...
export class ShowWindowsVulDetailResponse extends SdkResponse {
    private 'total_num'?: number;
    private 'data_list'?: Array<WindowsVulDetailInfo>;
    public constructor() { 
        super();
    }
    public withTotalNum(totalNum: number): ShowWindowsVulDetailResponse {
    ...
    public withDataList(dataList: Array<WindowsVulDetailInfo>): ShowWindowsVulDetailResponse {
