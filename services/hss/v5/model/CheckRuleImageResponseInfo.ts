...
export class CheckRuleImageResponseInfo {
    ...
    public withNamespace(namespace: string): CheckRuleImageResponseInfo {
        this['namespace'] = namespace;
        return this;
    }
    public withImageDigest(imageDigest: string): CheckRuleImageResponseInfo {
    ...
    public withImageName(imageName: string): CheckRuleImageResponseInfo {
    ...
    public withImageVersion(imageVersion: string): CheckRuleImageResponseInfo {
    ...
    public withImageType(imageType: string): CheckRuleImageResponseInfo {
    ...
    public withRegistryName(registryName: string): CheckRuleImageResponseInfo {
    ...
    public withImageSize(imageSize: number): CheckRuleImageResponseInfo {
