...
export class SubJobDatas {
    ...
    public withId(id: number): SubJobDatas {
        this['id'] = id;
        return this;
    }
    public withName(name: string): SubJobDatas {
        this['name'] = name;
        return this;
    }
    public withDescription(description: string): SubJobDatas {
        this['description'] = description;
        return this;
    }
    public withSubmissionTime(submissionTime: string): SubJobDatas {
    ...
    public withCompletionTime(completionTime: string): SubJobDatas {
    ...
    public withStageIds(stageIds: Array<number>): SubJobDatas {
    ...
    public withJobGroup(jobGroup: string): SubJobDatas {
    ...
    public withStatus(status: string): SubJobDatas {
        this['status'] = status;
        return this;
    }
    public withNumTasks(numTasks: number): SubJobDatas {
    ...
    public withNumActiveTasks(numActiveTasks: number): SubJobDatas {
    ...
    public withNumCompletedTasks(numCompletedTasks: number): SubJobDatas {
    ...
    public withNumSkippedTasks(numSkippedTasks: number): SubJobDatas {
    ...
    public withNumFailedTasks(numFailedTasks: number): SubJobDatas {
    ...
    public withNumKilledTasks(numKilledTasks: number): SubJobDatas {
    ...
    public withNumCompletedIndices(numCompletedIndices: number): SubJobDatas {
    ...
    public withNumActiveStages(numActiveStages: number): SubJobDatas {
    ...
    public withNumCompletedStages(numCompletedStages: number): SubJobDatas {
    ...
    public withNumSkippedStages(numSkippedStages: number): SubJobDatas {
    ...
    public withNumFailedStages(numFailedStages: number): SubJobDatas {
    ...
    public withKilledTasksSummary(killedTasksSummary: { [key: string]: number; }): SubJobDatas {
