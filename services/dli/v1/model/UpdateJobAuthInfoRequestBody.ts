...
export class UpdateJobAuthInfoRequestBody {
    ...
    public withAuthInfoName(authInfoName: string): UpdateJobAuthInfoRequestBody {
        this['auth_info_name'] = authInfoName;
        return this;
    }
    ...
    public withUserName(userName: string): UpdateJobAuthInfoRequestBody {
    ...
    public withPassword(password: string): UpdateJobAuthInfoRequestBody {
        this['password'] = password;
        return this;
    }
    public withKrb5Conf(krb5Conf: string): UpdateJobAuthInfoRequestBody {
    ...
    public withKeytab(keytab: string): UpdateJobAuthInfoRequestBody {
        this['keytab'] = keytab;
        return this;
    }
    public withTruststoreLocation(truststoreLocation: string): UpdateJobAuthInfoRequestBody {
    ...
    public withTruststorePassword(truststorePassword: string): UpdateJobAuthInfoRequestBody {
    ...
    public withKeystoreLocation(keystoreLocation: string): UpdateJobAuthInfoRequestBody {
    ...
    public withKeystorePassword(keystorePassword: string): UpdateJobAuthInfoRequestBody {
