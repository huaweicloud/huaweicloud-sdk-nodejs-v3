...
export class PartitionInfo {
    ...
    public withPartitionName(partitionName: string): PartitionInfo {
        this['partition_name'] = partitionName;
        return this;
    }
    ...
    public withCreateTime(createTime: number): PartitionInfo {
        this['create_time'] = createTime;
        return this;
    }
    ...
    public withLastAccessTime(lastAccessTime: number): PartitionInfo {
        this['last_access_time'] = lastAccessTime;
        return this;
    }
    ...
    public withLocations(locations: Array<string>): PartitionInfo {
        this['locations'] = locations;
        return this;
    }
    public withLastDdlTime(lastDdlTime: number): PartitionInfo {
    ...
    public withNumRows(numRows: number): PartitionInfo {
    ...
    public withNumFiles(numFiles: number): PartitionInfo {
    ...
    public withTotalSize(totalSize: number): PartitionInfo {
