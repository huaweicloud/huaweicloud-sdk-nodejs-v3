...
export class CreateJobRespJob {
    private 'job_id'?: number;
    private 'status_name'?: string;
    private 'status_desc'?: string;
    public constructor() { 
    }
    public withJobId(jobId: number): CreateJobRespJob {
        this['job_id'] = jobId;
        return this;
    }
    ...
    public withStatusName(statusName: string): CreateJobRespJob {
    ...
    public withStatusDesc(statusDesc: string): CreateJobRespJob {
