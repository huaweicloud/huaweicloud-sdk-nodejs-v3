...
export class ListAllTablesRequest {
    ...
    public withDatabaseName(databaseName: string): ListAllTablesRequest {
        this['database_name'] = databaseName;
        return this;
    }
    ...
    public withCurrentPage(currentPage: number): ListAllTablesRequest {
    ...
    public withKeyword(keyword: string): ListAllTablesRequest {
        this['keyword'] = keyword;
        return this;
    }
    public withPageSize(pageSize: number): ListAllTablesRequest {
    ...
    public withTableType(tableType: string): ListAllTablesRequest {
    ...
    public withWithDetail(withDetail: boolean): ListAllTablesRequest {
    ...
    public withWithPriv(withPriv: boolean): ListAllTablesRequest {
