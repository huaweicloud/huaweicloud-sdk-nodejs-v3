...
export class QueuePlanRequestBody {
    private 'plan_name'?: string;
    private 'target_cu'?: number;
    private 'start_hour'?: number;
    private 'start_minute'?: number;
    private 'repeat_day'?: Array<QueuePlanRequestBodyRepeatDayEnum> | Array<string>;
    ...
    public withPlanName(planName: string): QueuePlanRequestBody {
        this['plan_name'] = planName;
        return this;
    }
    ...
    public withTargetCu(targetCu: number): QueuePlanRequestBody {
        this['target_cu'] = targetCu;
        return this;
    }
    ...
    public withStartHour(startHour: number): QueuePlanRequestBody {
        this['start_hour'] = startHour;
        return this;
    }
    ...
    public withStartMinute(startMinute: number): QueuePlanRequestBody {
        this['start_minute'] = startMinute;
        return this;
    }
    ...
    public withRepeatDay(repeatDay: Array<QueuePlanRequestBodyRepeatDayEnum> | Array<string>): QueuePlanRequestBody {
        this['repeat_day'] = repeatDay;
        return this;
    }
    public set repeatDay(repeatDay: Array<QueuePlanRequestBodyRepeatDayEnum> | Array<string>  | undefined) {
        this['repeat_day'] = repeatDay;
    }
    public get repeatDay(): Array<QueuePlanRequestBodyRepeatDayEnum> | Array<string> | undefined {
        return this['repeat_day'];
    }
    public withValidDateBegin(validDateBegin: number): QueuePlanRequestBody {
    ...
    public withValidDateEnd(validDateEnd: number): QueuePlanRequestBody {
    ...
    public withActivate(activate: boolean): QueuePlanRequestBody {
...
/**
    ...
    * @enum {string}
    */
export enum QueuePlanRequestBodyRepeatDayEnum {
    SUNDAY = 'SUNDAY',
    MONDAY = 'MONDAY',
    TUESDAY = 'TUESDAY',
    WEDNESDAY = 'WEDNESDAY',
