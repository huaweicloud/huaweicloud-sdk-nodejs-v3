...
export class CreateFlinkJarJobRequestBody {
    public name?: string;
    public desc?: string;
    ...
    public withName(name: string): CreateFlinkJarJobRequestBody {
        this['name'] = name;
        return this;
    }
    public withDesc(desc: string): CreateFlinkJarJobRequestBody {
        this['desc'] = desc;
        return this;
    }
    public withQueueName(queueName: string): CreateFlinkJarJobRequestBody {
    ...
    public withCuNumber(cuNumber: number): CreateFlinkJarJobRequestBody {
    ...
    public withManagerCuNumber(managerCuNumber: number): CreateFlinkJarJobRequestBody {
    ...
    public withParallelNumber(parallelNumber: number): CreateFlinkJarJobRequestBody {
    ...
    public withObsBucket(obsBucket: string): CreateFlinkJarJobRequestBody {
    ...
    public withSmnTopic(smnTopic: string): CreateFlinkJarJobRequestBody {
    ...
    public withMainClass(mainClass: string): CreateFlinkJarJobRequestBody {
    ...
    public withEntrypointArgs(entrypointArgs: string): CreateFlinkJarJobRequestBody {
    ...
    public withRestartWhenException(restartWhenException: boolean): CreateFlinkJarJobRequestBody {
    ...
    public withEntrypoint(entrypoint: string): CreateFlinkJarJobRequestBody {
        this['entrypoint'] = entrypoint;
        return this;
    }
    public withDependencyJars(dependencyJars: Array<string>): CreateFlinkJarJobRequestBody {
    ...
    public withDependencyFiles(dependencyFiles: Array<string>): CreateFlinkJarJobRequestBody {
    ...
    public withFlinkVersion(flinkVersion: string): CreateFlinkJarJobRequestBody {
    ...
    public withImage(image: string): CreateFlinkJarJobRequestBody {
        this['image'] = image;
        return this;
    }
    public withTmSlotNum(tmSlotNum: number): CreateFlinkJarJobRequestBody {
    ...
    public withTmCus(tmCus: number): CreateFlinkJarJobRequestBody {
        this['tm_cus'] = tmCus;
        return this;
    }
    ...
    public withFeature(feature: string): CreateFlinkJarJobRequestBody {
        this['feature'] = feature;
        return this;
    }
    public withResumeCheckpoint(resumeCheckpoint: boolean): CreateFlinkJarJobRequestBody {
    ...
    public withResumeMaxNum(resumeMaxNum: number): CreateFlinkJarJobRequestBody {
    ...
    public withCheckpointPath(checkpointPath: string): CreateFlinkJarJobRequestBody {
    ...
    public withRuntimeConfig(runtimeConfig: string): CreateFlinkJarJobRequestBody {
