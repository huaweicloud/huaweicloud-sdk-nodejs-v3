...
export class CreateFlinkJarRequestBody {
    public name?: string;
    public desc?: string;
    ...
    public withName(name: string): CreateFlinkJarRequestBody {
        this['name'] = name;
        return this;
    }
    public withDesc(desc: string): CreateFlinkJarRequestBody {
        this['desc'] = desc;
        return this;
    }
    public withQueueName(queueName: string): CreateFlinkJarRequestBody {
    ...
    public withCuNumber(cuNumber: number): CreateFlinkJarRequestBody {
    ...
    public withManagerCuNumber(managerCuNumber: number): CreateFlinkJarRequestBody {
    ...
    public withParallelNumber(parallelNumber: number): CreateFlinkJarRequestBody {
    ...
    public withLogEnabled(logEnabled: boolean): CreateFlinkJarRequestBody {
    ...
    public withObsBucket(obsBucket: string): CreateFlinkJarRequestBody {
    ...
    public withSmnTopic(smnTopic: string): CreateFlinkJarRequestBody {
    ...
    public withMainClass(mainClass: string): CreateFlinkJarRequestBody {
    ...
    public withEntrypointArgs(entrypointArgs: string): CreateFlinkJarRequestBody {
    ...
    public withRestartWhenException(restartWhenException: boolean): CreateFlinkJarRequestBody {
    ...
    public withEntrypoint(entrypoint: string): CreateFlinkJarRequestBody {
        this['entrypoint'] = entrypoint;
        return this;
    }
    public withDependencyJars(dependencyJars: Array<string>): CreateFlinkJarRequestBody {
    ...
    public withDependencyFiles(dependencyFiles: Array<string>): CreateFlinkJarRequestBody {
    ...
    public withFlinkVersion(flinkVersion: string): CreateFlinkJarRequestBody {
    ...
    public withImage(image: string): CreateFlinkJarRequestBody {
        this['image'] = image;
        return this;
    }
    public withTmSlotNum(tmSlotNum: number): CreateFlinkJarRequestBody {
    ...
    public withTmCus(tmCus: number): CreateFlinkJarRequestBody {
        this['tm_cus'] = tmCus;
        return this;
    }
    ...
    public withFeature(feature: string): CreateFlinkJarRequestBody {
        this['feature'] = feature;
        return this;
    }
    public withResumeCheckpoint(resumeCheckpoint: boolean): CreateFlinkJarRequestBody {
    ...
    public withResumeMaxNum(resumeMaxNum: number): CreateFlinkJarRequestBody {
    ...
    public withCheckpointPath(checkpointPath: string): CreateFlinkJarRequestBody {
    ...
    public withRuntimeConfig(runtimeConfig: string): CreateFlinkJarRequestBody {
    ...
    public withTags(tags: Array<TmsTagEntity>): CreateFlinkJarRequestBody {
        this['tags'] = tags;
        return this;
    }
}