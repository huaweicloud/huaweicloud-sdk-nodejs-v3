...
export class CreateAuthInfoRequestBody {
    ...
    public withAuthInfoName(authInfoName: string): CreateAuthInfoRequestBody {
        this['auth_info_name'] = authInfoName;
        return this;
    }
    ...
    public withUserName(userName: string): CreateAuthInfoRequestBody {
    ...
    public withPassword(password: string): CreateAuthInfoRequestBody {
        this['password'] = password;
        return this;
    }
    public withKrb5Conf(krb5Conf: string): CreateAuthInfoRequestBody {
    ...
    public withKeytab(keytab: string): CreateAuthInfoRequestBody {
        this['keytab'] = keytab;
        return this;
    }
    public withTruststoreLocation(truststoreLocation: string): CreateAuthInfoRequestBody {
    ...
    public withTruststorePassword(truststorePassword: string): CreateAuthInfoRequestBody {
    ...
    public withKeystoreLocation(keystoreLocation: string): CreateAuthInfoRequestBody {
    ...
    public withKeystorePassword(keystorePassword: string): CreateAuthInfoRequestBody {
    ...
    public withCertificateLocation(certificateLocation: string): CreateAuthInfoRequestBody {
    ...
    public withDatasourceType(datasourceType: string): CreateAuthInfoRequestBody {
        this['datasource_type'] = datasourceType;
        return this;
    }
    ...
    public withKeyPassword(keyPassword: string): CreateAuthInfoRequestBody {
