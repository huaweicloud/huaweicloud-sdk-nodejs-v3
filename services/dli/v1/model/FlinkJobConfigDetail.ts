...
export class FlinkJobConfigDetail {
    ...
    public withCheckpointEnabled(checkpointEnabled: boolean): FlinkJobConfigDetail {
    ...
    public withCheckpointMode(checkpointMode: string): FlinkJobConfigDetail {
    ...
    public withCheckpointInterval(checkpointInterval: number): FlinkJobConfigDetail {
    ...
    public withLogEnabled(logEnabled: boolean): FlinkJobConfigDetail {
    ...
    public withObsBucket(obsBucket: string): FlinkJobConfigDetail {
    ...
    public withSmnTopic(smnTopic: string): FlinkJobConfigDetail {
    ...
    public withEdgeGroupIds(edgeGroupIds: Array<string>): FlinkJobConfigDetail {
    ...
    public withRootId(rootId: number): FlinkJobConfigDetail {
        this['root_id'] = rootId;
        return this;
    }
    ...
    public withManagerCuNumber(managerCuNumber: number): FlinkJobConfigDetail {
    ...
    public withCuNumber(cuNumber: number): FlinkJobConfigDetail {
    ...
    public withParallelNumber(parallelNumber: number): FlinkJobConfigDetail {
    ...
    public withRestartWhenException(restartWhenException: boolean): FlinkJobConfigDetail {
    ...
    public withIdleStateRetention(idleStateRetention: number): FlinkJobConfigDetail {
    ...
    public withUdfJarUrl(udfJarUrl: string): FlinkJobConfigDetail {
    ...
    public withDirtyDataStrategy(dirtyDataStrategy: string): FlinkJobConfigDetail {
    ...
    public withEntrypoint(entrypoint: string): FlinkJobConfigDetail {
        this['entrypoint'] = entrypoint;
        return this;
    }
    public withDependencyJars(dependencyJars: Array<string>): FlinkJobConfigDetail {
    ...
    public withDependencyFiles(dependencyFiles: Array<string>): FlinkJobConfigDetail {
    ...
    public withExecutorNumber(executorNumber: number): FlinkJobConfigDetail {
    ...
    public withExecutorCuNumber(executorCuNumber: number): FlinkJobConfigDetail {
    ...
    public withResumeCheckpoint(resumeCheckpoint: boolean): FlinkJobConfigDetail {
    ...
    public withRuntimeConfig(runtimeConfig: string): FlinkJobConfigDetail {
    ...
    public withGraphEditorEnabled(graphEditorEnabled: boolean): FlinkJobConfigDetail {
    ...
    public withGraphEditorData(graphEditorData: string): FlinkJobConfigDetail {
    ...
    public withResumeMaxNum(resumeMaxNum: number): FlinkJobConfigDetail {
    ...
    public withCheckpointPath(checkpointPath: string): FlinkJobConfigDetail {
    ...
    public withConfigUrl(configUrl: string): FlinkJobConfigDetail {
    ...
    public withTmCus(tmCus: number): FlinkJobConfigDetail {
        this['tm_cus'] = tmCus;
        return this;
    }
    ...
    public withTmSlotNum(tmSlotNum: number): FlinkJobConfigDetail {
    ...
    public withImage(image: string): FlinkJobConfigDetail {
        this['image'] = image;
        return this;
    }
    public withFeature(feature: string): FlinkJobConfigDetail {
        this['feature'] = feature;
        return this;
    }
    public withFlinkVersion(flinkVersion: string): FlinkJobConfigDetail {
    ...
    public withOperatorConfig(operatorConfig: string): FlinkJobConfigDetail {
    ...
    public withStaticEstimatorConfig(staticEstimatorConfig: string): FlinkJobConfigDetail {
