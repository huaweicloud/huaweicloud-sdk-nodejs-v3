...
export class CreateJobAuthInfoRequestBody {
    ...
    public withAuthInfoName(authInfoName: string): CreateJobAuthInfoRequestBody {
        this['auth_info_name'] = authInfoName;
        return this;
    }
    ...
    public withUserName(userName: string): CreateJobAuthInfoRequestBody {
    ...
    public withPassword(password: string): CreateJobAuthInfoRequestBody {
        this['password'] = password;
        return this;
    }
    public withKrb5Conf(krb5Conf: string): CreateJobAuthInfoRequestBody {
    ...
    public withKeytab(keytab: string): CreateJobAuthInfoRequestBody {
        this['keytab'] = keytab;
        return this;
    }
    public withTruststoreLocation(truststoreLocation: string): CreateJobAuthInfoRequestBody {
    ...
    public withTruststorePassword(truststorePassword: string): CreateJobAuthInfoRequestBody {
    ...
    public withKeystoreLocation(keystoreLocation: string): CreateJobAuthInfoRequestBody {
    ...
    public withKeystorePassword(keystorePassword: string): CreateJobAuthInfoRequestBody {
    ...
    public withCertificateLocation(certificateLocation: string): CreateJobAuthInfoRequestBody {
    ...
    public withDatasourceType(datasourceType: string): CreateJobAuthInfoRequestBody {
        this['datasource_type'] = datasourceType;
        return this;
    }
    ...
    public withKeyPassword(keyPassword: string): CreateJobAuthInfoRequestBody {
