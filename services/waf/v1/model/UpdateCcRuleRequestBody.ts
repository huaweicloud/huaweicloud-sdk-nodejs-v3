...
export class UpdateCcRuleRequestBody {
    ...
    private 'tag_type'?: UpdateCcRuleRequestBodyTagTypeEnum | string;
    ...
    public withTagType(tagType: UpdateCcRuleRequestBodyTagTypeEnum | string): UpdateCcRuleRequestBody {
        this['tag_type'] = tagType;
        return this;
    }
    public set tagType(tagType: UpdateCcRuleRequestBodyTagTypeEnum | string  | undefined) {
        this['tag_type'] = tagType;
    }
    public get tagType(): UpdateCcRuleRequestBodyTagTypeEnum | string | undefined {
