...
export class CreateAlertNoticeConfigResponse extends SdkResponse {
    public id?: string;
    public name?: string;
    ...
    public withId(id: string): CreateAlertNoticeConfigResponse {
        this['id'] = id;
        return this;
    }
    public withName(name: string): CreateAlertNoticeConfigResponse {
        this['name'] = name;
        return this;
    }
    public withEnabled(enabled: boolean): CreateAlertNoticeConfigResponse {
        this['enabled'] = enabled;
        return this;
    }
    public withTopicUrn(topicUrn: string): CreateAlertNoticeConfigResponse {
    ...
    public withSendfreq(sendfreq: number): CreateAlertNoticeConfigResponse {
        this['sendfreq'] = sendfreq;
        return this;
    }
    public withLocale(locale: string): CreateAlertNoticeConfigResponse {
        this['locale'] = locale;
        return this;
    }
    public withTimes(times: number): CreateAlertNoticeConfigResponse {
        this['times'] = times;
        return this;
    }
    public withThreat(threat: Array<string>): CreateAlertNoticeConfigResponse {
        this['threat'] = threat;
        return this;
    }
    public withPreferHtml(preferHtml: boolean): CreateAlertNoticeConfigResponse {
    ...
    public withNoticeClass(noticeClass: string): CreateAlertNoticeConfigResponse {
    ...
    public withEnterpriseProjectId(enterpriseProjectId: string): CreateAlertNoticeConfigResponse {
    ...
    public withUpdateTime(updateTime: number): CreateAlertNoticeConfigResponse {
