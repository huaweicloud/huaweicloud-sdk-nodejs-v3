...
export class UpdateBotMTrafficDetectionConditionResponse extends SdkResponse {
    public id?: string;
    ...
    public withId(id: string): UpdateBotMTrafficDetectionConditionResponse {
        this['id'] = id;
        return this;
    }
    public withMatchField(matchField: string): UpdateBotMTrafficDetectionConditionResponse {
    ...
    public withMatchFieldIndex(matchFieldIndex: string): UpdateBotMTrafficDetectionConditionResponse {
    ...
    public withLogicalOperator(logicalOperator: string): UpdateBotMTrafficDetectionConditionResponse {
    ...
    public withMatchContents(matchContents: Array<string>): UpdateBotMTrafficDetectionConditionResponse {
    ...
    public withValueListRes(valueListRes: string): UpdateBotMTrafficDetectionConditionResponse {
