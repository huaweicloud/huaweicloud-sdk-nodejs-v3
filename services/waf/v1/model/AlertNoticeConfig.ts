...
export class AlertNoticeConfig {
    ...
    public withLocal(local: string): AlertNoticeConfig {
        this['local'] = local;
        return this;
    }
    ...
    public withPreferHtml(preferHtml: boolean): AlertNoticeConfig {
    ...
    public withThreat(threat: Array<string>): AlertNoticeConfig {
        this['threat'] = threat;
        return this;
    }
}