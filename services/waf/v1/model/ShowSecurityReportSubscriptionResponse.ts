...
export class ShowSecurityReportSubscriptionResponse extends SdkResponse {
    ...
    public withSubscriptionId(subscriptionId: string): ShowSecurityReportSubscriptionResponse {
    ...
    public withSendingPeriod(sendingPeriod: string): ShowSecurityReportSubscriptionResponse {
    ...
    public withReportName(reportName: string): ShowSecurityReportSubscriptionResponse {
    ...
    public withReportCategory(reportCategory: string): ShowSecurityReportSubscriptionResponse {
    ...
    public withTopicUrn(topicUrn: string): ShowSecurityReportSubscriptionResponse {
    ...
    public withSubscriptionType(subscriptionType: string): ShowSecurityReportSubscriptionResponse {
    ...
    public withReportContentSubscription(reportContentSubscription: SecurityReportSubscriptionResponseReportContentSubscription): ShowSecurityReportSubscriptionResponse {
    ...
    public withStatPeriod(statPeriod: SecurityReportSubscriptionResponseStatPeriod): ShowSecurityReportSubscriptionResponse {
    ...
    public withIsAllEnterpriseProject(isAllEnterpriseProject: boolean): ShowSecurityReportSubscriptionResponse {
    ...
    public withEnterpriseProjectId(enterpriseProjectId: string): ShowSecurityReportSubscriptionResponse {
