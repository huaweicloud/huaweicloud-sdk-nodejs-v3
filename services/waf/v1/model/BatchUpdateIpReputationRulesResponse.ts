...
export class BatchUpdateIpReputationRulesResponse extends SdkResponse {
    private 'policy_rule_ids'?: Array<PolicyRuleIdResponseBodyPolicyRuleIds>;
    public constructor() { 
        super();
    }
    public withPolicyRuleIds(policyRuleIds: Array<PolicyRuleIdResponseBodyPolicyRuleIds>): BatchUpdateIpReputationRulesResponse {
