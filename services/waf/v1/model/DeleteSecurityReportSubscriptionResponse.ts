...
export class DeleteSecurityReportSubscriptionResponse extends SdkResponse {
    ...
    public withSubscriptionId(subscriptionId: string): DeleteSecurityReportSubscriptionResponse {
    ...
    public withSendingPeriod(sendingPeriod: string): DeleteSecurityReportSubscriptionResponse {
    ...
    public withReportName(reportName: string): DeleteSecurityReportSubscriptionResponse {
    ...
    public withReportCategory(reportCategory: string): DeleteSecurityReportSubscriptionResponse {
    ...
    public withTopicUrn(topicUrn: string): DeleteSecurityReportSubscriptionResponse {
    ...
    public withSubscriptionType(subscriptionType: string): DeleteSecurityReportSubscriptionResponse {
    ...
    public withReportContentSubscription(reportContentSubscription: SecurityReportSubscriptionResponseReportContentSubscription): DeleteSecurityReportSubscriptionResponse {
    ...
    public withStatPeriod(statPeriod: SecurityReportSubscriptionResponseStatPeriod): DeleteSecurityReportSubscriptionResponse {
    ...
    public withIsAllEnterpriseProject(isAllEnterpriseProject: boolean): DeleteSecurityReportSubscriptionResponse {
    ...
    public withEnterpriseProjectId(enterpriseProjectId: string): DeleteSecurityReportSubscriptionResponse {
