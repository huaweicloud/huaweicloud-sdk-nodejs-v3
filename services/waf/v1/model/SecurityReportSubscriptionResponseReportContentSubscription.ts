...
export class SecurityReportSubscriptionResponseReportContentSubscription {
    ...
    public withOverviewStatisticsEnable(overviewStatisticsEnable: boolean): SecurityReportSubscriptionResponseReportContentSubscription {
    ...
    public withGroupByDayEnable(groupByDayEnable: boolean): SecurityReportSubscriptionResponseReportContentSubscription {
    ...
    public withRequestStatisticsEnable(requestStatisticsEnable: boolean): SecurityReportSubscriptionResponseReportContentSubscription {
    ...
    public withQpsStatisticsEnable(qpsStatisticsEnable: boolean): SecurityReportSubscriptionResponseReportContentSubscription {
    ...
    public withBandwidthStatisticsEnable(bandwidthStatisticsEnable: boolean): SecurityReportSubscriptionResponseReportContentSubscription {
    ...
    public withResponseCodeStatisticsEnable(responseCodeStatisticsEnable: boolean): SecurityReportSubscriptionResponseReportContentSubscription {
    ...
    public withAttackTypeDistributionEnable(attackTypeDistributionEnable: boolean): SecurityReportSubscriptionResponseReportContentSubscription {
    ...
    public withTopAttackedDomainsEnable(topAttackedDomainsEnable: boolean): SecurityReportSubscriptionResponseReportContentSubscription {
    ...
    public withTopAttackSourceIpsEnable(topAttackSourceIpsEnable: boolean): SecurityReportSubscriptionResponseReportContentSubscription {
    ...
    public withTopAttackedUrlsEnable(topAttackedUrlsEnable: boolean): SecurityReportSubscriptionResponseReportContentSubscription {
    ...
    public withTopAttackSourceLocationsEnable(topAttackSourceLocationsEnable: boolean): SecurityReportSubscriptionResponseReportContentSubscription {
    ...
    public withTopAbnormalUrlsEnable(topAbnormalUrlsEnable: boolean): SecurityReportSubscriptionResponseReportContentSubscription {
