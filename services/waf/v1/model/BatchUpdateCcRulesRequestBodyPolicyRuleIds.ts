...
export class BatchUpdateCcRulesRequestBodyPolicyRuleIds {
    ...
    public withPolicyId(policyId: string): BatchUpdateCcRulesRequestBodyPolicyRuleIds {
        this['policy_id'] = policyId;
        return this;
    }
    ...
    public withRuleIds(ruleIds: Array<string>): BatchUpdateCcRulesRequestBodyPolicyRuleIds {
        this['rule_ids'] = ruleIds;
        return this;
    }
