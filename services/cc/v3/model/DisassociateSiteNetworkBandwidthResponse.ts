...
export class DisassociateSiteNetworkBandwidthResponse extends SdkResponse {
    ...
    public withRequestId(requestId: string): DisassociateSiteNetworkBandwidthResponse {
        this['request_id'] = requestId;
        return this;
    }
    ...
    public withSiteConnection(siteConnection: SiteConnection): DisassociateSiteNetworkBandwidthResponse {
        this['site_connection'] = siteConnection;
        return this;
    }
