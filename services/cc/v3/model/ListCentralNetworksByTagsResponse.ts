...
export class ListCentralNetworksByTagsResponse extends SdkResponse {
    ...
    public withRequestId(requestId: string): ListCentralNetworksByTagsResponse {
        this['request_id'] = requestId;
        return this;
    }
    ...
    public withPageInfo(pageInfo: PageInfo): ListCentralNetworksByTagsResponse {
    ...
    public withCentralNetworks(centralNetworks: Array<CentralNetwork>): ListCentralNetworksByTagsResponse {
        this['central_networks'] = centralNetworks;
        return this;
    }
