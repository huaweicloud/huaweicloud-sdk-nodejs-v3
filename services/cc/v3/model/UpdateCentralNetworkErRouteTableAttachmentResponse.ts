...
export class UpdateCentralNetworkErRouteTableAttachmentResponse extends SdkResponse {
    ...
    public withRequestId(requestId: string): UpdateCentralNetworkErRouteTableAttachmentResponse {
        this['request_id'] = requestId;
        return this;
    }
    ...
    public withCentralNetworkErRouteTableAttachment(centralNetworkErRouteTableAttachment: CentralNetworkErRouteTableAttachment): UpdateCentralNetworkErRouteTableAttachmentResponse {
        this['central_network_er_route_table_attachment'] = centralNetworkErRouteTableAttachment;
        return this;
    }
