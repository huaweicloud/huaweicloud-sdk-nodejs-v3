...
export class CreateBandwidthPackageResponse extends SdkResponse {
    ...
    public withRequestId(requestId: string): CreateBandwidthPackageResponse {
        this['request_id'] = requestId;
        return this;
    }
    ...
    public withBandwidthPackage(bandwidthPackage: BandwidthPackage): CreateBandwidthPackageResponse {
        this['bandwidth_package'] = bandwidthPackage;
        return this;
    }
