...
export class UpdateBandwidthPackageResponse extends SdkResponse {
    private 'bandwidth_package'?: BandwidthPackage;
    private 'request_id'?: string;
    public constructor() { 
        super();
    }
    public withBandwidthPackage(bandwidthPackage: BandwidthPackage): UpdateBandwidthPackageResponse {
    ...
    public withRequestId(requestId: string): UpdateBandwidthPackageResponse {
