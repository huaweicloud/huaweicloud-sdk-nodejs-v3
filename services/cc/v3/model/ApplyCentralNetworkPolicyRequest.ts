...
export class ApplyCentralNetworkPolicyRequest {
    ...
    public withPolicyId(policyId: string): ApplyCentralNetworkPolicyRequest {
        this['policy_id'] = policyId;
        return this;
    }
    ...
    public withCentralNetworkId(centralNetworkId: string): ApplyCentralNetworkPolicyRequest {
        this['central_network_id'] = centralNetworkId;
        return this;
    }
