...
export class ListGlobalConnectionBandwidthsResponse extends SdkResponse {
    ...
    public withRequestId(requestId: string): ListGlobalConnectionBandwidthsResponse {
        this['request_id'] = requestId;
        return this;
    }
    ...
    public withPageInfo(pageInfo: PageInfo): ListGlobalConnectionBandwidthsResponse {
    ...
    public withGlobalconnectionBandwidths(globalconnectionBandwidths: Array<GlobalConnectionBandwidth>): ListGlobalConnectionBandwidthsResponse {
        this['globalconnection_bandwidths'] = globalconnectionBandwidths;
        return this;
    }
