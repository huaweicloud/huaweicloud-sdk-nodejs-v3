...
export class DeleteSiteNetworkResponse extends SdkResponse {
    ...
    public withRequestId(requestId: string): DeleteSiteNetworkResponse {
        this['request_id'] = requestId;
        return this;
    }
    ...
    public withSiteNetwork(siteNetwork: SiteNetworkEntry): DeleteSiteNetworkResponse {
        this['site_network'] = siteNetwork;
        return this;
    }
