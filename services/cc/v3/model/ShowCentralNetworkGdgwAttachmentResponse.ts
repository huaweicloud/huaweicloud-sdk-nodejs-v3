...
export class ShowCentralNetworkGdgwAttachmentResponse extends SdkResponse {
    ...
    public withRequestId(requestId: string): ShowCentralNetworkGdgwAttachmentResponse {
        this['request_id'] = requestId;
        return this;
    }
    ...
    public withCentralNetworkGdgwAttachment(centralNetworkGdgwAttachment: CentralNetworkGdgwAttachment): ShowCentralNetworkGdgwAttachmentResponse {
        this['central_network_gdgw_attachment'] = centralNetworkGdgwAttachment;
        return this;
    }
