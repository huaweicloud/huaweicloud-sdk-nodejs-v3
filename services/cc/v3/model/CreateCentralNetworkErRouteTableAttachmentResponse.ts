...
export class CreateCentralNetworkErRouteTableAttachmentResponse extends SdkResponse {
    ...
    public withRequestId(requestId: string): CreateCentralNetworkErRouteTableAttachmentResponse {
        this['request_id'] = requestId;
        return this;
    }
    ...
    public withCentralNetworkErRouteTableAttachment(centralNetworkErRouteTableAttachment: CentralNetworkErRouteTableAttachment): CreateCentralNetworkErRouteTableAttachmentResponse {
        this['central_network_er_route_table_attachment'] = centralNetworkErRouteTableAttachment;
        return this;
    }
