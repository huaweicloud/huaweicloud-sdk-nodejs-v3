...
export class AssociateSiteNetworkBandwidthResponse extends SdkResponse {
    ...
    public withRequestId(requestId: string): AssociateSiteNetworkBandwidthResponse {
        this['request_id'] = requestId;
        return this;
    }
    ...
    public withSiteConnection(siteConnection: SiteConnection): AssociateSiteNetworkBandwidthResponse {
        this['site_connection'] = siteConnection;
        return this;
    }
