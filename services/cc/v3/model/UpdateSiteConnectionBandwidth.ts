...
export class UpdateSiteConnectionBandwidth {
    private 'global_connection_bandwidth_id'?: string;
    private 'bandwidth_size'?: number;
    public constructor() { 
    }
    public withGlobalConnectionBandwidthId(globalConnectionBandwidthId: string): UpdateSiteConnectionBandwidth {
    ...
    public withBandwidthSize(bandwidthSize: number): UpdateSiteConnectionBandwidth {
