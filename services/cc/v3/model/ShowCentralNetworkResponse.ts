...
export class ShowCentralNetworkResponse extends SdkResponse {
    ...
    public withRequestId(requestId: string): ShowCentralNetworkResponse {
        this['request_id'] = requestId;
        return this;
    }
    ...
    public withCentralNetwork(centralNetwork: CentralNetwork): ShowCentralNetworkResponse {
        this['central_network'] = centralNetwork;
        return this;
    }
