...
export class CreateCloudConnectionResponse extends SdkResponse {
    private 'cloud_connection'?: CloudConnection;
    private 'request_id'?: string;
    public constructor() { 
        super();
    }
    public withCloudConnection(cloudConnection: CloudConnection): CreateCloudConnectionResponse {
    ...
    public withRequestId(requestId: string): CreateCloudConnectionResponse {
