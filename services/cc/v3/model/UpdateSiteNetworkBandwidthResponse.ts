...
export class UpdateSiteNetworkBandwidthResponse extends SdkResponse {
    ...
    public withRequestId(requestId: string): UpdateSiteNetworkBandwidthResponse {
        this['request_id'] = requestId;
        return this;
    }
    ...
    public withSiteConnection(siteConnection: SiteConnection): UpdateSiteNetworkBandwidthResponse {
        this['site_connection'] = siteConnection;
        return this;
    }
