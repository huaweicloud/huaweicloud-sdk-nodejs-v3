...
export class ShowCloudConnectionResponse extends SdkResponse {
    ...
    public withRequestId(requestId: string): ShowCloudConnectionResponse {
        this['request_id'] = requestId;
        return this;
    }
    ...
    public withCloudConnection(cloudConnection: CloudConnection): ShowCloudConnectionResponse {
        this['cloud_connection'] = cloudConnection;
        return this;
    }
