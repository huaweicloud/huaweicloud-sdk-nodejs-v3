...
export class CreateCentralNetworkGdgwAttachmentResponse extends SdkResponse {
    ...
    public withRequestId(requestId: string): CreateCentralNetworkGdgwAttachmentResponse {
        this['request_id'] = requestId;
        return this;
    }
    ...
    public withCentralNetworkGdgwAttachment(centralNetworkGdgwAttachment: CentralNetworkGdgwAttachment): CreateCentralNetworkGdgwAttachmentResponse {
        this['central_network_gdgw_attachment'] = centralNetworkGdgwAttachment;
        return this;
    }
