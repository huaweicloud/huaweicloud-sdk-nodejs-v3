...
export class UpdateProjectWebhookResponse extends SdkResponse {
    public url?: string;
    ...
    public withUrl(url: string): UpdateProjectWebhookResponse {
        this['url'] = url;
        return this;
    }
    public withPushEvents(pushEvents: boolean): UpdateProjectWebhookResponse {
    ...
    public withPushEventsBranchRegexFilter(pushEventsBranchRegexFilter: string): UpdateProjectWebhookResponse {
    ...
    public withNotePlainTextFilter(notePlainTextFilter: Array<string>): UpdateProjectWebhookResponse {
    ...
    public withTagPushEvents(tagPushEvents: boolean): UpdateProjectWebhookResponse {
    ...
    public withMergeRequestsEvents(mergeRequestsEvents: boolean): UpdateProjectWebhookResponse {
    ...
    public withNoteEvents(noteEvents: boolean): UpdateProjectWebhookResponse {
    ...
    public withToken(token: string): UpdateProjectWebhookResponse {
        this['token'] = token;
        return this;
    }
    public withTokenType(tokenType: string): UpdateProjectWebhookResponse {
    ...
    public withName(name: string): UpdateProjectWebhookResponse {
        this['name'] = name;
        return this;
    }
    public withDescription(description: string): UpdateProjectWebhookResponse {
        this['description'] = description;
        return this;
    }
    public withEventCfgs(eventCfgs: Array<WebHookEventCfgDto>): UpdateProjectWebhookResponse {
    ...
    public withProjectCfgs(projectCfgs: Array<WebHookBranchCfgDto>): UpdateProjectWebhookResponse {
    ...
    public withBranchCfgs(branchCfgs: Array<WebHookBranchCfgDto>): UpdateProjectWebhookResponse {
    ...
    public withId(id: number): UpdateProjectWebhookResponse {
        this['id'] = id;
        return this;
    }
    public withCreatedAt(createdAt: string): UpdateProjectWebhookResponse {
    ...
    public withUpdatedAt(updatedAt: string): UpdateProjectWebhookResponse {
    ...
    public withService(service: string): UpdateProjectWebhookResponse {
