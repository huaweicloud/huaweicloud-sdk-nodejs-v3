...
export class UpdateMergeRequestResponse extends SdkResponse {
    public id?: number;
    public iid?: number;
    ...
    public withId(id: number): UpdateMergeRequestResponse {
        this['id'] = id;
        return this;
    }
    public withIid(iid: number): UpdateMergeRequestResponse {
        this['iid'] = iid;
        return this;
    }
    public withRepositoryId(repositoryId: number): UpdateMergeRequestResponse {
    ...
    public withTitle(title: string): UpdateMergeRequestResponse {
        this['title'] = title;
        return this;
    }
    public withDescription(description: string): UpdateMergeRequestResponse {
        this['description'] = description;
        return this;
    }
    public withState(state: string): UpdateMergeRequestResponse {
        this['state'] = state;
        return this;
    }
    public withCreatedAt(createdAt: string): UpdateMergeRequestResponse {
    ...
    public withUpdatedAt(updatedAt: string): UpdateMergeRequestResponse {
    ...
    public withSourceBranch(sourceBranch: string): UpdateMergeRequestResponse {
    ...
    public withTargetBranch(targetBranch: string): UpdateMergeRequestResponse {
    ...
    public withIsSourceBranchProtected(isSourceBranchProtected: boolean): UpdateMergeRequestResponse {
    ...
    public withTargetRepositoryId(targetRepositoryId: number): UpdateMergeRequestResponse {
    ...
    public withSourceProjectId(sourceProjectId: string): UpdateMergeRequestResponse {
    ...
    public withTargetProjectId(targetProjectId: string): UpdateMergeRequestResponse {
    ...
    public withLabels(labels: Array<object>): UpdateMergeRequestResponse {
        this['labels'] = labels;
        return this;
    }
    public withWorkInProgress(workInProgress: boolean): UpdateMergeRequestResponse {
    ...
    public withMilestone(milestone: MilestoneBasicDto): UpdateMergeRequestResponse {
        this['milestone'] = milestone;
        return this;
    }
    public withMergeWhenBuildSucceeds(mergeWhenBuildSucceeds: boolean): UpdateMergeRequestResponse {
    ...
    public withMergeStatus(mergeStatus: string): UpdateMergeRequestResponse {
    ...
    public withSha(sha: string): UpdateMergeRequestResponse {
        this['sha'] = sha;
        return this;
    }
    public withMergeCommitSha(mergeCommitSha: string): UpdateMergeRequestResponse {
    ...
    public withSubscribed(subscribed: boolean): UpdateMergeRequestResponse {
        this['subscribed'] = subscribed;
        return this;
    }
    public withMergedBy(mergedBy: UserBasicExternalDto): UpdateMergeRequestResponse {
    ...
    public withMergedAt(mergedAt: string): UpdateMergeRequestResponse {
    ...
    public withClosedBy(closedBy: UserBasicExternalDto): UpdateMergeRequestResponse {
    ...
    public withClosedAt(closedAt: string): UpdateMergeRequestResponse {
    ...
    public withUserNotesCount(userNotesCount: number): UpdateMergeRequestResponse {
    ...
    public withWebUrl(webUrl: string): UpdateMergeRequestResponse {
        this['web_url'] = webUrl;
        return this;
    }
    ...
    public withMergeRequestDiff(mergeRequestDiff: MergeRequestDiffExternalDto): UpdateMergeRequestResponse {
    ...
    public withMergeRequestReviewersCount(mergeRequestReviewersCount: number): UpdateMergeRequestResponse {
    ...
    public withMergeRequestReviewCount(mergeRequestReviewCount: number): UpdateMergeRequestResponse {
    ...
    public withMergeRequestReviewerList(mergeRequestReviewerList: Array<MergeRequestReviewerExternalDto>): UpdateMergeRequestResponse {
    ...
    public withMergeRequestAssigneeList(mergeRequestAssigneeList: Array<UserBasicExternalDto>): UpdateMergeRequestResponse {
    ...
    public withNotes(notes: number): UpdateMergeRequestResponse {
        this['notes'] = notes;
        return this;
    }
    public withCodecheckState(codecheckState: number): UpdateMergeRequestResponse {
    ...
    public withCodecheckDefectCount(codecheckDefectCount: number): UpdateMergeRequestResponse {
    ...
    public withMergeRequestRelatedWorkItems(mergeRequestRelatedWorkItems: Array<MergeRequestRelatedWorkItemDto>): UpdateMergeRequestResponse {
    ...
    public withDivergedCommitsCount(divergedCommitsCount: number): UpdateMergeRequestResponse {
    ...
    public withModerationResult(moderationResult: boolean): UpdateMergeRequestResponse {
    ...
    public withModerationTime(moderationTime: number): UpdateMergeRequestResponse {
    ...
    public withModerationStatus(moderationStatus: number): UpdateMergeRequestResponse {
    ...
    public withIsUseTempBranch(isUseTempBranch: boolean): UpdateMergeRequestResponse {
    ...
    public withReviewMode(reviewMode: UpdateMergeRequestResponseReviewModeEnum | string): UpdateMergeRequestResponse {
        this['review_mode'] = reviewMode;
        return this;
    }
    public set reviewMode(reviewMode: UpdateMergeRequestResponseReviewModeEnum | string  | undefined) {
        this['review_mode'] = reviewMode;
    }
    public get reviewMode(): UpdateMergeRequestResponseReviewModeEnum | string | undefined {
        return this['review_mode'];
    }
    public withSquash(squash: boolean): UpdateMergeRequestResponse {
        this['squash'] = squash;
        return this;
    }
    public withSquashCommitMessage(squashCommitMessage: string): UpdateMergeRequestResponse {
    ...
    public withRebaseInProgress(rebaseInProgress: boolean): UpdateMergeRequestResponse {
    ...
    public withSourceRepository(sourceRepository: ProjectSimpleDto): UpdateMergeRequestResponse {
    ...
    public withTargetRepository(targetRepository: ProjectSimpleDto): UpdateMergeRequestResponse {
    ...
    public withIsSourceBranchExist(isSourceBranchExist: boolean): UpdateMergeRequestResponse {
    ...
    public withMergeRequestType(mergeRequestType: string): UpdateMergeRequestResponse {
...
/**
    ...
    * @enum {string}
    */
export enum UpdateMergeRequestResponseReviewModeEnum {
    VOTE = 'vote',
    APPROVAL = 'approval'
}
