...
export class ReviewMergeRequestRequest {
    ...
    public withRepositoryId(repositoryId: number): ReviewMergeRequestRequest {
        this['repository_id'] = repositoryId;
        return this;
    }
    ...
    public withMergeRequestIid(mergeRequestIid: number): ReviewMergeRequestRequest {
        this['merge_request_iid'] = mergeRequestIid;
        return this;
    }
    ...
    public withBody(body: ApprovalActionTypeDto): ReviewMergeRequestRequest {
        this['body'] = body;
        return this;
    }
}