...
export class UpdateGroupMergeRequestApproverSettingResponse extends SdkResponse {
    public id?: string;
    public target?: string;
    private 'target_type'?: UpdateGroupMergeRequestApproverSettingResponseTargetTypeEnum | string;
    ...
    public withId(id: string): UpdateGroupMergeRequestApproverSettingResponse {
        this['id'] = id;
        return this;
    }
    public withTarget(target: string): UpdateGroupMergeRequestApproverSettingResponse {
        this['target'] = target;
        return this;
    }
    public withTargetType(targetType: UpdateGroupMergeRequestApproverSettingResponseTargetTypeEnum | string): UpdateGroupMergeRequestApproverSettingResponse {
        this['target_type'] = targetType;
        return this;
    }
    public set targetType(targetType: UpdateGroupMergeRequestApproverSettingResponseTargetTypeEnum | string  | undefined) {
        this['target_type'] = targetType;
    }
    public get targetType(): UpdateGroupMergeRequestApproverSettingResponseTargetTypeEnum | string | undefined {
        return this['target_type'];
    }
    public withIsUseApproval(isUseApproval: boolean): UpdateGroupMergeRequestApproverSettingResponse {
    ...
    public withApprovalRequiredReviewers(approvalRequiredReviewers: number): UpdateGroupMergeRequestApproverSettingResponse {
    ...
    public withApprovalRequiredApprovers(approvalRequiredApprovers: number): UpdateGroupMergeRequestApproverSettingResponse {
    ...
    public withResetApprovalsOnPush(resetApprovalsOnPush: boolean): UpdateGroupMergeRequestApproverSettingResponse {
    ...
    public withResetReviewersOnPush(resetReviewersOnPush: boolean): UpdateGroupMergeRequestApproverSettingResponse {
    ...
    public withApproversFromProject(approversFromProject: boolean): UpdateGroupMergeRequestApproverSettingResponse {
    ...
    public withAppendReviewerIds(appendReviewerIds: Array<number>): UpdateGroupMergeRequestApproverSettingResponse {
    ...
    public withAppendReviewers(appendReviewers: Array<UserBasicDto>): UpdateGroupMergeRequestApproverSettingResponse {
    ...
    public withAppendApproverIds(appendApproverIds: Array<number>): UpdateGroupMergeRequestApproverSettingResponse {
    ...
    public withAppendApprovers(appendApprovers: Array<UserBasicDto>): UpdateGroupMergeRequestApproverSettingResponse {
    ...
    public withOnlyMergeWhenPipelinePass(onlyMergeWhenPipelinePass: boolean): UpdateGroupMergeRequestApproverSettingResponse {
    ...
    public withAssigneeIds(assigneeIds: Array<number>): UpdateGroupMergeRequestApproverSettingResponse {
    ...
    public withAssignees(assignees: Array<UserBasicDto>): UpdateGroupMergeRequestApproverSettingResponse {
        this['assignees'] = assignees;
        return this;
    }
    public withApproverIds(approverIds: Array<number>): UpdateGroupMergeRequestApproverSettingResponse {
    ...
    public withApprovers(approvers: Array<UserBasicDto>): UpdateGroupMergeRequestApproverSettingResponse {
        this['approvers'] = approvers;
        return this;
    }
    public withReviewerIds(reviewerIds: Array<number>): UpdateGroupMergeRequestApproverSettingResponse {
    ...
    public withReviewers(reviewers: Array<UserBasicDto>): UpdateGroupMergeRequestApproverSettingResponse {
...
/**
    ...
    * @enum {string}
    */
export enum UpdateGroupMergeRequestApproverSettingResponseTargetTypeEnum {
    BRANCH = 'branch',
    FILE = 'file',
    BINARY = 'binary'
}
