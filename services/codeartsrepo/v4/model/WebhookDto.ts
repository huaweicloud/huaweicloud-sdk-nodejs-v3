...
export class WebhookDto {
    ...
    public withNotePlainTextFilter(notePlainTextFilter: Array<string>): WebhookDto {
    ...
    public withEventCfgs(eventCfgs: Array<WebHookEventCfgDto>): WebhookDto {
    ...
    public withProjectCfgs(projectCfgs: Array<WebHookBranchCfgDto>): WebhookDto {
    ...
    public withBranchCfgs(branchCfgs: Array<WebHookBranchCfgDto>): WebhookDto {
    ...
    public withService(service: string): WebhookDto {
