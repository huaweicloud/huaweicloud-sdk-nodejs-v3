...
export class ShowDiffCommitResponse extends SdkResponse {
    ...
    public withDiffs(diffs: Array<DiffNoLineDto>): ShowDiffCommitResponse {
        this['diffs'] = diffs;
        return this;
    }
    public withDiffRefs(diffRefs: DiffRefsDto): ShowDiffCommitResponse {
    ...
    public withAddedLines(addedLines: number): ShowDiffCommitResponse {
    ...
    public withRemovedLines(removedLines: number): ShowDiffCommitResponse {
    ...
    public withChangeFileCount(changeFileCount: number): ShowDiffCommitResponse {
    ...
    public withChangeLineCount(changeLineCount: number): ShowDiffCommitResponse {
    ...
    public withTooLarge(tooLarge: boolean): ShowDiffCommitResponse {
