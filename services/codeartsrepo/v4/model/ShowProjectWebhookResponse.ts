...
export class ShowProjectWebhookResponse extends SdkResponse {
    public url?: string;
    ...
    public withUrl(url: string): ShowProjectWebhookResponse {
        this['url'] = url;
        return this;
    }
    public withPushEvents(pushEvents: boolean): ShowProjectWebhookResponse {
    ...
    public withPushEventsBranchRegexFilter(pushEventsBranchRegexFilter: string): ShowProjectWebhookResponse {
    ...
    public withNotePlainTextFilter(notePlainTextFilter: Array<string>): ShowProjectWebhookResponse {
    ...
    public withTagPushEvents(tagPushEvents: boolean): ShowProjectWebhookResponse {
    ...
    public withMergeRequestsEvents(mergeRequestsEvents: boolean): ShowProjectWebhookResponse {
    ...
    public withNoteEvents(noteEvents: boolean): ShowProjectWebhookResponse {
    ...
    public withToken(token: string): ShowProjectWebhookResponse {
        this['token'] = token;
        return this;
    }
    public withTokenType(tokenType: string): ShowProjectWebhookResponse {
    ...
    public withName(name: string): ShowProjectWebhookResponse {
        this['name'] = name;
        return this;
    }
    public withDescription(description: string): ShowProjectWebhookResponse {
        this['description'] = description;
        return this;
    }
    public withEventCfgs(eventCfgs: Array<WebHookEventCfgDto>): ShowProjectWebhookResponse {
    ...
    public withProjectCfgs(projectCfgs: Array<WebHookBranchCfgDto>): ShowProjectWebhookResponse {
    ...
    public withBranchCfgs(branchCfgs: Array<WebHookBranchCfgDto>): ShowProjectWebhookResponse {
    ...
    public withId(id: number): ShowProjectWebhookResponse {
        this['id'] = id;
        return this;
    }
    public withCreatedAt(createdAt: string): ShowProjectWebhookResponse {
    ...
    public withUpdatedAt(updatedAt: string): ShowProjectWebhookResponse {
    ...
    public withService(service: string): ShowProjectWebhookResponse {
