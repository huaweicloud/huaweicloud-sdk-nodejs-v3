...
export class MergeMergeRequestResponse extends SdkResponse {
    ...
    public withIsSourceBranchDefault(isSourceBranchDefault: boolean): MergeMergeRequestResponse {
    ...
    public withUpvotes(upvotes: number): MergeMergeRequestResponse {
        this['upvotes'] = upvotes;
        return this;
    }
    public withDownvotes(downvotes: number): MergeMergeRequestResponse {
    ...
    public withAssignee(assignee: UserBasicExternalDto): MergeMergeRequestResponse {
    ...
    public withShouldRemoveSourceBranch(shouldRemoveSourceBranch: boolean): MergeMergeRequestResponse {
    ...
    public withOnlyAssigneeCanMerge(onlyAssigneeCanMerge: boolean): MergeMergeRequestResponse {
    ...
    public withTopic(topic: string): MergeMergeRequestResponse {
        this['topic'] = topic;
        return this;
    }
}
