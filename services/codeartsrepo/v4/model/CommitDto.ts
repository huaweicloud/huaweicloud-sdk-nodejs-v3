...
export class CommitDto {
    ...
    public withMessage(message: string): CommitDto {
        this['message'] = message;
        return this;
    }
    public withParentIds(parentIds: Array<string>): CommitDto {
    ...
    public withAuthoredDate(authoredDate: string): CommitDto {
    ...
    public withAuthorName(authorName: string): CommitDto {
    ...
    public withAuthorEmail(authorEmail: string): CommitDto {
    ...
    public withCommittedDate(committedDate: string): CommitDto {
    ...
    public withCommitterName(committerName: string): CommitDto {
    ...
    public withCommitterEmail(committerEmail: string): CommitDto {
    ...
    public withOpenGpgVerified(openGpgVerified: boolean): CommitDto {
    ...
    public withVerificationStatus(verificationStatus: number): CommitDto {
    ...
    public withGpgPrimaryKeyId(gpgPrimaryKeyId: string): CommitDto {
    ...
    public withName(name: string): CommitDto {
        this['name'] = name;
        return this;
    }
    public withGpgNickName(gpgNickName: string): CommitDto {
    ...
    public withGpgTenantName(gpgTenantName: string): CommitDto {
    ...
    public withGpgUserName(gpgUserName: string): CommitDto {
    ...
    public withShortId(shortId: string): CommitDto {
    ...
    public withCreatedAt(createdAt: string): CommitDto {
    ...
    public withTitle(title: string): CommitDto {
        this['title'] = title;
        return this;
    }
    public withAuthorAvatarUrl(authorAvatarUrl: string): CommitDto {
    ...
    public withCommitterAvatarUrl(committerAvatarUrl: string): CommitDto {
    ...
    public withRelateUrl(relateUrl: Array<RelatedCommitSimpleDto>): CommitDto {
    ...
    public withNickName(nickName: string): CommitDto {
    ...
    public withTenantName(tenantName: string): CommitDto {
    ...
    public withUserName(userName: string): CommitDto {
