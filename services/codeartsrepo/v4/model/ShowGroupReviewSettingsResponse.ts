...
export class ShowGroupReviewSettingsResponse extends SdkResponse {
    ...
    public withSecondaryCategoryType(secondaryCategoryType: string): ShowGroupReviewSettingsResponse {
    ...
    public withSecondaryCategories(secondaryCategories: Array<CategoryDto>): ShowGroupReviewSettingsResponse {
