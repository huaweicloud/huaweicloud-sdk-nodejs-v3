...
export class UpdateMergeRequestSettingResponse extends SdkResponse {
    public id?: number;
    ...
    private 'review_mode'?: UpdateMergeRequestSettingResponseReviewModeEnum | string;
    private 'add_notes_after_merged'?: boolean;
    private 'merged_commit_author'?: UpdateMergeRequestSettingResponseMergedCommitAuthorEnum | string;
    private 'evaluation_role'?: UpdateMergeRequestSettingResponseEvaluationRoleEnum | number;
    ...
    private 'merge_method'?: UpdateMergeRequestSettingResponseMergeMethodEnum | string;
    ...
    public withId(id: number): UpdateMergeRequestSettingResponse {
        this['id'] = id;
        return this;
    }
    public withDisableMergeBySelf(disableMergeBySelf: boolean): UpdateMergeRequestSettingResponse {
    ...
    public withDisableApproveBySelf(disableApproveBySelf: boolean): UpdateMergeRequestSettingResponse {
    ...
    public withDisableReviewBySelf(disableReviewBySelf: boolean): UpdateMergeRequestSettingResponse {
    ...
    public withCreatedAt(createdAt: string): UpdateMergeRequestSettingResponse {
    ...
    public withUpdatedAt(updatedAt: string): UpdateMergeRequestSettingResponse {
    ...
    public withCanForceMerge(canForceMerge: boolean): UpdateMergeRequestSettingResponse {
    ...
    public withDisableSquashMerge(disableSquashMerge: boolean): UpdateMergeRequestSettingResponse {
    ...
    public withMustRelateIssue(mustRelateIssue: boolean): UpdateMergeRequestSettingResponse {
    ...
    public withNeedRelateIssueBranches(needRelateIssueBranches: string): UpdateMergeRequestSettingResponse {
    ...
    public withNeedAllIssuesCheckPassed(needAllIssuesCheckPassed: boolean): UpdateMergeRequestSettingResponse {
    ...
    public withReviewMode(reviewMode: UpdateMergeRequestSettingResponseReviewModeEnum | string): UpdateMergeRequestSettingResponse {
        this['review_mode'] = reviewMode;
        return this;
    }
    public set reviewMode(reviewMode: UpdateMergeRequestSettingResponseReviewModeEnum | string  | undefined) {
        this['review_mode'] = reviewMode;
    }
    public get reviewMode(): UpdateMergeRequestSettingResponseReviewModeEnum | string | undefined {
        return this['review_mode'];
    }
    public withAddNotesAfterMerged(addNotesAfterMerged: boolean): UpdateMergeRequestSettingResponse {
    ...
    public withMergedCommitAuthor(mergedCommitAuthor: UpdateMergeRequestSettingResponseMergedCommitAuthorEnum | string): UpdateMergeRequestSettingResponse {
        this['merged_commit_author'] = mergedCommitAuthor;
        return this;
    }
    public set mergedCommitAuthor(mergedCommitAuthor: UpdateMergeRequestSettingResponseMergedCommitAuthorEnum | string  | undefined) {
        this['merged_commit_author'] = mergedCommitAuthor;
    }
    public get mergedCommitAuthor(): UpdateMergeRequestSettingResponseMergedCommitAuthorEnum | string | undefined {
        return this['merged_commit_author'];
    }
    public withEvaluationRole(evaluationRole: UpdateMergeRequestSettingResponseEvaluationRoleEnum | number): UpdateMergeRequestSettingResponse {
        this['evaluation_role'] = evaluationRole;
        return this;
    }
    public set evaluationRole(evaluationRole: UpdateMergeRequestSettingResponseEvaluationRoleEnum | number  | undefined) {
        this['evaluation_role'] = evaluationRole;
    }
    public get evaluationRole(): UpdateMergeRequestSettingResponseEvaluationRoleEnum | number | undefined {
        return this['evaluation_role'];
    }
    public withEvaluationMergeGate(evaluationMergeGate: boolean): UpdateMergeRequestSettingResponse {
    ...
    public withMarkAutoMergedMrAsClosed(markAutoMergedMrAsClosed: boolean): UpdateMergeRequestSettingResponse {
    ...
    public withDeleteSourceBranchWhenMerged(deleteSourceBranchWhenMerged: boolean): UpdateMergeRequestSettingResponse {
    ...
    public withAutoSquashMerge(autoSquashMerge: boolean): UpdateMergeRequestSettingResponse {
    ...
    public withSquashMergeWithNoMergeCommit(squashMergeWithNoMergeCommit: boolean): UpdateMergeRequestSettingResponse {
    ...
    public withOnlyAllowOneIssueCheckPassed(onlyAllowOneIssueCheckPassed: boolean): UpdateMergeRequestSettingResponse {
    ...
    public withEnableCustomEvaluation(enableCustomEvaluation: boolean): UpdateMergeRequestSettingResponse {
    ...
    public withEvaluationTypes(evaluationTypes: Array<EvaluationTypeDto>): UpdateMergeRequestSettingResponse {
    ...
    public withCanReopen(canReopen: boolean): UpdateMergeRequestSettingResponse {
    ...
    public withOnlyAllowMergeIfAllDiscussionsAreResolved(onlyAllowMergeIfAllDiscussionsAreResolved: boolean): UpdateMergeRequestSettingResponse {
    ...
    public withMergeMethod(mergeMethod: UpdateMergeRequestSettingResponseMergeMethodEnum | string): UpdateMergeRequestSettingResponse {
        this['merge_method'] = mergeMethod;
        return this;
    }
    public set mergeMethod(mergeMethod: UpdateMergeRequestSettingResponseMergeMethodEnum | string  | undefined) {
        this['merge_method'] = mergeMethod;
    }
    public get mergeMethod(): UpdateMergeRequestSettingResponseMergeMethodEnum | string | undefined {
        return this['merge_method'];
    }
    public withOnlyAllowMergeIfVoteBiggerThan(onlyAllowMergeIfVoteBiggerThan: number): UpdateMergeRequestSettingResponse {
    ...
    public withOnlyAssigneeCanMerge(onlyAssigneeCanMerge: boolean): UpdateMergeRequestSettingResponse {
    ...
    public withRepositoryId(repositoryId: number): UpdateMergeRequestSettingResponse {
    ...
    public withHasEvaluationPermission(hasEvaluationPermission: boolean): UpdateMergeRequestSettingResponse {
...
/**
    ...
    * @enum {string}
    */
export enum UpdateMergeRequestSettingResponseReviewModeEnum {
    APPROVAL = 'approval',
    VOTE = 'vote'
}
/**
    ...
    * @enum {string}
    */
export enum UpdateMergeRequestSettingResponseMergedCommitAuthorEnum {
    MERGED_BY = 'merged_by',
...
/**
    ...
    * @enum {string}
    */
export enum UpdateMergeRequestSettingResponseEvaluationRoleEnum {
    NUMBER_29 = 29,
    NUMBER_30 = 30,
    NUMBER_35 = 35,
    NUMBER_40 = 40
...
/**
    ...
    * @enum {string}
    */
export enum UpdateMergeRequestSettingResponseMergeMethodEnum {
    MERGE = 'merge',
