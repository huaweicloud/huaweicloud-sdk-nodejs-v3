...
export class UpdateRepositoryLabelResponse extends SdkResponse {
    public id?: number;
    public name?: string;
    public color?: string;
    ...
    public withId(id: number): UpdateRepositoryLabelResponse {
        this['id'] = id;
        return this;
    }
    public withName(name: string): UpdateRepositoryLabelResponse {
        this['name'] = name;
        return this;
    }
    public withColor(color: string): UpdateRepositoryLabelResponse {
        this['color'] = color;
        return this;
    }
    public withDescription(description: string): UpdateRepositoryLabelResponse {
        this['description'] = description;
        return this;
    }
    public withTextColor(textColor: string): UpdateRepositoryLabelResponse {
    ...
    public withExpiresAt(expiresAt: string): UpdateRepositoryLabelResponse {
    ...
    public withIsExpired(isExpired: boolean): UpdateRepositoryLabelResponse {
    ...
    public withOpenMergeRequestsCount(openMergeRequestsCount: number): UpdateRepositoryLabelResponse {
    ...
    public withOpenChangeRequestCount(openChangeRequestCount: number): UpdateRepositoryLabelResponse {
    ...
    public withPriority(priority: number): UpdateRepositoryLabelResponse {
