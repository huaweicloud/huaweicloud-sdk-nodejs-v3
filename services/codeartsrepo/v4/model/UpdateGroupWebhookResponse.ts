...
export class UpdateGroupWebhookResponse extends SdkResponse {
    ...
    public withNotePlainTextFilter(notePlainTextFilter: Array<string>): UpdateGroupWebhookResponse {
    ...
    public withEventCfgs(eventCfgs: Array<WebHookEventCfgDto>): UpdateGroupWebhookResponse {
    ...
    public withProjectCfgs(projectCfgs: Array<WebHookBranchCfgDto>): UpdateGroupWebhookResponse {
    ...
    public withBranchCfgs(branchCfgs: Array<WebHookBranchCfgDto>): UpdateGroupWebhookResponse {
    ...
    public withService(service: string): UpdateGroupWebhookResponse {
