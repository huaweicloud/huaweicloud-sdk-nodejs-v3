...
export class CreateGroupMergeRequestApproverSettingResponse extends SdkResponse {
    public id?: string;
    public target?: string;
    private 'target_type'?: CreateGroupMergeRequestApproverSettingResponseTargetTypeEnum | string;
    ...
    public withId(id: string): CreateGroupMergeRequestApproverSettingResponse {
        this['id'] = id;
        return this;
    }
    public withTarget(target: string): CreateGroupMergeRequestApproverSettingResponse {
        this['target'] = target;
        return this;
    }
    public withTargetType(targetType: CreateGroupMergeRequestApproverSettingResponseTargetTypeEnum | string): CreateGroupMergeRequestApproverSettingResponse {
        this['target_type'] = targetType;
        return this;
    }
    public set targetType(targetType: CreateGroupMergeRequestApproverSettingResponseTargetTypeEnum | string  | undefined) {
        this['target_type'] = targetType;
    }
    public get targetType(): CreateGroupMergeRequestApproverSettingResponseTargetTypeEnum | string | undefined {
        return this['target_type'];
    }
    public withIsUseApproval(isUseApproval: boolean): CreateGroupMergeRequestApproverSettingResponse {
    ...
    public withApprovalRequiredReviewers(approvalRequiredReviewers: number): CreateGroupMergeRequestApproverSettingResponse {
    ...
    public withApprovalRequiredApprovers(approvalRequiredApprovers: number): CreateGroupMergeRequestApproverSettingResponse {
    ...
    public withResetApprovalsOnPush(resetApprovalsOnPush: boolean): CreateGroupMergeRequestApproverSettingResponse {
    ...
    public withResetReviewersOnPush(resetReviewersOnPush: boolean): CreateGroupMergeRequestApproverSettingResponse {
    ...
    public withApproversFromProject(approversFromProject: boolean): CreateGroupMergeRequestApproverSettingResponse {
    ...
    public withAppendReviewerIds(appendReviewerIds: Array<number>): CreateGroupMergeRequestApproverSettingResponse {
    ...
    public withAppendReviewers(appendReviewers: Array<UserBasicDto>): CreateGroupMergeRequestApproverSettingResponse {
    ...
    public withAppendApproverIds(appendApproverIds: Array<number>): CreateGroupMergeRequestApproverSettingResponse {
    ...
    public withAppendApprovers(appendApprovers: Array<UserBasicDto>): CreateGroupMergeRequestApproverSettingResponse {
    ...
    public withOnlyMergeWhenPipelinePass(onlyMergeWhenPipelinePass: boolean): CreateGroupMergeRequestApproverSettingResponse {
    ...
    public withAssigneeIds(assigneeIds: Array<number>): CreateGroupMergeRequestApproverSettingResponse {
    ...
    public withAssignees(assignees: Array<UserBasicDto>): CreateGroupMergeRequestApproverSettingResponse {
        this['assignees'] = assignees;
        return this;
    }
    public withApproverIds(approverIds: Array<number>): CreateGroupMergeRequestApproverSettingResponse {
    ...
    public withApprovers(approvers: Array<UserBasicDto>): CreateGroupMergeRequestApproverSettingResponse {
        this['approvers'] = approvers;
        return this;
    }
    public withReviewerIds(reviewerIds: Array<number>): CreateGroupMergeRequestApproverSettingResponse {
    ...
    public withReviewers(reviewers: Array<UserBasicDto>): CreateGroupMergeRequestApproverSettingResponse {
...
/**
    ...
    * @enum {string}
    */
export enum CreateGroupMergeRequestApproverSettingResponseTargetTypeEnum {
    BRANCH = 'branch',
    FILE = 'file',
    BINARY = 'binary'
}
