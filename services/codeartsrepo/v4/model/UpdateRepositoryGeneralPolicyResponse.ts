...
export class UpdateRepositoryGeneralPolicyResponse extends SdkResponse {
    ...
    public withRepoEncryptionEnabled(repoEncryptionEnabled: boolean): UpdateRepositoryGeneralPolicyResponse {
    ...
    public withRepoEncryptionStatus(repoEncryptionStatus: ProjectEncryptionStatusBriefDto): UpdateRepositoryGeneralPolicyResponse {
