...
export class ShowGroupWebhookLogResponse extends SdkResponse {
    public id?: number;
    ...
    public withId(id: number): ShowGroupWebhookLogResponse {
        this['id'] = id;
        return this;
    }
    public withWebHookId(webHookId: number): ShowGroupWebhookLogResponse {
    ...
    public withTrigger(trigger: string): ShowGroupWebhookLogResponse {
        this['trigger'] = trigger;
        return this;
    }
    public withUrl(url: string): ShowGroupWebhookLogResponse {
        this['url'] = url;
        return this;
    }
    public withResponseStatus(responseStatus: string): ShowGroupWebhookLogResponse {
    ...
    public withExecutionDuration(executionDuration: number): ShowGroupWebhookLogResponse {
    ...
    public withUuid(uuid: string): ShowGroupWebhookLogResponse {
        this['uuid'] = uuid;
        return this;
    }
    public withCreatedAt(createdAt: string): ShowGroupWebhookLogResponse {
    ...
    public withUpdatedAt(updatedAt: string): ShowGroupWebhookLogResponse {
    ...
    public withRequestHeaders(requestHeaders: object): ShowGroupWebhookLogResponse {
    ...
    public withRequestData(requestData: object): ShowGroupWebhookLogResponse {
    ...
    public withResponseHeaders(responseHeaders: object): ShowGroupWebhookLogResponse {
    ...
    public withResponseBody(responseBody: object): ShowGroupWebhookLogResponse {
