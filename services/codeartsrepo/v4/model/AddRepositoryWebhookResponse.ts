...
export class AddRepositoryWebhookResponse extends SdkResponse {
    public url?: string;
    ...
    public withUrl(url: string): AddRepositoryWebhookResponse {
        this['url'] = url;
        return this;
    }
    public withPushEvents(pushEvents: boolean): AddRepositoryWebhookResponse {
    ...
    public withPushEventsBranchRegexFilter(pushEventsBranchRegexFilter: string): AddRepositoryWebhookResponse {
    ...
    public withNotePlainTextFilter(notePlainTextFilter: Array<string>): AddRepositoryWebhookResponse {
    ...
    public withTagPushEvents(tagPushEvents: boolean): AddRepositoryWebhookResponse {
    ...
    public withMergeRequestsEvents(mergeRequestsEvents: boolean): AddRepositoryWebhookResponse {
    ...
    public withNoteEvents(noteEvents: boolean): AddRepositoryWebhookResponse {
    ...
    public withToken(token: string): AddRepositoryWebhookResponse {
        this['token'] = token;
        return this;
    }
    public withTokenType(tokenType: string): AddRepositoryWebhookResponse {
    ...
    public withName(name: string): AddRepositoryWebhookResponse {
        this['name'] = name;
        return this;
    }
    public withDescription(description: string): AddRepositoryWebhookResponse {
        this['description'] = description;
        return this;
    }
    public withEventCfgs(eventCfgs: Array<WebHookEventCfgDto>): AddRepositoryWebhookResponse {
    ...
    public withProjectCfgs(projectCfgs: Array<WebHookBranchCfgDto>): AddRepositoryWebhookResponse {
    ...
    public withBranchCfgs(branchCfgs: Array<WebHookBranchCfgDto>): AddRepositoryWebhookResponse {
    ...
    public withId(id: number): AddRepositoryWebhookResponse {
        this['id'] = id;
        return this;
    }
    public withCreatedAt(createdAt: string): AddRepositoryWebhookResponse {
    ...
    public withUpdatedAt(updatedAt: string): AddRepositoryWebhookResponse {
    ...
    public withService(service: string): AddRepositoryWebhookResponse {
