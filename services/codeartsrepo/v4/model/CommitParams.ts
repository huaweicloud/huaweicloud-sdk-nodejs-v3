...
export class CommitParams {
    ...
    public constructor(branch?: string, commitMessage?: string, actions?: Array<ActionDto>) { 
        this['branch'] = branch;
        this['commit_message'] = commitMessage;
        this['actions'] = actions;
    }
    public withBranch(branch: string): CommitParams {
        this['branch'] = branch;
        return this;
    }
    public withCommitMessage(commitMessage: string): CommitParams {
        this['commit_message'] = commitMessage;
        return this;
    }
    ...
    public withActions(actions: Array<ActionDto>): CommitParams {
        this['actions'] = actions;
        return this;
    }
    public withStartBranch(startBranch: string): CommitParams {
    ...
    public withAuthorEmail(authorEmail: string): CommitParams {
    ...
    public withAuthorName(authorName: string): CommitParams {
    ...
    public withStats(stats: boolean): CommitParams {
        this['stats'] = stats;
        return this;
    }
    public withForce(force: boolean): CommitParams {
        this['force'] = force;
        return this;
    }
}