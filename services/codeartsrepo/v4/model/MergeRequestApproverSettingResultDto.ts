...
export class MergeRequestApproverSettingResultDto {
    public id?: string;
    public target?: string;
    private 'target_type'?: MergeRequestApproverSettingResultDtoTargetTypeEnum | string;
    ...
    public withId(id: string): MergeRequestApproverSettingResultDto {
        this['id'] = id;
        return this;
    }
    public withTarget(target: string): MergeRequestApproverSettingResultDto {
        this['target'] = target;
        return this;
    }
    public withTargetType(targetType: MergeRequestApproverSettingResultDtoTargetTypeEnum | string): MergeRequestApproverSettingResultDto {
        this['target_type'] = targetType;
        return this;
    }
    public set targetType(targetType: MergeRequestApproverSettingResultDtoTargetTypeEnum | string  | undefined) {
        this['target_type'] = targetType;
    }
    public get targetType(): MergeRequestApproverSettingResultDtoTargetTypeEnum | string | undefined {
        return this['target_type'];
    }
    public withIsUseApproval(isUseApproval: boolean): MergeRequestApproverSettingResultDto {
    ...
    public withApprovalRequiredReviewers(approvalRequiredReviewers: number): MergeRequestApproverSettingResultDto {
    ...
    public withApprovalRequiredApprovers(approvalRequiredApprovers: number): MergeRequestApproverSettingResultDto {
    ...
    public withResetApprovalsOnPush(resetApprovalsOnPush: boolean): MergeRequestApproverSettingResultDto {
    ...
    public withResetReviewersOnPush(resetReviewersOnPush: boolean): MergeRequestApproverSettingResultDto {
    ...
    public withApproversFromProject(approversFromProject: boolean): MergeRequestApproverSettingResultDto {
    ...
    public withAppendReviewerIds(appendReviewerIds: Array<number>): MergeRequestApproverSettingResultDto {
    ...
    public withAppendReviewers(appendReviewers: Array<UserBasicDto>): MergeRequestApproverSettingResultDto {
    ...
    public withAppendApproverIds(appendApproverIds: Array<number>): MergeRequestApproverSettingResultDto {
    ...
    public withAppendApprovers(appendApprovers: Array<UserBasicDto>): MergeRequestApproverSettingResultDto {
    ...
    public withOnlyMergeWhenPipelinePass(onlyMergeWhenPipelinePass: boolean): MergeRequestApproverSettingResultDto {
    ...
    public withAssigneeIds(assigneeIds: Array<number>): MergeRequestApproverSettingResultDto {
    ...
    public withAssignees(assignees: Array<UserBasicDto>): MergeRequestApproverSettingResultDto {
        this['assignees'] = assignees;
        return this;
    }
    public withApproverIds(approverIds: Array<number>): MergeRequestApproverSettingResultDto {
    ...
    public withApprovers(approvers: Array<UserBasicDto>): MergeRequestApproverSettingResultDto {
        this['approvers'] = approvers;
        return this;
    }
    public withReviewerIds(reviewerIds: Array<number>): MergeRequestApproverSettingResultDto {
    ...
    public withReviewers(reviewers: Array<UserBasicDto>): MergeRequestApproverSettingResultDto {
...
/**
    ...
    * @enum {string}
    */
export enum MergeRequestApproverSettingResultDtoTargetTypeEnum {
    BRANCH = 'branch',
    FILE = 'file',
    BINARY = 'binary'
}
