...
export class UpdateGroupReviewSettingsResponse extends SdkResponse {
    ...
    public withCategoriesAndModulesEnabled(categoriesAndModulesEnabled: boolean): UpdateGroupReviewSettingsResponse {
    ...
    public withSecondaryCategoryEnabled(secondaryCategoryEnabled: boolean): UpdateGroupReviewSettingsResponse {
    ...
    public withPrimaryCategories(primaryCategories: Array<CategoryDto>): UpdateGroupReviewSettingsResponse {
    ...
    public withReviewDefaultCategories(reviewDefaultCategories: Array<string>): UpdateGroupReviewSettingsResponse {
    ...
    public withReviewCustomizedCategories(reviewCustomizedCategories: Array<string>): UpdateGroupReviewSettingsResponse {
    ...
    public withReviewModules(reviewModules: Array<string>): UpdateGroupReviewSettingsResponse {
    ...
    public withRepositoryId(repositoryId: number): UpdateGroupReviewSettingsResponse {
    ...
    public withNoteRequiredAttributes(noteRequiredAttributes: Array<RequiredAttributeDto>): UpdateGroupReviewSettingsResponse {
    ...
    public withCodehubDefaultCategories(codehubDefaultCategories: Array<CategoryDto>): UpdateGroupReviewSettingsResponse {
    ...
    public withHicodeDefaultCategories(hicodeDefaultCategories: Array<CategoryDto>): UpdateGroupReviewSettingsResponse {
