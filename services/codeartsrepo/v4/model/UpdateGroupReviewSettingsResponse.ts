...
export class UpdateGroupReviewSettingsResponse extends SdkResponse {
    ...
    public withSecondaryCategoryType(secondaryCategoryType: string): UpdateGroupReviewSettingsResponse {
    ...
    public withSecondaryCategories(secondaryCategories: Array<CategoryDto>): UpdateGroupReviewSettingsResponse {
