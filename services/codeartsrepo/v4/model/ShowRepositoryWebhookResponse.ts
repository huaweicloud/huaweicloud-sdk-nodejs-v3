...
export class ShowRepositoryWebhookResponse extends SdkResponse {
    ...
    public withNotePlainTextFilter(notePlainTextFilter: Array<string>): ShowRepositoryWebhookResponse {
    ...
    public withEventCfgs(eventCfgs: Array<WebHookEventCfgDto>): ShowRepositoryWebhookResponse {
    ...
    public withProjectCfgs(projectCfgs: Array<WebHookBranchCfgDto>): ShowRepositoryWebhookResponse {
    ...
    public withBranchCfgs(branchCfgs: Array<WebHookBranchCfgDto>): ShowRepositoryWebhookResponse {
    ...
    public withService(service: string): ShowRepositoryWebhookResponse {
