...
export class RepositoryProtectedActionBasicBodyDto {
    ...
    public withEnable(enable: boolean): RepositoryProtectedActionBasicBodyDto {
        this['enable'] = enable;
        return this;
    }
    ...
    public withRelatedRoleIds(relatedRoleIds: Array<string>): RepositoryProtectedActionBasicBodyDto {
