...
export class AddProjectWebhookResponse extends SdkResponse {
    public url?: string;
    ...
    public withUrl(url: string): AddProjectWebhookResponse {
        this['url'] = url;
        return this;
    }
    public withPushEvents(pushEvents: boolean): AddProjectWebhookResponse {
    ...
    public withPushEventsBranchRegexFilter(pushEventsBranchRegexFilter: string): AddProjectWebhookResponse {
    ...
    public withNotePlainTextFilter(notePlainTextFilter: Array<string>): AddProjectWebhookResponse {
    ...
    public withTagPushEvents(tagPushEvents: boolean): AddProjectWebhookResponse {
    ...
    public withMergeRequestsEvents(mergeRequestsEvents: boolean): AddProjectWebhookResponse {
    ...
    public withNoteEvents(noteEvents: boolean): AddProjectWebhookResponse {
    ...
    public withToken(token: string): AddProjectWebhookResponse {
        this['token'] = token;
        return this;
    }
    public withTokenType(tokenType: string): AddProjectWebhookResponse {
    ...
    public withName(name: string): AddProjectWebhookResponse {
        this['name'] = name;
        return this;
    }
    public withDescription(description: string): AddProjectWebhookResponse {
        this['description'] = description;
        return this;
    }
    public withEventCfgs(eventCfgs: Array<WebHookEventCfgDto>): AddProjectWebhookResponse {
    ...
    public withProjectCfgs(projectCfgs: Array<WebHookBranchCfgDto>): AddProjectWebhookResponse {
    ...
    public withBranchCfgs(branchCfgs: Array<WebHookBranchCfgDto>): AddProjectWebhookResponse {
    ...
    public withId(id: number): AddProjectWebhookResponse {
        this['id'] = id;
        return this;
    }
    public withCreatedAt(createdAt: string): AddProjectWebhookResponse {
    ...
    public withUpdatedAt(updatedAt: string): AddProjectWebhookResponse {
    ...
    public withService(service: string): AddProjectWebhookResponse {
