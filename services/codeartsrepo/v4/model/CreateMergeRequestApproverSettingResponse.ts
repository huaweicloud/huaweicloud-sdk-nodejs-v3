...
export class CreateMergeRequestApproverSettingResponse extends SdkResponse {
    public id?: string;
    public target?: string;
    private 'target_type'?: CreateMergeRequestApproverSettingResponseTargetTypeEnum | string;
    ...
    public withId(id: string): CreateMergeRequestApproverSettingResponse {
        this['id'] = id;
        return this;
    }
    public withTarget(target: string): CreateMergeRequestApproverSettingResponse {
        this['target'] = target;
        return this;
    }
    public withTargetType(targetType: CreateMergeRequestApproverSettingResponseTargetTypeEnum | string): CreateMergeRequestApproverSettingResponse {
        this['target_type'] = targetType;
        return this;
    }
    public set targetType(targetType: CreateMergeRequestApproverSettingResponseTargetTypeEnum | string  | undefined) {
        this['target_type'] = targetType;
    }
    public get targetType(): CreateMergeRequestApproverSettingResponseTargetTypeEnum | string | undefined {
        return this['target_type'];
    }
    public withIsUseApproval(isUseApproval: boolean): CreateMergeRequestApproverSettingResponse {
    ...
    public withApprovalRequiredReviewers(approvalRequiredReviewers: number): CreateMergeRequestApproverSettingResponse {
    ...
    public withApprovalRequiredApprovers(approvalRequiredApprovers: number): CreateMergeRequestApproverSettingResponse {
    ...
    public withResetApprovalsOnPush(resetApprovalsOnPush: boolean): CreateMergeRequestApproverSettingResponse {
    ...
    public withResetReviewersOnPush(resetReviewersOnPush: boolean): CreateMergeRequestApproverSettingResponse {
    ...
    public withApproversFromProject(approversFromProject: boolean): CreateMergeRequestApproverSettingResponse {
    ...
    public withAppendReviewerIds(appendReviewerIds: Array<number>): CreateMergeRequestApproverSettingResponse {
    ...
    public withAppendReviewers(appendReviewers: Array<UserBasicDto>): CreateMergeRequestApproverSettingResponse {
    ...
    public withAppendApproverIds(appendApproverIds: Array<number>): CreateMergeRequestApproverSettingResponse {
    ...
    public withAppendApprovers(appendApprovers: Array<UserBasicDto>): CreateMergeRequestApproverSettingResponse {
    ...
    public withOnlyMergeWhenPipelinePass(onlyMergeWhenPipelinePass: boolean): CreateMergeRequestApproverSettingResponse {
    ...
    public withAssigneeIds(assigneeIds: Array<number>): CreateMergeRequestApproverSettingResponse {
    ...
    public withAssignees(assignees: Array<UserBasicDto>): CreateMergeRequestApproverSettingResponse {
        this['assignees'] = assignees;
        return this;
    }
    public withApproverIds(approverIds: Array<number>): CreateMergeRequestApproverSettingResponse {
    ...
    public withApprovers(approvers: Array<UserBasicDto>): CreateMergeRequestApproverSettingResponse {
        this['approvers'] = approvers;
        return this;
    }
    public withReviewerIds(reviewerIds: Array<number>): CreateMergeRequestApproverSettingResponse {
    ...
    public withReviewers(reviewers: Array<UserBasicDto>): CreateMergeRequestApproverSettingResponse {
...
/**
    ...
    * @enum {string}
    */
export enum CreateMergeRequestApproverSettingResponseTargetTypeEnum {
    BRANCH = 'branch',
    FILE = 'file',
    BINARY = 'binary'
}
