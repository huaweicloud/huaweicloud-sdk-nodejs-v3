...
export class ShowGroupMergeRequestSettingResponse extends SdkResponse {
    public id?: number;
    ...
    private 'review_mode'?: ShowGroupMergeRequestSettingResponseReviewModeEnum | string;
    private 'add_notes_after_merged'?: boolean;
    private 'merged_commit_author'?: ShowGroupMergeRequestSettingResponseMergedCommitAuthorEnum | string;
    private 'evaluation_role'?: ShowGroupMergeRequestSettingResponseEvaluationRoleEnum | number;
    ...
    private 'merge_method'?: ShowGroupMergeRequestSettingResponseMergeMethodEnum | string;
    ...
    public withId(id: number): ShowGroupMergeRequestSettingResponse {
        this['id'] = id;
        return this;
    }
    public withDisableMergeBySelf(disableMergeBySelf: boolean): ShowGroupMergeRequestSettingResponse {
    ...
    public withDisableApproveBySelf(disableApproveBySelf: boolean): ShowGroupMergeRequestSettingResponse {
    ...
    public withDisableReviewBySelf(disableReviewBySelf: boolean): ShowGroupMergeRequestSettingResponse {
    ...
    public withCreatedAt(createdAt: string): ShowGroupMergeRequestSettingResponse {
    ...
    public withUpdatedAt(updatedAt: string): ShowGroupMergeRequestSettingResponse {
    ...
    public withCanForceMerge(canForceMerge: boolean): ShowGroupMergeRequestSettingResponse {
    ...
    public withDisableSquashMerge(disableSquashMerge: boolean): ShowGroupMergeRequestSettingResponse {
    ...
    public withMustRelateIssue(mustRelateIssue: boolean): ShowGroupMergeRequestSettingResponse {
    ...
    public withNeedRelateIssueBranches(needRelateIssueBranches: string): ShowGroupMergeRequestSettingResponse {
    ...
    public withNeedAllIssuesCheckPassed(needAllIssuesCheckPassed: boolean): ShowGroupMergeRequestSettingResponse {
    ...
    public withReviewMode(reviewMode: ShowGroupMergeRequestSettingResponseReviewModeEnum | string): ShowGroupMergeRequestSettingResponse {
        this['review_mode'] = reviewMode;
        return this;
    }
    public set reviewMode(reviewMode: ShowGroupMergeRequestSettingResponseReviewModeEnum | string  | undefined) {
        this['review_mode'] = reviewMode;
    }
    public get reviewMode(): ShowGroupMergeRequestSettingResponseReviewModeEnum | string | undefined {
        return this['review_mode'];
    }
    public withAddNotesAfterMerged(addNotesAfterMerged: boolean): ShowGroupMergeRequestSettingResponse {
    ...
    public withMergedCommitAuthor(mergedCommitAuthor: ShowGroupMergeRequestSettingResponseMergedCommitAuthorEnum | string): ShowGroupMergeRequestSettingResponse {
        this['merged_commit_author'] = mergedCommitAuthor;
        return this;
    }
    public set mergedCommitAuthor(mergedCommitAuthor: ShowGroupMergeRequestSettingResponseMergedCommitAuthorEnum | string  | undefined) {
        this['merged_commit_author'] = mergedCommitAuthor;
    }
    public get mergedCommitAuthor(): ShowGroupMergeRequestSettingResponseMergedCommitAuthorEnum | string | undefined {
        return this['merged_commit_author'];
    }
    public withEvaluationRole(evaluationRole: ShowGroupMergeRequestSettingResponseEvaluationRoleEnum | number): ShowGroupMergeRequestSettingResponse {
        this['evaluation_role'] = evaluationRole;
        return this;
    }
    public set evaluationRole(evaluationRole: ShowGroupMergeRequestSettingResponseEvaluationRoleEnum | number  | undefined) {
        this['evaluation_role'] = evaluationRole;
    }
    public get evaluationRole(): ShowGroupMergeRequestSettingResponseEvaluationRoleEnum | number | undefined {
        return this['evaluation_role'];
    }
    public withEvaluationMergeGate(evaluationMergeGate: boolean): ShowGroupMergeRequestSettingResponse {
    ...
    public withMarkAutoMergedMrAsClosed(markAutoMergedMrAsClosed: boolean): ShowGroupMergeRequestSettingResponse {
    ...
    public withDeleteSourceBranchWhenMerged(deleteSourceBranchWhenMerged: boolean): ShowGroupMergeRequestSettingResponse {
    ...
    public withAutoSquashMerge(autoSquashMerge: boolean): ShowGroupMergeRequestSettingResponse {
    ...
    public withSquashMergeWithNoMergeCommit(squashMergeWithNoMergeCommit: boolean): ShowGroupMergeRequestSettingResponse {
    ...
    public withOnlyAllowOneIssueCheckPassed(onlyAllowOneIssueCheckPassed: boolean): ShowGroupMergeRequestSettingResponse {
    ...
    public withEnableCustomEvaluation(enableCustomEvaluation: boolean): ShowGroupMergeRequestSettingResponse {
    ...
    public withEvaluationTypes(evaluationTypes: Array<EvaluationTypeDto>): ShowGroupMergeRequestSettingResponse {
    ...
    public withCanReopen(canReopen: boolean): ShowGroupMergeRequestSettingResponse {
    ...
    public withOnlyAllowMergeIfAllDiscussionsAreResolved(onlyAllowMergeIfAllDiscussionsAreResolved: boolean): ShowGroupMergeRequestSettingResponse {
    ...
    public withMergeMethod(mergeMethod: ShowGroupMergeRequestSettingResponseMergeMethodEnum | string): ShowGroupMergeRequestSettingResponse {
        this['merge_method'] = mergeMethod;
        return this;
    }
    public set mergeMethod(mergeMethod: ShowGroupMergeRequestSettingResponseMergeMethodEnum | string  | undefined) {
        this['merge_method'] = mergeMethod;
    }
    public get mergeMethod(): ShowGroupMergeRequestSettingResponseMergeMethodEnum | string | undefined {
        return this['merge_method'];
    }
    public withOnlyAllowMergeIfVoteBiggerThan(onlyAllowMergeIfVoteBiggerThan: number): ShowGroupMergeRequestSettingResponse {
    ...
    public withOnlyAssigneeCanMerge(onlyAssigneeCanMerge: boolean): ShowGroupMergeRequestSettingResponse {
    ...
    public withGroupId(groupId: number): ShowGroupMergeRequestSettingResponse {
...
/**
    ...
    * @enum {string}
    */
export enum ShowGroupMergeRequestSettingResponseReviewModeEnum {
    APPROVAL = 'approval',
    VOTE = 'vote'
}
/**
    ...
    * @enum {string}
    */
export enum ShowGroupMergeRequestSettingResponseMergedCommitAuthorEnum {
    MERGED_BY = 'merged_by',
...
/**
    ...
    * @enum {string}
    */
export enum ShowGroupMergeRequestSettingResponseEvaluationRoleEnum {
    NUMBER_29 = 29,
    NUMBER_30 = 30,
    NUMBER_35 = 35,
    NUMBER_40 = 40
...
/**
    ...
    * @enum {string}
    */
export enum ShowGroupMergeRequestSettingResponseMergeMethodEnum {
    MERGE = 'merge',
