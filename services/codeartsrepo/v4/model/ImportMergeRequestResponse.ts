...
export class ImportMergeRequestResponse extends SdkResponse {
    ...
    public withIsSourceBranchDefault(isSourceBranchDefault: boolean): ImportMergeRequestResponse {
    ...
    public withUpvotes(upvotes: number): ImportMergeRequestResponse {
        this['upvotes'] = upvotes;
        return this;
    }
    public withDownvotes(downvotes: number): ImportMergeRequestResponse {
    ...
    public withAssignee(assignee: UserBasicExternalDto): ImportMergeRequestResponse {
    ...
    public withShouldRemoveSourceBranch(shouldRemoveSourceBranch: boolean): ImportMergeRequestResponse {
    ...
    public withOnlyAssigneeCanMerge(onlyAssigneeCanMerge: boolean): ImportMergeRequestResponse {
    ...
    public withTopic(topic: string): ImportMergeRequestResponse {
        this['topic'] = topic;
        return this;
    }
