...
export class DeleteMergeRequestDiscussionRequest {
    ...
    public withRepositoryId(repositoryId: number): DeleteMergeRequestDiscussionRequest {
        this['repository_id'] = repositoryId;
        return this;
    }
    ...
    public withMergeRequestIid(mergeRequestIid: number): DeleteMergeRequestDiscussionRequest {
        this['merge_request_iid'] = mergeRequestIid;
        return this;
    }
    ...
    public withDiscussionId(discussionId: string): DeleteMergeRequestDiscussionRequest {
        this['discussion_id'] = discussionId;
        return this;
    }
    ...
    public withNoteId(noteId: number): DeleteMergeRequestDiscussionRequest {
        this['note_id'] = noteId;
        return this;
    }
