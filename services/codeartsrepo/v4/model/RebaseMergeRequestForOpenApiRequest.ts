...
export class RebaseMergeRequestForOpenApiRequest {
    ...
    public withRepositoryId(repositoryId: number): RebaseMergeRequestForOpenApiRequest {
        this['repository_id'] = repositoryId;
        return this;
    }
    ...
    public withMergeRequestIid(mergeRequestIid: number): RebaseMergeRequestForOpenApiRequest {
        this['merge_request_iid'] = mergeRequestIid;
        return this;
    }
