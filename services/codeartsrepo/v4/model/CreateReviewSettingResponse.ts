...
export class CreateReviewSettingResponse extends SdkResponse {
    ...
    public withCategoriesAndModulesEnabled(categoriesAndModulesEnabled: boolean): CreateReviewSettingResponse {
    ...
    public withSecondaryCategoryEnabled(secondaryCategoryEnabled: boolean): CreateReviewSettingResponse {
    ...
    public withPrimaryCategories(primaryCategories: Array<CategoryDto>): CreateReviewSettingResponse {
    ...
    public withReviewDefaultCategories(reviewDefaultCategories: Array<string>): CreateReviewSettingResponse {
    ...
    public withReviewCustomizedCategories(reviewCustomizedCategories: Array<string>): CreateReviewSettingResponse {
    ...
    public withReviewModules(reviewModules: Array<string>): CreateReviewSettingResponse {
    ...
    public withCodehubDefaultCategories(codehubDefaultCategories: Array<CategoryDto>): CreateReviewSettingResponse {
    ...
    public withHicodeDefaultCategories(hicodeDefaultCategories: Array<CategoryDto>): CreateReviewSettingResponse {
