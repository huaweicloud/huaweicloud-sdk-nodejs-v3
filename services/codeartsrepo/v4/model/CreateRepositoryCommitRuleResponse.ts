...
export class CreateRepositoryCommitRuleResponse extends SdkResponse {
    public id?: number;
    ...
    public withId(id: number): CreateRepositoryCommitRuleResponse {
        this['id'] = id;
        return this;
    }
    public withRepositoryId(repositoryId: number): CreateRepositoryCommitRuleResponse {
    ...
    public withCommitMessageRegex(commitMessageRegex: string): CreateRepositoryCommitRuleResponse {
    ...
    public withCommitMessageNegativeRegex(commitMessageNegativeRegex: string): CreateRepositoryCommitRuleResponse {
    ...
    public withProhibitedFileNameRegex(prohibitedFileNameRegex: string): CreateRepositoryCommitRuleResponse {
    ...
    public withAuthorEmailRegex(authorEmailRegex: string): CreateRepositoryCommitRuleResponse {
    ...
    public withMaxFileSize(maxFileSize: number): CreateRepositoryCommitRuleResponse {
    ...
    public withAllowedMaxFileSize(allowedMaxFileSize: number): CreateRepositoryCommitRuleResponse {
    ...
    public withEffectiveDate(effectiveDate: string): CreateRepositoryCommitRuleResponse {
    ...
    public withBinaryGateEnabled(binaryGateEnabled: boolean): CreateRepositoryCommitRuleResponse {
    ...
    public withPrivilegedUsers(privilegedUsers: Array<RepositoryUserBasicDto>): CreateRepositoryCommitRuleResponse {
    ...
    public withAllowedModifyBinary(allowedModifyBinary: boolean): CreateRepositoryCommitRuleResponse {
    ...
    public withAllowedBinaryFileNameRegex(allowedBinaryFileNameRegex: string): CreateRepositoryCommitRuleResponse {
    ...
    public withAuthorRegex(authorRegex: object): CreateRepositoryCommitRuleResponse {
    ...
    public withUpdatedAt(updatedAt: string): CreateRepositoryCommitRuleResponse {
    ...
    public withName(name: string): CreateRepositoryCommitRuleResponse {
        this['name'] = name;
        return this;
    }
    public withBranchName(branchName: string): CreateRepositoryCommitRuleResponse {
    ...
    public withCreatedAt(createdAt: string): CreateRepositoryCommitRuleResponse {
    ...
    public withSkipRuleCheck(skipRuleCheck: boolean): CreateRepositoryCommitRuleResponse {
    ...
    public withSkipRuleEndDate(skipRuleEndDate: string): CreateRepositoryCommitRuleResponse {
