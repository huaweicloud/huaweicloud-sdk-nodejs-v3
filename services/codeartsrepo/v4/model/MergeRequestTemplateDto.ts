...
export class MergeRequestTemplateDto {
    ...
    public withCreatedAt(createdAt: string): MergeRequestTemplateDto {
    ...
    public withUpdatedAt(updatedAt: string): MergeRequestTemplateDto {
    ...
    public withTemplateName(templateName: string): MergeRequestTemplateDto {
    ...
    public withMergeRequestTitle(mergeRequestTitle: string): MergeRequestTemplateDto {
    ...
    public withIsDefault(isDefault: boolean): MergeRequestTemplateDto {
    ...
    public withIsWip(isWip: boolean): MergeRequestTemplateDto {
        this['is_wip'] = isWip;
        return this;
    }
    ...
    public withAutoExtractMrTitle(autoExtractMrTitle: number): MergeRequestTemplateDto {
    ...
    public withCreator(creator: UserBasicDto): MergeRequestTemplateDto {
