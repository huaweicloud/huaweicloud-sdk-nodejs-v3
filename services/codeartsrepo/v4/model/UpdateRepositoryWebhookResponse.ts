...
export class UpdateRepositoryWebhookResponse extends SdkResponse {
    public url?: string;
    ...
    public withUrl(url: string): UpdateRepositoryWebhookResponse {
        this['url'] = url;
        return this;
    }
    public withPushEvents(pushEvents: boolean): UpdateRepositoryWebhookResponse {
    ...
    public withPushEventsBranchRegexFilter(pushEventsBranchRegexFilter: string): UpdateRepositoryWebhookResponse {
    ...
    public withNotePlainTextFilter(notePlainTextFilter: Array<string>): UpdateRepositoryWebhookResponse {
    ...
    public withTagPushEvents(tagPushEvents: boolean): UpdateRepositoryWebhookResponse {
    ...
    public withMergeRequestsEvents(mergeRequestsEvents: boolean): UpdateRepositoryWebhookResponse {
    ...
    public withNoteEvents(noteEvents: boolean): UpdateRepositoryWebhookResponse {
    ...
    public withToken(token: string): UpdateRepositoryWebhookResponse {
        this['token'] = token;
        return this;
    }
    public withTokenType(tokenType: string): UpdateRepositoryWebhookResponse {
    ...
    public withName(name: string): UpdateRepositoryWebhookResponse {
        this['name'] = name;
        return this;
    }
    public withDescription(description: string): UpdateRepositoryWebhookResponse {
        this['description'] = description;
        return this;
    }
    public withEventCfgs(eventCfgs: Array<WebHookEventCfgDto>): UpdateRepositoryWebhookResponse {
    ...
    public withProjectCfgs(projectCfgs: Array<WebHookBranchCfgDto>): UpdateRepositoryWebhookResponse {
    ...
    public withBranchCfgs(branchCfgs: Array<WebHookBranchCfgDto>): UpdateRepositoryWebhookResponse {
    ...
    public withId(id: number): UpdateRepositoryWebhookResponse {
        this['id'] = id;
        return this;
    }
    public withCreatedAt(createdAt: string): UpdateRepositoryWebhookResponse {
    ...
    public withUpdatedAt(updatedAt: string): UpdateRepositoryWebhookResponse {
    ...
    public withService(service: string): UpdateRepositoryWebhookResponse {
