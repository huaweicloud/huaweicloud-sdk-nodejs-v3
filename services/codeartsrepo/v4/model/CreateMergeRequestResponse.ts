...
export class CreateMergeRequestResponse extends SdkResponse {
    ...
    public withIsSourceBranchDefault(isSourceBranchDefault: boolean): CreateMergeRequestResponse {
    ...
    public withUpvotes(upvotes: number): CreateMergeRequestResponse {
        this['upvotes'] = upvotes;
        return this;
    }
    public withDownvotes(downvotes: number): CreateMergeRequestResponse {
    ...
    public withAssignee(assignee: UserBasicExternalDto): CreateMergeRequestResponse {
    ...
    public withShouldRemoveSourceBranch(shouldRemoveSourceBranch: boolean): CreateMergeRequestResponse {
    ...
    public withOnlyAssigneeCanMerge(onlyAssigneeCanMerge: boolean): CreateMergeRequestResponse {
    ...
    public withTopic(topic: string): CreateMergeRequestResponse {
        this['topic'] = topic;
        return this;
    }
}
