...
export class ShowProjectReviewSettingsResponse extends SdkResponse {
    ...
    public withSecondaryCategoryType(secondaryCategoryType: string): ShowProjectReviewSettingsResponse {
    ...
    public withSecondaryCategories(secondaryCategories: Array<CategoryDto>): ShowProjectReviewSettingsResponse {
