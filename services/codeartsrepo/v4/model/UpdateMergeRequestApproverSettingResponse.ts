...
export class UpdateMergeRequestApproverSettingResponse extends SdkResponse {
    public id?: string;
    public target?: string;
    private 'target_type'?: UpdateMergeRequestApproverSettingResponseTargetTypeEnum | string;
    ...
    public withId(id: string): UpdateMergeRequestApproverSettingResponse {
        this['id'] = id;
        return this;
    }
    public withTarget(target: string): UpdateMergeRequestApproverSettingResponse {
        this['target'] = target;
        return this;
    }
    public withTargetType(targetType: UpdateMergeRequestApproverSettingResponseTargetTypeEnum | string): UpdateMergeRequestApproverSettingResponse {
        this['target_type'] = targetType;
        return this;
    }
    public set targetType(targetType: UpdateMergeRequestApproverSettingResponseTargetTypeEnum | string  | undefined) {
        this['target_type'] = targetType;
    }
    public get targetType(): UpdateMergeRequestApproverSettingResponseTargetTypeEnum | string | undefined {
        return this['target_type'];
    }
    public withIsUseApproval(isUseApproval: boolean): UpdateMergeRequestApproverSettingResponse {
    ...
    public withApprovalRequiredReviewers(approvalRequiredReviewers: number): UpdateMergeRequestApproverSettingResponse {
    ...
    public withApprovalRequiredApprovers(approvalRequiredApprovers: number): UpdateMergeRequestApproverSettingResponse {
    ...
    public withResetApprovalsOnPush(resetApprovalsOnPush: boolean): UpdateMergeRequestApproverSettingResponse {
    ...
    public withResetReviewersOnPush(resetReviewersOnPush: boolean): UpdateMergeRequestApproverSettingResponse {
    ...
    public withApproversFromProject(approversFromProject: boolean): UpdateMergeRequestApproverSettingResponse {
    ...
    public withAppendReviewerIds(appendReviewerIds: Array<number>): UpdateMergeRequestApproverSettingResponse {
    ...
    public withAppendReviewers(appendReviewers: Array<UserBasicDto>): UpdateMergeRequestApproverSettingResponse {
    ...
    public withAppendApproverIds(appendApproverIds: Array<number>): UpdateMergeRequestApproverSettingResponse {
    ...
    public withAppendApprovers(appendApprovers: Array<UserBasicDto>): UpdateMergeRequestApproverSettingResponse {
    ...
    public withOnlyMergeWhenPipelinePass(onlyMergeWhenPipelinePass: boolean): UpdateMergeRequestApproverSettingResponse {
    ...
    public withAssigneeIds(assigneeIds: Array<number>): UpdateMergeRequestApproverSettingResponse {
    ...
    public withAssignees(assignees: Array<UserBasicDto>): UpdateMergeRequestApproverSettingResponse {
        this['assignees'] = assignees;
        return this;
    }
    public withApproverIds(approverIds: Array<number>): UpdateMergeRequestApproverSettingResponse {
    ...
    public withApprovers(approvers: Array<UserBasicDto>): UpdateMergeRequestApproverSettingResponse {
        this['approvers'] = approvers;
        return this;
    }
    public withReviewerIds(reviewerIds: Array<number>): UpdateMergeRequestApproverSettingResponse {
    ...
    public withReviewers(reviewers: Array<UserBasicDto>): UpdateMergeRequestApproverSettingResponse {
...
/**
    ...
    * @enum {string}
    */
export enum UpdateMergeRequestApproverSettingResponseTargetTypeEnum {
    BRANCH = 'branch',
    FILE = 'file',
    BINARY = 'binary'
}
