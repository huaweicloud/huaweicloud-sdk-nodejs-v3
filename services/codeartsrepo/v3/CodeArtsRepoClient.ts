...
export class CodeArtsRepoClient {
    public static newBuilder(): ClientBuilder<CodeArtsRepoClient> {
            let client = new ClientBuilder<CodeArtsRepoClient>(newClient);
            return client;
    }
...
function newClient(client: HcClient): CodeArtsRepoClient {
    return new CodeArtsRepoClient(client);
}
