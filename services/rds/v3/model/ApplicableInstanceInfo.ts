...
export class ApplicableInstanceInfo {
    ...
    public withEntityId(entityId: string): ApplicableInstanceInfo {
        this['entity_id'] = entityId;
        return this;
    }
    ...
    public withEntityName(entityName: string): ApplicableInstanceInfo {
        this['entity_name'] = entityName;
        return this;
    }
