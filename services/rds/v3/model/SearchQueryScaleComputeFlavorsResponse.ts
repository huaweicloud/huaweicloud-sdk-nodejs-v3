...
export class SearchQueryScaleComputeFlavorsResponse extends SdkResponse {
    private 'compute_flavor_groups'?: Array<Computes>;
    public constructor() { 
        super();
    }
    public withComputeFlavorGroups(computeFlavorGroups: Array<Computes>): SearchQueryScaleComputeFlavorsResponse {
