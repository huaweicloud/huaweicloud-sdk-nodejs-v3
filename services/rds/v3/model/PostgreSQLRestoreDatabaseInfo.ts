...
export class PostgreSQLRestoreDatabaseInfo {
    private 'old_name'?: string;
    private 'new_name'?: string;
    public constructor() { 
    }
    public withOldName(oldName: string): PostgreSQLRestoreDatabaseInfo {
    ...
    public withNewName(newName: string): PostgreSQLRestoreDatabaseInfo {
