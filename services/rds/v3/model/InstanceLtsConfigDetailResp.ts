...
export class InstanceLtsConfigDetailResp {
    ...
    public withLogType(logType: string): InstanceLtsConfigDetailResp {
    ...
    public withLtsGroupId(ltsGroupId: string): InstanceLtsConfigDetailResp {
    ...
    public withLtsStreamId(ltsStreamId: string): InstanceLtsConfigDetailResp {
    ...
    public withEnabled(enabled: boolean): InstanceLtsConfigDetailResp {
