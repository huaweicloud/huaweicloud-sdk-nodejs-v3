...
export class ErrorlogDownloadInfo {
    ...
    public withWorkflowId(workflowId: string): ErrorlogDownloadInfo {
        this['workflow_id'] = workflowId;
        return this;
    }
    ...
    public withFileName(fileName: string): ErrorlogDownloadInfo {
        this['file_name'] = fileName;
        return this;
    }
    ...
    public withStatus(status: string): ErrorlogDownloadInfo {
        this['status'] = status;
        return this;
    }
    public withFileSize(fileSize: string): ErrorlogDownloadInfo {
        this['file_size'] = fileSize;
        return this;
    }
    ...
    public withFileLink(fileLink: string): ErrorlogDownloadInfo {
        this['file_link'] = fileLink;
        return this;
    }
    ...
    public withCreateAt(createAt: number): ErrorlogDownloadInfo {
        this['create_at'] = createAt;
        return this;
    }
    ...
    public withUpdateAt(updateAt: number): ErrorlogDownloadInfo {
        this['update_at'] = updateAt;
        return this;
    }
