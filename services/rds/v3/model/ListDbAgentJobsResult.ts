...
export class ListDbAgentJobsResult {
    ...
    public withJobId(jobId: string): ListDbAgentJobsResult {
        this['job_id'] = jobId;
        return this;
    }
    ...
    public withJobName(jobName: string): ListDbAgentJobsResult {
    ...
    public withIsEnabled(isEnabled: boolean): ListDbAgentJobsResult {
    ...
    public withRunTime(runTime: string): ListDbAgentJobsResult {
    ...
    public withRunStatus(runStatus: string): ListDbAgentJobsResult {
    ...
    public withLastFailureTime(lastFailureTime: string): ListDbAgentJobsResult {
    ...
    public withFailureCount(failureCount: number): ListDbAgentJobsResult {
    ...
    public withAgentType(agentType: string): ListDbAgentJobsResult {
    ...
    public withProfileId(profileId: string): ListDbAgentJobsResult {
    ...
    public withProfileName(profileName: string): ListDbAgentJobsResult {
