...
export class ListIpsRulesRequest {
    ...
    public withAffectedApplicationLike(affectedApplicationLike: number): ListIpsRulesRequest {
    ...
    public withCreateTime(createTime: number): ListIpsRulesRequest {
    ...
    public withFwInstanceId(fwInstanceId: string): ListIpsRulesRequest {
    ...
    public withIpsCveLike(ipsCveLike: number): ListIpsRulesRequest {
    ...
    public withIpsGroup(ipsGroup: number): ListIpsRulesRequest {
    ...
    public withIpsId(ipsId: string): ListIpsRulesRequest {
        this['ips_id'] = ipsId;
        return this;
    }
    ...
    public withIpsLevel(ipsLevel: number): ListIpsRulesRequest {
    ...
    public withIpsNameLike(ipsNameLike: string): ListIpsRulesRequest {
    ...
    public withIpsRulesTypeLike(ipsRulesTypeLike: number): ListIpsRulesRequest {
    ...
    public withIpsStatus(ipsStatus: string): ListIpsRulesRequest {
    ...
    public withIsUpdatedIpsRuleQueried(isUpdatedIpsRuleQueried: boolean): ListIpsRulesRequest {
    ...
    public withLimit(limit: number): ListIpsRulesRequest {
        this['limit'] = limit;
        return this;
    }
    ...
    public withOffset(offset: number): ListIpsRulesRequest {
        this['offset'] = offset;
        return this;
    }
