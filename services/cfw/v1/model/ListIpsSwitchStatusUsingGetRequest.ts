...
export class ListIpsSwitchStatusUsingGetRequest {
    ...
    public withEnterpriseProjectId(enterpriseProjectId: string): ListIpsSwitchStatusUsingGetRequest {
    ...
    public withFwInstanceId(fwInstanceId: string): ListIpsSwitchStatusUsingGetRequest {
