...
export class ScheduleInfoDTOPeriodic {
    public type?: number;
    ...
    public constructor(type?: number, startTime?: string, endTime?: string) { 
        this['type'] = type;
        this['start_time'] = startTime;
        this['end_time'] = endTime;
    }
    public withType(type: number): ScheduleInfoDTOPeriodic {
        this['type'] = type;
        return this;
    }
    public withStartTime(startTime: string): ScheduleInfoDTOPeriodic {
        this['start_time'] = startTime;
        return this;
    }
    ...
    public withEndTime(endTime: string): ScheduleInfoDTOPeriodic {
        this['end_time'] = endTime;
        return this;
    }
    ...
    public withWeekMask(weekMask: Array<number>): ScheduleInfoDTOPeriodic {
    ...
    public withStartWeek(startWeek: number): ScheduleInfoDTOPeriodic {
    ...
    public withEndWeek(endWeek: number): ScheduleInfoDTOPeriodic {
