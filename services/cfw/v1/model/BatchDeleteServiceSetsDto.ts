...
export class BatchDeleteServiceSetsDto {
    ...
    public withObjectId(objectId: string): BatchDeleteServiceSetsDto {
        this['object_id'] = objectId;
        return this;
    }
    ...
    public withSetIds(setIds: Array<string>): BatchDeleteServiceSetsDto {
        this['set_ids'] = setIds;
        return this;
    }
