...
export class DescribePermissionSetProvisioningStatusResponse extends SdkResponse {
    private 'permission_set_provisioning_status'?: PermissionSetProvisioningStatusDto;
    public constructor() { 
        super();
    }
    public withPermissionSetProvisioningStatus(permissionSetProvisioningStatus: PermissionSetProvisioningStatusDto): DescribePermissionSetProvisioningStatusResponse {
