...
export class DescribeApplicationRequest {
    ...
    public withXSecurityToken(xSecurityToken: string): DescribeApplicationRequest {
    ...
    public withInstanceId(instanceId: string): DescribeApplicationRequest {
        this['instance_id'] = instanceId;
        return this;
    }
    ...
    public withApplicationInstanceId(applicationInstanceId: string): DescribeApplicationRequest {
        this['application_instance_id'] = applicationInstanceId;
        return this;
    }
