...
export class GetApplicationInstanceRequest {
    ...
    public withXSecurityToken(xSecurityToken: string): GetApplicationInstanceRequest {
    ...
    public withInstanceId(instanceId: string): GetApplicationInstanceRequest {
        this['instance_id'] = instanceId;
        return this;
    }
    ...
    public withApplicationInstanceId(applicationInstanceId: string): GetApplicationInstanceRequest {
        this['application_instance_id'] = applicationInstanceId;
        return this;
    }
