...
export class DeleteApplicationInstanceRequest {
    ...
    public withXSecurityToken(xSecurityToken: string): DeleteApplicationInstanceRequest {
    ...
    public withInstanceId(instanceId: string): DeleteApplicationInstanceRequest {
        this['instance_id'] = instanceId;
        return this;
    }
    ...
    public withApplicationInstanceId(applicationInstanceId: string): DeleteApplicationInstanceRequest {
        this['application_instance_id'] = applicationInstanceId;
        return this;
    }
