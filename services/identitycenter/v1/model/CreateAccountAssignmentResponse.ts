...
export class CreateAccountAssignmentResponse extends SdkResponse {
    private 'account_assignment_creation_status'?: AccountAssignmentOperationStatusDto;
    public constructor() { 
        super();
    }
    public withAccountAssignmentCreationStatus(accountAssignmentCreationStatus: AccountAssignmentOperationStatusDto): CreateAccountAssignmentResponse {
