...
export class DeletePermissionSetRequest {
    ...
    public withXSecurityToken(xSecurityToken: string): DeletePermissionSetRequest {
    ...
    public withInstanceId(instanceId: string): DeletePermissionSetRequest {
        this['instance_id'] = instanceId;
        return this;
    }
    ...
    public withPermissionSetId(permissionSetId: string): DeletePermissionSetRequest {
        this['permission_set_id'] = permissionSetId;
        return this;
    }
