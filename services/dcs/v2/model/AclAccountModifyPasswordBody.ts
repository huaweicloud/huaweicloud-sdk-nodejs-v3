...
export class AclAccountModifyPasswordBody {
    private 'old_password'?: string;
    private 'new_password'?: string;
    public constructor() { 
    }
    public withOldPassword(oldPassword: string): AclAccountModifyPasswordBody {
    ...
    public withNewPassword(newPassword: string): AclAccountModifyPasswordBody {
