...
export class CreateBigkeyScanTaskResponse extends SdkResponse {
    ...
    public status?: CreateBigkeyScanTaskResponseStatusEnum | string;
    private 'scan_type'?: CreateBigkeyScanTaskResponseScanTypeEnum | string;
    ...
    public withStatus(status: CreateBigkeyScanTaskResponseStatusEnum | string): CreateBigkeyScanTaskResponse {
        this['status'] = status;
        return this;
    }
    public withScanType(scanType: CreateBigkeyScanTaskResponseScanTypeEnum | string): CreateBigkeyScanTaskResponse {
        this['scan_type'] = scanType;
        return this;
    }
    public set scanType(scanType: CreateBigkeyScanTaskResponseScanTypeEnum | string  | undefined) {
        this['scan_type'] = scanType;
    }
    public get scanType(): CreateBigkeyScanTaskResponseScanTypeEnum | string | undefined {
