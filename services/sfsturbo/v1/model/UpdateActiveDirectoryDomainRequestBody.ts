...
export class UpdateActiveDirectoryDomainRequestBody {
    ...
    public withServiceAccount(serviceAccount: string): UpdateActiveDirectoryDomainRequestBody {
        this['service_account'] = serviceAccount;
        return this;
    }
    ...
    public withPassword(password: string): UpdateActiveDirectoryDomainRequestBody {
        this['password'] = password;
        return this;
    }
    public withDomainName(domainName: string): UpdateActiveDirectoryDomainRequestBody {
        this['domain_name'] = domainName;
        return this;
    }
    ...
    public withSystemName(systemName: string): UpdateActiveDirectoryDomainRequestBody {
        this['system_name'] = systemName;
        return this;
    }
    ...
    public withOverwriteSameAccount(overwriteSameAccount: boolean): UpdateActiveDirectoryDomainRequestBody {
    ...
    public withDnsServer(dnsServer: Array<string>): UpdateActiveDirectoryDomainRequestBody {
        this['dns_server'] = dnsServer;
        return this;
    }
    ...
    public withOrganizationUnit(organizationUnit: string): UpdateActiveDirectoryDomainRequestBody {
    ...
    public withVpcId(vpcId: string): UpdateActiveDirectoryDomainRequestBody {
        this['vpc_id'] = vpcId;
        return this;
    }
