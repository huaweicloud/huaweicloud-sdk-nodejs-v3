...
export class ServiceResponse {
    ...
    public constructor(failureReason?: string) { 
        this['failure_reason'] = failureReason;
    }
    public withId(id: string): ServiceResponse {
        this['id'] = id;
        return this;
    }
    public withName(name: string): ServiceResponse {
        this['name'] = name;
        return this;
    }
    public withWorkspaceId(workspaceId: string): ServiceResponse {
    ...
    public withType(type: string): ServiceResponse {
        this['type'] = type;
        return this;
    }
    public withDeployType(deployType: string): ServiceResponse {
    ...
    public withStatus(status: string): ServiceResponse {
        this['status'] = status;
        return this;
    }
    public withFailureReason(failureReason: string): ServiceResponse {
        this['failure_reason'] = failureReason;
        return this;
    }
    ...
    public withVersion(version: ServiceVersionResponse): ServiceResponse {
        this['version'] = version;
        return this;
    }
    public withPredictUrl(predictUrl: Array<PredictUrlResponse>): ServiceResponse {
    ...
    public withDispatcherGroupId(dispatcherGroupId: string): ServiceResponse {
    ...
    public withTags(tags: Array<TagsResponse>): ServiceResponse {
        this['tags'] = tags;
        return this;
    }
    public withDeployTimeoutMinutes(deployTimeoutMinutes: number): ServiceResponse {
    ...
    public withSchedule(schedule: Array<ScheduleConfigResponse>): ServiceResponse {
        this['schedule'] = schedule;
        return this;
    }
    public withCreateAt(createAt: string): ServiceResponse {
    ...
    public withUpdateAt(updateAt: string): ServiceResponse {
    ...
    public withTaskType(taskType: string): ServiceResponse {
    ...
    public withProvider(provider: string): ServiceResponse {
        this['provider'] = provider;
        return this;
    }
    public withFrozenInfos(frozenInfos: Array<FrozenInfo>): ServiceResponse {
