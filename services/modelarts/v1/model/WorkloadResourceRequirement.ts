...
export class WorkloadResourceRequirement {
    public cpu?: string;
    ...
    public withCpu(cpu: string): WorkloadResourceRequirement {
        this['cpu'] = cpu;
        return this;
    }
    public withMemory(memory: string): WorkloadResourceRequirement {
        this['memory'] = memory;
        return this;
    }
    public withNvidiaComGpu(nvidiaComGpu: string): WorkloadResourceRequirement {
    ...
    public withHuaweiComAscend310(huaweiComAscend310: string): WorkloadResourceRequirement {
    ...
    public withHuaweiComAscend1980(huaweiComAscend1980: string): WorkloadResourceRequirement {
