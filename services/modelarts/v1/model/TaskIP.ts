...
export class TaskIP {
    ...
    public withTask(task: string): TaskIP {
        this['task'] = task;
        return this;
    }
    public withIp(ip: string): TaskIP {
        this['ip'] = ip;
        return this;
    }
    public withHostIp(hostIp: string): TaskIP {
        this['host_ip'] = hostIp;
        return this;
    }
    ...
    public withScheduleCount(scheduleCount: number): TaskIP {
