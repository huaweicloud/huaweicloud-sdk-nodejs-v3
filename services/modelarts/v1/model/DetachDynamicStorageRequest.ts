...
export class DetachDynamicStorageRequest {
    ...
    public withInstanceId(instanceId: string): DetachDynamicStorageRequest {
        this['instance_id'] = instanceId;
        return this;
    }
    ...
    public withStorageId(storageId: string): DetachDynamicStorageRequest {
        this['storage_id'] = storageId;
        return this;
    }
