...
export class ShowInferHraRequest {
    ...
    public withServiceId(serviceId: string): ShowInferHraRequest {
        this['service_id'] = serviceId;
        return this;
    }
    ...
    public withDeploymentId(deploymentId: string): ShowInferHraRequest {
        this['deployment_id'] = deploymentId;
        return this;
    }
