...
export class CreateInferDeploymentHpaResponse extends SdkResponse {
    public id?: string;
    public name?: string;
    ...
    public withId(id: string): CreateInferDeploymentHpaResponse {
        this['id'] = id;
        return this;
    }
    public withName(name: string): CreateInferDeploymentHpaResponse {
        this['name'] = name;
        return this;
    }
    public withTargetResourceId(targetResourceId: string): CreateInferDeploymentHpaResponse {
    ...
    public withTargetResourceType(targetResourceType: string): CreateInferDeploymentHpaResponse {
    ...
    public withMinReplicas(minReplicas: number): CreateInferDeploymentHpaResponse {
    ...
    public withMaxReplicas(maxReplicas: number): CreateInferDeploymentHpaResponse {
    ...
    public withStatus(status: string): CreateInferDeploymentHpaResponse {
        this['status'] = status;
        return this;
    }
    public withWorkspaceId(workspaceId: string): CreateInferDeploymentHpaResponse {
    ...
    public withHpaRules(hpaRules: Array<HpaRule>): CreateInferDeploymentHpaResponse {
