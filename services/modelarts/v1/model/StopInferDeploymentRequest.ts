...
export class StopInferDeploymentRequest {
    ...
    public withServiceId(serviceId: string): StopInferDeploymentRequest {
        this['service_id'] = serviceId;
        return this;
    }
    ...
    public withDeploymentId(deploymentId: string): StopInferDeploymentRequest {
        this['deployment_id'] = deploymentId;
        return this;
    }
