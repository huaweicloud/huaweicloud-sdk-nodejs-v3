...
export class ElbConnectionCreateRequest {
    ...
    public withElbId(elbId: string): ElbConnectionCreateRequest {
        this['elb_id'] = elbId;
        return this;
    }
    ...
    public withMTls(mTls: boolean): ElbConnectionCreateRequest {
        this['m_tls'] = mTls;
        return this;
    }
    ...
    public withCaCertId(caCertId: string): ElbConnectionCreateRequest {
    ...
    public withServerCertId(serverCertId: string): ElbConnectionCreateRequest {
    ...
    public withSniCertIds(sniCertIds: Array<string>): ElbConnectionCreateRequest {
