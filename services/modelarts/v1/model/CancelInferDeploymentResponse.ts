...
export class CancelInferDeploymentResponse extends SdkResponse {
    public id?: string;
    public name?: string;
    ...
    public withId(id: string): CancelInferDeploymentResponse {
        this['id'] = id;
        return this;
    }
    public withName(name: string): CancelInferDeploymentResponse {
        this['name'] = name;
        return this;
    }
    public withPoolId(poolId: string): CancelInferDeploymentResponse {
        this['pool_id'] = poolId;
        return this;
    }
    ...
    public withCount(count: number): CancelInferDeploymentResponse {
        this['count'] = count;
        return this;
    }
    public withSystemLogDumpEnable(systemLogDumpEnable: boolean): CancelInferDeploymentResponse {
    ...
    public withUnitConfigs(unitConfigs: Array<UnitConfigResponse>): CancelInferDeploymentResponse {
    ...
    public withWeight(weight: number): CancelInferDeploymentResponse {
        this['weight'] = weight;
        return this;
    }
    public withTrafficRatio(trafficRatio: string): CancelInferDeploymentResponse {
    ...
    public withSecretType(secretType: string): CancelInferDeploymentResponse {
    ...
    public withSecretName(secretName: string): CancelInferDeploymentResponse {
    ...
    public withPriority(priority: number): CancelInferDeploymentResponse {
        this['priority'] = priority;
        return this;
    }
    public withHighAvailSwitch(highAvailSwitch: boolean): CancelInferDeploymentResponse {
    ...
    public withFramework(framework: string): CancelInferDeploymentResponse {
        this['framework'] = framework;
        return this;
    }
    public withVersion(version: string): CancelInferDeploymentResponse {
        this['version'] = version;
        return this;
    }
    public withVersionId(versionId: string): CancelInferDeploymentResponse {
    ...
    public withStatus(status: string): CancelInferDeploymentResponse {
        this['status'] = status;
        return this;
    }
    public withRunningCount(runningCount: number): CancelInferDeploymentResponse {
    ...
    public withDeployType(deployType: string): CancelInferDeploymentResponse {
    ...
    public withMirrorTrafficEnable(mirrorTrafficEnable: boolean): CancelInferDeploymentResponse {
    ...
    public withMirrorTrafficWeight(mirrorTrafficWeight: string): CancelInferDeploymentResponse {
    ...
    public withVersionCount(versionCount: number): CancelInferDeploymentResponse {
    ...
    public withWorkloadType(workloadType: string): CancelInferDeploymentResponse {
    ...
    public withUpdateAt(updateAt: number): CancelInferDeploymentResponse {
    ...
    public withLtsState(ltsState: string): CancelInferDeploymentResponse {
    ...
    public withInferName(inferName: string): CancelInferDeploymentResponse {
    ...
    public withModel(model: InferModelResponse): CancelInferDeploymentResponse {
        this['model'] = model;
        return this;
    }
    public withAdvancedConfig(advancedConfig: AdvancedConfig): CancelInferDeploymentResponse {
    ...
    public withDescription(description: string): CancelInferDeploymentResponse {
        this['description'] = description;
        return this;
    }
    public withCreateAt(createAt: string): CancelInferDeploymentResponse {
    ...
    public withScheduleStrategy(scheduleStrategy: string): CancelInferDeploymentResponse {
