...
export class TaskAlgorithmEngine {
    ...
    public withEngineId(engineId: string): TaskAlgorithmEngine {
    ...
    public withEngineName(engineName: string): TaskAlgorithmEngine {
    ...
    public withEngineVersion(engineVersion: string): TaskAlgorithmEngine {
    ...
    public withImageUrl(imageUrl: string): TaskAlgorithmEngine {
    ...
    public withRunUser(runUser: string): TaskAlgorithmEngine {
