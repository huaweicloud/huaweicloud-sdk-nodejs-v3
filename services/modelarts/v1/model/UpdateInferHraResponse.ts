...
export class UpdateInferHraResponse extends SdkResponse {
    public id?: string;
    ...
    public withId(id: string): UpdateInferHraResponse {
        this['id'] = id;
        return this;
    }
    public withWorkspaceId(workspaceId: string): UpdateInferHraResponse {
    ...
    public withHraRules(hraRules: Array<HraRuleResponse>): UpdateInferHraResponse {
    ...
    public withDisable(disable: boolean): UpdateInferHraResponse {
        this['disable'] = disable;
        return this;
    }
    public withPolicyStatus(policyStatus: string): UpdateInferHraResponse {
    ...
    public withMinReplicas(minReplicas: number): UpdateInferHraResponse {
    ...
    public withMaxReplicas(maxReplicas: number): UpdateInferHraResponse {
    ...
    public withScaleWindow(scaleWindow: number): UpdateInferHraResponse {
