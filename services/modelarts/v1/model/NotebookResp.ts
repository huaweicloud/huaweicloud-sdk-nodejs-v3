...
export class NotebookResp {
    ...
    public name?: string;
    public pool?: Pool;
    public status?: NotebookRespStatusEnum | string;
    public token?: string;
    public url?: string;
    public volume?: VolumeRes;
    private 'workspace_id'?: string;
    public feature?: string;
    private 'billing_items'?: Array<NotebookRespBillingItemsEnum> | Array<string>;
    ...
    public withActionProgress(actionProgress: Array<JobProgress>): NotebookResp {
    ...
    public withDescription(description: string): NotebookResp {
        this['description'] = description;
        return this;
    }
    public withEndpoints(endpoints: Array<EndpointsRes>): NotebookResp {
        this['endpoints'] = endpoints;
        return this;
    }
    public withFailReason(failReason: string): NotebookResp {
    ...
    public withFlavor(flavor: string): NotebookResp {
        this['flavor'] = flavor;
        return this;
    }
    public withCustomSpec(customSpec: NotebookCustomSpecRep): NotebookResp {
    ...
    public withId(id: string): NotebookResp {
        this['id'] = id;
        return this;
    }
    public withImage(image: Image): NotebookResp {
        this['image'] = image;
        return this;
    }
    public withLease(lease: Lease): NotebookResp {
        this['lease'] = lease;
        return this;
    }
    public withName(name: string): NotebookResp {
        this['name'] = name;
        return this;
    }
    public withPool(pool: Pool): NotebookResp {
        this['pool'] = pool;
        return this;
    }
    public withStatus(status: NotebookRespStatusEnum | string): NotebookResp {
        this['status'] = status;
        return this;
    }
    public withToken(token: string): NotebookResp {
        this['token'] = token;
        return this;
    }
    public withUrl(url: string): NotebookResp {
        this['url'] = url;
        return this;
    }
    public withVolume(volume: VolumeRes): NotebookResp {
        this['volume'] = volume;
        return this;
    }
    public withWorkspaceId(workspaceId: string): NotebookResp {
    ...
    public withFeature(feature: string): NotebookResp {
        this['feature'] = feature;
        return this;
    }
    public withBillingItems(billingItems: Array<NotebookRespBillingItemsEnum> | Array<string>): NotebookResp {
        this['billing_items'] = billingItems;
        return this;
    }
    public set billingItems(billingItems: Array<NotebookRespBillingItemsEnum> | Array<string>  | undefined) {
        this['billing_items'] = billingItems;
    }
    public get billingItems(): Array<NotebookRespBillingItemsEnum> | Array<string> | undefined {
        return this['billing_items'];
    }
    public withUser(user: UserResponse): NotebookResp {
        this['user'] = user;
        return this;
    }
    public withAffinity(affinity: AffinityType): NotebookResp {
        this['affinity'] = affinity;
        return this;
    }
    public withRunUser(runUser: RunUserInfo): NotebookResp {
    ...
    public withDataVolumes(dataVolumes: Array<VolumeResponse>): NotebookResp {
    ...
    public withIp(ip: string): NotebookResp {
        this['ip'] = ip;
        return this;
    }
    public withUserVpc(userVpc: UserVpcResponse): NotebookResp {
    ...
    public withUserId(userId: string): NotebookResp {
        this['user_id'] = userId;
        return this;
    }
    ...
    public withIsNeedCredentials(isNeedCredentials: boolean): NotebookResp {
    ...
    public withJupyterVersion(jupyterVersion: string): NotebookResp {
    ...
    public withTags(tags: Array<TmsTagResponse>): NotebookResp {
        this['tags'] = tags;
        return this;
    }
}
...
/**
    ...
    * @enum {string}
    */
export enum NotebookRespStatusEnum {
...
/**
    ...
    * @enum {string}
    */
export enum NotebookRespBillingItemsEnum {
    STORAGE = 'STORAGE',
    COMPUTE = 'COMPUTE',
    ALL = 'ALL'
}
