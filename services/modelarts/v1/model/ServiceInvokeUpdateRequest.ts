import { ElbConnectionUpdateRequest } from './ElbConnectionUpdateRequest';
import { FuseConfig } from './FuseConfig';


export class ServiceInvokeUpdateRequest {
    public port?: number;
    ...
    private 'elb_connection'?: ElbConnectionUpdateRequest;
    ...
    public withPort(port: number): ServiceInvokeUpdateRequest {
        this['port'] = port;
        return this;
    }
    public withProtocol(protocol: string): ServiceInvokeUpdateRequest {
        this['protocol'] = protocol;
        return this;
    }
    public withAuthType(authType: string): ServiceInvokeUpdateRequest {
        this['auth_type'] = authType;
        return this;
    }
    ...
    public withInternetAccessEnable(internetAccessEnable: boolean): ServiceInvokeUpdateRequest {
    ...
    public withIntranetApprovalEnable(intranetApprovalEnable: boolean): ServiceInvokeUpdateRequest {
    ...
    public withDynamicRoutingEnable(dynamicRoutingEnable: boolean): ServiceInvokeUpdateRequest {
    ...
    public withStrategy(strategy: string): ServiceInvokeUpdateRequest {
        this['strategy'] = strategy;
        return this;
    }
    public withMetricApiScheme(metricApiScheme: string): ServiceInvokeUpdateRequest {
    ...
    public withMetricApiPort(metricApiPort: string): ServiceInvokeUpdateRequest {
    ...
    public withMetricApiPath(metricApiPath: string): ServiceInvokeUpdateRequest {
    ...
    public withEmsEnable(emsEnable: boolean): ServiceInvokeUpdateRequest {
    ...
    public withRequestRetryEnable(requestRetryEnable: boolean): ServiceInvokeUpdateRequest {
    ...
    public withRequestRetryCntMax(requestRetryCntMax: number): ServiceInvokeUpdateRequest {
    ...
    public withRequestRetryIntervalMs(requestRetryIntervalMs: number): ServiceInvokeUpdateRequest {
    ...
    public withFuseConfigs(fuseConfigs: FuseConfig): ServiceInvokeUpdateRequest {
    ...
    public withElbConnection(elbConnection: ElbConnectionUpdateRequest): ServiceInvokeUpdateRequest {
        this['elb_connection'] = elbConnection;
        return this;
    }
    public set elbConnection(elbConnection: ElbConnectionUpdateRequest  | undefined) {
        this['elb_connection'] = elbConnection;
    }
    public get elbConnection(): ElbConnectionUpdateRequest | undefined {
        return this['elb_connection'];
    }
    public withCustomUrls(customUrls: Array<string>): ServiceInvokeUpdateRequest {
