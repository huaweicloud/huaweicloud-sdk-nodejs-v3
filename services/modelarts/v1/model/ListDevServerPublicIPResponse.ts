...
export class ListDevServerPublicIPResponse extends SdkResponse {
    private 'public_ips'?: Array<ServerPublicIp>;
    private 'X-Request-Id'?: string;
    public constructor() { 
        super();
    }
    public withPublicIps(publicIps: Array<ServerPublicIp>): ListDevServerPublicIPResponse {
    ...
    public withXRequestId(xRequestId: string): ListDevServerPublicIPResponse {
