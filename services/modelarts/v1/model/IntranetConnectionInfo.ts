...
export class IntranetConnectionInfo {
    ...
    public type?: IntranetConnectionInfoTypeEnum | string;
    ...
    public withApplicantUserName(applicantUserName: string): IntranetConnectionInfo {
    ...
    public withId(id: string): IntranetConnectionInfo {
        this['id'] = id;
        return this;
    }
    public withMessage(message: string): IntranetConnectionInfo {
        this['message'] = message;
        return this;
    }
    public withOwnerDomainName(ownerDomainName: string): IntranetConnectionInfo {
    ...
    public withScene(scene: string): IntranetConnectionInfo {
        this['scene'] = scene;
        return this;
    }
    public withServiceId(serviceId: string): IntranetConnectionInfo {
    ...
    public withServiceName(serviceName: string): IntranetConnectionInfo {
    ...
    public withStatus(status: string): IntranetConnectionInfo {
        this['status'] = status;
        return this;
    }
    public withSubnetId(subnetId: string): IntranetConnectionInfo {
    ...
    public withUrlList(urlList: Array<string>): IntranetConnectionInfo {
    ...
    public withCustomUrlList(customUrlList: Array<string>): IntranetConnectionInfo {
    ...
    public withVpcId(vpcId: string): IntranetConnectionInfo {
        this['vpc_id'] = vpcId;
        return this;
    }
    ...
    public withDispatcherGroupId(dispatcherGroupId: string): IntranetConnectionInfo {
    ...
    public withType(type: IntranetConnectionInfoTypeEnum | string): IntranetConnectionInfo {
        this['type'] = type;
        return this;
    }
    public withMaosNetworkName(maosNetworkName: string): IntranetConnectionInfo {
    ...
    public withServiceType(serviceType: string): IntranetConnectionInfo {
    ...
    public withPoolId(poolId: string): IntranetConnectionInfo {
        this['pool_id'] = poolId;
        return this;
    }
    ...
    public withCreateAt(createAt: string): IntranetConnectionInfo {
    ...
    public withUpdateAt(updateAt: string): IntranetConnectionInfo {
...
/**
    ...
    * @enum {string}
    */
export enum IntranetConnectionInfoTypeEnum {
    SERVICE = 'SERVICE',
    GLOBAL = 'GLOBAL'
}
