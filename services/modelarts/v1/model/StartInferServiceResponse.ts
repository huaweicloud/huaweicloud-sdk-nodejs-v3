...
export class StartInferServiceResponse extends SdkResponse {
    public id?: string;
    public name?: string;
    ...
    public withId(id: string): StartInferServiceResponse {
        this['id'] = id;
        return this;
    }
    public withName(name: string): StartInferServiceResponse {
        this['name'] = name;
        return this;
    }
    public withWorkspaceId(workspaceId: string): StartInferServiceResponse {
    ...
    public withType(type: string): StartInferServiceResponse {
        this['type'] = type;
        return this;
    }
    public withDeployType(deployType: string): StartInferServiceResponse {
    ...
    public withStatus(status: string): StartInferServiceResponse {
        this['status'] = status;
        return this;
    }
    public withFailureReason(failureReason: string): StartInferServiceResponse {
    ...
    public withVersion(version: ServiceVersionResponse): StartInferServiceResponse {
        this['version'] = version;
        return this;
    }
    public withPredictUrl(predictUrl: Array<PredictUrlResponse>): StartInferServiceResponse {
    ...
    public withDispatcherGroupId(dispatcherGroupId: string): StartInferServiceResponse {
    ...
    public withTags(tags: Array<TagsResponse>): StartInferServiceResponse {
        this['tags'] = tags;
        return this;
    }
    public withDeployTimeoutMinutes(deployTimeoutMinutes: number): StartInferServiceResponse {
    ...
    public withSchedule(schedule: Array<ScheduleConfigResponse>): StartInferServiceResponse {
        this['schedule'] = schedule;
        return this;
    }
    public withCreateAt(createAt: string): StartInferServiceResponse {
    ...
    public withUpdateAt(updateAt: string): StartInferServiceResponse {
    ...
    public withTaskType(taskType: string): StartInferServiceResponse {
    ...
    public withProvider(provider: string): StartInferServiceResponse {
        this['provider'] = provider;
        return this;
    }
    public withFrozenInfos(frozenInfos: Array<FrozenInfo>): StartInferServiceResponse {
