...
export class UpdateInferDeploymentResponse extends SdkResponse {
    public id?: string;
    public name?: string;
    ...
    public withId(id: string): UpdateInferDeploymentResponse {
        this['id'] = id;
        return this;
    }
    public withName(name: string): UpdateInferDeploymentResponse {
        this['name'] = name;
        return this;
    }
    public withWorkspaceId(workspaceId: string): UpdateInferDeploymentResponse {
    ...
    public withType(type: string): UpdateInferDeploymentResponse {
        this['type'] = type;
        return this;
    }
    public withDeployType(deployType: string): UpdateInferDeploymentResponse {
    ...
    public withStatus(status: string): UpdateInferDeploymentResponse {
        this['status'] = status;
        return this;
    }
    public withFailureReason(failureReason: string): UpdateInferDeploymentResponse {
    ...
    public withVersion(version: ServiceVersionResponse): UpdateInferDeploymentResponse {
        this['version'] = version;
        return this;
    }
    public withPredictUrl(predictUrl: Array<PredictUrlResponse>): UpdateInferDeploymentResponse {
    ...
    public withDispatcherGroupId(dispatcherGroupId: string): UpdateInferDeploymentResponse {
    ...
    public withTags(tags: Array<TagsResponse>): UpdateInferDeploymentResponse {
        this['tags'] = tags;
        return this;
    }
    public withDeployTimeoutMinutes(deployTimeoutMinutes: number): UpdateInferDeploymentResponse {
    ...
    public withSchedule(schedule: Array<ScheduleConfigResponse>): UpdateInferDeploymentResponse {
        this['schedule'] = schedule;
        return this;
    }
    public withCreateAt(createAt: string): UpdateInferDeploymentResponse {
    ...
    public withUpdateAt(updateAt: string): UpdateInferDeploymentResponse {
    ...
    public withTaskType(taskType: string): UpdateInferDeploymentResponse {
    ...
    public withProvider(provider: string): UpdateInferDeploymentResponse {
        this['provider'] = provider;
        return this;
    }
    public withFrozenInfos(frozenInfos: Array<FrozenInfo>): UpdateInferDeploymentResponse {
