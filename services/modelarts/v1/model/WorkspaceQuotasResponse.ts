...
export class WorkspaceQuotasResponse {
    ...
    public withMaxQuota(maxQuota: number): WorkspaceQuotasResponse {
    ...
    public withUpdateTime(updateTime: number): WorkspaceQuotasResponse {
    ...
    public withResource(resource: string): WorkspaceQuotasResponse {
        this['resource'] = resource;
        return this;
    }
    public withQuota(quota: number): WorkspaceQuotasResponse {
        this['quota'] = quota;
        return this;
    }
    public withMinQuota(minQuota: number): WorkspaceQuotasResponse {
    ...
    public withNameCn(nameCn: string): WorkspaceQuotasResponse {
        this['name_cn'] = nameCn;
        return this;
    }
    ...
    public withUnitCn(unitCn: string): WorkspaceQuotasResponse {
        this['unit_cn'] = unitCn;
        return this;
    }
    ...
    public withNameEn(nameEn: string): WorkspaceQuotasResponse {
        this['name_en'] = nameEn;
        return this;
    }
    ...
    public withUnitEn(unitEn: string): WorkspaceQuotasResponse {
        this['unit_en'] = unitEn;
        return this;
    }
    ...
    public withUsedQuota(usedQuota: number): WorkspaceQuotasResponse {
