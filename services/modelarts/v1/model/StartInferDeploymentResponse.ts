...
export class StartInferDeploymentResponse extends SdkResponse {
    public id?: string;
    public name?: string;
    ...
    public withId(id: string): StartInferDeploymentResponse {
        this['id'] = id;
        return this;
    }
    public withName(name: string): StartInferDeploymentResponse {
        this['name'] = name;
        return this;
    }
    public withPoolId(poolId: string): StartInferDeploymentResponse {
        this['pool_id'] = poolId;
        return this;
    }
    ...
    public withCount(count: number): StartInferDeploymentResponse {
        this['count'] = count;
        return this;
    }
    public withSystemLogDumpEnable(systemLogDumpEnable: boolean): StartInferDeploymentResponse {
    ...
    public withUnitConfigs(unitConfigs: Array<UnitConfigResponse>): StartInferDeploymentResponse {
    ...
    public withWeight(weight: number): StartInferDeploymentResponse {
        this['weight'] = weight;
        return this;
    }
    public withTrafficRatio(trafficRatio: string): StartInferDeploymentResponse {
    ...
    public withSecretType(secretType: string): StartInferDeploymentResponse {
    ...
    public withSecretName(secretName: string): StartInferDeploymentResponse {
    ...
    public withPriority(priority: number): StartInferDeploymentResponse {
        this['priority'] = priority;
        return this;
    }
    public withHighAvailSwitch(highAvailSwitch: boolean): StartInferDeploymentResponse {
    ...
    public withFramework(framework: string): StartInferDeploymentResponse {
        this['framework'] = framework;
        return this;
    }
    public withVersion(version: string): StartInferDeploymentResponse {
        this['version'] = version;
        return this;
    }
    public withVersionId(versionId: string): StartInferDeploymentResponse {
    ...
    public withStatus(status: string): StartInferDeploymentResponse {
        this['status'] = status;
        return this;
    }
    public withRunningCount(runningCount: number): StartInferDeploymentResponse {
    ...
    public withDeployType(deployType: string): StartInferDeploymentResponse {
    ...
    public withMirrorTrafficEnable(mirrorTrafficEnable: boolean): StartInferDeploymentResponse {
    ...
    public withMirrorTrafficWeight(mirrorTrafficWeight: string): StartInferDeploymentResponse {
    ...
    public withVersionCount(versionCount: number): StartInferDeploymentResponse {
    ...
    public withWorkloadType(workloadType: string): StartInferDeploymentResponse {
    ...
    public withUpdateAt(updateAt: number): StartInferDeploymentResponse {
    ...
    public withLtsState(ltsState: string): StartInferDeploymentResponse {
    ...
    public withInferName(inferName: string): StartInferDeploymentResponse {
    ...
    public withModel(model: InferModelResponse): StartInferDeploymentResponse {
        this['model'] = model;
        return this;
    }
    public withAdvancedConfig(advancedConfig: AdvancedConfig): StartInferDeploymentResponse {
    ...
    public withDescription(description: string): StartInferDeploymentResponse {
        this['description'] = description;
        return this;
    }
    public withCreateAt(createAt: string): StartInferDeploymentResponse {
    ...
    public withScheduleStrategy(scheduleStrategy: string): StartInferDeploymentResponse {
