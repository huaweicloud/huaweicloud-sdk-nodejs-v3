...
export class WorkflowStepExecutionPolicy {
    private 'execution_policy'?: string;
    private 'use_cache'?: boolean;
    public constructor() { 
    }
    public withExecutionPolicy(executionPolicy: string): WorkflowStepExecutionPolicy {
    ...
    public withUseCache(useCache: boolean): WorkflowStepExecutionPolicy {
