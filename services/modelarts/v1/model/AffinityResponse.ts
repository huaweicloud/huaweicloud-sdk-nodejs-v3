...
export class AffinityResponse {
    ...
    public withAffinityType(affinityType: string): AffinityResponse {
        this['affinity_type'] = affinityType;
        return this;
    }
    ...
    public withRequired(required: boolean): AffinityResponse {
        this['required'] = required;
        return this;
    }
    public withSelectionMode(selectionMode: string): AffinityResponse {
        this['selection_mode'] = selectionMode;
        return this;
    }
    ...
    public withTargets(targets: { [key: string]: string; }): AffinityResponse {
        this['targets'] = targets;
        return this;
    }
}