...
export class StartInferDeploymentRequest {
    ...
    public withServiceId(serviceId: string): StartInferDeploymentRequest {
        this['service_id'] = serviceId;
        return this;
    }
    ...
    public withDeploymentId(deploymentId: string): StartInferDeploymentRequest {
        this['deployment_id'] = deploymentId;
        return this;
    }
