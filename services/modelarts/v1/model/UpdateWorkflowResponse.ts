...
export class UpdateWorkflowResponse extends SdkResponse {
    ...
    public withWorkflowId(workflowId: string): UpdateWorkflowResponse {
    ...
    public withCreatedAt(createdAt: string): UpdateWorkflowResponse {
    ...
    public withSteps(steps: Array<WorkflowStep>): UpdateWorkflowResponse {
        this['steps'] = steps;
        return this;
    }
    public withUserName(userName: string): UpdateWorkflowResponse {
    ...
    public withWorkspaceId(workspaceId: string): UpdateWorkflowResponse {
    ...
    public withDataRequirements(dataRequirements: Array<DataRequirement>): UpdateWorkflowResponse {
    ...
    public withData(data: Array<Data>): UpdateWorkflowResponse {
        this['data'] = data;
        return this;
    }
    public withParameters(parameters: Array<WorkflowParameter>): UpdateWorkflowResponse {
        this['parameters'] = parameters;
        return this;
    }
    public withSourceWorkflowId(sourceWorkflowId: string): UpdateWorkflowResponse {
    ...
    public withGallerySubscription(gallerySubscription: WorkflowGallerySubscription): UpdateWorkflowResponse {
    ...
    public withLatestExecution(latestExecution: ExecutionBrief): UpdateWorkflowResponse {
    ...
    public withRunCount(runCount: number): UpdateWorkflowResponse {
    ...
    public withParamReady(paramReady: boolean): UpdateWorkflowResponse {
    ...
    public withSource(source: string): UpdateWorkflowResponse {
        this['source'] = source;
        return this;
    }
    public withStorages(storages: Array<WorkflowStorage>): UpdateWorkflowResponse {
        this['storages'] = storages;
        return this;
    }
    public withLabels(labels: Array<string>): UpdateWorkflowResponse {
        this['labels'] = labels;
        return this;
    }
    public withAssets(assets: Array<WorkflowAsset>): UpdateWorkflowResponse {
        this['assets'] = assets;
        return this;
    }
    public withSubGraphs(subGraphs: Array<WorkflowSubgraph>): UpdateWorkflowResponse {
    ...
    public withExtend(extend: { [key: string]: object; }): UpdateWorkflowResponse {
        this['extend'] = extend;
        return this;
    }
    public withPolicy(policy: WorkflowPolicy): UpdateWorkflowResponse {
        this['policy'] = policy;
        return this;
    }
    public withWithSubscription(withSubscription: boolean): UpdateWorkflowResponse {
    ...
    public withSmnSwitch(smnSwitch: boolean): UpdateWorkflowResponse {
    ...
    public withSubscriptionId(subscriptionId: string): UpdateWorkflowResponse {
    ...
    public withExemlTemplateId(exemlTemplateId: string): UpdateWorkflowResponse {
    ...
    public withLastModifiedAt(lastModifiedAt: string): UpdateWorkflowResponse {
    ...
    public withPackage(_package: WorkflowServicePackege): UpdateWorkflowResponse {
