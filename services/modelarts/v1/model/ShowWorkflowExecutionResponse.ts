...
export class ShowWorkflowExecutionResponse extends SdkResponse {
    ...
    public withCreatedAt(createdAt: string): ShowWorkflowExecutionResponse {
    ...
    public withName(name: string): ShowWorkflowExecutionResponse {
        this['name'] = name;
        return this;
    }
    ...
    public withDescription(description: string): ShowWorkflowExecutionResponse {
        this['description'] = description;
        return this;
    }
    public withStatus(status: string): ShowWorkflowExecutionResponse {
        this['status'] = status;
        return this;
    }
    public withWorkspaceId(workspaceId: string): ShowWorkflowExecutionResponse {
    ...
    public withWorkflowName(workflowName: string): ShowWorkflowExecutionResponse {
    ...
    public withSceneId(sceneId: string): ShowWorkflowExecutionResponse {
    ...
    public withSceneName(sceneName: string): ShowWorkflowExecutionResponse {
    ...
    public withStepsExecution(stepsExecution: Array<StepExecutionResp>): ShowWorkflowExecutionResponse {
    ...
    public withSubGraphs(subGraphs: Array<WorkflowSubgraphResp>): ShowWorkflowExecutionResponse {
    ...
    public withDuration(duration: string): ShowWorkflowExecutionResponse {
        this['duration'] = duration;
        return this;
    }
    public withEvents(events: Array<string>): ShowWorkflowExecutionResponse {
        this['events'] = events;
        return this;
    }
    public withLabels(labels: Array<string>): ShowWorkflowExecutionResponse {
        this['labels'] = labels;
        return this;
    }
    public withDataRequirements(dataRequirements: Array<DataRequirementResp>): ShowWorkflowExecutionResponse {
    ...
    public withParameters(parameters: Array<WorkflowParameterResp>): ShowWorkflowExecutionResponse {
        this['parameters'] = parameters;
        return this;
    }
    public withPolicies(policies: WorkflowDagPoliciesResp): ShowWorkflowExecutionResponse {
