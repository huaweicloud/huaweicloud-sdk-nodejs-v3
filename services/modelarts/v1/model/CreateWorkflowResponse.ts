...
export class CreateWorkflowResponse extends SdkResponse {
    ...
    public withCreatedAt(createdAt: string): CreateWorkflowResponse {
    ...
    public withSteps(steps: Array<WorkflowStep>): CreateWorkflowResponse {
        this['steps'] = steps;
        return this;
    }
    public withUserName(userName: string): CreateWorkflowResponse {
    ...
    public withWorkspaceId(workspaceId: string): CreateWorkflowResponse {
    ...
    public withDataRequirements(dataRequirements: Array<DataRequirement>): CreateWorkflowResponse {
    ...
    public withData(data: Array<Data>): CreateWorkflowResponse {
        this['data'] = data;
        return this;
    }
    public withParameters(parameters: Array<WorkflowParameter>): CreateWorkflowResponse {
        this['parameters'] = parameters;
        return this;
    }
    public withSourceWorkflowId(sourceWorkflowId: string): CreateWorkflowResponse {
    ...
    public withGallerySubscription(gallerySubscription: WorkflowGallerySubscription): CreateWorkflowResponse {
    ...
    public withLatestExecution(latestExecution: ExecutionBrief): CreateWorkflowResponse {
    ...
    public withRunCount(runCount: number): CreateWorkflowResponse {
    ...
    public withParamReady(paramReady: boolean): CreateWorkflowResponse {
    ...
    public withSource(source: string): CreateWorkflowResponse {
        this['source'] = source;
        return this;
    }
    public withStorages(storages: Array<WorkflowStorage>): CreateWorkflowResponse {
        this['storages'] = storages;
        return this;
    }
    public withLabels(labels: Array<string>): CreateWorkflowResponse {
        this['labels'] = labels;
        return this;
    }
    public withAssets(assets: Array<WorkflowAsset>): CreateWorkflowResponse {
        this['assets'] = assets;
        return this;
    }
    public withSubGraphs(subGraphs: Array<WorkflowSubgraph>): CreateWorkflowResponse {
    ...
    public withExtend(extend: { [key: string]: object; }): CreateWorkflowResponse {
        this['extend'] = extend;
        return this;
    }
    public withPolicy(policy: WorkflowPolicy): CreateWorkflowResponse {
        this['policy'] = policy;
        return this;
    }
    public withWithSubscription(withSubscription: boolean): CreateWorkflowResponse {
    ...
    public withSmnSwitch(smnSwitch: boolean): CreateWorkflowResponse {
    ...
    public withSubscriptionId(subscriptionId: string): CreateWorkflowResponse {
    ...
    public withExemlTemplateId(exemlTemplateId: string): CreateWorkflowResponse {
    ...
    public withLastModifiedAt(lastModifiedAt: string): CreateWorkflowResponse {
    ...
    public withPackage(_package: WorkflowServicePackege): CreateWorkflowResponse {
