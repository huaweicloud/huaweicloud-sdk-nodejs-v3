...
export class GroupConfigResponse {
    public id?: string;
    public name?: string;
    ...
    public withId(id: string): GroupConfigResponse {
        this['id'] = id;
        return this;
    }
    public withName(name: string): GroupConfigResponse {
        this['name'] = name;
        return this;
    }
    public withPoolId(poolId: string): GroupConfigResponse {
        this['pool_id'] = poolId;
        return this;
    }
    ...
    public withCount(count: number): GroupConfigResponse {
        this['count'] = count;
        return this;
    }
    public withSystemLogDumpEnable(systemLogDumpEnable: boolean): GroupConfigResponse {
    ...
    public withUnitConfigs(unitConfigs: Array<UnitConfigResponse>): GroupConfigResponse {
    ...
    public withWeight(weight: number): GroupConfigResponse {
        this['weight'] = weight;
        return this;
    }
    public withTrafficRatio(trafficRatio: string): GroupConfigResponse {
    ...
    public withSecretType(secretType: string): GroupConfigResponse {
    ...
    public withSecretName(secretName: string): GroupConfigResponse {
    ...
    public withPriority(priority: number): GroupConfigResponse {
        this['priority'] = priority;
        return this;
    }
    public withHighAvailSwitch(highAvailSwitch: boolean): GroupConfigResponse {
    ...
    public withFramework(framework: string): GroupConfigResponse {
        this['framework'] = framework;
        return this;
    }
    public withVersion(version: string): GroupConfigResponse {
        this['version'] = version;
        return this;
    }
    public withVersionId(versionId: string): GroupConfigResponse {
    ...
    public withStatus(status: string): GroupConfigResponse {
        this['status'] = status;
        return this;
    }
    public withRunningCount(runningCount: number): GroupConfigResponse {
    ...
    public withDeployType(deployType: string): GroupConfigResponse {
    ...
    public withMirrorTrafficEnable(mirrorTrafficEnable: boolean): GroupConfigResponse {
    ...
    public withMirrorTrafficWeight(mirrorTrafficWeight: string): GroupConfigResponse {
    ...
    public withVersionCount(versionCount: number): GroupConfigResponse {
    ...
    public withWorkloadType(workloadType: string): GroupConfigResponse {
    ...
    public withUpdateAt(updateAt: number): GroupConfigResponse {
    ...
    public withLtsState(ltsState: string): GroupConfigResponse {
    ...
    public withInferName(inferName: string): GroupConfigResponse {
    ...
    public withModel(model: InferModelResponse): GroupConfigResponse {
        this['model'] = model;
        return this;
    }
    public withAdvancedConfig(advancedConfig: AdvancedConfig): GroupConfigResponse {
    ...
    public withDescription(description: string): GroupConfigResponse {
        this['description'] = description;
        return this;
    }
    public withCreateAt(createAt: string): GroupConfigResponse {
    ...
    public withScheduleStrategy(scheduleStrategy: string): GroupConfigResponse {
