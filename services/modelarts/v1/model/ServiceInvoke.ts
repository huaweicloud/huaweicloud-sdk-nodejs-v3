...
export class ServiceInvoke {
    ...
    public withPort(port: number): ServiceInvoke {
        this['port'] = port;
        return this;
    }
    public withProtocol(protocol: string): ServiceInvoke {
        this['protocol'] = protocol;
        return this;
    }
    public withAuthType(authType: string): ServiceInvoke {
        this['auth_type'] = authType;
        return this;
    }
    ...
    public withInternetAccessEnable(internetAccessEnable: boolean): ServiceInvoke {
    ...
    public withIntranetApprovalEnable(intranetApprovalEnable: boolean): ServiceInvoke {
    ...
    public withDynamicRoutingEnable(dynamicRoutingEnable: boolean): ServiceInvoke {
    ...
    public withStrategy(strategy: string): ServiceInvoke {
        this['strategy'] = strategy;
        return this;
    }
    public withMetricApiScheme(metricApiScheme: string): ServiceInvoke {
    ...
    public withMetricApiPort(metricApiPort: string): ServiceInvoke {
    ...
    public withMetricApiPath(metricApiPath: string): ServiceInvoke {
    ...
    public withEmsEnable(emsEnable: boolean): ServiceInvoke {
    ...
    public withRequestRetryEnable(requestRetryEnable: boolean): ServiceInvoke {
    ...
    public withRequestRetryCntMax(requestRetryCntMax: number): ServiceInvoke {
    ...
    public withRequestRetryIntervalMs(requestRetryIntervalMs: number): ServiceInvoke {
    ...
    public withFuseConfigs(fuseConfigs: FuseConfig): ServiceInvoke {
