import { ElbConnectionCreateRequest } from './ElbConnectionCreateRequest';
import { FuseConfig } from './FuseConfig';


export class ServiceInvokeCreateRequest {
    public port?: number;
    ...
    private 'elb_connection'?: ElbConnectionCreateRequest;
    ...
    public withPort(port: number): ServiceInvokeCreateRequest {
        this['port'] = port;
        return this;
    }
    public withProtocol(protocol: string): ServiceInvokeCreateRequest {
        this['protocol'] = protocol;
        return this;
    }
    public withAuthType(authType: string): ServiceInvokeCreateRequest {
        this['auth_type'] = authType;
        return this;
    }
    ...
    public withInternetAccessEnable(internetAccessEnable: boolean): ServiceInvokeCreateRequest {
    ...
    public withIntranetApprovalEnable(intranetApprovalEnable: boolean): ServiceInvokeCreateRequest {
    ...
    public withDynamicRoutingEnable(dynamicRoutingEnable: boolean): ServiceInvokeCreateRequest {
    ...
    public withStrategy(strategy: string): ServiceInvokeCreateRequest {
        this['strategy'] = strategy;
        return this;
    }
    public withMetricApiScheme(metricApiScheme: string): ServiceInvokeCreateRequest {
    ...
    public withMetricApiPort(metricApiPort: string): ServiceInvokeCreateRequest {
    ...
    public withMetricApiPath(metricApiPath: string): ServiceInvokeCreateRequest {
    ...
    public withEmsEnable(emsEnable: boolean): ServiceInvokeCreateRequest {
    ...
    public withRequestRetryEnable(requestRetryEnable: boolean): ServiceInvokeCreateRequest {
    ...
    public withRequestRetryCntMax(requestRetryCntMax: number): ServiceInvokeCreateRequest {
    ...
    public withRequestRetryIntervalMs(requestRetryIntervalMs: number): ServiceInvokeCreateRequest {
    ...
    public withFuseConfigs(fuseConfigs: FuseConfig): ServiceInvokeCreateRequest {
    ...
    public withElbConnection(elbConnection: ElbConnectionCreateRequest): ServiceInvokeCreateRequest {
        this['elb_connection'] = elbConnection;
        return this;
    }
    public set elbConnection(elbConnection: ElbConnectionCreateRequest  | undefined) {
        this['elb_connection'] = elbConnection;
    }
    public get elbConnection(): ElbConnectionCreateRequest | undefined {
        return this['elb_connection'];
    }
    public withCustomUrls(customUrls: Array<string>): ServiceInvokeCreateRequest {
