...
export class CancelInferDeploymentRequest {
    ...
    public withServiceId(serviceId: string): CancelInferDeploymentRequest {
        this['service_id'] = serviceId;
        return this;
    }
    ...
    public withDeploymentId(deploymentId: string): CancelInferDeploymentRequest {
        this['deployment_id'] = deploymentId;
        return this;
    }
