...
export class ShowObsUrlOfTrainingJobLogsRequest {
    ...
    public withTrainingJobId(trainingJobId: string): ShowObsUrlOfTrainingJobLogsRequest {
        this['training_job_id'] = trainingJobId;
        return this;
    }
    ...
    public withTaskId(taskId: string): ShowObsUrlOfTrainingJobLogsRequest {
        this['task_id'] = taskId;
        return this;
    }
