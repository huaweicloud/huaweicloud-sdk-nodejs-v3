...
export class ShowTrainingJobMetricsRequest {
    ...
    public withTrainingJobId(trainingJobId: string): ShowTrainingJobMetricsRequest {
        this['training_job_id'] = trainingJobId;
        return this;
    }
    ...
    public withTaskId(taskId: string): ShowTrainingJobMetricsRequest {
        this['task_id'] = taskId;
        return this;
    }
