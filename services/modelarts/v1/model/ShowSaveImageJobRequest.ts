...
export class ShowSaveImageJobRequest {
    ...
    public withTrainingJobId(trainingJobId: string): ShowSaveImageJobRequest {
        this['training_job_id'] = trainingJobId;
        return this;
    }
    ...
    public withTaskId(taskId: string): ShowSaveImageJobRequest {
        this['task_id'] = taskId;
        return this;
    }
