...
export class CreateNodePoolAnnotations {
    ...
    public withOsModelartsBillingMode(osModelartsBillingMode: string): CreateNodePoolAnnotations {
    ...
    public withOsModelartsPeriodNum(osModelartsPeriodNum: string): CreateNodePoolAnnotations {
    ...
    public withOsModelartsPeriodType(osModelartsPeriodType: string): CreateNodePoolAnnotations {
    ...
    public withOsModelartsAutoRenew(osModelartsAutoRenew: string): CreateNodePoolAnnotations {
    ...
    public withOsModelartsPromotionInfo(osModelartsPromotionInfo: string): CreateNodePoolAnnotations {
    ...
    public withOsModelartsServiceConsoleUrl(osModelartsServiceConsoleUrl: string): CreateNodePoolAnnotations {
    ...
    public withOsModelartsOrderId(osModelartsOrderId: string): CreateNodePoolAnnotations {
