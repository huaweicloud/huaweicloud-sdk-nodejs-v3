...
export class ShowInferDeploymentHpaResponse extends SdkResponse {
    public id?: string;
    public name?: string;
    ...
    public withId(id: string): ShowInferDeploymentHpaResponse {
        this['id'] = id;
        return this;
    }
    public withName(name: string): ShowInferDeploymentHpaResponse {
        this['name'] = name;
        return this;
    }
    public withTargetResourceId(targetResourceId: string): ShowInferDeploymentHpaResponse {
    ...
    public withTargetResourceType(targetResourceType: string): ShowInferDeploymentHpaResponse {
    ...
    public withMinReplicas(minReplicas: number): ShowInferDeploymentHpaResponse {
    ...
    public withMaxReplicas(maxReplicas: number): ShowInferDeploymentHpaResponse {
    ...
    public withStatus(status: string): ShowInferDeploymentHpaResponse {
        this['status'] = status;
        return this;
    }
    public withWorkspaceId(workspaceId: string): ShowInferDeploymentHpaResponse {
    ...
    public withHpaRules(hpaRules: Array<HpaRule>): ShowInferDeploymentHpaResponse {
