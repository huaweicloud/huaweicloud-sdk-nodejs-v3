...
export class CreateWorkflowExecutionResponse extends SdkResponse {
    ...
    public withCreatedAt(createdAt: string): CreateWorkflowExecutionResponse {
    ...
    public withName(name: string): CreateWorkflowExecutionResponse {
        this['name'] = name;
        return this;
    }
    public withExecutionId(executionId: string): CreateWorkflowExecutionResponse {
    ...
    public withDescription(description: string): CreateWorkflowExecutionResponse {
        this['description'] = description;
        return this;
    }
    public withStatus(status: string): CreateWorkflowExecutionResponse {
        this['status'] = status;
        return this;
    }
    public withWorkspaceId(workspaceId: string): CreateWorkflowExecutionResponse {
    ...
    public withWorkflowId(workflowId: string): CreateWorkflowExecutionResponse {
    ...
    public withWorkflowName(workflowName: string): CreateWorkflowExecutionResponse {
    ...
    public withSceneId(sceneId: string): CreateWorkflowExecutionResponse {
    ...
    public withSceneName(sceneName: string): CreateWorkflowExecutionResponse {
    ...
    public withStepsExecution(stepsExecution: Array<StepExecutionResp>): CreateWorkflowExecutionResponse {
    ...
    public withSubGraphs(subGraphs: Array<WorkflowSubgraphResp>): CreateWorkflowExecutionResponse {
    ...
    public withDuration(duration: string): CreateWorkflowExecutionResponse {
        this['duration'] = duration;
        return this;
    }
    public withEvents(events: Array<string>): CreateWorkflowExecutionResponse {
        this['events'] = events;
        return this;
    }
    public withLabels(labels: Array<string>): CreateWorkflowExecutionResponse {
        this['labels'] = labels;
        return this;
    }
    public withDataRequirements(dataRequirements: Array<DataRequirementResp>): CreateWorkflowExecutionResponse {
    ...
    public withParameters(parameters: Array<WorkflowParameterResp>): CreateWorkflowExecutionResponse {
        this['parameters'] = parameters;
        return this;
    }
    public withPolicies(policies: WorkflowDagPoliciesResp): CreateWorkflowExecutionResponse {
