...
export class DeleteInferDeploymentResponse extends SdkResponse {
    public id?: string;
    public name?: string;
    ...
    public withId(id: string): DeleteInferDeploymentResponse {
        this['id'] = id;
        return this;
    }
    public withName(name: string): DeleteInferDeploymentResponse {
        this['name'] = name;
        return this;
    }
    public withPoolId(poolId: string): DeleteInferDeploymentResponse {
        this['pool_id'] = poolId;
        return this;
    }
    ...
    public withCount(count: number): DeleteInferDeploymentResponse {
        this['count'] = count;
        return this;
    }
    public withSystemLogDumpEnable(systemLogDumpEnable: boolean): DeleteInferDeploymentResponse {
    ...
    public withUnitConfigs(unitConfigs: Array<UnitConfigResponse>): DeleteInferDeploymentResponse {
    ...
    public withWeight(weight: number): DeleteInferDeploymentResponse {
        this['weight'] = weight;
        return this;
    }
    public withTrafficRatio(trafficRatio: string): DeleteInferDeploymentResponse {
    ...
    public withSecretType(secretType: string): DeleteInferDeploymentResponse {
    ...
    public withSecretName(secretName: string): DeleteInferDeploymentResponse {
    ...
    public withPriority(priority: number): DeleteInferDeploymentResponse {
        this['priority'] = priority;
        return this;
    }
    public withHighAvailSwitch(highAvailSwitch: boolean): DeleteInferDeploymentResponse {
    ...
    public withFramework(framework: string): DeleteInferDeploymentResponse {
        this['framework'] = framework;
        return this;
    }
    public withVersion(version: string): DeleteInferDeploymentResponse {
        this['version'] = version;
        return this;
    }
    public withVersionId(versionId: string): DeleteInferDeploymentResponse {
    ...
    public withStatus(status: string): DeleteInferDeploymentResponse {
        this['status'] = status;
        return this;
    }
    public withRunningCount(runningCount: number): DeleteInferDeploymentResponse {
    ...
    public withDeployType(deployType: string): DeleteInferDeploymentResponse {
    ...
    public withMirrorTrafficEnable(mirrorTrafficEnable: boolean): DeleteInferDeploymentResponse {
    ...
    public withMirrorTrafficWeight(mirrorTrafficWeight: string): DeleteInferDeploymentResponse {
    ...
    public withVersionCount(versionCount: number): DeleteInferDeploymentResponse {
    ...
    public withWorkloadType(workloadType: string): DeleteInferDeploymentResponse {
    ...
    public withUpdateAt(updateAt: number): DeleteInferDeploymentResponse {
    ...
    public withLtsState(ltsState: string): DeleteInferDeploymentResponse {
    ...
    public withInferName(inferName: string): DeleteInferDeploymentResponse {
    ...
    public withModel(model: InferModelResponse): DeleteInferDeploymentResponse {
        this['model'] = model;
        return this;
    }
    public withAdvancedConfig(advancedConfig: AdvancedConfig): DeleteInferDeploymentResponse {
    ...
    public withDescription(description: string): DeleteInferDeploymentResponse {
        this['description'] = description;
        return this;
    }
    public withCreateAt(createAt: string): DeleteInferDeploymentResponse {
    ...
    public withScheduleStrategy(scheduleStrategy: string): DeleteInferDeploymentResponse {
