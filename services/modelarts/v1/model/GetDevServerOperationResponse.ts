...
export class GetDevServerOperationResponse extends SdkResponse {
    ...
    public withOperationId(operationId: string): GetDevServerOperationResponse {
    ...
    public withOperationStatus(operationStatus: string): GetDevServerOperationResponse {
    ...
    public withOperationType(operationType: string): GetDevServerOperationResponse {
    ...
    public withOperationError(operationError: ServerOperationError): GetDevServerOperationResponse {
