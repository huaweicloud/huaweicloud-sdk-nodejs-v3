...
export class UpdateInferDeploymentScaleResponse extends SdkResponse {
    public id?: string;
    public name?: string;
    ...
    public withId(id: string): UpdateInferDeploymentScaleResponse {
        this['id'] = id;
        return this;
    }
    public withName(name: string): UpdateInferDeploymentScaleResponse {
        this['name'] = name;
        return this;
    }
    public withInferName(inferName: string): UpdateInferDeploymentScaleResponse {
    ...
    public withCreateAt(createAt: Date): UpdateInferDeploymentScaleResponse {
    ...
    public withDescription(description: string): UpdateInferDeploymentScaleResponse {
        this['description'] = description;
        return this;
    }
    public withPoolId(poolId: string): UpdateInferDeploymentScaleResponse {
        this['pool_id'] = poolId;
        return this;
    }
    ...
    public withFramework(framework: string): UpdateInferDeploymentScaleResponse {
        this['framework'] = framework;
        return this;
    }
    public withPriority(priority: string): UpdateInferDeploymentScaleResponse {
        this['priority'] = priority;
        return this;
    }
    public withSecretType(secretType: string): UpdateInferDeploymentScaleResponse {
    ...
    public withStatus(status: string): UpdateInferDeploymentScaleResponse {
        this['status'] = status;
        return this;
    }
    public withCount(count: number): UpdateInferDeploymentScaleResponse {
        this['count'] = count;
        return this;
    }
    public withHighAvailSwitch(highAvailSwitch: string): UpdateInferDeploymentScaleResponse {
    ...
    public withSystemLogDumpEnable(systemLogDumpEnable: string): UpdateInferDeploymentScaleResponse {
    ...
    public withUnitConfigs(unitConfigs: Array<UnitConfig>): UpdateInferDeploymentScaleResponse {
    ...
    public withUpdateAt(updateAt: Date): UpdateInferDeploymentScaleResponse {
    ...
    public withVersion(version: string): UpdateInferDeploymentScaleResponse {
        this['version'] = version;
        return this;
    }
    public withVersionCount(versionCount: number): UpdateInferDeploymentScaleResponse {
    ...
    public withWeight(weight: number): UpdateInferDeploymentScaleResponse {
        this['weight'] = weight;
        return this;
    }
    public withAdvancedConfig(advancedConfig: AdvancedConfig): UpdateInferDeploymentScaleResponse {
    ...
    public withJobId(jobId: string): UpdateInferDeploymentScaleResponse {
        this['job_id'] = jobId;
        return this;
    }
    ...
    public withDeploymentName(deploymentName: string): UpdateInferDeploymentScaleResponse {
    ...
    public withFrozenInfos(frozenInfos: Array<FrozenInfo>): UpdateInferDeploymentScaleResponse {
