...
export class Workflow {
    ...
    public withCreatedAt(createdAt: string): Workflow {
    ...
    public withSteps(steps: Array<WorkflowStep>): Workflow {
        this['steps'] = steps;
        return this;
    }
    public withUserName(userName: string): Workflow {
    ...
    public withWorkspaceId(workspaceId: string): Workflow {
    ...
    public withDataRequirements(dataRequirements: Array<DataRequirement>): Workflow {
    ...
    public withData(data: Array<Data>): Workflow {
        this['data'] = data;
        return this;
    }
    public withParameters(parameters: Array<WorkflowParameter>): Workflow {
        this['parameters'] = parameters;
        return this;
    }
    public withSourceWorkflowId(sourceWorkflowId: string): Workflow {
    ...
    public withGallerySubscription(gallerySubscription: WorkflowGallerySubscription): Workflow {
    ...
    public withLatestExecution(latestExecution: ExecutionBrief): Workflow {
    ...
    public withRunCount(runCount: number): Workflow {
    ...
    public withParamReady(paramReady: boolean): Workflow {
    ...
    public withSource(source: string): Workflow {
        this['source'] = source;
        return this;
    }
    public withStorages(storages: Array<WorkflowStorage>): Workflow {
        this['storages'] = storages;
        return this;
    }
    public withLabels(labels: Array<string>): Workflow {
        this['labels'] = labels;
        return this;
    }
    public withAssets(assets: Array<WorkflowAsset>): Workflow {
        this['assets'] = assets;
        return this;
    }
    public withSubGraphs(subGraphs: Array<WorkflowSubgraph>): Workflow {
    ...
    public withExtend(extend: { [key: string]: object; }): Workflow {
        this['extend'] = extend;
        return this;
    }
    public withPolicy(policy: WorkflowPolicy): Workflow {
        this['policy'] = policy;
        return this;
    }
    public withWithSubscription(withSubscription: boolean): Workflow {
    ...
    public withSmnSwitch(smnSwitch: boolean): Workflow {
    ...
    public withSubscriptionId(subscriptionId: string): Workflow {
    ...
    public withExemlTemplateId(exemlTemplateId: string): Workflow {
    ...
    public withLastModifiedAt(lastModifiedAt: string): Workflow {
    ...
    public withPackage(_package: WorkflowServicePackege): Workflow {
