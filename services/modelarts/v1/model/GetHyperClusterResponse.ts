...
export class GetHyperClusterResponse extends SdkResponse {
    public id?: string;
    public name?: string;
    ...
    public withId(id: string): GetHyperClusterResponse {
        this['id'] = id;
        return this;
    }
    public withName(name: string): GetHyperClusterResponse {
        this['name'] = name;
        return this;
    }
    public withNetworkInfo(networkInfo: Array<HyperClusterNetworkInfo>): GetHyperClusterResponse {
