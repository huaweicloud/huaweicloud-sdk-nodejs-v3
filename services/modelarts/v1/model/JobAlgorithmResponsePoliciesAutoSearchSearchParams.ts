...
export class JobAlgorithmResponsePoliciesAutoSearchSearchParams {
    public name?: string;
    ...
    public withName(name: string): JobAlgorithmResponsePoliciesAutoSearchSearchParams {
        this['name'] = name;
        return this;
    }
    public withParamType(paramType: string): JobAlgorithmResponsePoliciesAutoSearchSearchParams {
    ...
    public withLowerBound(lowerBound: string): JobAlgorithmResponsePoliciesAutoSearchSearchParams {
    ...
    public withUpperBound(upperBound: string): JobAlgorithmResponsePoliciesAutoSearchSearchParams {
    ...
    public withDiscretePointsNum(discretePointsNum: string): JobAlgorithmResponsePoliciesAutoSearchSearchParams {
    ...
    public withDiscreteValues(discreteValues: Array<string>): JobAlgorithmResponsePoliciesAutoSearchSearchParams {
