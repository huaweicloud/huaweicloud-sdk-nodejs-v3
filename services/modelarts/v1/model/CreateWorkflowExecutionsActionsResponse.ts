...
export class CreateWorkflowExecutionsActionsResponse extends SdkResponse {
    ...
    public withCreatedAt(createdAt: string): CreateWorkflowExecutionsActionsResponse {
    ...
    public withName(name: string): CreateWorkflowExecutionsActionsResponse {
        this['name'] = name;
        return this;
    }
    public withExecutionId(executionId: string): CreateWorkflowExecutionsActionsResponse {
    ...
    public withDescription(description: string): CreateWorkflowExecutionsActionsResponse {
        this['description'] = description;
        return this;
    }
    public withStatus(status: string): CreateWorkflowExecutionsActionsResponse {
        this['status'] = status;
        return this;
    }
    public withWorkspaceId(workspaceId: string): CreateWorkflowExecutionsActionsResponse {
    ...
    public withWorkflowId(workflowId: string): CreateWorkflowExecutionsActionsResponse {
    ...
    public withWorkflowName(workflowName: string): CreateWorkflowExecutionsActionsResponse {
    ...
    public withSceneId(sceneId: string): CreateWorkflowExecutionsActionsResponse {
    ...
    public withSceneName(sceneName: string): CreateWorkflowExecutionsActionsResponse {
    ...
    public withStepsExecution(stepsExecution: Array<StepExecutionResp>): CreateWorkflowExecutionsActionsResponse {
    ...
    public withSubGraphs(subGraphs: Array<WorkflowSubgraphResp>): CreateWorkflowExecutionsActionsResponse {
    ...
    public withDuration(duration: string): CreateWorkflowExecutionsActionsResponse {
        this['duration'] = duration;
        return this;
    }
    public withEvents(events: Array<string>): CreateWorkflowExecutionsActionsResponse {
        this['events'] = events;
        return this;
    }
    public withLabels(labels: Array<string>): CreateWorkflowExecutionsActionsResponse {
        this['labels'] = labels;
        return this;
    }
    public withDataRequirements(dataRequirements: Array<DataRequirementResp>): CreateWorkflowExecutionsActionsResponse {
    ...
    public withParameters(parameters: Array<WorkflowParameterResp>): CreateWorkflowExecutionsActionsResponse {
        this['parameters'] = parameters;
        return this;
    }
    public withPolicies(policies: WorkflowDagPoliciesResp): CreateWorkflowExecutionsActionsResponse {
