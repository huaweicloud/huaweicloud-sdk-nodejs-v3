...
export class CreateInferServiceResponse extends SdkResponse {
    public id?: string;
    public name?: string;
    ...
    public withId(id: string): CreateInferServiceResponse {
        this['id'] = id;
        return this;
    }
    public withName(name: string): CreateInferServiceResponse {
        this['name'] = name;
        return this;
    }
    public withWorkspaceId(workspaceId: string): CreateInferServiceResponse {
    ...
    public withType(type: string): CreateInferServiceResponse {
        this['type'] = type;
        return this;
    }
    public withDeployType(deployType: string): CreateInferServiceResponse {
    ...
    public withStatus(status: string): CreateInferServiceResponse {
        this['status'] = status;
        return this;
    }
    public withFailureReason(failureReason: string): CreateInferServiceResponse {
    ...
    public withVersion(version: ServiceVersionResponse): CreateInferServiceResponse {
        this['version'] = version;
        return this;
    }
    public withPredictUrl(predictUrl: Array<PredictUrlResponse>): CreateInferServiceResponse {
    ...
    public withDispatcherGroupId(dispatcherGroupId: string): CreateInferServiceResponse {
    ...
    public withTags(tags: Array<TagsResponse>): CreateInferServiceResponse {
        this['tags'] = tags;
        return this;
    }
    public withDeployTimeoutMinutes(deployTimeoutMinutes: number): CreateInferServiceResponse {
    ...
    public withSchedule(schedule: Array<ScheduleConfigResponse>): CreateInferServiceResponse {
        this['schedule'] = schedule;
        return this;
    }
    public withCreateAt(createAt: string): CreateInferServiceResponse {
    ...
    public withUpdateAt(updateAt: string): CreateInferServiceResponse {
    ...
    public withTaskType(taskType: string): CreateInferServiceResponse {
    ...
    public withProvider(provider: string): CreateInferServiceResponse {
        this['provider'] = provider;
        return this;
    }
    public withFrozenInfos(frozenInfos: Array<FrozenInfo>): CreateInferServiceResponse {
