...
export class ShowWorkflowStepExecutionMetricsRequest {
    ...
    public withWorkflowId(workflowId: string): ShowWorkflowStepExecutionMetricsRequest {
        this['workflow_id'] = workflowId;
        return this;
    }
    ...
    public withExecutionId(executionId: string): ShowWorkflowStepExecutionMetricsRequest {
        this['execution_id'] = executionId;
        return this;
    }
    ...
    public withStepExecutionId(stepExecutionId: string): ShowWorkflowStepExecutionMetricsRequest {
        this['step_execution_id'] = stepExecutionId;
        return this;
    }
