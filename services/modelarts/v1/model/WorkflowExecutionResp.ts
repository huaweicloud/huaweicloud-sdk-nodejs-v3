...
export class WorkflowExecutionResp {
    ...
    public withCreatedAt(createdAt: string): WorkflowExecutionResp {
    ...
    public withName(name: string): WorkflowExecutionResp {
        this['name'] = name;
        return this;
    }
    public withExecutionId(executionId: string): WorkflowExecutionResp {
    ...
    public withDescription(description: string): WorkflowExecutionResp {
        this['description'] = description;
        return this;
    }
    public withStatus(status: string): WorkflowExecutionResp {
        this['status'] = status;
        return this;
    }
    public withWorkspaceId(workspaceId: string): WorkflowExecutionResp {
    ...
    public withWorkflowId(workflowId: string): WorkflowExecutionResp {
    ...
    public withWorkflowName(workflowName: string): WorkflowExecutionResp {
    ...
    public withSceneId(sceneId: string): WorkflowExecutionResp {
    ...
    public withSceneName(sceneName: string): WorkflowExecutionResp {
    ...
    public withStepsExecution(stepsExecution: Array<StepExecutionResp>): WorkflowExecutionResp {
    ...
    public withSubGraphs(subGraphs: Array<WorkflowSubgraphResp>): WorkflowExecutionResp {
    ...
    public withDuration(duration: string): WorkflowExecutionResp {
        this['duration'] = duration;
        return this;
    }
    public withEvents(events: Array<string>): WorkflowExecutionResp {
        this['events'] = events;
        return this;
    }
    public withLabels(labels: Array<string>): WorkflowExecutionResp {
        this['labels'] = labels;
        return this;
    }
    public withDataRequirements(dataRequirements: Array<DataRequirementResp>): WorkflowExecutionResp {
    ...
    public withParameters(parameters: Array<WorkflowParameterResp>): WorkflowExecutionResp {
        this['parameters'] = parameters;
        return this;
    }
    public withPolicies(policies: WorkflowDagPoliciesResp): WorkflowExecutionResp {
