...
export class StopInferServiceResponse extends SdkResponse {
    public id?: string;
    public name?: string;
    ...
    public withId(id: string): StopInferServiceResponse {
        this['id'] = id;
        return this;
    }
    public withName(name: string): StopInferServiceResponse {
        this['name'] = name;
        return this;
    }
    public withWorkspaceId(workspaceId: string): StopInferServiceResponse {
    ...
    public withType(type: string): StopInferServiceResponse {
        this['type'] = type;
        return this;
    }
    public withDeployType(deployType: string): StopInferServiceResponse {
    ...
    public withStatus(status: string): StopInferServiceResponse {
        this['status'] = status;
        return this;
    }
    public withFailureReason(failureReason: string): StopInferServiceResponse {
    ...
    public withVersion(version: ServiceVersionResponse): StopInferServiceResponse {
        this['version'] = version;
        return this;
    }
    public withPredictUrl(predictUrl: Array<PredictUrlResponse>): StopInferServiceResponse {
    ...
    public withDispatcherGroupId(dispatcherGroupId: string): StopInferServiceResponse {
    ...
    public withTags(tags: Array<TagsResponse>): StopInferServiceResponse {
        this['tags'] = tags;
        return this;
    }
    public withDeployTimeoutMinutes(deployTimeoutMinutes: number): StopInferServiceResponse {
    ...
    public withSchedule(schedule: Array<ScheduleConfigResponse>): StopInferServiceResponse {
        this['schedule'] = schedule;
        return this;
    }
    public withCreateAt(createAt: string): StopInferServiceResponse {
    ...
    public withUpdateAt(updateAt: string): StopInferServiceResponse {
    ...
    public withTaskType(taskType: string): StopInferServiceResponse {
    ...
    public withProvider(provider: string): StopInferServiceResponse {
        this['provider'] = provider;
        return this;
    }
    public withFrozenInfos(frozenInfos: Array<FrozenInfo>): StopInferServiceResponse {
