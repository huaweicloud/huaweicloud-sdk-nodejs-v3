...
export class ShowWorkflowTemplateRequest {
    ...
    public withProjectId(projectId: string): ShowWorkflowTemplateRequest {
        this['project_id'] = projectId;
        return this;
    }
    ...
    public withIssueCategory(issueCategory: string): ShowWorkflowTemplateRequest {
        this['issue_category'] = issueCategory;
        return this;
    }
