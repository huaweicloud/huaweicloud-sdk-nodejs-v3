...
export class ListIssueItemResponse {
    ...
    public withActualWorkHours(actualWorkHours: number): ListIssueItemResponse {
    ...
    public withAssignedCcUser(assignedCcUser: Array<IssueUser>): ListIssueItemResponse {
    ...
    public withAssignedUser(assignedUser: IssueUser): ListIssueItemResponse {
    ...
    public withBeginTime(beginTime: string): ListIssueItemResponse {
    ...
    public withCreatedTime(createdTime: string): ListIssueItemResponse {
    ...
    public withCreator(creator: IssueUser): ListIssueItemResponse {
        this['creator'] = creator;
        return this;
    }
    public withCustomFields(customFields: Array<CustomField>): ListIssueItemResponse {
    ...
    public withNewCustomFields(newCustomFields: Array<NewCustomField>): ListIssueItemResponse {
    ...
    public withDeveloper(developer: IssueUser): ListIssueItemResponse {
        this['developer'] = developer;
        return this;
    }
    public withDomain(domain: IssueItemSfV4Domain): ListIssueItemResponse {
        this['domain'] = domain;
        return this;
    }
    public withDoneRatio(doneRatio: number): ListIssueItemResponse {
    ...
    public withEndTime(endTime: string): ListIssueItemResponse {
    ...
    public withExpectedWorkHours(expectedWorkHours: number): ListIssueItemResponse {
    ...
    public withId(id: number): ListIssueItemResponse {
        this['id'] = id;
        return this;
    }
    public withProject(project: IssueProjectResponseV4): ListIssueItemResponse {
        this['project'] = project;
        return this;
    }
    public withIteration(iteration: IssueItemSfV4Iteration): ListIssueItemResponse {
        this['iteration'] = iteration;
        return this;
    }
    public withModule(module: IssueItemSfV4Module): ListIssueItemResponse {
        this['module'] = module;
        return this;
    }
    public withName(name: string): ListIssueItemResponse {
        this['name'] = name;
        return this;
    }
    public withParentIssue(parentIssue: CreateIssueResponseV4ParentIssue): ListIssueItemResponse {
    ...
    public withPriority(priority: IssueItemSfV4Priority): ListIssueItemResponse {
        this['priority'] = priority;
        return this;
    }
    public withOrder(order: IssueResponseV4Order): ListIssueItemResponse {
        this['order'] = order;
        return this;
    }
    public withSeverity(severity: IssueItemSfV4Severity): ListIssueItemResponse {
        this['severity'] = severity;
        return this;
    }
    public withStatus(status: IssueItemSfV4Status): ListIssueItemResponse {
        this['status'] = status;
        return this;
    }
    public withReleaseDev(releaseDev: string): ListIssueItemResponse {
    ...
    public withFindReleaseDev(findReleaseDev: string): ListIssueItemResponse {
    ...
    public withEnv(env: IssueDetailResponseV4Env): ListIssueItemResponse {
        this['env'] = env;
        return this;
    }
    public withTracker(tracker: CreateIssueResponseV4Tracker): ListIssueItemResponse {
        this['tracker'] = tracker;
        return this;
    }
    public withUpdatedTime(updatedTime: string): ListIssueItemResponse {
    ...
    public withClosedTime(closedTime: string): ListIssueItemResponse {
    ...
    public withDeleted(deleted: boolean): ListIssueItemResponse {
