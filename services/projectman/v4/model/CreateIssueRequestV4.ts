...
export class CreateIssueRequestV4 {
    ...
    public constructor(name?: string, priorityId?: number, trackerId?: number) { 
        this['name'] = name;
        this['priority_id'] = priorityId;
        this['tracker_id'] = trackerId;
    }
    public withActualWorkHours(actualWorkHours: number): CreateIssueRequestV4 {
    ...
    public withAssignedId(assignedId: number): CreateIssueRequestV4 {
    ...
    public withBeginTime(beginTime: string): CreateIssueRequestV4 {
    ...
    public withDescription(description: string): CreateIssueRequestV4 {
        this['description'] = description;
        return this;
    }
    public withDeveloperId(developerId: number): CreateIssueRequestV4 {
    ...
    public withDomainId(domainId: number): CreateIssueRequestV4 {
    ...
    public withDoneRatio(doneRatio: number): CreateIssueRequestV4 {
    ...
    public withEndTime(endTime: string): CreateIssueRequestV4 {
    ...
    public withExpectedWorkHours(expectedWorkHours: number): CreateIssueRequestV4 {
    ...
    public withIterationId(iterationId: number): CreateIssueRequestV4 {
    ...
    public withModuleId(moduleId: number): CreateIssueRequestV4 {
    ...
    public withName(name: string): CreateIssueRequestV4 {
        this['name'] = name;
        return this;
    }
    public withParentIssueId(parentIssueId: number): CreateIssueRequestV4 {
    ...
    public withPriorityId(priorityId: number): CreateIssueRequestV4 {
        this['priority_id'] = priorityId;
        return this;
    }
    ...
    public withSeverityId(severityId: number): CreateIssueRequestV4 {
    ...
    public withStatusId(statusId: number): CreateIssueRequestV4 {
    ...
    public withTrackerId(trackerId: number): CreateIssueRequestV4 {
        this['tracker_id'] = trackerId;
        return this;
    }
    ...
    public withNewCustomFields(newCustomFields: Array<NewCustomField>): CreateIssueRequestV4 {
