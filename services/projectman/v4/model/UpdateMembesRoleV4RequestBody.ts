...
export class UpdateMembesRoleV4RequestBody {
    ...
    public withRoleId(roleId: number): UpdateMembesRoleV4RequestBody {
        this['role_id'] = roleId;
        return this;
    }
    ...
    public withUserIds(userIds: Array<string>): UpdateMembesRoleV4RequestBody {
        this['user_ids'] = userIds;
        return this;
    }
