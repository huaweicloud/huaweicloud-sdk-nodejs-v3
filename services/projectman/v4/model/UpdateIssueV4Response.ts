...
export class UpdateIssueV4Response extends SdkResponse {
    ...
    public withActualWorkHours(actualWorkHours: number): UpdateIssueV4Response {
    ...
    public withAssignedCcUser(assignedCcUser: Array<IssueUser>): UpdateIssueV4Response {
    ...
    public withAssignedUser(assignedUser: IssueUser): UpdateIssueV4Response {
    ...
    public withBeginTime(beginTime: string): UpdateIssueV4Response {
    ...
    public withCreatedTime(createdTime: string): UpdateIssueV4Response {
    ...
    public withCreator(creator: IssueUser): UpdateIssueV4Response {
        this['creator'] = creator;
        return this;
    }
    public withCustomFields(customFields: Array<CustomField>): UpdateIssueV4Response {
    ...
    public withNewCustomFields(newCustomFields: Array<NewCustomField>): UpdateIssueV4Response {
    ...
    public withDeveloper(developer: IssueUser): UpdateIssueV4Response {
        this['developer'] = developer;
        return this;
    }
    public withDomain(domain: IssueItemSfV4Domain): UpdateIssueV4Response {
        this['domain'] = domain;
        return this;
    }
    public withDoneRatio(doneRatio: number): UpdateIssueV4Response {
    ...
    public withEndTime(endTime: string): UpdateIssueV4Response {
    ...
    public withExpectedWorkHours(expectedWorkHours: number): UpdateIssueV4Response {
    ...
    public withId(id: number): UpdateIssueV4Response {
        this['id'] = id;
        return this;
    }
    public withProject(project: IssueProjectResponseV4): UpdateIssueV4Response {
        this['project'] = project;
        return this;
    }
    public withIteration(iteration: IssueItemSfV4Iteration): UpdateIssueV4Response {
        this['iteration'] = iteration;
        return this;
    }
    public withModule(module: IssueItemSfV4Module): UpdateIssueV4Response {
        this['module'] = module;
        return this;
    }
    public withName(name: string): UpdateIssueV4Response {
        this['name'] = name;
        return this;
    }
    public withParentIssue(parentIssue: CreateIssueResponseV4ParentIssue): UpdateIssueV4Response {
    ...
    public withPriority(priority: IssueItemSfV4Priority): UpdateIssueV4Response {
        this['priority'] = priority;
        return this;
    }
    public withOrder(order: IssueResponseV4Order): UpdateIssueV4Response {
        this['order'] = order;
        return this;
    }
    public withSeverity(severity: IssueItemSfV4Severity): UpdateIssueV4Response {
        this['severity'] = severity;
        return this;
    }
    public withStatus(status: IssueItemSfV4Status): UpdateIssueV4Response {
        this['status'] = status;
        return this;
    }
    public withReleaseDev(releaseDev: string): UpdateIssueV4Response {
    ...
    public withFindReleaseDev(findReleaseDev: string): UpdateIssueV4Response {
    ...
    public withEnv(env: IssueDetailResponseV4Env): UpdateIssueV4Response {
        this['env'] = env;
        return this;
    }
    public withTracker(tracker: CreateIssueResponseV4Tracker): UpdateIssueV4Response {
        this['tracker'] = tracker;
        return this;
    }
    public withUpdatedTime(updatedTime: string): UpdateIssueV4Response {
    ...
    public withClosedTime(closedTime: string): UpdateIssueV4Response {
