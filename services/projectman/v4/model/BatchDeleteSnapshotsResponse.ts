...
export class BatchDeleteSnapshotsResponse extends SdkResponse {
    ...
    public withMessage(message: string): BatchDeleteSnapshotsResponse {
        this['message'] = message;
        return this;
    }
    public withCode(code: string): BatchDeleteSnapshotsResponse {
        this['code'] = code;
        return this;
    }
    public withTotalCount(totalCount: number): BatchDeleteSnapshotsResponse {
    ...
    public withSuccessCount(successCount: number): BatchDeleteSnapshotsResponse {
    ...
    public withFailureCount(failureCount: number): BatchDeleteSnapshotsResponse {
    ...
    public withFailureDetails(failureDetails: Array<FailureDetail>): BatchDeleteSnapshotsResponse {
