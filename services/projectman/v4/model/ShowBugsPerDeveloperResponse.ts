...
export class ShowBugsPerDeveloperResponse extends SdkResponse {
    ...
    public withDividendValue(dividendValue: string): ShowBugsPerDeveloperResponse {
    ...
    public withDivisorValue(divisorValue: string): ShowBugsPerDeveloperResponse {
    ...
    public withMetricName(metricName: string): ShowBugsPerDeveloperResponse {
    ...
    public withMetricValue(metricValue: string): ShowBugsPerDeveloperResponse {
    ...
    public withProjectId(projectId: string): ShowBugsPerDeveloperResponse {
    ...
    public withProjectName(projectName: string): ShowBugsPerDeveloperResponse {
