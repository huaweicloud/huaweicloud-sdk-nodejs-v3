...
export class RemoveSourcesFromTrafficMirrorSessionResponse extends SdkResponse {
    private 'traffic_mirror_session'?: TrafficMirrorSession;
    private 'request_id'?: string;
    public constructor() { 
        super();
    }
    public withTrafficMirrorSession(trafficMirrorSession: TrafficMirrorSession): RemoveSourcesFromTrafficMirrorSessionResponse {
    ...
    public withRequestId(requestId: string): RemoveSourcesFromTrafficMirrorSessionResponse {
