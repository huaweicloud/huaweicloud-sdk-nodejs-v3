...
export class ShowVirsubnetCidrReservationRequest {
    ...
    public withVirsubnetCidrReservationId(virsubnetCidrReservationId: string): ShowVirsubnetCidrReservationRequest {
        this['virsubnet_cidr_reservation_id'] = virsubnetCidrReservationId;
        return this;
    }
