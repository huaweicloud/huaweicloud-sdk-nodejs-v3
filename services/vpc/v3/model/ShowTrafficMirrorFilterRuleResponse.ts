...
export class ShowTrafficMirrorFilterRuleResponse extends SdkResponse {
    private 'traffic_mirror_filter_rule'?: TrafficMirrorFilterRule;
    private 'request_id'?: string;
    public constructor() { 
        super();
    }
    public withTrafficMirrorFilterRule(trafficMirrorFilterRule: TrafficMirrorFilterRule): ShowTrafficMirrorFilterRuleResponse {
    ...
    public withRequestId(requestId: string): ShowTrafficMirrorFilterRuleResponse {
