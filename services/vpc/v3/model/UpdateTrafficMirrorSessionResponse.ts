...
export class UpdateTrafficMirrorSessionResponse extends SdkResponse {
    private 'traffic_mirror_session'?: TrafficMirrorSession;
    private 'request_id'?: string;
    public constructor() { 
        super();
    }
    public withTrafficMirrorSession(trafficMirrorSession: TrafficMirrorSession): UpdateTrafficMirrorSessionResponse {
    ...
    public withRequestId(requestId: string): UpdateTrafficMirrorSessionResponse {
