...
export class ShowTrafficMirrorFilterResponse extends SdkResponse {
    private 'traffic_mirror_filter'?: TrafficMirrorFilter;
    private 'request_id'?: string;
    public constructor() { 
        super();
    }
    public withTrafficMirrorFilter(trafficMirrorFilter: TrafficMirrorFilter): ShowTrafficMirrorFilterResponse {
    ...
    public withRequestId(requestId: string): ShowTrafficMirrorFilterResponse {
