...
export class ShowVirsubnetCidrReservationResponse extends SdkResponse {
    private 'request_id'?: string;
    private 'virsubnet_cidr_reservation'?: VirsubnetCidrReservation;
    public constructor() { 
        super();
    }
    public withRequestId(requestId: string): ShowVirsubnetCidrReservationResponse {
    ...
    public withVirsubnetCidrReservation(virsubnetCidrReservation: VirsubnetCidrReservation): ShowVirsubnetCidrReservationResponse {
