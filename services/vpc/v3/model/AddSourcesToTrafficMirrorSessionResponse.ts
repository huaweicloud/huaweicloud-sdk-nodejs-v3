...
export class AddSourcesToTrafficMirrorSessionResponse extends SdkResponse {
    private 'traffic_mirror_session'?: TrafficMirrorSession;
    private 'request_id'?: string;
    public constructor() { 
        super();
    }
    public withTrafficMirrorSession(trafficMirrorSession: TrafficMirrorSession): AddSourcesToTrafficMirrorSessionResponse {
    ...
    public withRequestId(requestId: string): AddSourcesToTrafficMirrorSessionResponse {
