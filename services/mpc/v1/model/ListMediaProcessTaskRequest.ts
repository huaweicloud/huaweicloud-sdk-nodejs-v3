...
export class ListMediaProcessTaskRequest {
    ...
    public status?: ListMediaProcessTaskRequestStatusEnum | string;
    ...
    public withStatus(status: ListMediaProcessTaskRequestStatusEnum | string): ListMediaProcessTaskRequest {
        this['status'] = status;
        return this;
    }
