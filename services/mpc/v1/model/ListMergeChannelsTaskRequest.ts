...
export class ListMergeChannelsTaskRequest {
    ...
    public status?: ListMergeChannelsTaskRequestStatusEnum | string;
    ...
    public withStatus(status: ListMergeChannelsTaskRequestStatusEnum | string): ListMergeChannelsTaskRequest {
        this['status'] = status;
        return this;
    }
