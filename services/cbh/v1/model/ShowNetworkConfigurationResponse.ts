...
export class ShowNetworkConfigurationResponse extends SdkResponse {
    ...
    public withStatus(status: boolean): ShowNetworkConfigurationResponse {
        this['status'] = status;
        return this;
    }
    public withSecurityGrpStatus(securityGrpStatus: boolean): ShowNetworkConfigurationResponse {
    ...
    public withFirewallStatus(firewallStatus: boolean): ShowNetworkConfigurationResponse {
    ...
    public withPublicEipStatus(publicEipStatus: boolean): ShowNetworkConfigurationResponse {
