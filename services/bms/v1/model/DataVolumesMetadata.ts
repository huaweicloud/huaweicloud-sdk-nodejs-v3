...
export class DataVolumesMetadata {
    private '__system__encrypted'?: string;
    private '__system__cmkid'?: string;
    public constructor() { 
    }
    public withSystemEncrypted(systemEncrypted: string): DataVolumesMetadata {
    ...
    public withSystemCmkid(systemCmkid: string): DataVolumesMetadata {
