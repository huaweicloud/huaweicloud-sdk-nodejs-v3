...
export class RootVolumeMetadata {
    private '__system__encrypted'?: string;
    private '__system__cmkid'?: string;
    public constructor() { 
    }
    public withSystemEncrypted(systemEncrypted: string): RootVolumeMetadata {
    ...
    public withSystemCmkid(systemCmkid: string): RootVolumeMetadata {
